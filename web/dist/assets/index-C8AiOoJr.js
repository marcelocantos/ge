 ...
 */var B0;function ZS(){if(B0)return Po;B0=1;var r=Symbol.for("react.transitional.element"),t=Symbol.for("react.fragment");function i(s,l,c){var f=null;if(c!==void 0&&(f=""+c),l.key!==void 0&&(f=""+l.key),"key"in l){c={};for(var d in l)d!=="key"&&(c[d]=l[d])}else c=l;return l=c.ref,{$$typeof:r,type:s,key:f,ref:l!==void 0?l:null,props:c}}return Po.Fragment=t,Po.jsx=i,Po.jsxs=i,Po}var I0;function jS(){return I0||(I0=1,ah.exports=ZS()),ah.exports}var Ot=jS(),sh={exports:{}},me={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var H0;function KS(){if(H0)return me;H0=1;var r=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),c=Symbol.for("react.consumer"),f=Symbol.for("react.context"),d=Symbol.for("react.forward_ref"),m=Symbol.for("react.suspense"),p=Symbol.for("react.memo"),g=Symbol.for("react.lazy"),_=Symbol.for("react.activity"),x=Symbol.iterator;function y(L){return L===null||typeof L!="object"?null:(L=x&&L[x]||L["@@iterator"],typeof L=="function"?L:null)}var T={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},C=Object.assign,M={};function v(L,K,ft){this.props=L,this.context=K,this.refs=M,this.updater=ft||T}v.prototype.isReactComponent={},v.prototype.setState=function(L,K){if(typeof L!="object"&&typeof L!="function"&&L!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,L,K,"setState")},v.prototype.forceUpdate=function(L){this.updater.enqueueForceUpdate(this,L,"forceUpdate")};function B(){}B.prototype=v.prototype;function N(L,K,ft){this.props=L,this.context=K,this.refs=M,this.updater=ft||T}var D=N.prototype=new B;D.constructor=N,C(D,v.prototype),D.isPureReactComponent=!0;var O=Array.isArray;function I(){}var z={H:null,A:null,T:null,S:null},Y=Object.prototype.hasOwnProperty;function b(L,K,ft){var Et=ft.ref;return{$$typeof:r,type:L,key:K,ref:Et!==void 0?Et:null,props:ft}}function w(L,K){return b(L.type,K,L.props)}function V(L){return typeof L=="object"&&L!==null&&L.$$typeof===r}function nt(L){var K={"=":"=0",":":"=2"};return"$"+L.replace(/[=:]/g,function(ft){return K[ft]})}var it=/\/+/g;function dt(L,K){return typeof L=="object"&&L!==null&&L.key!=null?nt(""+L.key):K.toString(36)}function rt(L){switch(L.status){case"fulfilled":return L.value;case"rejected":throw L.reason;default:switch(typeof L.status=="string"?L.then(I,I):(L.status="pending",L.then(function(K){L.status==="pending"&&(L.status="fulfilled",L.value=K)},function(K){L.status==="pending"&&(L.status="rejected",L.reason=K)})),L.status){case"fulfilled":return L.value;case"rejected":throw L.reason}}throw L}function F(L,K,ft,Et,Rt){var Q=typeof L;(Q==="undefined"||Q==="boolean")&&(L=null);var ct=!1;if(L===null)ct=!0;else switch(Q){case"bigint":case"string":case"number":ct=!0;break;case"object":switch(L.$$typeof){case r:case t:ct=!0;break;case g:return ct=L._init,F(ct(L._payload),K,ft,Et,Rt)}}if(ct)return Rt=Rt(L),ct=Et===""?"."+dt(L,0):Et,O(Rt)?(ft="",ct!=null&&(ft=ct.replace(it,"$&/")+"/"),F(Rt,K,ft,"",function(qt){return qt})):Rt!=null&&(V(Rt)&&(Rt=w(Rt,ft+(Rt.key==null||L&&L.key===Rt.key?"":(""+Rt.key).replace(it,"$&/")+"/")+ct)),K.push(Rt)),1;ct=0;var Dt=Et===""?".":Et+":";if(O(L))for(var Vt=0;Vt<L.length;Vt++)Et=L[Vt],Q=Dt+dt(Et,Vt),ct+=F(Et,K,ft,Q,Rt);else if(Vt=y(L),typeof Vt=="function")for(L=Vt.call(L),Vt=0;!(Et=L.next()).done;)Et=Et.value,Q=Dt+dt(Et,Vt++),ct+=F(Et,K,ft,Q,Rt);else if(Q==="object"){if(typeof L.then=="function")return F(rt(L),K,ft,Et,Rt);throw K=String(L),Error("Objects are not valid as a React child (found: "+(K==="[object Object]"?"object with keys {"+Object.keys(L).join(", ")+"}":K)+"). If you meant to render a collection of children, use an array instead.")}return ct}function H(L,K,ft){if(L==null)return L;var Et=[],Rt=0;return F(L,Et,"","",function(Q){return K.call(ft,Q,Rt++)}),Et}function $(L){if(L._status===-1){var K=L._result;K=K(),K.then(function(ft){(L._status===0||L._status===-1)&&(L._status=1,L._result=ft)},function(ft){(L._status===0||L._status===-1)&&(L._status=2,L._result=ft)}),L._status===-1&&(L._status=0,L._result=K)}if(L._status===1)return L._result.default;throw L._result}var yt=typeof reportError=="function"?reportError:function(L){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var K=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof L=="object"&&L!==null&&typeof L.message=="string"?String(L.message):String(L),error:L});if(!window.dispatchEvent(K))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",L);return}console.error(L)},xt={map:H,forEach:function(L,K,ft){H(L,function(){K.apply(this,arguments)},ft)},count:function(L){var K=0;return H(L,function(){K++}),K},toArray:function(L){return H(L,function(K){return K})||[]},only:function(L){if(!V(L))throw Error("React.Children.only expected to receive a single React element child.");return L}};return me.Activity=_,me.Children=xt,me.Component=v,me.Fragment=i,me.Profiler=l,me.PureComponent=N,me.StrictMode=s,me.Suspense=m,me.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=z,me.__COMPILER_RUNTIME={__proto__:null,c:function(L){return z.H.useMemoCache(L)}},me.cache=function(L){return function(){return L.apply(null,arguments)}},me.cacheSignal=function(){return null},me.cloneElement=function(L,K,ft){if(L==null)throw Error("The argument must be a React element, but you passed "+L+".");var Et=C({},L.props),Rt=L.key;if(K!=null)for(Q in K.key!==void 0&&(Rt=""+K.key),K)!Y.call(K,Q)||Q==="key"||Q==="__self"||Q==="__source"||Q==="ref"&&K.ref===void 0||(Et[Q]=K[Q]);var Q=arguments.length-2;if(Q===1)Et.children=ft;else if(1<Q){for(var ct=Array(Q),Dt=0;Dt<Q;Dt++)ct[Dt]=arguments[Dt+2];Et.children=ct}return b(L.type,Rt,Et)},me.createContext=function(L){return L={$$typeof:f,_currentValue:L,_currentValue2:L,_threadCount:0,Provider:null,Consumer:null},L.Provider=L,L.Consumer={$$typeof:c,_context:L},L},me.createElement=function(L,K,ft){var Et,Rt={},Q=null;if(K!=null)for(Et in K.key!==void 0&&(Q=""+K.key),K)Y.call(K,Et)&&Et!=="key"&&Et!=="__self"&&Et!=="__source"&&(Rt[Et]=K[Et]);var ct=arguments.length-2;if(ct===1)Rt.children=ft;else if(1<ct){for(var Dt=Array(ct),Vt=0;Vt<ct;Vt++)Dt[Vt]=arguments[Vt+2];Rt.children=Dt}if(L&&L.defaultProps)for(Et in ct=L.defaultProps,ct)Rt[Et]===void 0&&(Rt[Et]=ct[Et]);return b(L,Q,Rt)},me.createRef=function(){return{current:null}},me.forwardRef=function(L){return{$$typeof:d,render:L}},me.isValidElement=V,me.lazy=function(L){return{$$typeof:g,_payload:{_status:-1,_result:L},_init:$}},me.memo=function(L,K){return{$$typeof:p,type:L,compare:K===void 0?null:K}},me.startTransition=function(L){var K=z.T,ft={};z.T=ft;try{var Et=L(),Rt=z.S;Rt!==null&&Rt(ft,Et),typeof Et=="object"&&Et!==null&&typeof Et.then=="function"&&Et.then(I,yt)}catch(Q){yt(Q)}finally{K!==null&&ft.types!==null&&(K.types=ft.types),z.T=K}},me.unstable_useCacheRefresh=function(){return z.H.useCacheRefresh()},me.use=function(L){return z.H.use(L)},me.useActionState=function(L,K,ft){return z.H.useActionState(L,K,ft)},me.useCallback=function(L,K){return z.H.useCallback(L,K)},me.useContext=function(L){return z.H.useContext(L)},me.useDebugValue=function(){},me.useDeferredValue=function(L,K){return z.H.useDeferredValue(L,K)},me.useEffect=function(L,K){return z.H.useEffect(L,K)},me.useEffectEvent=function(L){return z.H.useEffectEvent(L)},me.useId=function(){return z.H.useId()},me.useImperativeHandle=function(L,K,ft){return z.H.useImperativeHandle(L,K,ft)},me.useInsertionEffect=function(L,K){return z.H.useInsertionEffect(L,K)},me.useLayoutEffect=function(L,K){return z.H.useLayoutEffect(L,K)},me.useMemo=function(L,K){return z.H.useMemo(L,K)},me.useOptimistic=function(L,K){return z.H.useOptimistic(L,K)},me.useReducer=function(L,K,ft){return z.H.useReducer(L,K,ft)},me.useRef=function(L){return z.H.useRef(L)},me.useState=function(L){return z.H.useState(L)},me.useSyncExternalStore=function(L,K,ft){return z.H.useSyncExternalStore(L,K,ft)},me.useTransition=function(){return z.H.useTransition()},me.version="19.2.4",me}var G0;function Vd(){return G0||(G0=1,sh.exports=KS()),sh.exports}var ne=Vd(),rh={exports:{}},zo={},oh={exports:{}},lh={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var V0;function JS(){return V0||(V0=1,(function(r){function t(F,H){var $=F.length;F.push(H);t:for(;0<$;){var yt=$-1>>>1,xt=F[yt];if(0<l(xt,H))F[yt]=H,F[$]=xt,$=yt;else break t}}function i(F){return F.length===0?null:F[0]}function s(F){if(F.length===0)return null;var H=F[0],$=F.pop();if($!==H){F[0]=$;t:for(var yt=0,xt=F.length,L=xt>>>1;yt<L;){var K=2*(yt+1)-1,ft=F[K],Et=K+1,Rt=F[Et];if(0>l(ft,$))Et<xt&&0>l(Rt,ft)?(F[yt]=Rt,F[Et]=$,yt=Et):(F[yt]=ft,F[K]=$,yt=K);else if(Et<xt&&0>l(Rt,$))F[yt]=Rt,F[Et]=$,yt=Et;else break t}}return H}function l(F,H){var $=F.sortIndex-H.sortIndex;return $!==0?$:F.id-H.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;r.unstable_now=function(){return c.now()}}else{var f=Date,d=f.now();r.unstable_now=function(){return f.now()-d}}var m=[],p=[],g=1,_=null,x=3,y=!1,T=!1,C=!1,M=!1,v=typeof setTimeout=="function"?setTimeout:null,B=typeof clearTimeout=="function"?clearTimeout:null,N=typeof setImmediate<"u"?setImmediate:null;function D(F){for(var H=i(p);H!==null;){if(H.callback===null)s(p);else if(H.startTime<=F)s(p),H.sortIndex=H.expirationTime,t(m,H);else break;H=i(p)}}function O(F){if(C=!1,D(F),!T)if(i(m)!==null)T=!0,I||(I=!0,nt());else{var H=i(p);H!==null&&rt(O,H.startTime-F)}}var I=!1,z=-1,Y=5,b=-1;function w(){return M?!0:!(r.unstable_now()-b<Y)}function V(){if(M=!1,I){var F=r.unstable_now();b=F;var H=!0;try{t:{T=!1,C&&(C=!1,B(z),z=-1),y=!0;var $=x;try{e:{for(D(F),_=i(m);_!==null&&!(_.expirationTime>F&&w());){var yt=_.callback;if(typeof yt=="function"){_.callback=null,x=_.priorityLevel;var xt=yt(_.expirationTime<=F);if(F=r.unstable_now(),typeof xt=="function"){_.callback=xt,D(F),H=!0;break e}_===i(m)&&s(m),D(F)}else s(m);_=i(m)}if(_!==null)H=!0;else{var L=i(p);L!==null&&rt(O,L.startTime-F),H=!1}}break t}finally{_=null,x=$,y=!1}H=void 0}}finally{H?nt():I=!1}}}var nt;if(typeof N=="function")nt=function(){N(V)};else if(typeof MessageChannel<"u"){var it=new MessageChannel,dt=it.port2;it.port1.onmessage=V,nt=function(){dt.postMessage(null)}}else nt=function(){v(V,0)};function rt(F,H){z=v(function(){F(r.unstable_now())},H)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(F){F.callback=null},r.unstable_forceFrameRate=function(F){0>F||125<F?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Y=0<F?Math.floor(1e3/F):5},r.unstable_getCurrentPriorityLevel=function(){return x},r.unstable_next=function(F){switch(x){case 1:case 2:case 3:var H=3;break;default:H=x}var $=x;x=H;try{return F()}finally{x=$}},r.unstable_requestPaint=function(){M=!0},r.unstable_runWithPriority=function(F,H){switch(F){case 1:case 2:case 3:case 4:case 5:break;default:F=3}var $=x;x=F;try{return H()}finally{x=$}},r.unstable_scheduleCallback=function(F,H,$){var yt=r.unstable_now();switch(typeof $=="object"&&$!==null?($=$.delay,$=typeof $=="number"&&0<$?yt+$:yt):$=yt,F){case 1:var xt=-1;break;case 2:xt=250;break;case 5:xt=1073741823;break;case 4:xt=1e4;break;default:xt=5e3}return xt=$+xt,F={id:g++,callback:H,priorityLevel:F,startTime:$,expirationTime:xt,sortIndex:-1},$>yt?(F.sortIndex=$,t(p,F),i(m)===null&&F===i(p)&&(C?(B(z),z=-1):C=!0,rt(O,$-yt))):(F.sortIndex=xt,t(m,F),T||y||(T=!0,I||(I=!0,nt()))),F},r.unstable_shouldYield=w,r.unstable_wrapCallback=function(F){var H=x;return function(){var $=x;x=H;try{return F.apply(this,arguments)}finally{x=$}}}})(lh)),lh}var k0;function QS(){return k0||(k0=1,oh.exports=JS()),oh.exports}var ch={exports:{}},Nn={};/**
 * @license React
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:_a,depthTest:!1,depthWrite:!1})}function r1(r,t,i){const s=new Float32Array(Cs),l=new j(0,1,0);return new ki({name:"SphericalGaussianBlur",defines:{n:Cs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/i,CUBEUV_MAX_MIP:`${r}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:s},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:l}},vertexShader:Qc(),fragmentShader:`
	...
	`}function o1(r){let t=new WeakMap,i=null;function s(d){if(d&&d.isTexture){const m=d.mapping,p=m===td||m===ed,g=m===Us||m===Or;if(p||g){let _=t.get(d);const x=_!==void 0?_.texture.pmremVersion:0;if(d.isRenderTargetTexture&&d.pmremVersion!==x)return i===null&&(i=new U_(r)),_=p?i.fromEquirectangular(d,_):i.fromCubemap(d,_),_.texture.pmremVersion=d.pmremVersion,t.set(d,_),_.texture;if(_!==void 0)return _.texture;{const y=d.image;return p&&y&&y.height>0||g&&y&&l(y)?(i===null&&(i=new U_(r)),_=p?i.fromEquirectangular(d):i.fromCubemap(d),_.texture.pmremVersion=d.pmremVersion,t.set(d,_),d.addEventListener("dispose",c),_.texture):null}}}return d}function l(d){let m=0;const p=6;for(let g=0;g<p;g++)d[g]!==void 0&&m++;return m===p}function c(d){const m=d.target;m.removeEventListener("dispose",c);const p=t.get(m);p!==void 0&&(t.delete(m),p.dispose())}function f(){t=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:s,dispose:f}}function l1(r){const t={};function i(s){if(t[s]!==void 0)return t[s];const l=r.getExtension(s);return t[s]=l,l}return{has:function(s){return i(s)!==null},init:function(){i("EXT_color_buffer_float"),i("WEBGL_clip_cull_distance"),i("OES_texture_float_linear"),i("EXT_color_buffer_half_float"),i("WEBGL_multisampled_render_to_texture"),i("WEBGL_render_shared_exponent")},get:function(s){const l=i(s);return l===null&&Jo("WebGLRenderer: "+s+" extension not supported."),l}}}function c1(r,t,i,s){const l={},c=new WeakMap;function f(_){const x=_.target;x.index!==null&&t.remove(x.index);for(const T in x.attributes)t.remove(x.attributes[T]);x.removeEventListener("dispose",f),delete l[x.id];const y=c.get(x);y&&(t.remove(y),c.delete(x)),s.releaseStatesOfGeometry(x),x.isInstancedBufferGeometry===!0&&delete x._maxInstanceCount,i.memory.geometries--}function d(_,x){return l[x.id]===!0||(x.addEventListener("dispose",f),l[x.id]=!0,i.memory.geometries++),x}function m(_){const x=_.attributes;for(const y in x)t.update(x[y],r.ARRAY_BUFFER)}function p(_){const x=[],y=_.index,T=_.attributes.position;let C=0;if(y!==null){const B=y.array;C=y.version;for(let N=0,D=B.length;N<D;N+=3){const O=B[N+0],I=B[N+1],z=B[N+2];x.push(O,I,I,z,z,O)}}else if(T!==void 0){const B=T.array;C=T.version;for(let N=0,D=B.length/3-1;N<D;N+=3){const O=N+0,I=N+1,z=N+2;x.push(O,I,I,z,z,O)}}else return;const M=new(vv(x)?Ev:Mv)(x,1);M.version=C;const v=c.get(_);v&&t.remove(v),c.set(_,M)}function g(_){const x=c.get(_);if(x){const y=_.index;y!==null&&x.version<y.version&&p(_)}else p(_);return c.get(_)}return{get:d,update:m,getWireframeAttribute:g}}function u1(r,t,i){let s;function l(x){s=x}let c,f;function d(x){c=x.type,f=x.bytesPerElement}function m(x,y){r.drawElements(s,y,c,x*f),i.update(y,s,1)}function p(x,y,T){T!==0&&(r.drawElementsInstanced(s,y,c,x*f,T),i.update(y,s,T))}function g(x,y,T){if(T===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(s,y,0,c,x,0,T);let M=0;for(let v=0;v<T;v++)M+=y[v];i.update(M,s,1)}function _(x,y,T,C){if(T===0)return;const M=t.get("WEBGL_multi_draw");if(M===null)for(let v=0;v<x.length;v++)p(x[v]/f,y[v],C[v]);else{M.multiDrawElementsInstancedWEBGL(s,y,0,c,x,0,C,0,T);let v=0;for(let B=0;B<T;B++)v+=y[B]*C[B];i.update(v,s,1)}}this.setMode=l,this.setIndex=d,this.render=m,this.renderInstances=p,this.renderMultiDraw=g,this.renderMultiDrawInstances=_}function f1(r){const t={geometries:0,textures:0},i={frame:0,calls:0,triangles:0,points:0,lines:0};function s(c,f,d){switch(i.calls++,f){case r.TRIANGLES:i.triangles+=d*(c/3);break;case r.LINES:i.lines+=d*(c/2);break;case r.LINE_STRIP:i.lines+=d*(c-1);break;case r.LINE_LOOP:i.lines+=d*c;break;case r.POINTS:i.points+=d*c;break;default:we("WebGLInfo: Unknown draw mode:",f);break}}function l(){i.calls=0,i.triangles=0,i.points=0,i.lines=0}return{memory:t,render:i,programs:null,autoReset:!0,reset:l,update:s}}function h1(r,t,i){const s=new WeakMap,l=new an;function c(f,d,m){const p=f.morphTargetInfluences,g=d.morphAttributes.position||d.morphAttributes.normal||d.morphAttributes.color,_=g!==void 0?g.length:0;let x=s.get(d);if(x===void 0||x.count!==_){let w=function(){Y.dispose(),s.delete(d),d.removeEventListener("dispose",w)};var y=w;x!==void 0&&x.texture.dispose();const T=d.morphAttributes.position!==void 0,C=d.morphAttributes.normal!==void 0,M=d.morphAttributes.color!==void 0,v=d.morphAttributes.position||[],B=d.morphAttributes.normal||[],N=d.morphAttributes.color||[];let D=0;T===!0&&(D=1),C===!0&&(D=2),M===!0&&(D=3);let O=d.attributes.position.count*D,I=1;O>t.maxTextureSize&&(I=Math.ceil(O/t.maxTextureSize),O=t.maxTextureSize);const z=new Float32Array(O*I*4*_),Y=new xv(z,O,I,_);Y.type=zi,Y.needsUpdate=!0;const b=D*4;for(let V=0;V<_;V++){const nt=v[V],it=B[V],dt=N[V],rt=O*I*4*V;for(let F=0;F<nt.count;F++){const H=F*b;T===!0&&(l.fromBufferAttribute(nt,F),z[rt+H+0]=l.x,z[rt+H+1]=l.y,z[rt+H+2]=l.z,z[rt+H+3]=0),C===!0&&(l.fromBufferAttribute(it,F),z[rt+H+4]=l.x,z[rt+H+5]=l.y,z[rt+H+6]=l.z,z[rt+H+7]=0),M===!0&&(l.fromBufferAttribute(dt,F),z[rt+H+8]=l.x,z[rt+H+9]=l.y,z[rt+H+10]=l.z,z[rt+H+11]=dt.itemSize===4?l.w:1)}}x={count:_,texture:Y,size:new Wt(O,I)},s.set(d,x),d.addEventListener("dispose",w)}if(f.isInstancedMesh===!0&&f.morphTexture!==null)m.getUniforms().setValue(r,"morphTexture",f.morphTexture,i);else{let T=0;for(let M=0;M<p.length;M++)T+=p[M];const C=d.morphTargetsRelative?1:1-T;m.getUniforms().setValue(r,"morphTargetBaseInfluence",C),m.getUniforms().setValue(r,"morphTargetInfluences",p)}m.getUniforms().setValue(r,"morphTargetsTexture",x.texture,i),m.getUniforms().setValue(r,"morphTargetsTextureSize",x.size)}return{update:c}}function d1(r,t,i,s){let l=new WeakMap;function c(m){const p=s.render.frame,g=m.geometry,_=t.get(m,g);if(l.get(_)!==p&&(t.update(_),l.set(_,p)),m.isInstancedMesh&&(m.hasEventListener("dispose",d)===!1&&m.addEventListener("dispose",d),l.get(m)!==p&&(i.update(m.instanceMatrix,r.ARRAY_BUFFER),m.instanceColor!==null&&i.update(m.instanceColor,r.ARRAY_BUFFER),l.set(m,p))),m.isSkinnedMesh){const x=m.skeleton;l.get(x)!==p&&(x.update(),l.set(x,p))}return _}function f(){l=new WeakMap}function d(m){const p=m.target;p.removeEventListener("dispose",d),i.remove(p.instanceMatrix),p.instanceColor!==null&&i.remove(p.instanceColor)}return{update:c,dispose:f}}const p1={[nv]:"LINEAR_TONE_MAPPING",[iv]:"REINHARD_TONE_MAPPING",[av]:"CINEON_TONE_MAPPING",[sv]:"ACES_FILMIC_TONE_MAPPING",[ov]:"AGX_TONE_MAPPING",[lv]:"NEUTRAL_TONE_MAPPING",[rv]:"CUSTOM_TONE_MAPPING"};function m1(r,t,i,s,l){const c=new Ii(t,i,{type:r,depthBuffer:s,stencilBuffer:l}),f=new Ii(t,i,{type:xa,depthBuffer:!1,stencilBuffer:!1}),d=new Xi;d.setAttribute("position",new Ri([-1,3,0,-1,-1,0,3,-1,0],3)),d.setAttribute("uv",new Ri([0,2,0,0,2,0],2));const m=new sE({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
`].filter(qo).join(`
`)),f=Gd(f),f=X_(f,i),f=W_(f,i),d=Gd(d),d=X_(d,i),d=W_(d,i),f=q_(f),d=q_(d),i.isRawShaderMaterial!==!0&&(B=`#version 300 es
...
`)+`
`+v);const N=B+M+f,D=B+v+d,O=G_(l,l.VERTEX_SHADER,N),I=G_(l,l.FRAGMENT_SHADER,D);l.attachShader(C,O),l.attachShader(C,I),i.index0AttributeName!==void 0?l.bindAttribLocation(C,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(C,0,"position"),l.linkProgram(C);function z(V){if(r.debug.checkShaderErrors){const nt=l.getProgramInfoLog(C)||"",it=l.getShaderInfoLog(O)||"",dt=l.getShaderInfoLog(I)||"",rt=nt.trim(),F=it.trim(),H=dt.trim();let $=!0,yt=!0;if(l.getProgramParameter(C,l.LINK_STATUS)===!1)if($=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(l,C,O,I);else{const xt=k_(l,O,"vertex"),L=k_(l,I,"fragment");we("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(C,l.VALIDATE_STATUS)+`
...
Program Info Log: `+rt+`
`+xt+`
`+L)}else rt!==""?pe("WebGLProgram: Program Info Log:",rt):(F===""||H==="")&&(yt=!1);yt&&(V.diagnostics={runnable:$,programLog:rt,vertexShader:{log:F,prefix:M},fragmentShader:{log:H,prefix:v}})}l.deleteShader(O),l.deleteShader(I),Y=new Yc(l,C),b=gA(l,C)}let Y;this.getUniforms=function(){return Y===void 0&&z(this),Y};let b;this.getAttributes=function(){return b===void 0&&z(this),b};let w=i.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return w===!1&&(w=l.getProgramParameter(C,rA)),w},this.destroy=function(){s.releaseStatesOfProgram(this),l.deleteProgram(C),this.program=void 0},this.type=i.shaderType,this.name=i.shaderName,this.id=oA++,this.cacheKey=t,this.usedTimes=1,this.program=C,this.vertexShader=O,this.fragmentShader=I,this}let NA=0;class LA{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(t){const i=t.vertexShader,s=t.fragmentShader,l=this._getShaderStage(i),c=this._getShaderStage(s),f=this._getShaderCacheForMaterial(t);return f.has(l)===!1&&(f.add(l),l.usedTimes++),f.has(c)===!1&&(f.add(c),c.usedTimes++),this}remove(t){const i=this.materialCache.get(t);for(const s of i)s.usedTimes--,s.usedTimes===0&&this.shaderCache.delete(s.code);return this.materialCache.delete(t),this}getVertexShaderID(t){return this._getShaderStage(t.vertexShader).id}getFragmentShaderID(t){return this._getShaderStage(t.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(t){const i=this.materialCache;let s=i.get(t);return s===void 0&&(s=new Set,i.set(t,s)),s}_getShaderStage(t){const i=this.shaderCache;let s=i.get(t);return s===void 0&&(s=new OA(t),i.set(t,s)),s}}class OA{constructor(t){this.id=NA++,this.code=t,this.usedTimes=0}}function PA(r,t,i,s,l,c,f){const d=new Sv,m=new LA,p=new Set,g=[],_=new Map,x=l.logarithmicDepthBuffer;let y=l.precision;const T={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function C(b){return p.add(b),b===0?"uv":`uv${b}`}function M(b,w,V,nt,it){const dt=nt.fog,rt=it.geometry,F=b.isMeshStandardMaterial?nt.environment:null,H=(b.isMeshStandardMaterial?i:t).get(b.envMap||F),$=H&&H.mapping===Jc?H.image.height:null,yt=T[b.type];b.precision!==null&&(y=l.getMaxPrecision(b.precision),y!==b.precision&&pe("WebGLProgram.getParameters:",b.precision,"not supported, using",y,"instead."));const xt=rt.morphAttributes.position||rt.morphAttributes.normal||rt.morphAttributes.color,L=xt!==void 0?xt.length:0;let K=0;rt.morphAttributes.position!==void 0&&(K=1),rt.morphAttributes.normal!==void 0&&(K=2),rt.morphAttributes.color!==void 0&&(K=3);let ft,Et,Rt,Q;if(yt){const Ce=Pi[yt];ft=Ce.vertexShader,Et=Ce.fragmentShader}else ft=b.vertexShader,Et=b.fragmentShader,m.update(b),Rt=m.getVertexShaderID(b),Q=m.getFragmentShaderID(b);const ct=r.getRenderTarget(),Dt=r.state.buffers.depth.getReversed(),Vt=it.isInstancedMesh===!0,qt=it.isBatchedMesh===!0,ye=!!b.map,Ue=!!b.matcap,fe=!!H,gt=!!b.aoMap,At=!!b.lightMap,Mt=!!b.bumpMap,Bt=!!b.normalMap,P=!!b.displacementMap,ie=!!b.emissiveMap,Gt=!!b.metalnessMap,se=!!b.roughnessMap,Ut=b.anisotropy>0,U=b.clearcoat>0,E=b.dispersion>0,W=b.iridescence>0,ut=b.sheen>0,St=b.transmission>0,ht=Ut&&!!b.anisotropyMap,Qt=U&&!!b.clearcoatMap,Lt=U&&!!b.clearcoatNormalMap,Jt=U&&!!b.clearcoatRoughnessMap,le=W&&!!b.iridescenceMap,Tt=W&&!!b.iridescenceThicknessMap,Ct=ut&&!!b.sheenColorMap,Yt=ut&&!!b.sheenRoughnessMap,kt=!!b.specularMap,Pt=!!b.specularColorMap,_e=!!b.specularIntensityMap,X=St&&!!b.transmissionMap,Ft=St&&!!b.thicknessMap,wt=!!b.gradientMap,Xt=!!b.alphaMap,bt=b.alphaTest>0,vt=!!b.alphaHash,Nt=!!b.extensions;let he=Bi;b.toneMapped&&(ct===null||ct.isXRRenderTarget===!0)&&(he=r.toneMapping);const Ie={shaderID:yt,shaderType:b.type,shaderName:b.name,vertexShader:ft,fragmentShader:Et,defines:b.defines,customVertexShaderID:Rt,customFragmentShaderID:Q,isRawShaderMaterial:b.isRawShaderMaterial===!0,glslVersion:b.glslVersion,precision:y,batching:qt,batchingColor:qt&&it._colorsTexture!==null,instancing:Vt,instancingColor:Vt&&it.instanceColor!==null,instancingMorph:Vt&&it.morphTexture!==null,outputColorSpace:ct===null?r.outputColorSpace:ct.isXRRenderTarget===!0?ct.texture.colorSpace:zr,alphaToCoverage:!!b.alphaToCoverage,map:ye,matcap:Ue,envMap:fe,envMapMode:fe&&H.mapping,envMapCubeUVHeight:$,aoMap:gt,lightMap:At,bumpMap:Mt,normalMap:Bt,displacementMap:P,emissiveMap:ie,normalMapObjectSpace:Bt&&b.normalMapType===Iy,normalMapTangentSpace:Bt&&b.normalMapType===_v,metalnessMap:Gt,roughnessMap:se,anisotropy:Ut,anisotropyMap:ht,clearcoat:U,clearcoatMap:Qt,clearcoatNormalMap:Lt,clearcoatRoughnessMap:Jt,dispersion:E,iridescence:W,iridescenceMap:le,iridescenceThicknessMap:Tt,sheen:ut,sheenColorMap:Ct,sheenRoughnessMap:Yt,specularMap:kt,specularColorMap:Pt,specularIntensityMap:_e,transmission:St,transmissionMap:X,thicknessMap:Ft,gradientMap:wt,opaque:b.transparent===!1&&b.blending===Ur&&b.alphaToCoverage===!1,alphaMap:Xt,alphaTest:bt,alphaHash:vt,combine:b.combine,mapUv:ye&&C(b.map.channel),aoMapUv:gt&&C(b.aoMap.channel),lightMapUv:At&&C(b.lightMap.channel),bumpMapUv:Mt&&C(b.bumpMap.channel),normalMapUv:Bt&&C(b.normalMap.channel),displacementMapUv:P&&C(b.displacementMap.channel),emissiveMapUv:ie&&C(b.emissiveMap.channel),metalnessMapUv:Gt&&C(b.metalnessMap.channel),roughnessMapUv:se&&C(b.roughnessMap.channel),anisotropyMapUv:ht&&C(b.anisotropyMap.channel),clearcoatMapUv:Qt&&C(b.clearcoatMap.channel),clearcoatNormalMapUv:Lt&&C(b.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:Jt&&C(b.clearcoatRoughnessMap.channel),iridescenceMapUv:le&&C(b.iridescenceMap.channel),iridescenceThicknessMapUv:Tt&&C(b.iridescenceThicknessMap.channel),sheenColorMapUv:Ct&&C(b.sheenColorMap.channel),sheenRoughnessMapUv:Yt&&C(b.sheenRoughnessMap.channel),specularMapUv:kt&&C(b.specularMap.channel),specularColorMapUv:Pt&&C(b.specularColorMap.channel),specularIntensityMapUv:_e&&C(b.specularIntensityMap.channel),transmissionMapUv:X&&C(b.transmissionMap.channel),thicknessMapUv:Ft&&C(b.thicknessMap.channel),alphaMapUv:Xt&&C(b.alphaMap.channel),vertexTangents:!!rt.attributes.tangent&&(Bt||Ut),vertexColors:b.vertexColors,vertexAlphas:b.vertexColors===!0&&!!rt.attributes.color&&rt.attributes.color.itemSize===4,pointsUvs:it.isPoints===!0&&!!rt.attributes.uv&&(ye||Xt),fog:!!dt,useFog:b.fog===!0,fogExp2:!!dt&&dt.isFogExp2,flatShading:b.flatShading===!0&&b.wireframe===!1,sizeAttenuation:b.sizeAttenuation===!0,logarithmicDepthBuffer:x,reversedDepthBuffer:Dt,skinning:it.isSkinnedMesh===!0,morphTargets:rt.morphAttributes.position!==void 0,morphNormals:rt.morphAttributes.normal!==void 0,morphColors:rt.morphAttributes.color!==void 0,morphTargetsCount:L,morphTextureStride:K,numDirLights:w.directional.length,numPointLights:w.point.length,numSpotLights:w.spot.length,numSpotLightMaps:w.spotLightMap.length,numRectAreaLights:w.rectArea.length,numHemiLights:w.hemi.length,numDirLightShadows:w.directionalShadowMap.length,numPointLightShadows:w.pointShadowMap.length,numSpotLightShadows:w.spotShadowMap.length,numSpotLightShadowsWithMaps:w.numSpotLightShadowsWithMaps,numLightProbes:w.numLightProbes,numClippingPlanes:f.numPlanes,numClipIntersection:f.numIntersection,dithering:b.dithering,shadowMapEnabled:r.shadowMap.enabled&&V.length>0,shadowMapType:r.shadowMap.type,toneMapping:he,decodeVideoTexture:ye&&b.map.isVideoTexture===!0&&De.getTransfer(b.map.colorSpace)===ke,decodeVideoTextureEmissive:ie&&b.emissiveMap.isVideoTexture===!0&&De.getTransfer(b.emissiveMap.colorSpace)===ke,premultipliedAlpha:b.premultipliedAlpha,doubleSided:b.side===ma,flipSided:b.side===qn,useDepthPacking:b.depthPacking>=0,depthPacking:b.depthPacking||0,index0AttributeName:b.index0AttributeName,extensionClipCullDistance:Nt&&b.extensions.clipCullDistance===!0&&s.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(Nt&&b.extensions.multiDraw===!0||qt)&&s.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:s.has("KHR_parallel_shader_compile"),customProgramCacheKey:b.customProgramCacheKey()};return Ie.vertexUv1s=p.has(1),Ie.vertexUv2s=p.has(2),Ie.vertexUv3s=p.has(3),p.clear(),Ie}function v(b){const w=[];if(b.shaderID?w.push(b.shaderID):(w.push(b.customVertexShaderID),w.push(b.customFragmentShaderID)),b.defines!==void 0)for(const V in b.defines)w.push(V),w.push(b.defines[V]);return b.isRawShaderMaterial===!1&&(B(w,b),N(w,b),w.push(r.outputColorSpace)),w.push(b.customProgramCacheKey),w.join()}function B(b,w){b.push(w.precision),b.push(w.outputColorSpace),b.push(w.envMapMode),b.push(w.envMapCubeUVHeight),b.push(w.mapUv),b.push(w.alphaMapUv),b.push(w.lightMapUv),b.push(w.aoMapUv),b.push(w.bumpMapUv),b.push(w.normalMapUv),b.push(w.displacementMapUv),b.push(w.emissiveMapUv),b.push(w.metalnessMapUv),b.push(w.roughnessMapUv),b.push(w.anisotropyMapUv),b.push(w.clearcoatMapUv),b.push(w.clearcoatNormalMapUv),b.push(w.clearcoatRoughnessMapUv),b.push(w.iridescenceMapUv),b.push(w.iridescenceThicknessMapUv),b.push(w.sheenColorMapUv),b.push(w.sheenRoughnessMapUv),b.push(w.specularMapUv),b.push(w.specularColorMapUv),b.push(w.specularIntensityMapUv),b.push(w.transmissionMapUv),b.push(w.thicknessMapUv),b.push(w.combine),b.push(w.fogExp2),b.push(w.sizeAttenuation),b.push(w.morphTargetsCount),b.push(w.morphAttributeCount),b.push(w.numDirLights),b.push(w.numPointLights),b.push(w.numSpotLights),b.push(w.numSpotLightMaps),b.push(w.numHemiLights),b.push(w.numRectAreaLights),b.push(w.numDirLightShadows),b.push(w.numPointLightShadows),b.push(w.numSpotLightShadows),b.push(w.numSpotLightShadowsWithMaps),b.push(w.numLightProbes),b.push(w.shadowMapType),b.push(w.toneMapping),b.push(w.numClippingPlanes),b.push(w.numClipIntersection),b.push(w.depthPacking)}function N(b,w){d.disableAll(),w.instancing&&d.enable(0),w.instancingColor&&d.enable(1),w.instancingMorph&&d.enable(2),w.matcap&&d.enable(3),w.envMap&&d.enable(4),w.normalMapObjectSpace&&d.enable(5),w.normalMapTangentSpace&&d.enable(6),w.clearcoat&&d.enable(7),w.iridescence&&d.enable(8),w.alphaTest&&d.enable(9),w.vertexColors&&d.enable(10),w.vertexAlphas&&d.enable(11),w.vertexUv1s&&d.enable(12),w.vertexUv2s&&d.enable(13),w.vertexUv3s&&d.enable(14),w.vertexTangents&&d.enable(15),w.anisotropy&&d.enable(16),w.alphaHash&&d.enable(17),w.batching&&d.enable(18),w.dispersion&&d.enable(19),w.batchingColor&&d.enable(20),w.gradientMap&&d.enable(21),b.push(d.mask),d.disableAll(),w.fog&&d.enable(0),w.useFog&&d.enable(1),w.flatShading&&d.enable(2),w.logarithmicDepthBuffer&&d.enable(3),w.reversedDepthBuffer&&d.enable(4),w.skinning&&d.enable(5),w.morphTargets&&d.enable(6),w.morphNormals&&d.enable(7),w.morphColors&&d.enable(8),w.premultipliedAlpha&&d.enable(9),w.shadowMapEnabled&&d.enable(10),w.doubleSided&&d.enable(11),w.flipSided&&d.enable(12),w.useDepthPacking&&d.enable(13),w.dithering&&d.enable(14),w.transmission&&d.enable(15),w.sheen&&d.enable(16),w.opaque&&d.enable(17),w.pointsUvs&&d.enable(18),w.decodeVideoTexture&&d.enable(19),w.decodeVideoTextureEmissive&&d.enable(20),w.alphaToCoverage&&d.enable(21),b.push(d.mask)}function D(b){const w=T[b.type];let V;if(w){const nt=Pi[w];V=pM.clone(nt.uniforms)}else V=b.uniforms;return V}function O(b,w){let V=_.get(w);return V!==void 0?++V.usedTimes:(V=new UA(r,w,b,c),g.push(V),_.set(w,V)),V}function I(b){if(--b.usedTimes===0){const w=g.indexOf(b);g[w]=g[g.length-1],g.pop(),_.delete(b.cacheKey),b.destroy()}}function z(b){m.remove(b)}function Y(){m.dispose()}return{getParameters:M,getProgramCacheKey:v,getUniforms:D,acquireProgram:O,releaseProgram:I,releaseShaderCache:z,programs:g,dispose:Y}}function zA(){let r=new WeakMap;function t(f){return r.has(f)}function i(f){let d=r.get(f);return d===void 0&&(d={},r.set(f,d)),d}function s(f){r.delete(f)}function l(f,d,m){r.get(f)[d]=m}function c(){r=new WeakMap}return{has:t,get:i,remove:s,update:l,dispose:c}}function FA(r,t){return r.groupOrder!==t.groupOrder?r.groupOrder-t.groupOrder:r.renderOrder!==t.renderOrder?r.renderOrder-t.renderOrder:r.material.id!==t.material.id?r.material.id-t.material.id:r.z!==t.z?r.z-t.z:r.id-t.id}function Z_(r,t){return r.groupOrder!==t.groupOrder?r.groupOrder-t.groupOrder:r.renderOrder!==t.renderOrder?r.renderOrder-t.renderOrder:r.z!==t.z?t.z-r.z:r.id-t.id}function j_(){const r=[];let t=0;const i=[],s=[],l=[];function c(){t=0,i.length=0,s.length=0,l.length=0}function f(_,x,y,T,C,M){let v=r[t];return v===void 0?(v={id:_.id,object:_,geometry:x,material:y,groupOrder:T,renderOrder:_.renderOrder,z:C,group:M},r[t]=v):(v.id=_.id,v.object=_,v.geometry=x,v.material=y,v.groupOrder=T,v.renderOrder=_.renderOrder,v.z=C,v.group=M),t++,v}function d(_,x,y,T,C,M){const v=f(_,x,y,T,C,M);y.transmission>0?s.push(v):y.transparent===!0?l.push(v):i.push(v)}function m(_,x,y,T,C,M){const v=f(_,x,y,T,C,M);y.transmission>0?s.unshift(v):y.transparent===!0?l.unshift(v):i.unshift(v)}function p(_,x){i.length>1&&i.sort(_||FA),s.length>1&&s.sort(x||Z_),l.length>1&&l.sort(x||Z_)}function g(){for(let _=t,x=r.length;_<x;_++){const y=r[_];if(y.id===null)break;y.id=null,y.object=null,y.geometry=null,y.material=null,y.group=null}}return{opaque:i,transmissive:s,transparent:l,init:c,push:d,unshift:m,finish:g,sort:p}}function BA(){let r=new WeakMap;function t(s,l){const c=r.get(s);let f;return c===void 0?(f=new j_,r.set(s,[f])):l>=c.length?(f=new j_,c.push(f)):f=c[l],f}function i(){r=new WeakMap}return{get:t,dispose:i}}function IA(){const r={};return{get:function(t){if(r[t.id]!==void 0)return r[t.id];let i;switch(t.type){case"DirectionalLight":i={direction:new j,color:new Fe};break;case"SpotLight":i={position:new j,direction:new j,color:new Fe,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":i={position:new j,color:new Fe,distance:0,decay:0};break;case"HemisphereLight":i={direction:new j,skyColor:new Fe,groundColor:new Fe};break;case"RectAreaLight":i={color:new Fe,position:new j,halfWidth:new j,halfHeight:new j};break}return r[t.id]=i,i}}}function HA(){const r={};return{get:function(t){if(r[t.id]!==void 0)return r[t.id];let i;switch(t.type){case"DirectionalLight":i={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Wt};break;case"SpotLight":i={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Wt};break;case"PointLight":i={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Wt,shadowCameraNear:1,shadowCameraFar:1e3};break}return r[t.id]=i,i}}}let GA=0;function VA(r,t){return(t.castShadow?2:0)-(r.castShadow?2:0)+(t.map?1:0)-(r.map?1:0)}function kA(r){const t=new IA,i=HA(),s={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let p=0;p<9;p++)s.probe.push(new j);const l=new j,c=new tn,f=new tn;function d(p){let g=0,_=0,x=0;for(let b=0;b<9;b++)s.probe[b].set(0,0,0);let y=0,T=0,C=0,M=0,v=0,B=0,N=0,D=0,O=0,I=0,z=0;p.sort(VA);for(let b=0,w=p.length;b<w;b++){const V=p[b],nt=V.color,it=V.intensity,dt=V.distance;let rt=null;if(V.shadow&&V.shadow.map&&(V.shadow.map.texture.format===Pr?rt=V.shadow.map.texture:rt=V.shadow.map.depthTexture||V.shadow.map.texture),V.isAmbientLight)g+=nt.r*it,_+=nt.g*it,x+=nt.b*it;else if(V.isLightProbe){for(let F=0;F<9;F++)s.probe[F].addScaledVector(V.sh.coefficients[F],it);z++}else if(V.isDirectionalLight){const F=t.get(V);if(F.color.copy(V.color).multiplyScalar(V.intensity),V.castShadow){const H=V.shadow,$=i.get(V);$.shadowIntensity=H.intensity,$.shadowBias=H.bias,$.shadowNormalBias=H.normalBias,$.shadowRadius=H.radius,$.shadowMapSize=H.mapSize,s.directionalShadow[y]=$,s.directionalShadowMap[y]=rt,s.directionalShadowMatrix[y]=V.shadow.matrix,B++}s.directional[y]=F,y++}else if(V.isSpotLight){const F=t.get(V);F.position.setFromMatrixPosition(V.matrixWorld),F.color.copy(nt).multiplyScalar(it),F.distance=dt,F.coneCos=Math.cos(V.angle),F.penumbraCos=Math.cos(V.angle*(1-V.penumbra)),F.decay=V.decay,s.spot[C]=F;const H=V.shadow;if(V.map&&(s.spotLightMap[O]=V.map,O++,H.updateMatrices(V),V.castShadow&&I++),s.spotLightMatrix[C]=H.matrix,V.castShadow){const $=i.get(V);$.shadowIntensity=H.intensity,$.shadowBias=H.bias,$.shadowNormalBias=H.normalBias,$.shadowRadius=H.radius,$.shadowMapSize=H.mapSize,s.spotShadow[C]=$,s.spotShadowMap[C]=rt,D++}C++}else if(V.isRectAreaLight){const F=t.get(V);F.color.copy(nt).multiplyScalar(it),F.halfWidth.set(V.width*.5,0,0),F.halfHeight.set(0,V.height*.5,0),s.rectArea[M]=F,M++}else if(V.isPointLight){const F=t.get(V);if(F.color.copy(V.color).multiplyScalar(V.intensity),F.distance=V.distance,F.decay=V.decay,V.castShadow){const H=V.shadow,$=i.get(V);$.shadowIntensity=H.intensity,$.shadowBias=H.bias,$.shadowNormalBias=H.normalBias,$.shadowRadius=H.radius,$.shadowMapSize=H.mapSize,$.shadowCameraNear=H.camera.near,$.shadowCameraFar=H.camera.far,s.pointShadow[T]=$,s.pointShadowMap[T]=rt,s.pointShadowMatrix[T]=V.shadow.matrix,N++}s.point[T]=F,T++}else if(V.isHemisphereLight){const F=t.get(V);F.skyColor.copy(V.color).multiplyScalar(it),F.groundColor.copy(V.groundColor).multiplyScalar(it),s.hemi[v]=F,v++}}M>0&&(r.has("OES_texture_float_linear")===!0?(s.rectAreaLTC1=Ht.LTC_FLOAT_1,s.rectAreaLTC2=Ht.LTC_FLOAT_2):(s.rectAreaLTC1=Ht.LTC_HALF_1,s.rectAreaLTC2=Ht.LTC_HALF_2)),s.ambient[0]=g,s.ambient[1]=_,s.ambient[2]=x;const Y=s.hash;(Y.directionalLength!==y||Y.pointLength!==T||Y.spotLength!==C||Y.rectAreaLength!==M||Y.hemiLength!==v||Y.numDirectionalShadows!==B||Y.numPointShadows!==N||Y.numSpotShadows!==D||Y.numSpotMaps!==O||Y.numLightProbes!==z)&&(s.directional.length=y,s.spot.length=C,s.rectArea.length=M,s.point.length=T,s.hemi.length=v,s.directionalShadow.length=B,s.directionalShadowMap.length=B,s.pointShadow.length=N,s.pointShadowMap.length=N,s.spotShadow.length=D,s.spotShadowMap.length=D,s.directionalShadowMatrix.length=B,s.pointShadowMatrix.length=N,s.spotLightMatrix.length=D+O-I,s.spotLightMap.length=O,s.numSpotLightShadowsWithMaps=I,s.numLightProbes=z,Y.directionalLength=y,Y.pointLength=T,Y.spotLength=C,Y.rectAreaLength=M,Y.hemiLength=v,Y.numDirectionalShadows=B,Y.numPointShadows=N,Y.numSpotShadows=D,Y.numSpotMaps=O,Y.numLightProbes=z,s.version=GA++)}function m(p,g){let _=0,x=0,y=0,T=0,C=0;const M=g.matrixWorldInverse;for(let v=0,B=p.length;v<B;v++){const N=p[v];if(N.isDirectionalLight){const D=s.directional[_];D.direction.setFromMatrixPosition(N.matrixWorld),l.setFromMatrixPosition(N.target.matrixWorld),D.direction.sub(l),D.direction.transformDirection(M),_++}else if(N.isSpotLight){const D=s.spot[y];D.position.setFromMatrixPosition(N.matrixWorld),D.position.applyMatrix4(M),D.direction.setFromMatrixPosition(N.matrixWorld),l.setFromMatrixPosition(N.target.matrixWorld),D.direction.sub(l),D.direction.transformDirection(M),y++}else if(N.isRectAreaLight){const D=s.rectArea[T];D.position.setFromMatrixPosition(N.matrixWorld),D.position.applyMatrix4(M),f.identity(),c.copy(N.matrixWorld),c.premultiply(M),f.extractRotation(c),D.halfWidth.set(N.width*.5,0,0),D.halfHeight.set(0,N.height*.5,0),D.halfWidth.applyMatrix4(f),D.halfHeight.applyMatrix4(f),T++}else if(N.isPointLight){const D=s.point[x];D.position.setFromMatrixPosition(N.matrixWorld),D.position.applyMatrix4(M),x++}else if(N.isHemisphereLight){const D=s.hemi[C];D.direction.setFromMatrixPosition(N.matrixWorld),D.direction.transformDirection(M),C++}}}return{setup:d,setupView:m,state:s}}function K_(r){const t=new kA(r),i=[],s=[];function l(g){p.camera=g,i.length=0,s.length=0}function c(g){i.push(g)}function f(g){s.push(g)}function d(){t.setup(i)}function m(g){t.setupView(i,g)}const p={lightsArray:i,shadowsArray:s,camera:null,lights:t,transmissionRenderTarget:{}};return{init:l,state:p,setupLights:d,setupLightsView:m,pushLight:c,pushShadow:f}}function XA(r){let t=new WeakMap;function i(l,c=0){const f=t.get(l);let d;return f===void 0?(d=new K_(r),t.set(l,[d])):c>=f.length?(d=new K_(r),f.push(d)):d=f[c],d}function s(){t=new WeakMap}return{get:i,dispose:s}}const WA=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;class nR{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,i){if(this.texture===null){const s=new Cv(t.texture);(t.depthNear!==i.depthNear||t.depthFar!==i.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=s}}getMesh(t){if(this.texture!==null&&this.mesh===null){const i=t.cameras[0].viewport,s=new ki({vertexShader:tR,fragmentShader:eR,uniforms:{depthColor:{value:this.texture},depthWidth:{value:i.z},depthHeight:{value:i.w}}});this.mesh=new Ci(new rl(20,20),s)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class iR extends Ir{constructor(t,i){super();const s=this;let l=null,c=1,f=null,d="local-floor",m=1,p=null,g=null,_=null,x=null,y=null,T=null;const C=typeof XRWebGLBinding<"u",M=new nR,v={},B=i.getContextAttributes();let N=null,D=null;const O=[],I=[],z=new Wt;let Y=null;const b=new mi;b.viewport=new an;const w=new mi;w.viewport=new an;const V=[b,w],nt=new dE;let it=null,dt=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Q){let ct=O[Q];return ct===void 0&&(ct=new Lh,O[Q]=ct),ct.getTargetRaySpace()},this.getControllerGrip=function(Q){let ct=O[Q];return ct===void 0&&(ct=new Lh,O[Q]=ct),ct.getGripSpace()},this.getHand=function(Q){let ct=O[Q];return ct===void 0&&(ct=new Lh,O[Q]=ct),ct.getHandSpace()};function rt(Q){const ct=I.indexOf(Q.inputSource);if(ct===-1)return;const Dt=O[ct];Dt!==void 0&&(Dt.update(Q.inputSource,Q.frame,p||f),Dt.dispatchEvent({type:Q.type,data:Q.inputSource}))}function F(){l.removeEventListener("select",rt),l.removeEventListener("selectstart",rt),l.removeEventListener("selectend",rt),l.removeEventListener("squeeze",rt),l.removeEventListener("squeezestart",rt),l.removeEventListener("squeezeend",rt),l.removeEventListener("end",F),l.removeEventListener("inputsourceschange",H);for(let Q=0;Q<O.length;Q++){const ct=I[Q];ct!==null&&(I[Q]=null,O[Q].disconnect(ct))}it=null,dt=null,M.reset();for(const Q in v)delete v[Q];t.setRenderTarget(N),y=null,x=null,_=null,l=null,D=null,Rt.stop(),s.isPresenting=!1,t.setPixelRatio(Y),t.setSize(z.width,z.height,!1),s.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Q){c=Q,s.isPresenting===!0&&pe("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Q){d=Q,s.isPresenting===!0&&pe("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return p||f},this.setReferenceSpace=function(Q){p=Q},this.getBaseLayer=function(){return x!==null?x:y},this.getBinding=function(){return _===null&&C&&(_=new XRWebGLBinding(l,i)),_},this.getFrame=function(){return T},this.getSession=function(){return l},this.setSession=async function(Q){if(l=Q,l!==null){if(N=t.getRenderTarget(),l.addEventListener("select",rt),l.addEventListener("selectstart",rt),l.addEventListener("selectend",rt),l.addEventListener("squeeze",rt),l.addEventListener("squeezestart",rt),l.addEventListener("squeezeend",rt),l.addEventListener("end",F),l.addEventListener("inputsourceschange",H),B.xrCompatible!==!0&&await i.makeXRCompatible(),Y=t.getPixelRatio(),t.getSize(z),C&&"createProjectionLayer"in XRWebGLBinding.prototype){let Dt=null,Vt=null,qt=null;B.depth&&(qt=B.stencil?i.DEPTH24_STENCIL8:i.DEPTH_COMPONENT24,Dt=B.stencil?Ds:Sa,Vt=B.stencil?Ko:Gi);const ye={colorFormat:i.RGBA8,depthFormat:qt,scaleFactor:c};_=this.getBinding(),x=_.createProjectionLayer(ye),l.updateRenderState({layers:[x]}),t.setPixelRatio(1),t.setSize(x.textureWidth,x.textureHeight,!1),D=new Ii(x.textureWidth,x.textureHeight,{format:Ai,type:ii,depthTexture:new Qo(x.textureWidth,x.textureHeight,Vt,void 0,void 0,void 0,void 0,void 0,void 0,Dt),stencilBuffer:B.stencil,colorSpace:t.outputColorSpace,samples:B.antialias?4:0,resolveDepthBuffer:x.ignoreDepthValues===!1,resolveStencilBuffer:x.ignoreDepthValues===!1})}else{const Dt={antialias:B.antialias,alpha:!0,depth:B.depth,stencil:B.stencil,framebufferScaleFactor:c};y=new XRWebGLLayer(l,i,Dt),l.updateRenderState({baseLayer:y}),t.setPixelRatio(1),t.setSize(y.framebufferWidth,y.framebufferHeight,!1),D=new Ii(y.framebufferWidth,y.framebufferHeight,{format:Ai,type:ii,colorSpace:t.outputColorSpace,stencilBuffer:B.stencil,resolveDepthBuffer:y.ignoreDepthValues===!1,resolveStencilBuffer:y.ignoreDepthValues===!1})}D.isXRRenderTarget=!0,this.setFoveation(m),p=null,f=await l.requestReferenceSpace(d),Rt.setContext(l),Rt.start(),s.isPresenting=!0,s.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(l!==null)return l.environmentBlendMode},this.getDepthTexture=function(){return M.getDepthTexture()};function H(Q){for(let ct=0;ct<Q.removed.length;ct++){const Dt=Q.removed[ct],Vt=I.indexOf(Dt);Vt>=0&&(I[Vt]=null,O[Vt].disconnect(Dt))}for(let ct=0;ct<Q.added.length;ct++){const Dt=Q.added[ct];let Vt=I.indexOf(Dt);if(Vt===-1){for(let ye=0;ye<O.length;ye++)if(ye>=I.length){I.push(Dt),Vt=ye;break}else if(I[ye]===null){I[ye]=Dt,Vt=ye;break}if(Vt===-1)break}const qt=O[Vt];qt&&qt.connect(Dt)}}const $=new j,yt=new j;function xt(Q,ct,Dt){$.setFromMatrixPosition(ct.matrixWorld),yt.setFromMatrixPosition(Dt.matrixWorld);const Vt=$.distanceTo(yt),qt=ct.projectionMatrix.elements,ye=Dt.projectionMatrix.elements,Ue=qt[14]/(qt[10]-1),fe=qt[14]/(qt[10]+1),gt=(qt[9]+1)/qt[5],At=(qt[9]-1)/qt[5],Mt=(qt[8]-1)/qt[0],Bt=(ye[8]+1)/ye[0],P=Ue*Mt,ie=Ue*Bt,Gt=Vt/(-Mt+Bt),se=Gt*-Mt;if(ct.matrixWorld.decompose(Q.position,Q.quaternion,Q.scale),Q.translateX(se),Q.translateZ(Gt),Q.matrixWorld.compose(Q.position,Q.quaternion,Q.scale),Q.matrixWorldInverse.copy(Q.matrixWorld).invert(),qt[10]===-1)Q.projectionMatrix.copy(ct.projectionMatrix),Q.projectionMatrixInverse.copy(ct.projectionMatrixInverse);else{const Ut=Ue+Gt,U=fe+Gt,E=P-se,W=ie+(Vt-se),ut=gt*fe/U*Ut,St=At*fe/U*Ut;Q.projectionMatrix.makePerspective(E,W,ut,St,Ut,U),Q.projectionMatrixInverse.copy(Q.projectionMatrix).invert()}}function L(Q,ct){ct===null?Q.matrixWorld.copy(Q.matrix):Q.matrixWorld.multiplyMatrices(ct.matrixWorld,Q.matrix),Q.matrixWorldInverse.copy(Q.matrixWorld).invert()}this.updateCamera=function(Q){if(l===null)return;let ct=Q.near,Dt=Q.far;M.texture!==null&&(M.depthNear>0&&(ct=M.depthNear),M.depthFar>0&&(Dt=M.depthFar)),nt.near=w.near=b.near=ct,nt.far=w.far=b.far=Dt,(it!==nt.near||dt!==nt.far)&&(l.updateRenderState({depthNear:nt.near,depthFar:nt.far}),it=nt.near,dt=nt.far),nt.layers.mask=Q.layers.mask|6,b.layers.mask=nt.layers.mask&3,w.layers.mask=nt.layers.mask&5;const Vt=Q.parent,qt=nt.cameras;L(nt,Vt);for(let ye=0;ye<qt.length;ye++)L(qt[ye],Vt);qt.length===2?xt(nt,b,w):nt.projectionMatrix.copy(b.projectionMatrix),K(Q,nt,Vt)};function K(Q,ct,Dt){Dt===null?Q.matrix.copy(ct.matrixWorld):(Q.matrix.copy(Dt.matrixWorld),Q.matrix.invert(),Q.matrix.multiply(ct.matrixWorld)),Q.matrix.decompose(Q.position,Q.quaternion,Q.scale),Q.updateMatrixWorld(!0),Q.projectionMatrix.copy(ct.projectionMatrix),Q.projectionMatrixInverse.copy(ct.projectionMatrixInverse),Q.isPerspectiveCamera&&(Q.fov=zd*2*Math.atan(1/Q.projectionMatrix.elements[5]),Q.zoom=1)}this.getCamera=function(){return nt},this.getFoveation=function(){if(!(x===null&&y===null))return m},this.setFoveation=function(Q){m=Q,x!==null&&(x.fixedFoveation=Q),y!==null&&y.fixedFoveation!==void 0&&(y.fixedFoveation=Q)},this.hasDepthSensing=function(){return M.texture!==null},this.getDepthSensingMesh=function(){return M.getMesh(nt)},this.getCameraTexture=function(Q){return v[Q]};let ft=null;function Et(Q,ct){if(g=ct.getViewerPose(p||f),T=ct,g!==null){const Dt=g.views;y!==null&&(t.setRenderTargetFramebuffer(D,y.framebuffer),t.setRenderTarget(D));let Vt=!1;Dt.length!==nt.cameras.length&&(nt.cameras.length=0,Vt=!0);for(let fe=0;fe<Dt.length;fe++){const gt=Dt[fe];let At=null;if(y!==null)At=y.getViewport(gt);else{const Bt=_.getViewSubImage(x,gt);At=Bt.viewport,fe===0&&(t.setRenderTargetTextures(D,Bt.colorTexture,Bt.depthStencilTexture),t.setRenderTarget(D))}let Mt=V[fe];Mt===void 0&&(Mt=new mi,Mt.layers.enable(fe),Mt.viewport=new an,V[fe]=Mt),Mt.matrix.fromArray(gt.transform.matrix),Mt.matrix.decompose(Mt.position,Mt.quaternion,Mt.scale),Mt.projectionMatrix.fromArray(gt.projectionMatrix),Mt.projectionMatrixInverse.copy(Mt.projectionMatrix).invert(),Mt.viewport.set(At.x,At.y,At.width,At.height),fe===0&&(nt.matrix.copy(Mt.matrix),nt.matrix.decompose(nt.position,nt.quaternion,nt.scale)),Vt===!0&&nt.cameras.push(Mt)}const qt=l.enabledFeatures;if(qt&&qt.includes("depth-sensing")&&l.depthUsage=="gpu-optimized"&&C){_=s.getBinding();const fe=_.getDepthInformation(Dt[0]);fe&&fe.isValid&&fe.texture&&M.init(fe,l.renderState)}if(qt&&qt.includes("camera-access")&&C){t.state.unbindTexture(),_=s.getBinding();for(let fe=0;fe<Dt.length;fe++){const gt=Dt[fe].camera;if(gt){let At=v[gt];At||(At=new Cv,v[gt]=At);const Mt=_.getCameraImage(gt);At.sourceTexture=Mt}}}}for(let Dt=0;Dt<O.length;Dt++){const Vt=I[Dt],qt=O[Dt];Vt!==null&&qt!==void 0&&qt.update(Vt,ct,p||f)}ft&&ft(Q,ct),ct.detectedPlanes&&s.dispatchEvent({type:"planesdetected",data:ct}),T=null}const Rt=new Iv;Rt.setAnimationLoop(Et),this.setAnimationLoop=function(Q){ft=Q},this.dispose=function(){}}}const bs=new Vi,aR=new tn;function sR(r,t){function i(M,v){M.matrixAutoUpdate===!0&&M.updateMatrix(),v.value.copy(M.matrix)}function s(M,v){v.color.getRGB(M.fogColor.value,Tv(r)),v.isFog?(M.fogNear.value=v.near,M.fogFar.value=v.far):v.isFogExp2&&(M.fogDensity.value=v.density)}function l(M,v,B,N,D){v.isMeshBasicMaterial||v.isMeshLambertMaterial?c(M,v):v.isMeshToonMaterial?(c(M,v),_(M,v)):v.isMeshPhongMaterial?(c(M,v),g(M,v)):v.isMeshStandardMaterial?(c(M,v),x(M,v),v.isMeshPhysicalMaterial&&y(M,v,D)):v.isMeshMatcapMaterial?(c(M,v),T(M,v)):v.isMeshDepthMaterial?c(M,v):v.isMeshDistanceMaterial?(c(M,v),C(M,v)):v.isMeshNormalMaterial?c(M,v):v.isLineBasicMaterial?(f(M,v),v.isLineDashedMaterial&&d(M,v)):v.isPointsMaterial?m(M,v,B,N):v.isSpriteMaterial?p(M,v):v.isShadowMaterial?(M.color.value.copy(v.color),M.opacity.value=v.opacity):v.isShaderMaterial&&(v.uniformsNeedUpdate=!1)}function c(M,v){M.opacity.value=v.opacity,v.color&&M.diffuse.value.copy(v.color),v.emissive&&M.emissive.value.copy(v.emissive).multiplyScalar(v.emissiveIntensity),v.map&&(M.map.value=v.map,i(v.map,M.mapTransform)),v.alphaMap&&(M.alphaMap.value=v.alphaMap,i(v.alphaMap,M.alphaMapTransform)),v.bumpMap&&(M.bumpMap.value=v.bumpMap,i(v.bumpMap,M.bumpMapTransform),M.bumpScale.value=v.bumpScale,v.side===qn&&(M.bumpScale.value*=-1)),v.normalMap&&(M.normalMap.value=v.normalMap,i(v.normalMap,M.normalMapTransform),M.normalScale.value.copy(v.normalScale),v.side===qn&&M.normalScale.value.negate()),v.displacementMap&&(M.displacementMap.value=v.displacementMap,i(v.displacementMap,M.displacementMapTransform),M.displacementScale.value=v.displacementScale,M.displacementBias.value=v.displacementBias),v.emissiveMap&&(M.emissiveMap.value=v.emissiveMap,i(v.emissiveMap,M.emissiveMapTransform)),v.specularMap&&(M.specularMap.value=v.specularMap,i(v.specularMap,M.specularMapTransform)),v.alphaTest>0&&(M.alphaTest.value=v.alphaTest);const B=t.get(v),N=B.envMap,D=B.envMapRotation;N&&(M.envMap.value=N,bs.copy(D),bs.x*=-1,bs.y*=-1,bs.z*=-1,N.isCubeTexture&&N.isRenderTargetTexture===!1&&(bs.y*=-1,bs.z*=-1),M.envMapRotation.value.setFromMatrix4(aR.makeRotationFromEuler(bs)),M.flipEnvMap.value=N.isCubeTexture&&N.isRenderTargetTexture===!1?-1:1,M.reflectivity.value=v.reflectivity,M.ior.value=v.ior,M.refractionRatio.value=v.refractionRatio),v.lightMap&&(M.lightMap.value=v.lightMap,M.lightMapIntensity.value=v.lightMapIntensity,i(v.lightMap,M.lightMapTransform)),v.aoMap&&(M.aoMap.value=v.aoMap,M.aoMapIntensity.value=v.aoMapIntensity,i(v.aoMap,M.aoMapTransform))}function f(M,v){M.diffuse.value.copy(v.color),M.opacity.value=v.opacity,v.map&&(M.map.value=v.map,i(v.map,M.mapTransform))}function d(M,v){M.dashSize.value=v.dashSize,M.totalSize.value=v.dashSize+v.gapSize,M.scale.value=v.scale}function m(M,v,B,N){M.diffuse.value.copy(v.color),M.opacity.value=v.opacity,M.size.value=v.size*B,M.scale.value=N*.5,v.map&&(M.map.value=v.map,i(v.map,M.uvTransform)),v.alphaMap&&(M.alphaMap.value=v.alphaMap,i(v.alphaMap,M.alphaMapTransform)),v.alphaTest>0&&(M.alphaTest.value=v.alphaTest)}function p(M,v){M.diffuse.value.copy(v.color),M.opacity.value=v.opacity,M.rotation.value=v.rotation,v.map&&(M.map.value=v.map,i(v.map,M.mapTransform)),v.alphaMap&&(M.alphaMap.value=v.alphaMap,i(v.alphaMap,M.alphaMapTransform)),v.alphaTest>0&&(M.alphaTest.value=v.alphaTest)}function g(M,v){M.specular.value.copy(v.specular),M.shininess.value=Math.max(v.shininess,1e-4)}function _(M,v){v.gradientMap&&(M.gradientMap.value=v.gradientMap)}function x(M,v){M.metalness.value=v.metalness,v.metalnessMap&&(M.metalnessMap.value=v.metalnessMap,i(v.metalnessMap,M.metalnessMapTransform)),M.roughness.value=v.roughness,v.roughnessMap&&(M.roughnessMap.value=v.roughnessMap,i(v.roughnessMap,M.roughnessMapTransform)),v.envMap&&(M.envMapIntensity.value=v.envMapIntensity)}function y(M,v,B){M.ior.value=v.ior,v.sheen>0&&(M.sheenColor.value.copy(v.sheenColor).multiplyScalar(v.sheen),M.sheenRoughness.value=v.sheenRoughness,v.sheenColorMap&&(M.sheenColorMap.value=v.sheenColorMap,i(v.sheenColorMap,M.sheenColorMapTransform)),v.sheenRoughnessMap&&(M.sheenRoughnessMap.value=v.sheenRoughnessMap,i(v.sheenRoughnessMap,M.sheenRoughnessMapTransform))),v.clearcoat>0&&(M.clearcoat.value=v.clearcoat,M.clearcoatRoughness.value=v.clearcoatRoughness,v.clearcoatMap&&(M.clearcoatMap.value=v.clearcoatMap,i(v.clearcoatMap,M.clearcoatMapTransform)),v.clearcoatRoughnessMap&&(M.clearcoatRoughnessMap.value=v.clearcoatRoughnessMap,i(v.clearcoatRoughnessMap,M.clearcoatRoughnessMapTransform)),v.clearcoatNormalMap&&(M.clearcoatNormalMap.value=v.clearcoatNormalMap,i(v.clearcoatNormalMap,M.clearcoatNormalMapTransform),M.clearcoatNormalScale.value.copy(v.clearcoatNormalScale),v.side===qn&&M.clearcoatNormalScale.value.negate())),v.dispersion>0&&(M.dispersion.value=v.dispersion),v.iridescence>0&&(M.iridescence.value=v.iridescence,M.iridescenceIOR.value=v.iridescenceIOR,M.iridescenceThicknessMinimum.value=v.iridescenceThicknessRange[0],M.iridescenceThicknessMaximum.value=v.iridescenceThicknessRange[1],v.iridescenceMap&&(M.iridescenceMap.value=v.iridescenceMap,i(v.iridescenceMap,M.iridescenceMapTransform)),v.iridescenceThicknessMap&&(M.iridescenceThicknessMap.value=v.iridescenceThicknessMap,i(v.iridescenceThicknessMap,M.iridescenceThicknessMapTransform))),v.transmission>0&&(M.transmission.value=v.transmission,M.transmissionSamplerMap.value=B.texture,M.transmissionSamplerSize.value.set(B.width,B.height),v.transmissionMap&&(M.transmissionMap.value=v.transmissionMap,i(v.transmissionMap,M.transmissionMapTransform)),M.thickness.value=v.thickness,v.thicknessMap&&(M.thicknessMap.value=v.thicknessMap,i(v.thicknessMap,M.thicknessMapTransform)),M.attenuationDistance.value=v.attenuationDistance,M.attenuationColor.value.copy(v.attenuationColor)),v.anisotropy>0&&(M.anisotropyVector.value.set(v.anisotropy*Math.cos(v.anisotropyRotation),v.anisotropy*Math.sin(v.anisotropyRotation)),v.anisotropyMap&&(M.anisotropyMap.value=v.anisotropyMap,i(v.anisotropyMap,M.anisotropyMapTransform))),M.specularIntensity.value=v.specularIntensity,M.specularColor.value.copy(v.specularColor),v.specularColorMap&&(M.specularColorMap.value=v.specularColorMap,i(v.specularColorMap,M.specularColorMapTransform)),v.specularIntensityMap&&(M.specularIntensityMap.value=v.specularIntensityMap,i(v.specularIntensityMap,M.specularIntensityMapTransform))}function T(M,v){v.matcap&&(M.matcap.value=v.matcap)}function C(M,v){const B=t.get(v).light;M.referencePosition.value.setFromMatrixPosition(B.matrixWorld),M.nearDistance.value=B.shadow.camera.near,M.farDistance.value=B.shadow.camera.far}return{refreshFogUniforms:s,refreshMaterialUniforms:l}}function rR(r,t,i,s){let l={},c={},f=[];const d=r.getParameter(r.MAX_UNIFORM_BUFFER_BINDINGS);function m(B,N){const D=N.program;s.uniformBlockBinding(B,D)}function p(B,N){let D=l[B.id];D===void 0&&(T(B),D=g(B),l[B.id]=D,B.addEventListener("dispose",M));const O=N.program;s.updateUBOMapping(B,O);const I=t.render.frame;c[B.id]!==I&&(x(B),c[B.id]=I)}function g(B){const N=_();B.__bindingPointIndex=N;const D=r.createBuffer(),O=B.__size,I=B.usage;return r.bindBuffer(r.UNIFORM_BUFFER,D),r.bufferData(r.UNIFORM_BUFFER,O,I),r.bindBuffer(r.UNIFORM_BUFFER,null),r.bindBufferBase(r.UNIFORM_BUFFER,N,D),D}function _(){for(let B=0;B<d;B++)if(f.indexOf(B)===-1)return f.push(B),B;return we("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function x(B){const N=l[B.id],D=B.uniforms,O=B.__cache;r.bindBuffer(r.UNIFORM_BUFFER,N);for(let I=0,z=D.length;I<z;I++){const Y=Array.isArray(D[I])?D[I]:[D[I]];for(let b=0,w=Y.length;b<w;b++){const V=Y[b];if(y(V,I,b,O)===!0){const nt=V.__offset,it=Array.isArray(V.value)?V.value:[V.value];let dt=0;for(let rt=0;rt<it.length;rt++){const F=it[rt],H=C(F);typeof F=="number"||typeof F=="boolean"?(V.__data[0]=F,r.bufferSubData(r.UNIFORM_BUFFER,nt+dt,V.__data)):F.isMatrix3?(V.__data[0]=F.elements[0],V.__data[1]=F.elements[1],V.__data[2]=F.elements[2],V.__data[3]=0,V.__data[4]=F.elements[3],V.__data[5]=F.elements[4],V.__data[6]=F.elements[5],V.__data[7]=0,V.__data[8]=F.elements[6],V.__data[9]=F.elements[7],V.__data[10]=F.elements[8],V.__data[11]=0):(F.toArray(V.__data,dt),dt+=H.storage/Float32Array.BYTES_PER_ELEMENT)}r.bufferSubData(r.UNIFORM_BUFFER,nt,V.__data)}}}r.bindBuffer(r.UNIFORM_BUFFER,null)}function y(B,N,D,O){const I=B.value,z=N+"_"+D;if(O[z]===void 0)return typeof I=="number"||typeof I=="boolean"?O[z]=I:O[z]=I.clone(),!0;{const Y=O[z];if(typeof I=="number"||typeof I=="boolean"){if(Y!==I)return O[z]=I,!0}else if(Y.equals(I)===!1)return Y.copy(I),!0}return!1}function T(B){const N=B.uniforms;let D=0;const O=16;for(let z=0,Y=N.length;z<Y;z++){const b=Array.isArray(N[z])?N[z]:[N[z]];for(let w=0,V=b.length;w<V;w++){const nt=b[w],it=Array.isArray(nt.value)?nt.value:[nt.value];for(let dt=0,rt=it.length;dt<rt;dt++){const F=it[dt],H=C(F),$=D%O,yt=$%H.boundary,xt=$+yt;D+=yt,xt!==0&&O-xt<H.storage&&(D+=O-xt),nt.__data=new Float32Array(H.storage/Float32Array.BYTES_PER_ELEMENT),nt.__offset=D,D+=H.storage}}}const I=D%O;return I>0&&(D+=O-I),B.__size=D,B.__cache={},this}function C(B){const N={boundary:0,storage:0};return typeof B=="number"||typeof B=="boolean"?(N.boundary=4,N.storage=4):B.isVector2?(N.boundary=8,N.storage=8):B.isVector3||B.isColor?(N.boundary=16,N.storage=12):B.isVector4?(N.boundary=16,N.storage=16):B.isMatrix3?(N.boundary=48,N.storage=48):B.isMatrix4?(N.boundary=64,N.storage=64):B.isTexture?pe("WebGLRenderer: Texture samplers can not be part of an uniforms group."):pe("WebGLRenderer: Unsupported uniform value type.",B),N}function M(B){const N=B.target;N.removeEventListener("dispose",M);const D=f.indexOf(N.__bindingPointIndex);f.splice(D,1),r.deleteBuffer(l[N.id]),delete l[N.id],delete c[N.id]}function v(){for(const B in l)r.deleteBuffer(l[B]);f=[],l={},c={}}return{bind:m,update:p,dispose:v}}const oR=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let Oi=null;function lR(){return Oi===null&&(Oi=new SM(oR,16,16,Pr,xa),Oi.name="DFG_LUT",Oi.minFilter=xn,Oi.magFilter=xn,Oi.wrapS=ga,Oi.wrapT=ga,Oi.generateMipmaps=!1,Oi.needsUpdate=!0),Oi}class cR{constructor(t={}){const{canvas:i=qy(),context:s=null,depth:l=!0,stencil:c=!1,alpha:f=!1,antialias:d=!1,premultipliedAlpha:m=!0,preserveDrawingBuffer:p=!1,powerPreference:g="default",failIfMajorPerformanceCaveat:_=!1,reversedDepthBuffer:x=!1,outputBufferType:y=ii}=t;this.isWebGLRenderer=!0;let T;if(s!==null){if(typeof WebGLRenderingContext<"u"&&s instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");T=s.getContextAttributes().alpha}else T=f;const C=y,M=new Set([jd,Zd,Yd]),v=new Set([ii,Gi,jo,Ko,Wd,qd]),B=new Uint32Array(4),N=new Int32Array(4);let D=null,O=null;const I=[],z=[];let Y=null;this.domElement=i,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Bi,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const b=this;let w=!1;this._outputColorSpace=ni;let V=0,nt=0,it=null,dt=-1,rt=null;const F=new an,H=new an;let $=null;const yt=new Fe(0);let xt=0,L=i.width,K=i.height,ft=1,Et=null,Rt=null;const Q=new an(0,0,L,K),ct=new an(0,0,L,K);let Dt=!1;const Vt=new ep;let qt=!1,ye=!1;const Ue=new tn,fe=new j,gt=new an,At={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Mt=!1;function Bt(){return it===null?ft:1}let P=s;function ie(R,q){return i.getContext(R,q)}try{const R={alpha:!0,depth:l,stencil:c,antialias:d,premultipliedAlpha:m,preserveDrawingBuffer:p,powerPreference:g,failIfMajorPerformanceCaveat:_};if("setAttribute"in i&&i.setAttribute("data-engine",`three.js r${kd}`),i.addEventListener("webglcontextlost",he,!1),i.addEventListener("webglcontextrestored",Ie,!1),i.addEventListener("webglcontextcreationerror",Ce,!1),P===null){const q="webgl2";if(P=ie(q,R),P===null)throw ie(q)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(R){throw we("WebGLRenderer: "+R.message),R}let Gt,se,Ut,U,E,W,ut,St,ht,Qt,Lt,Jt,le,Tt,Ct,Yt,kt,Pt,_e,X,Ft,wt,Xt,bt;function vt(){Gt=new l1(P),Gt.init(),wt=new $A(P,Gt),se=new $b(P,Gt,t,wt),Ut=new JA(P,Gt),se.reversedDepthBuffer&&x&&Ut.buffers.depth.setReversed(!0),U=new f1(P),E=new zA,W=new QA(P,Gt,Ut,E,se,wt,U),ut=new e1(b),St=new o1(b),ht=new mE(P),Xt=new Jb(P,ht),Qt=new c1(P,ht,U,Xt),Lt=new d1(P,Qt,ht,U),_e=new h1(P,se,W),Yt=new t1(E),Jt=new PA(b,ut,St,Gt,se,Xt,Yt),le=new sR(b,E),Tt=new BA,Ct=new XA(Gt),Pt=new Kb(b,ut,St,Ut,Lt,T,m),kt=new jA(b,Lt,se),bt=new rR(P,U,se,Ut),X=new Qb(P,Gt,U),Ft=new u1(P,Gt,U),U.programs=Jt.programs,b.capabilities=se,b.extensions=Gt,b.properties=E,b.renderLists=Tt,b.shadowMap=kt,b.state=Ut,b.info=U}vt(),C!==ii&&(Y=new m1(C,i.width,i.height,l,c));const Nt=new iR(b,P);this.xr=Nt,this.getContext=function(){return P},this.getContextAttributes=function(){return P.getContextAttributes()},this.forceContextLoss=function(){const R=Gt.get("WEBGL_lose_context");R&&R.loseContext()},this.forceContextRestore=function(){const R=Gt.get("WEBGL_lose_context");R&&R.restoreContext()},this.getPixelRatio=function(){return ft},this.setPixelRatio=function(R){R!==void 0&&(ft=R,this.setSize(L,K,!1))},this.getSize=function(R){return R.set(L,K)},this.setSize=function(R,q,ot=!0){if(Nt.isPresenting){pe("WebGLRenderer: Can't change size while VR device is presenting.");return}L=R,K=q,i.width=Math.floor(R*ft),i.height=Math.floor(q*ft),ot===!0&&(i.style.width=R+"px",i.style.height=q+"px"),Y!==null&&Y.setSize(i.width,i.height),this.setViewport(0,0,R,q)},this.getDrawingBufferSize=function(R){return R.set(L*ft,K*ft).floor()},this.setDrawingBufferSize=function(R,q,ot){L=R,K=q,ft=ot,i.width=Math.floor(R*ot),i.height=Math.floor(q*ot),this.setViewport(0,0,R,q)},this.setEffects=function(R){if(C===ii){console.error("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(R){for(let q=0;q<R.length;q++)if(R[q].isOutputPass===!0){console.warn("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}Y.setEffects(R||[])},this.getCurrentViewport=function(R){return R.copy(F)},this.getViewport=function(R){return R.copy(Q)},this.setViewport=function(R,q,ot,at){R.isVector4?Q.set(R.x,R.y,R.z,R.w):Q.set(R,q,ot,at),Ut.viewport(F.copy(Q).multiplyScalar(ft).round())},this.getScissor=function(R){return R.copy(ct)},this.setScissor=function(R,q,ot,at){R.isVector4?ct.set(R.x,R.y,R.z,R.w):ct.set(R,q,ot,at),Ut.scissor(H.copy(ct).multiplyScalar(ft).round())},this.getScissorTest=function(){return Dt},this.setScissorTest=function(R){Ut.setScissorTest(Dt=R)},this.setOpaqueSort=function(R){Et=R},this.setTransparentSort=function(R){Rt=R},this.getClearColor=function(R){return R.copy(Pt.getClearColor())},this.setClearColor=function(){Pt.setClearColor(...arguments)},this.getClearAlpha=function(){return Pt.getClearAlpha()},this.setClearAlpha=function(){Pt.setClearAlpha(...arguments)},this.clear=function(R=!0,q=!0,ot=!0){let at=0;if(R){let J=!1;if(it!==null){const zt=it.texture.format;J=M.has(zt)}if(J){const zt=it.texture.type,Zt=v.has(zt),It=Pt.getClearColor(),jt=Pt.getClearAlpha(),$t=It.r,oe=It.g,te=It.b;Zt?(B[0]=$t,B[1]=oe,B[2]=te,B[3]=jt,P.clearBufferuiv(P.COLOR,0,B)):(N[0]=$t,N[1]=oe,N[2]=te,N[3]=jt,P.clearBufferiv(P.COLOR,0,N))}else at|=P.COLOR_BUFFER_BIT}q&&(at|=P.DEPTH_BUFFER_BIT),ot&&(at|=P.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),P.clear(at)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){i.removeEventListener("webglcontextlost",he,!1),i.removeEventListener("webglcontextrestored",Ie,!1),i.removeEventListener("webglcontextcreationerror",Ce,!1),Pt.dispose(),Tt.dispose(),Ct.dispose(),E.dispose(),ut.dispose(),St.dispose(),Lt.dispose(),Xt.dispose(),bt.dispose(),Jt.dispose(),Nt.dispose(),Nt.removeEventListener("sessionstart",Os),Nt.removeEventListener("sessionend",Xr),wi.stop()};function he(R){R.preventDefault(),a_("WebGLRenderer: Context Lost."),w=!0}function Ie(){a_("WebGLRenderer: Context Restored."),w=!1;const R=U.autoReset,q=kt.enabled,ot=kt.autoUpdate,at=kt.needsUpdate,J=kt.type;vt(),U.autoReset=R,kt.enabled=q,kt.autoUpdate=ot,kt.needsUpdate=at,kt.type=J}function Ce(R){we("WebGLRenderer: A WebGL context could not be created. Reason: ",R.statusMessage)}function Un(R){const q=R.target;q.removeEventListener("dispose",Un),gi(q)}function gi(R){ol(R),E.remove(R)}function ol(R){const q=E.get(R).programs;q!==void 0&&(q.forEach(function(ot){Jt.releaseProgram(ot)}),R.isShaderMaterial&&Jt.releaseShaderCache(R))}this.renderBufferDirect=function(R,q,ot,at,J,zt){q===null&&(q=At);const Zt=J.isMesh&&J.matrixWorld.determinant()<0,It=ns(R,q,ot,at,J);Ut.setMaterial(at,Zt);let jt=ot.index,$t=1;if(at.wireframe===!0){if(jt=Qt.getWireframeAttribute(ot),jt===void 0)return;$t=2}const oe=ot.drawRange,te=ot.attributes.position;let ce=oe.start*$t,Oe=(oe.start+oe.count)*$t;zt!==null&&(ce=Math.max(ce,zt.start*$t),Oe=Math.min(Oe,(zt.start+zt.count)*$t)),jt!==null?(ce=Math.max(ce,0),Oe=Math.min(Oe,jt.count)):te!=null&&(ce=Math.max(ce,0),Oe=Math.min(Oe,te.count));const Je=Oe-ce;if(Je<0||Je===1/0)return;Xt.setup(J,at,It,ot,jt);let Ze,Be=X;if(jt!==null&&(Ze=ht.get(jt),Be=Ft,Be.setIndex(Ze)),J.isMesh)at.wireframe===!0?(Ut.setLineWidth(at.wireframeLinewidth*Bt()),Be.setMode(P.LINES)):Be.setMode(P.TRIANGLES);else if(J.isLine){let ae=at.linewidth;ae===void 0&&(ae=1),Ut.setLineWidth(ae*Bt()),J.isLineSegments?Be.setMode(P.LINES):J.isLineLoop?Be.setMode(P.LINE_LOOP):Be.setMode(P.LINE_STRIP)}else J.isPoints?Be.setMode(P.POINTS):J.isSprite&&Be.setMode(P.TRIANGLES);if(J.isBatchedMesh)if(J._multiDrawInstances!==null)Jo("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),Be.renderMultiDrawInstances(J._multiDrawStarts,J._multiDrawCounts,J._multiDrawCount,J._multiDrawInstances);else if(Gt.get("WEBGL_multi_draw"))Be.renderMultiDraw(J._multiDrawStarts,J._multiDrawCounts,J._multiDrawCount);else{const ae=J._multiDrawStarts,Pe=J._multiDrawCounts,de=J._multiDrawCount,yn=jt?ht.get(jt).bytesPerElement:1,qi=E.get(at).currentProgram.getUniforms();for(let Mn=0;Mn<de;Mn++)qi.setValue(P,"_gl_DrawID",Mn),Be.render(ae[Mn]/yn,Pe[Mn])}else if(J.isInstancedMesh)Be.renderInstances(ce,Je,J.count);else if(ot.isInstancedBufferGeometry){const ae=ot._maxInstanceCount!==void 0?ot._maxInstanceCount:1/0,Pe=Math.min(ot.instanceCount,ae);Be.renderInstances(ce,Je,Pe)}else Be.render(ce,Je)};function Vr(R,q,ot){R.transparent===!0&&R.side===ma&&R.forceSinglePass===!1?(R.side=qn,R.needsUpdate=!0,zs(R,q,ot),R.side=es,R.needsUpdate=!0,zs(R,q,ot),R.side=ma):zs(R,q,ot)}this.compile=function(R,q,ot=null){ot===null&&(ot=R),O=Ct.get(ot),O.init(q),z.push(O),ot.traverseVisible(function(J){J.isLight&&J.layers.test(q.layers)&&(O.pushLight(J),J.castShadow&&O.pushShadow(J))}),R!==ot&&R.traverseVisible(function(J){J.isLight&&J.layers.test(q.layers)&&(O.pushLight(J),J.castShadow&&O.pushShadow(J))}),O.setupLights();const at=new Set;return R.traverse(function(J){if(!(J.isMesh||J.isPoints||J.isLine||J.isSprite))return;const zt=J.material;if(zt)if(Array.isArray(zt))for(let Zt=0;Zt<zt.length;Zt++){const It=zt[Zt];Vr(It,ot,J),at.add(It)}else Vr(zt,ot,J),at.add(zt)}),O=z.pop(),at},this.compileAsync=function(R,q,ot=null){const at=this.compile(R,q,ot);return new Promise(J=>{function zt(){if(at.forEach(function(Zt){E.get(Zt).currentProgram.isReady()&&at.delete(Zt)}),at.size===0){J(R);return}setTimeout(zt,10)}Gt.get("KHR_parallel_shader_compile")!==null?zt():setTimeout(zt,10)})};let Ls=null;function kr(R){Ls&&Ls(R)}function Os(){wi.stop()}function Xr(){wi.start()}const wi=new Iv;wi.setAnimationLoop(kr),typeof self<"u"&&wi.setContext(self),this.setAnimationLoop=function(R){Ls=R,Nt.setAnimationLoop(R),R===null?wi.stop():wi.start()},Nt.addEventListener("sessionstart",Os),Nt.addEventListener("sessionend",Xr),this.render=function(R,q){if(q!==void 0&&q.isCamera!==!0){we("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(w===!0)return;const ot=Nt.enabled===!0&&Nt.isPresenting===!0,at=Y!==null&&(it===null||ot)&&Y.begin(b,it);if(R.matrixWorldAutoUpdate===!0&&R.updateMatrixWorld(),q.parent===null&&q.matrixWorldAutoUpdate===!0&&q.updateMatrixWorld(),Nt.enabled===!0&&Nt.isPresenting===!0&&(Y===null||Y.isCompositing()===!1)&&(Nt.cameraAutoUpdate===!0&&Nt.updateCamera(q),q=Nt.getCamera()),R.isScene===!0&&R.onBeforeRender(b,R,q,it),O=Ct.get(R,z.length),O.init(q),z.push(O),Ue.multiplyMatrices(q.projectionMatrix,q.matrixWorldInverse),Vt.setFromProjectionMatrix(Ue,Fi,q.reversedDepth),ye=this.localClippingEnabled,qt=Yt.init(this.clippingPlanes,ye),D=Tt.get(R,I.length),D.init(),I.push(D),Nt.enabled===!0&&Nt.isPresenting===!0){const Zt=b.xr.getDepthSensingMesh();Zt!==null&&ai(Zt,q,-1/0,b.sortObjects)}ai(R,q,0,b.sortObjects),D.finish(),b.sortObjects===!0&&D.sort(Et,Rt),Mt=Nt.enabled===!1||Nt.isPresenting===!1||Nt.hasDepthSensing()===!1,Mt&&Pt.addToRenderList(D,R),this.info.render.frame++,qt===!0&&Yt.beginShadows();const J=O.state.shadowsArray;if(kt.render(J,R,q),qt===!0&&Yt.endShadows(),this.info.autoReset===!0&&this.info.reset(),(at&&Y.hasRenderPass())===!1){const Zt=D.opaque,It=D.transmissive;if(O.setupLights(),q.isArrayCamera){const jt=q.cameras;if(It.length>0)for(let $t=0,oe=jt.length;$t<oe;$t++){const te=jt[$t];Sn(Zt,It,R,te)}Mt&&Pt.render(R);for(let $t=0,oe=jt.length;$t<oe;$t++){const te=jt[$t];on(D,R,te,te.viewport)}}else It.length>0&&Sn(Zt,It,R,q),Mt&&Pt.render(R),on(D,R,q)}it!==null&&nt===0&&(W.updateMultisampleRenderTarget(it),W.updateRenderTargetMipmap(it)),at&&Y.end(b),R.isScene===!0&&R.onAfterRender(b,R,q),Xt.resetDefaultState(),dt=-1,rt=null,z.pop(),z.length>0?(O=z[z.length-1],qt===!0&&Yt.setGlobalState(b.clippingPlanes,O.state.camera)):O=null,I.pop(),I.length>0?D=I[I.length-1]:D=null};function ai(R,q,ot,at){if(R.visible===!1)return;if(R.layers.test(q.layers)){if(R.isGroup)ot=R.renderOrder;else if(R.isLOD)R.autoUpdate===!0&&R.update(q);else if(R.isLight)O.pushLight(R),R.castShadow&&O.pushShadow(R);else if(R.isSprite){if(!R.frustumCulled||Vt.intersectsSprite(R)){at&&gt.setFromMatrixPosition(R.matrixWorld).applyMatrix4(Ue);const Zt=Lt.update(R),It=R.material;It.visible&&D.push(R,Zt,It,ot,gt.z,null)}}else if((R.isMesh||R.isLine||R.isPoints)&&(!R.frustumCulled||Vt.intersectsObject(R))){const Zt=Lt.update(R),It=R.material;if(at&&(R.boundingSphere!==void 0?(R.boundingSphere===null&&R.computeBoundingSphere(),gt.copy(R.boundingSphere.center)):(Zt.boundingSphere===null&&Zt.computeBoundingSphere(),gt.copy(Zt.boundingSphere.center)),gt.applyMatrix4(R.matrixWorld).applyMatrix4(Ue)),Array.isArray(It)){const jt=Zt.groups;for(let $t=0,oe=jt.length;$t<oe;$t++){const te=jt[$t],ce=It[te.materialIndex];ce&&ce.visible&&D.push(R,Zt,ce,ot,gt.z,te)}}else It.visible&&D.push(R,Zt,It,ot,gt.z,null)}}const zt=R.children;for(let Zt=0,It=zt.length;Zt<It;Zt++)ai(zt[Zt],q,ot,at)}function on(R,q,ot,at){const{opaque:J,transmissive:zt,transparent:Zt}=R;O.setupLightsView(ot),qt===!0&&Yt.setGlobalState(b.clippingPlanes,ot),at&&Ut.viewport(F.copy(at)),J.length>0&&_i(J,q,ot),zt.length>0&&_i(zt,q,ot),Zt.length>0&&_i(Zt,q,ot),Ut.buffers.depth.setTest(!0),Ut.buffers.depth.setMask(!0),Ut.buffers.color.setMask(!0),Ut.setPolygonOffset(!1)}function Sn(R,q,ot,at){if((ot.isScene===!0?ot.overrideMaterial:null)!==null)return;if(O.state.transmissionRenderTarget[at.id]===void 0){const ce=Gt.has("EXT_color_buffer_half_float")||Gt.has("EXT_color_buffer_float");O.state.transmissionRenderTarget[at.id]=new Ii(1,1,{generateMipmaps:!0,type:ce?xa:ii,minFilter:ws,samples:se.samples,stencilBuffer:c,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:De.workingColorSpace})}const zt=O.state.transmissionRenderTarget[at.id],Zt=at.viewport||F;zt.setSize(Zt.z*b.transmissionResolutionScale,Zt.w*b.transmissionResolutionScale);const It=b.getRenderTarget(),jt=b.getActiveCubeFace(),$t=b.getActiveMipmapLevel();b.setRenderTarget(zt),b.getClearColor(yt),xt=b.getClearAlpha(),xt<1&&b.setClearColor(16777215,.5),b.clear(),Mt&&Pt.render(ot);const oe=b.toneMapping;b.toneMapping=Bi;const te=at.viewport;if(at.viewport!==void 0&&(at.viewport=void 0),O.setupLightsView(at),qt===!0&&Yt.setGlobalState(b.clippingPlanes,at),_i(R,ot,at),W.updateMultisampleRenderTarget(zt),W.updateRenderTargetMipmap(zt),Gt.has("WEBGL_multisampled_render_to_texture")===!1){let ce=!1;for(let Oe=0,Je=q.length;Oe<Je;Oe++){const Ze=q[Oe],{object:Be,geometry:ae,material:Pe,group:de}=Ze;if(Pe.side===ma&&Be.layers.test(at.layers)){const yn=Pe.side;Pe.side=qn,Pe.needsUpdate=!0,Ps(Be,ot,at,ae,Pe,de),Pe.side=yn,Pe.needsUpdate=!0,ce=!0}}ce===!0&&(W.updateMultisampleRenderTarget(zt),W.updateRenderTargetMipmap(zt))}b.setRenderTarget(It,jt,$t),b.setClearColor(yt,xt),te!==void 0&&(at.viewport=te),b.toneMapping=oe}function _i(R,q,ot){const at=q.isScene===!0?q.overrideMaterial:null;for(let J=0,zt=R.length;J<zt;J++){const Zt=R[J],{object:It,geometry:jt,group:$t}=Zt;let oe=Zt.material;oe.allowOverride===!0&&at!==null&&(oe=at),It.layers.test(ot.layers)&&Ps(It,q,ot,jt,oe,$t)}}function Ps(R,q,ot,at,J,zt){R.onBeforeRender(b,q,ot,at,J,zt),R.modelViewMatrix.multiplyMatrices(ot.matrixWorldInverse,R.matrixWorld),R.normalMatrix.getNormalMatrix(R.modelViewMatrix),J.onBeforeRender(b,q,ot,at,R,zt),J.transparent===!0&&J.side===ma&&J.forceSinglePass===!1?(J.side=qn,J.needsUpdate=!0,b.renderBufferDirect(ot,q,at,J,R,zt),J.side=es,J.needsUpdate=!0,b.renderBufferDirect(ot,q,at,J,R,zt),J.side=ma):b.renderBufferDirect(ot,q,at,J,R,zt),R.onAfterRender(b,q,ot,at,J,zt)}function zs(R,q,ot){q.isScene!==!0&&(q=At);const at=E.get(R),J=O.state.lights,zt=O.state.shadowsArray,Zt=J.state.version,It=Jt.getParameters(R,J.state,zt,q,ot),jt=Jt.getProgramCacheKey(It);let $t=at.programs;at.environment=R.isMeshStandardMaterial?q.environment:null,at.fog=q.fog,at.envMap=(R.isMeshStandardMaterial?St:ut).get(R.envMap||at.environment),at.envMapRotation=at.environment!==null&&R.envMap===null?q.environmentRotation:R.envMapRotation,$t===void 0&&(R.addEventListener("dispose",Un),$t=new Map,at.programs=$t);let oe=$t.get(jt);if(oe!==void 0){if(at.currentProgram===oe&&at.lightsStateVersion===Zt)return Wr(R,It),oe}else It.uniforms=Jt.getUniforms(R),R.onBeforeCompile(It,b),oe=Jt.acquireProgram(It,jt),$t.set(jt,oe),at.uniforms=It.uniforms;const te=at.uniforms;return(!R.isShaderMaterial&&!R.isRawShaderMaterial||R.clipping===!0)&&(te.clippingPlanes=Yt.uniform),Wr(R,It),at.needsLights=ya(R),at.lightsStateVersion=Zt,at.needsLights&&(te.ambientLightColor.value=J.state.ambient,te.lightProbe.value=J.state.probe,te.directionalLights.value=J.state.directional,te.directionalLightShadows.value=J.state.directionalShadow,te.spotLights.value=J.state.spot,te.spotLightShadows.value=J.state.spotShadow,te.rectAreaLights.value=J.state.rectArea,te.ltc_1.value=J.state.rectAreaLTC1,te.ltc_2.value=J.state.rectAreaLTC2,te.pointLights.value=J.state.point,te.pointLightShadows.value=J.state.pointShadow,te.hemisphereLights.value=J.state.hemi,te.directionalShadowMap.value=J.state.directionalShadowMap,te.directionalShadowMatrix.value=J.state.directionalShadowMatrix,te.spotShadowMap.value=J.state.spotShadowMap,te.spotLightMatrix.value=J.state.spotLightMatrix,te.spotLightMap.value=J.state.spotLightMap,te.pointShadowMap.value=J.state.pointShadowMap,te.pointShadowMatrix.value=J.state.pointShadowMatrix),at.currentProgram=oe,at.uniformsList=null,oe}function ll(R){if(R.uniformsList===null){const q=R.currentProgram.getUniforms();R.uniformsList=Yc.seqWithValue(q.seq,R.uniforms)}return R.uniformsList}function Wr(R,q){const ot=E.get(R);ot.outputColorSpace=q.outputColorSpace,ot.batching=q.batching,ot.batchingColor=q.batchingColor,ot.instancing=q.instancing,ot.instancingColor=q.instancingColor,ot.instancingMorph=q.instancingMorph,ot.skinning=q.skinning,ot.morphTargets=q.morphTargets,ot.morphNormals=q.morphNormals,ot.morphColors=q.morphColors,ot.morphTargetsCount=q.morphTargetsCount,ot.numClippingPlanes=q.numClippingPlanes,ot.numIntersection=q.numClipIntersection,ot.vertexAlphas=q.vertexAlphas,ot.vertexTangents=q.vertexTangents,ot.toneMapping=q.toneMapping}function ns(R,q,ot,at,J){q.isScene!==!0&&(q=At),W.resetTextureUnits();const zt=q.fog,Zt=at.isMeshStandardMaterial?q.environment:null,It=it===null?b.outputColorSpace:it.isXRRenderTarget===!0?it.texture.colorSpace:zr,jt=(at.isMeshStandardMaterial?St:ut).get(at.envMap||Zt),$t=at.vertexColors===!0&&!!ot.attributes.color&&ot.attributes.color.itemSize===4,oe=!!ot.attributes.tangent&&(!!at.normalMap||at.anisotropy>0),te=!!ot.morphAttributes.position,ce=!!ot.morphAttributes.normal,Oe=!!ot.morphAttributes.color;let Je=Bi;at.toneMapped&&(it===null||it.isXRRenderTarget===!0)&&(Je=b.toneMapping);const Ze=ot.morphAttributes.position||ot.morphAttributes.normal||ot.morphAttributes.color,Be=Ze!==void 0?Ze.length:0,ae=E.get(at),Pe=O.state.lights;if(qt===!0&&(ye===!0||R!==rt)){const Tn=R===rt&&at.id===dt;Yt.setState(at,R,Tn)}let de=!1;at.version===ae.__version?(ae.needsLights&&ae.lightsStateVersion!==Pe.state.version||ae.outputColorSpace!==It||J.isBatchedMesh&&ae.batching===!1||!J.isBatchedMesh&&ae.batching===!0||J.isBatchedMesh&&ae.batchingColor===!0&&J.colorTexture===null||J.isBatchedMesh&&ae.batchingColor===!1&&J.colorTexture!==null||J.isInstancedMesh&&ae.instancing===!1||!J.isInstancedMesh&&ae.instancing===!0||J.isSkinnedMesh&&ae.skinning===!1||!J.isSkinnedMesh&&ae.skinning===!0||J.isInstancedMesh&&ae.instancingColor===!0&&J.instanceColor===null||J.isInstancedMesh&&ae.instancingColor===!1&&J.instanceColor!==null||J.isInstancedMesh&&ae.instancingMorph===!0&&J.morphTexture===null||J.isInstancedMesh&&ae.instancingMorph===!1&&J.morphTexture!==null||ae.envMap!==jt||at.fog===!0&&ae.fog!==zt||ae.numClippingPlanes!==void 0&&(ae.numClippingPlanes!==Yt.numPlanes||ae.numIntersection!==Yt.numIntersection)||ae.vertexAlphas!==$t||ae.vertexTangents!==oe||ae.morphTargets!==te||ae.morphNormals!==ce||ae.morphColors!==Oe||ae.toneMapping!==Je||ae.morphTargetsCount!==Be)&&(de=!0):(de=!0,ae.__version=at.version);let yn=ae.currentProgram;de===!0&&(yn=zs(at,q,J));let qi=!1,Mn=!1,si=!1;const He=yn.getUniforms(),En=ae.uniforms;if(Ut.useProgram(yn.program)&&(qi=!0,Mn=!0,si=!0),at.id!==dt&&(dt=at.id,Mn=!0),qi||rt!==R){Ut.buffers.depth.getReversed()&&R.reversedDepth!==!0&&(R._reversedDepth=!0,R.updateProjectionMatrix()),He.setValue(P,"projectionMatrix",R.projectionMatrix),He.setValue(P,"viewMatrix",R.matrixWorldInverse);const bn=He.map.cameraPosition;bn!==void 0&&bn.setValue(P,fe.setFromMatrixPosition(R.matrixWorld)),se.logarithmicDepthBuffer&&He.setValue(P,"logDepthBufFC",2/(Math.log(R.far+1)/Math.LN2)),(at.isMeshPhongMaterial||at.isMeshToonMaterial||at.isMeshLambertMaterial||at.isMeshBasicMaterial||at.isMeshStandardMaterial||at.isShaderMaterial)&&He.setValue(P,"isOrthographic",R.isOrthographicCamera===!0),rt!==R&&(rt=R,Mn=!0,si=!0)}if(ae.needsLights&&(Pe.state.directionalShadowMap.length>0&&He.setValue(P,"directionalShadowMap",Pe.state.directionalShadowMap,W),Pe.state.spotShadowMap.length>0&&He.setValue(P,"spotShadowMap",Pe.state.spotShadowMap,W),Pe.state.pointShadowMap.length>0&&He.setValue(P,"pointShadowMap",Pe.state.pointShadowMap,W)),J.isSkinnedMesh){He.setOptional(P,J,"bindMatrix"),He.setOptional(P,J,"bindMatrixInverse");const Tn=J.skeleton;Tn&&(Tn.boneTexture===null&&Tn.computeBoneTexture(),He.setValue(P,"boneTexture",Tn.boneTexture,W))}J.isBatchedMesh&&(He.setOptional(P,J,"batchingTexture"),He.setValue(P,"batchingTexture",J._matricesTexture,W),He.setOptional(P,J,"batchingIdTexture"),He.setValue(P,"batchingIdTexture",J._indirectTexture,W),He.setOptional(P,J,"batchingColorTexture"),J._colorsTexture!==null&&He.setValue(P,"batchingColorTexture",J._colorsTexture,W));const dn=ot.morphAttributes;if((dn.position!==void 0||dn.normal!==void 0||dn.color!==void 0)&&_e.update(J,ot,yn),(Mn||ae.receiveShadow!==J.receiveShadow)&&(ae.receiveShadow=J.receiveShadow,He.setValue(P,"receiveShadow",J.receiveShadow)),at.isMeshGouraudMaterial&&at.envMap!==null&&(En.envMap.value=jt,En.flipEnvMap.value=jt.isCubeTexture&&jt.isRenderTargetTexture===!1?-1:1),at.isMeshStandardMaterial&&at.envMap===null&&q.environment!==null&&(En.envMapIntensity.value=q.environmentIntensity),En.dfgLUT!==void 0&&(En.dfgLUT.value=lR()),Mn&&(He.setValue(P,"toneMappingExposure",b.toneMappingExposure),ae.needsLights&&qr(En,si),zt&&at.fog===!0&&le.refreshFogUniforms(En,zt),le.refreshMaterialUniforms(En,at,ft,K,O.state.transmissionRenderTarget[R.id]),Yc.upload(P,ll(ae),En,W)),at.isShaderMaterial&&at.uniformsNeedUpdate===!0&&(Yc.upload(P,ll(ae),En,W),at.uniformsNeedUpdate=!1),at.isSpriteMaterial&&He.setValue(P,"center",J.center),He.setValue(P,"modelViewMatrix",J.modelViewMatrix),He.setValue(P,"normalMatrix",J.normalMatrix),He.setValue(P,"modelMatrix",J.matrixWorld),at.isShaderMaterial||at.isRawShaderMaterial){const Tn=at.uniformsGroups;for(let bn=0,Fs=Tn.length;bn<Fs;bn++){const vi=Tn[bn];bt.update(vi,yn),bt.bind(vi,yn)}}return yn}function qr(R,q){R.ambientLightColor.needsUpdate=q,R.lightProbe.needsUpdate=q,R.directionalLights.needsUpdate=q,R.directionalLightShadows.needsUpdate=q,R.pointLights.needsUpdate=q,R.pointLightShadows.needsUpdate=q,R.spotLights.needsUpdate=q,R.spotLightShadows.needsUpdate=q,R.rectAreaLights.needsUpdate=q,R.hemisphereLights.needsUpdate=q}function ya(R){return R.isMeshLambertMaterial||R.isMeshToonMaterial||R.isMeshPhongMaterial||R.isMeshStandardMaterial||R.isShadowMaterial||R.isShaderMaterial&&R.lights===!0}this.getActiveCubeFace=function(){return V},this.getActiveMipmapLevel=function(){return nt},this.getRenderTarget=function(){return it},this.setRenderTargetTextures=function(R,q,ot){const at=E.get(R);at.__autoAllocateDepthBuffer=R.resolveDepthBuffer===!1,at.__autoAllocateDepthBuffer===!1&&(at.__useRenderToTexture=!1),E.get(R.texture).__webglTexture=q,E.get(R.depthTexture).__webglTexture=at.__autoAllocateDepthBuffer?void 0:ot,at.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(R,q){const ot=E.get(R);ot.__webglFramebuffer=q,ot.__useDefaultFramebuffer=q===void 0};const Ma=P.createFramebuffer();this.setRenderTarget=function(R,q=0,ot=0){it=R,V=q,nt=ot;let at=null,J=!1,zt=!1;if(R){const It=E.get(R);if(It.__useDefaultFramebuffer!==void 0){Ut.bindFramebuffer(P.FRAMEBUFFER,It.__webglFramebuffer),F.copy(R.viewport),H.copy(R.scissor),$=R.scissorTest,Ut.viewport(F),Ut.scissor(H),Ut.setScissorTest($),dt=-1;return}else if(It.__webglFramebuffer===void 0)W.setupRenderTarget(R);else if(It.__hasExternalTextures)W.rebindTextures(R,E.get(R.texture).__webglTexture,E.get(R.depthTexture).__webglTexture);else if(R.depthBuffer){const oe=R.depthTexture;if(It.__boundDepthTexture!==oe){if(oe!==null&&E.has(oe)&&(R.width!==oe.image.width||R.height!==oe.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");W.setupDepthRenderbuffer(R)}}const jt=R.texture;(jt.isData3DTexture||jt.isDataArrayTexture||jt.isCompressedArrayTexture)&&(zt=!0);const $t=E.get(R).__webglFramebuffer;R.isWebGLCubeRenderTarget?(Array.isArray($t[q])?at=$t[q][ot]:at=$t[q],J=!0):R.samples>0&&W.useMultisampledRTT(R)===!1?at=E.get(R).__webglMultisampledFramebuffer:Array.isArray($t)?at=$t[ot]:at=$t,F.copy(R.viewport),H.copy(R.scissor),$=R.scissorTest}else F.copy(Q).multiplyScalar(ft).floor(),H.copy(ct).multiplyScalar(ft).floor(),$=Dt;if(ot!==0&&(at=Ma),Ut.bindFramebuffer(P.FRAMEBUFFER,at)&&Ut.drawBuffers(R,at),Ut.viewport(F),Ut.scissor(H),Ut.setScissorTest($),J){const It=E.get(R.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_CUBE_MAP_POSITIVE_X+q,It.__webglTexture,ot)}else if(zt){const It=q;for(let jt=0;jt<R.textures.length;jt++){const $t=E.get(R.textures[jt]);P.framebufferTextureLayer(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0+jt,$t.__webglTexture,ot,It)}}else if(R!==null&&ot!==0){const It=E.get(R.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,It.__webglTexture,ot)}dt=-1},this.readRenderTargetPixels=function(R,q,ot,at,J,zt,Zt,It=0){if(!(R&&R.isWebGLRenderTarget)){we("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let jt=E.get(R).__webglFramebuffer;if(R.isWebGLCubeRenderTarget&&Zt!==void 0&&(jt=jt[Zt]),jt){Ut.bindFramebuffer(P.FRAMEBUFFER,jt);try{const $t=R.textures[It],oe=$t.format,te=$t.type;if(!se.textureFormatReadable(oe)){we("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!se.textureTypeReadable(te)){we("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}q>=0&&q<=R.width-at&&ot>=0&&ot<=R.height-J&&(R.textures.length>1&&P.readBuffer(P.COLOR_ATTACHMENT0+It),P.readPixels(q,ot,at,J,wt.convert(oe),wt.convert(te),zt))}finally{const $t=it!==null?E.get(it).__webglFramebuffer:null;Ut.bindFramebuffer(P.FRAMEBUFFER,$t)}}},this.readRenderTargetPixelsAsync=async function(R,q,ot,at,J,zt,Zt,It=0){if(!(R&&R.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let jt=E.get(R).__webglFramebuffer;if(R.isWebGLCubeRenderTarget&&Zt!==void 0&&(jt=jt[Zt]),jt)if(q>=0&&q<=R.width-at&&ot>=0&&ot<=R.height-J){Ut.bindFramebuffer(P.FRAMEBUFFER,jt);const $t=R.textures[It],oe=$t.format,te=$t.type;if(!se.textureFormatReadable(oe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!se.textureTypeReadable(te))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const ce=P.createBuffer();P.bindBuffer(P.PIXEL_PACK_BUFFER,ce),P.bufferData(P.PIXEL_PACK_BUFFER,zt.byteLength,P.STREAM_READ),R.textures.length>1&&P.readBuffer(P.COLOR_ATTACHMENT0+It),P.readPixels(q,ot,at,J,wt.convert(oe),wt.convert(te),0);const Oe=it!==null?E.get(it).__webglFramebuffer:null;Ut.bindFramebuffer(P.FRAMEBUFFER,Oe);const Je=P.fenceSync(P.SYNC_GPU_COMMANDS_COMPLETE,0);return P.flush(),await Yy(P,Je,4),P.bindBuffer(P.PIXEL_PACK_BUFFER,ce),P.getBufferSubData(P.PIXEL_PACK_BUFFER,0,zt),P.deleteBuffer(ce),P.deleteSync(Je),zt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(R,q=null,ot=0){const at=Math.pow(2,-ot),J=Math.floor(R.image.width*at),zt=Math.floor(R.image.height*at),Zt=q!==null?q.x:0,It=q!==null?q.y:0;W.setTexture2D(R,0),P.copyTexSubImage2D(P.TEXTURE_2D,ot,0,0,Zt,It,J,zt),Ut.unbindTexture()};const is=P.createFramebuffer(),Ea=P.createFramebuffer();this.copyTextureToTexture=function(R,q,ot=null,at=null,J=0,zt=null){zt===null&&(J!==0?(Jo("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),zt=J,J=0):zt=0);let Zt,It,jt,$t,oe,te,ce,Oe,Je;const Ze=R.isCompressedTexture?R.mipmaps[zt]:R.image;if(ot!==null)Zt=ot.max.x-ot.min.x,It=ot.max.y-ot.min.y,jt=ot.isBox3?ot.max.z-ot.min.z:1,$t=ot.min.x,oe=ot.min.y,te=ot.isBox3?ot.min.z:0;else{const dn=Math.pow(2,-J);Zt=Math.floor(Ze.width*dn),It=Math.floor(Ze.height*dn),R.isDataArrayTexture?jt=Ze.depth:R.isData3DTexture?jt=Math.floor(Ze.depth*dn):jt=1,$t=0,oe=0,te=0}at!==null?(ce=at.x,Oe=at.y,Je=at.z):(ce=0,Oe=0,Je=0);const Be=wt.convert(q.format),ae=wt.convert(q.type);let Pe;q.isData3DTexture?(W.setTexture3D(q,0),Pe=P.TEXTURE_3D):q.isDataArrayTexture||q.isCompressedArrayTexture?(W.setTexture2DArray(q,0),Pe=P.TEXTURE_2D_ARRAY):(W.setTexture2D(q,0),Pe=P.TEXTURE_2D),P.pixelStorei(P.UNPACK_FLIP_Y_WEBGL,q.flipY),P.pixelStorei(P.UNPACK_PREMULTIPLY_ALPHA_WEBGL,q.premultiplyAlpha),P.pixelStorei(P.UNPACK_ALIGNMENT,q.unpackAlignment);const de=P.getParameter(P.UNPACK_ROW_LENGTH),yn=P.getParameter(P.UNPACK_IMAGE_HEIGHT),qi=P.getParameter(P.UNPACK_SKIP_PIXELS),Mn=P.getParameter(P.UNPACK_SKIP_ROWS),si=P.getParameter(P.UNPACK_SKIP_IMAGES);P.pixelStorei(P.UNPACK_ROW_LENGTH,Ze.width),P.pixelStorei(P.UNPACK_IMAGE_HEIGHT,Ze.height),P.pixelStorei(P.UNPACK_SKIP_PIXELS,$t),P.pixelStorei(P.UNPACK_SKIP_ROWS,oe),P.pixelStorei(P.UNPACK_SKIP_IMAGES,te);const He=R.isDataArrayTexture||R.isData3DTexture,En=q.isDataArrayTexture||q.isData3DTexture;if(R.isDepthTexture){const dn=E.get(R),Tn=E.get(q),bn=E.get(dn.__renderTarget),Fs=E.get(Tn.__renderTarget);Ut.bindFramebuffer(P.READ_FRAMEBUFFER,bn.__webglFramebuffer),Ut.bindFramebuffer(P.DRAW_FRAMEBUFFER,Fs.__webglFramebuffer);for(let vi=0;vi<jt;vi++)He&&(P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,E.get(R).__webglTexture,J,te+vi),P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,E.get(q).__webglTexture,zt,Je+vi)),P.blitFramebuffer($t,oe,Zt,It,ce,Oe,Zt,It,P.DEPTH_BUFFER_BIT,P.NEAREST);Ut.bindFramebuffer(P.READ_FRAMEBUFFER,null),Ut.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else if(J!==0||R.isRenderTargetTexture||E.has(R)){const dn=E.get(R),Tn=E.get(q);Ut.bindFramebuffer(P.READ_FRAMEBUFFER,is),Ut.bindFramebuffer(P.DRAW_FRAMEBUFFER,Ea);for(let bn=0;bn<jt;bn++)He?P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,dn.__webglTexture,J,te+bn):P.framebufferTexture2D(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,dn.__webglTexture,J),En?P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,Tn.__webglTexture,zt,Je+bn):P.framebufferTexture2D(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,Tn.__webglTexture,zt),J!==0?P.blitFramebuffer($t,oe,Zt,It,ce,Oe,Zt,It,P.COLOR_BUFFER_BIT,P.NEAREST):En?P.copyTexSubImage3D(Pe,zt,ce,Oe,Je+bn,$t,oe,Zt,It):P.copyTexSubImage2D(Pe,zt,ce,Oe,$t,oe,Zt,It);Ut.bindFramebuffer(P.READ_FRAMEBUFFER,null),Ut.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else En?R.isDataTexture||R.isData3DTexture?P.texSubImage3D(Pe,zt,ce,Oe,Je,Zt,It,jt,Be,ae,Ze.data):q.isCompressedArrayTexture?P.compressedTexSubImage3D(Pe,zt,ce,Oe,Je,Zt,It,jt,Be,Ze.data):P.texSubImage3D(Pe,zt,ce,Oe,Je,Zt,It,jt,Be,ae,Ze):R.isDataTexture?P.texSubImage2D(P.TEXTURE_2D,zt,ce,Oe,Zt,It,Be,ae,Ze.data):R.isCompressedTexture?P.compressedTexSubImage2D(P.TEXTURE_2D,zt,ce,Oe,Ze.width,Ze.height,Be,Ze.data):P.texSubImage2D(P.TEXTURE_2D,zt,ce,Oe,Zt,It,Be,ae,Ze);P.pixelStorei(P.UNPACK_ROW_LENGTH,de),P.pixelStorei(P.UNPACK_IMAGE_HEIGHT,yn),P.pixelStorei(P.UNPACK_SKIP_PIXELS,qi),P.pixelStorei(P.UNPACK_SKIP_ROWS,Mn),P.pixelStorei(P.UNPACK_SKIP_IMAGES,si),zt===0&&q.generateMipmaps&&P.generateMipmap(Pe),Ut.unbindTexture()},this.initRenderTarget=function(R){E.get(R).__webglFramebuffer===void 0&&W.setupRenderTarget(R)},this.initTexture=function(R){R.isCubeTexture?W.setTextureCube(R,0):R.isData3DTexture?W.setTexture3D(R,0):R.isDataArrayTexture||R.isCompressedArrayTexture?W.setTexture2DArray(R,0):W.setTexture2D(R,0),Ut.unbindTexture()},this.resetState=function(){V=0,nt=0,it=null,Ut.reset(),Xt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Fi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const i=this.getContext();i.drawingBufferColorSpace=De._getDrawingBufferColorSpace(t),i.unpackColorSpace=De._getUnpackColorSpace()}}const uR=2e3,Q_=2.4,Gc=5,$_=.25,fR=.3,tv=.15;function hR(r,t,i){const s=new Lv,l=r/2,c=t/2;return s.moveTo(-l+i,-c),s.lineTo(l-i,-c),s.quadraticCurveTo(l,-c,l,-c+i),s.lineTo(l,c-i),s.quadraticCurveTo(l,c,l-i,c),s.lineTo(-l+i,c),s.quadraticCurveTo(-l,c,-l,c-i),s.lineTo(-l,-c+i),s.quadraticCurveTo(-l,-c,-l+i,-c),s}function dR({selectedSession:r}){const t=ne.useRef(null),i=ne.useRef(null);return ne.useEffect(()=>{const s=i.current;s&&s.readyState===WebSocket.OPEN&&s.send(JSON.stringify({type:"select",session:r}))},[r]),ne.useEffect(()=>{const s=t.current;if(!s)return;const l=new xM,c=new mi(35,3/4,.1,100);c.position.set(0,0,10),c.lookAt(0,0,0);const f=new cR({antialias:!0,alpha:!0});f.setPixelRatio(Math.min(window.devicePixelRatio,2)),s.appendChild(f.domElement),l.add(new hE(16777215,.6));const d=new fE(16777215,.8);d.position.set(3,5,8),l.add(d);const m=new wr;l.add(m);const p=new wr;m.add(p);const g=document.createElement("canvas");g.width=540,g.height=1170;const _=g.getContext("2d");_.fillStyle="#111",_.fillRect(0,0,g.width,g.height);const x=new TM(g);x.colorSpace=ni,x.minFilter=xn,x.magFilter=xn;const y=new rE({color:1710638,metalness:.3,roughness:.7}),T=new tp({map:x});let C=null,M=null,v=null,B=null,N=Q_,D=Gc;function O(K,ft){C&&(p.remove(C),v.dispose()),M&&(p.remove(M),B.dispose()),N=K,D=ft;const Et=hR(K,ft,fR);v=new ap(Et,{depth:$_,bevelEnabled:!0,bevelThickness:.04,bevelSize:.04,bevelSegments:3}),v.center(),C=new Ci(v,y),p.add(C);const Rt=K-tv*2,Q=ft-tv*2;B=new rl(Rt,Q),M=new Ci(B,T),M.position.z=($_+.08)/2+.01,p.add(M),g.width=Math.round(Rt*200),g.height=Math.round(Q*200),_.fillStyle="#111",_.fillRect(0,0,g.width,g.height),x.dispose(),x.needsUpdate=!0,nt()}const I=.85;let z=0,Y=0,b=0;const w=[0,Math.PI/2,Math.PI,-Math.PI/2];let V=10;function nt(){const ft=(z===1||z===3?D:N)*I,Et=Math.atan(Math.tan(c.fov/2*Math.PI/180)*c.aspect);V=ft/2/Math.tan(Et)}O(Q_,Gc),p.scale.setScalar(I);function it(){const K=s.clientWidth,ft=s.clientHeight;K===0||ft===0||(c.aspect=K/ft,c.updateProjectionMatrix(),f.setSize(K,ft),nt())}it();const dt=new ResizeObserver(it);dt.observe(s);let rt=performance.now(),F=0;function H(){F=requestAnimationFrame(H);const K=performance.now(),ft=Math.min((K-rt)/1e3,.1);rt=K;const Et=1-Math.exp(-8*ft);let Rt=Y-b;Rt>Math.PI&&(Rt-=2*Math.PI),Rt<-Math.PI&&(Rt+=2*Math.PI),b+=Rt*Et,m.rotation.z=b,c.position.z+=(V-c.position.z)*Et,f.render(l,c)}H();let $=null,yt=null,xt=!1;function L(){if(xt)return;const ft=`${window.location.protocol==="https:"?"wss:":"ws:"}//${window.location.host}/ws/preview`;$=new WebSocket(ft),i.current=$,$.binaryType="arraybuffer",$.onopen=()=>{$.send(JSON.stringify({type:"select",session:r}))},$.onclose=()=>{i.current=null,xt||(yt=setTimeout(L,uR))},$.onerror=()=>{},$.onmessage=Et=>{if(typeof Et.data=="string")try{const Rt=JSON.parse(Et.data);if(Rt.type==="device"){const Q=Math.min(Rt.w,Rt.h),ct=Math.max(Rt.w,Rt.h),Dt=Q/ct;O(Gc*Dt,Gc)}if(Rt.type==="orient"&&Rt.o!==void 0){const Q=Rt.o;if(Q!==z){z=Q,Y=w[z],nt();const ct=z===1||z===3,Dt=s==null?void 0:s.closest(".preview-column");Dt&&(Dt.style.width=ct?`${Math.round(400*D/N)}px`:"400px")}}}catch{}else{const Rt=new Blob([Et.data],{type:"image/jpeg"});createImageBitmap(Rt).then(Q=>{const ct=z===1||z===3;if(_.clearRect(0,0,g.width,g.height),ct){const Dt=w[z];_.save(),_.translate(g.width/2,g.height/2),_.rotate(Dt),_.drawImage(Q,-g.height/2,-g.width/2,g.height,g.width),_.restore()}else z===2?(_.save(),_.translate(g.width/2,g.height/2),_.rotate(w[2]),_.drawImage(Q,-g.width/2,-g.height/2,g.width,g.height),_.restore()):_.drawImage(Q,0,0,g.width,g.height);x.needsUpdate=!0,Q.close()})}}}return L(),()=>{xt=!0,yt&&clearTimeout(yt),$&&($.onclose=null,$.close(),i.current=null),cancelAnimationFrame(F),dt.disconnect(),f.dispose(),v&&v.dispose(),y.dispose(),B&&B.dispose(),T.dispose(),x.dispose(),s.contains(f.domElement)&&s.removeChild(f.domElement)}},[]),Ot.jsx("div",{className:"phone-preview",ref:t})}function pR({sessions:r,servers:t,selectedSession:i,onSelectSession:s,onSwitchAll:l,onSwitchSession:c}){const[f,d]=ne.useState(null),m=ne.useRef(null),p=ne.useRef(null),g=ne.useCallback(M=>{const v=t.find(B=>B.id===M);return v?v.name:"(none)"},[t]),_=(()=>{if(r.length===0)return"";const M=r[0].serverID;return r.every(v=>v.serverID===M)?M:""})(),x=_?g(_):"(mixed)",y=ne.useCallback(M=>{t.length<2||(p.current&&(clearTimeout(p.current),p.current=null),m.current=setTimeout(()=>d(M),50))},[t.length]),T=ne.useCallback(()=>{m.current&&(clearTimeout(m.current),m.current=null),p.current=setTimeout(()=>d(null),200)},[]),C=ne.useCallback(()=>{p.current&&(clearTimeout(p.current),p.current=null)},[]);return r.length===0?null:Ot.jsxs("div",{className:"player-list",children:[Ot.jsx("h2",{className:"player-title",children:"Players"}),Ot.jsxs("div",{className:"player-items",children:[Ot.jsxs("div",{className:`player-row ${i===null?"selected":""}`,children:[Ot.jsxs("button",{className:"player-label",onClick:()=>s(null),children:[Ot.jsx("span",{className:"player-dot all"}),Ot.jsx("span",{children:"All"})]}),Ot.jsx("span",{className:"player-arrow",children:"→"}),Ot.jsxs("div",{className:"player-server",onMouseEnter:()=>y("all"),onMouseLeave:T,children:[x,f==="all"&&Ot.jsx("div",{className:"server-dropdown",onMouseEnter:C,onMouseLeave:T,children:t.map(M=>Ot.jsx("button",{className:`server-dropdown-item ${M.id===_?"current":""}`,onClick:()=>{l(M.id),d(null)},children:M.name},M.id))})]})]}),r.map(M=>Ot.jsxs("div",{className:`player-row ${i===M.id?"selected":""}`,children:[Ot.jsxs("button",{className:"player-label",onClick:()=>s(M.id),children:[Ot.jsx("span",{className:"player-dot active"}),Ot.jsx("span",{children:M.name||M.id})]}),Ot.jsx("span",{className:"player-arrow",children:"→"}),Ot.jsxs("div",{className:"player-server",onMouseEnter:()=>y(M.id),onMouseLeave:T,children:[g(M.serverID),f===M.id&&Ot.jsx("div",{className:"server-dropdown",onMouseEnter:C,onMouseLeave:T,children:t.map(v=>Ot.jsx("button",{className:`server-dropdown-item ${v.id===M.serverID?"current":""}`,onClick:()=>{c(M.id,v.id),d(null)},children:v.name},v.id))})]})]},M.id))]})]})}function mR(){const[r,t]=ne.useState(!1),[i,s]=ne.useState(!1),[l,c]=ne.useState(!1),f=ne.useRef(!1),[d,m]=ne.useState("ge"),p=ne.useRef(!1),[g,_]=ne.useState([]),[x,y]=ne.useState(null),[T,C]=ne.useState([]),M=ne.useCallback(O=>{if(O.buildId&&O.buildId!=="mm5ptlx5"){location.reload();return}const I=O.servers.map(b=>({id:b.id,name:b.name,pid:b.pid,active:b.active}));C(I);const z=new Set(O.sessions.map(b=>b.id));_(O.sessions.map(b=>({id:b.id,serverID:b.serverID,name:b.name}))),y(b=>b!==null&&!z.has(b)?null:b);const Y=O.servers.find(b=>b.active);if(Y){m(Y.name);const b=window.location.port;document.title=b?`${Y.name} :${b}`:Y.name}else m("ge")},[]),v=ne.useCallback(O=>{fetch(`/api/servers/${O}/select`,{method:"POST"}).catch(()=>{})},[]),B=ne.useCallback((O,I)=>{fetch(`/api/sessions/${O}/server/${I}`,{method:"POST"}).catch(()=>{})},[]),N=ne.useCallback(()=>{c(!0),p.current=!0,s(!1),fetch("/api/stop",{method:"POST"}).catch(()=>{})},[]);ne.useEffect(()=>{const O=()=>{p.current||navigator.sendBeacon("/api/stop")};return window.addEventListener("pagehide",O),()=>window.removeEventListener("pagehide",O)},[]);const D=ne.useCallback(O=>{f.current=O,s(!0)},[]);return ne.useEffect(()=>{const O=I=>{if(I.key==="c"&&(I.ctrlKey||I.metaKey)){if(I.preventDefault(),l)return;i&&f.current?N():i||D(!0)}else I.key==="Escape"&&i&&s(!1)};return window.addEventListener("keydown",O),()=>window.removeEventListener("keydown",O)},[i,l,N,D]),Ot.jsxs("div",{className:"app",children:[Ot.jsxs("header",{className:"header",children:[Ot.jsx("h1",{className:"title",children:d}),Ot.jsx("button",{className:"stop-btn",onClick:()=>D(!1),disabled:l,title:"Stop server (Ctrl-C)",children:l?"Stopped":"Stop"}),Ot.jsx("span",{className:`status-dot ${r?"connected":"disconnected"}`}),Ot.jsx("span",{className:"status-text",children:r?"connected":"disconnected"})]}),Ot.jsxs("div",{className:"layout",children:[Ot.jsxs("aside",{className:"sidebar",children:[Ot.jsx(ay,{}),Ot.jsx(pR,{sessions:g,servers:T,selectedSession:x,onSelectSession:y,onSwitchAll:v,onSwitchSession:B}),Ot.jsx(dy,{})]}),Ot.jsx("main",{className:"main",children:Ot.jsx(uy,{onConnectionChange:t,sessionFilter:x,onState:M})}),Ot.jsx("aside",{className:"preview-column",children:Ot.jsx(dR,{selectedSession:x})})]}),i&&Ot.jsx("div",{className:"confirm-overlay",onClick:()=>s(!1),children:Ot.jsxs("div",{className:"confirm-dialog",onClick:O=>O.stopPropagation(),children:[Ot.jsx("p",{className:"confirm-text",children:"Stop the game server?"}),f.current&&Ot.jsx("p",{className:"confirm-hint",children:"Ctrl-C again to confirm"}),Ot.jsxs("div",{className:"confirm-actions",children:[Ot.jsx("button",{className:"confirm-btn confirm-btn-stop",onClick:N,children:"Stop Server"}),Ot.jsx("button",{className:"confirm-btn confirm-btn-cancel",onClick:()=>s(!1),children:"Cancel"})]})]})})]})}iy.createRoot(document.getElementById("root")).render(Ot.jsx(ne.StrictMode,{children:Ot.jsx(mR,{})}));
