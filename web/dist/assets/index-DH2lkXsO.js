 ...
 */var B0;function ZS(){if(B0)return Po;B0=1;var r=Symbol.for("react.transitional.element"),t=Symbol.for("react.fragment");function i(s,l,c){var f=null;if(c!==void 0&&(f=""+c),l.key!==void 0&&(f=""+l.key),"key"in l){c={};for(var d in l)d!=="key"&&(c[d]=l[d])}else c=l;return l=c.ref,{$$typeof:r,type:s,key:f,ref:l!==void 0?l:null,props:c}}return Po.Fragment=t,Po.jsx=i,Po.jsxs=i,Po}var I0;function jS(){return I0||(I0=1,ah.exports=ZS()),ah.exports}var Pt=jS(),sh={exports:{}},me={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var H0;function KS(){if(H0)return me;H0=1;var r=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),c=Symbol.for("react.consumer"),f=Symbol.for("react.context"),d=Symbol.for("react.forward_ref"),m=Symbol.for("react.suspense"),p=Symbol.for("react.memo"),g=Symbol.for("react.lazy"),_=Symbol.for("react.activity"),v=Symbol.iterator;function y(L){return L===null||typeof L!="object"?null:(L=v&&L[v]||L["@@iterator"],typeof L=="function"?L:null)}var T={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},R=Object.assign,M={};function S(L,K,ft){this.props=L,this.context=K,this.refs=M,this.updater=ft||T}S.prototype.isReactComponent={},S.prototype.setState=function(L,K){if(typeof L!="object"&&typeof L!="function"&&L!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,L,K,"setState")},S.prototype.forceUpdate=function(L){this.updater.enqueueForceUpdate(this,L,"forceUpdate")};function B(){}B.prototype=S.prototype;function N(L,K,ft){this.props=L,this.context=K,this.refs=M,this.updater=ft||T}var w=N.prototype=new B;w.constructor=N,R(w,S.prototype),w.isPureReactComponent=!0;var z=Array.isArray;function I(){}var P={H:null,A:null,T:null,S:null},q=Object.prototype.hasOwnProperty;function C(L,K,ft){var Et=ft.ref;return{$$typeof:r,type:L,key:K,ref:Et!==void 0?Et:null,props:ft}}function D(L,K){return C(L.type,K,L.props)}function V(L){return typeof L=="object"&&L!==null&&L.$$typeof===r}function nt(L){var K={"=":"=0",":":"=2"};return"$"+L.replace(/[=:]/g,function(ft){return K[ft]})}var it=/\/+/g;function dt(L,K){return typeof L=="object"&&L!==null&&L.key!=null?nt(""+L.key):K.toString(36)}function rt(L){switch(L.status){case"fulfilled":return L.value;case"rejected":throw L.reason;default:switch(typeof L.status=="string"?L.then(I,I):(L.status="pending",L.then(function(K){L.status==="pending"&&(L.status="fulfilled",L.value=K)},function(K){L.status==="pending"&&(L.status="rejected",L.reason=K)})),L.status){case"fulfilled":return L.value;case"rejected":throw L.reason}}throw L}function F(L,K,ft,Et,Rt){var Q=typeof L;(Q==="undefined"||Q==="boolean")&&(L=null);var ct=!1;if(L===null)ct=!0;else switch(Q){case"bigint":case"string":case"number":ct=!0;break;case"object":switch(L.$$typeof){case r:case t:ct=!0;break;case g:return ct=L._init,F(ct(L._payload),K,ft,Et,Rt)}}if(ct)return Rt=Rt(L),ct=Et===""?"."+dt(L,0):Et,z(Rt)?(ft="",ct!=null&&(ft=ct.replace(it,"$&/")+"/"),F(Rt,K,ft,"",function(qt){return qt})):Rt!=null&&(V(Rt)&&(Rt=D(Rt,ft+(Rt.key==null||L&&L.key===Rt.key?"":(""+Rt.key).replace(it,"$&/")+"/")+ct)),K.push(Rt)),1;ct=0;var Dt=Et===""?".":Et+":";if(z(L))for(var Vt=0;Vt<L.length;Vt++)Et=L[Vt],Q=Dt+dt(Et,Vt),ct+=F(Et,K,ft,Q,Rt);else if(Vt=y(L),typeof Vt=="function")for(L=Vt.call(L),Vt=0;!(Et=L.next()).done;)Et=Et.value,Q=Dt+dt(Et,Vt++),ct+=F(Et,K,ft,Q,Rt);else if(Q==="object"){if(typeof L.then=="function")return F(rt(L),K,ft,Et,Rt);throw K=String(L),Error("Objects are not valid as a React child (found: "+(K==="[object Object]"?"object with keys {"+Object.keys(L).join(", ")+"}":K)+"). If you meant to render a collection of children, use an array instead.")}return ct}function H(L,K,ft){if(L==null)return L;var Et=[],Rt=0;return F(L,Et,"","",function(Q){return K.call(ft,Q,Rt++)}),Et}function $(L){if(L._status===-1){var K=L._result;K=K(),K.then(function(ft){(L._status===0||L._status===-1)&&(L._status=1,L._result=ft)},function(ft){(L._status===0||L._status===-1)&&(L._status=2,L._result=ft)}),L._status===-1&&(L._status=0,L._result=K)}if(L._status===1)return L._result.default;throw L._result}var yt=typeof reportError=="function"?reportError:function(L){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var K=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof L=="object"&&L!==null&&typeof L.message=="string"?String(L.message):String(L),error:L});if(!window.dispatchEvent(K))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",L);return}console.error(L)},xt={map:H,forEach:function(L,K,ft){H(L,function(){K.apply(this,arguments)},ft)},count:function(L){var K=0;return H(L,function(){K++}),K},toArray:function(L){return H(L,function(K){return K})||[]},only:function(L){if(!V(L))throw Error("React.Children.only expected to receive a single React element child.");return L}};return me.Activity=_,me.Children=xt,me.Component=S,me.Fragment=i,me.Profiler=l,me.PureComponent=N,me.StrictMode=s,me.Suspense=m,me.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=P,me.__COMPILER_RUNTIME={__proto__:null,c:function(L){return P.H.useMemoCache(L)}},me.cache=function(L){return function(){return L.apply(null,arguments)}},me.cacheSignal=function(){return null},me.cloneElement=function(L,K,ft){if(L==null)throw Error("The argument must be a React element, but you passed "+L+".");var Et=R({},L.props),Rt=L.key;if(K!=null)for(Q in K.key!==void 0&&(Rt=""+K.key),K)!q.call(K,Q)||Q==="key"||Q==="__self"||Q==="__source"||Q==="ref"&&K.ref===void 0||(Et[Q]=K[Q]);var Q=arguments.length-2;if(Q===1)Et.children=ft;else if(1<Q){for(var ct=Array(Q),Dt=0;Dt<Q;Dt++)ct[Dt]=arguments[Dt+2];Et.children=ct}return C(L.type,Rt,Et)},me.createContext=function(L){return L={$$typeof:f,_currentValue:L,_currentValue2:L,_threadCount:0,Provider:null,Consumer:null},L.Provider=L,L.Consumer={$$typeof:c,_context:L},L},me.createElement=function(L,K,ft){var Et,Rt={},Q=null;if(K!=null)for(Et in K.key!==void 0&&(Q=""+K.key),K)q.call(K,Et)&&Et!=="key"&&Et!=="__self"&&Et!=="__source"&&(Rt[Et]=K[Et]);var ct=arguments.length-2;if(ct===1)Rt.children=ft;else if(1<ct){for(var Dt=Array(ct),Vt=0;Vt<ct;Vt++)Dt[Vt]=arguments[Vt+2];Rt.children=Dt}if(L&&L.defaultProps)for(Et in ct=L.defaultProps,ct)Rt[Et]===void 0&&(Rt[Et]=ct[Et]);return C(L,Q,Rt)},me.createRef=function(){return{current:null}},me.forwardRef=function(L){return{$$typeof:d,render:L}},me.isValidElement=V,me.lazy=function(L){return{$$typeof:g,_payload:{_status:-1,_result:L},_init:$}},me.memo=function(L,K){return{$$typeof:p,type:L,compare:K===void 0?null:K}},me.startTransition=function(L){var K=P.T,ft={};P.T=ft;try{var Et=L(),Rt=P.S;Rt!==null&&Rt(ft,Et),typeof Et=="object"&&Et!==null&&typeof Et.then=="function"&&Et.then(I,yt)}catch(Q){yt(Q)}finally{K!==null&&ft.types!==null&&(K.types=ft.types),P.T=K}},me.unstable_useCacheRefresh=function(){return P.H.useCacheRefresh()},me.use=function(L){return P.H.use(L)},me.useActionState=function(L,K,ft){return P.H.useActionState(L,K,ft)},me.useCallback=function(L,K){return P.H.useCallback(L,K)},me.useContext=function(L){return P.H.useContext(L)},me.useDebugValue=function(){},me.useDeferredValue=function(L,K){return P.H.useDeferredValue(L,K)},me.useEffect=function(L,K){return P.H.useEffect(L,K)},me.useEffectEvent=function(L){return P.H.useEffectEvent(L)},me.useId=function(){return P.H.useId()},me.useImperativeHandle=function(L,K,ft){return P.H.useImperativeHandle(L,K,ft)},me.useInsertionEffect=function(L,K){return P.H.useInsertionEffect(L,K)},me.useLayoutEffect=function(L,K){return P.H.useLayoutEffect(L,K)},me.useMemo=function(L,K){return P.H.useMemo(L,K)},me.useOptimistic=function(L,K){return P.H.useOptimistic(L,K)},me.useReducer=function(L,K,ft){return P.H.useReducer(L,K,ft)},me.useRef=function(L){return P.H.useRef(L)},me.useState=function(L){return P.H.useState(L)},me.useSyncExternalStore=function(L,K,ft){return P.H.useSyncExternalStore(L,K,ft)},me.useTransition=function(){return P.H.useTransition()},me.version="19.2.4",me}var G0;function Vd(){return G0||(G0=1,sh.exports=KS()),sh.exports}var oe=Vd(),rh={exports:{}},zo={},oh={exports:{}},lh={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var V0;function JS(){return V0||(V0=1,(function(r){function t(F,H){var $=F.length;F.push(H);t:for(;0<$;){var yt=$-1>>>1,xt=F[yt];if(0<l(xt,H))F[yt]=H,F[$]=xt,$=yt;else break t}}function i(F){return F.length===0?null:F[0]}function s(F){if(F.length===0)return null;var H=F[0],$=F.pop();if($!==H){F[0]=$;t:for(var yt=0,xt=F.length,L=xt>>>1;yt<L;){var K=2*(yt+1)-1,ft=F[K],Et=K+1,Rt=F[Et];if(0>l(ft,$))Et<xt&&0>l(Rt,ft)?(F[yt]=Rt,F[Et]=$,yt=Et):(F[yt]=ft,F[K]=$,yt=K);else if(Et<xt&&0>l(Rt,$))F[yt]=Rt,F[Et]=$,yt=Et;else break t}}return H}function l(F,H){var $=F.sortIndex-H.sortIndex;return $!==0?$:F.id-H.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;r.unstable_now=function(){return c.now()}}else{var f=Date,d=f.now();r.unstable_now=function(){return f.now()-d}}var m=[],p=[],g=1,_=null,v=3,y=!1,T=!1,R=!1,M=!1,S=typeof setTimeout=="function"?setTimeout:null,B=typeof clearTimeout=="function"?clearTimeout:null,N=typeof setImmediate<"u"?setImmediate:null;function w(F){for(var H=i(p);H!==null;){if(H.callback===null)s(p);else if(H.startTime<=F)s(p),H.sortIndex=H.expirationTime,t(m,H);else break;H=i(p)}}function z(F){if(R=!1,w(F),!T)if(i(m)!==null)T=!0,I||(I=!0,nt());else{var H=i(p);H!==null&&rt(z,H.startTime-F)}}var I=!1,P=-1,q=5,C=-1;function D(){return M?!0:!(r.unstable_now()-C<q)}function V(){if(M=!1,I){var F=r.unstable_now();C=F;var H=!0;try{t:{T=!1,R&&(R=!1,B(P),P=-1),y=!0;var $=v;try{e:{for(w(F),_=i(m);_!==null&&!(_.expirationTime>F&&D());){var yt=_.callback;if(typeof yt=="function"){_.callback=null,v=_.priorityLevel;var xt=yt(_.expirationTime<=F);if(F=r.unstable_now(),typeof xt=="function"){_.callback=xt,w(F),H=!0;break e}_===i(m)&&s(m),w(F)}else s(m);_=i(m)}if(_!==null)H=!0;else{var L=i(p);L!==null&&rt(z,L.startTime-F),H=!1}}break t}finally{_=null,v=$,y=!1}H=void 0}}finally{H?nt():I=!1}}}var nt;if(typeof N=="function")nt=function(){N(V)};else if(typeof MessageChannel<"u"){var it=new MessageChannel,dt=it.port2;it.port1.onmessage=V,nt=function(){dt.postMessage(null)}}else nt=function(){S(V,0)};function rt(F,H){P=S(function(){F(r.unstable_now())},H)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(F){F.callback=null},r.unstable_forceFrameRate=function(F){0>F||125<F?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):q=0<F?Math.floor(1e3/F):5},r.unstable_getCurrentPriorityLevel=function(){return v},r.unstable_next=function(F){switch(v){case 1:case 2:case 3:var H=3;break;default:H=v}var $=v;v=H;try{return F()}finally{v=$}},r.unstable_requestPaint=function(){M=!0},r.unstable_runWithPriority=function(F,H){switch(F){case 1:case 2:case 3:case 4:case 5:break;default:F=3}var $=v;v=F;try{return H()}finally{v=$}},r.unstable_scheduleCallback=function(F,H,$){var yt=r.unstable_now();switch(typeof $=="object"&&$!==null?($=$.delay,$=typeof $=="number"&&0<$?yt+$:yt):$=yt,F){case 1:var xt=-1;break;case 2:xt=250;break;case 5:xt=1073741823;break;case 4:xt=1e4;break;default:xt=5e3}return xt=$+xt,F={id:g++,callback:H,priorityLevel:F,startTime:$,expirationTime:xt,sortIndex:-1},$>yt?(F.sortIndex=$,t(p,F),i(m)===null&&F===i(p)&&(R?(B(P),P=-1):R=!0,rt(z,$-yt))):(F.sortIndex=xt,t(m,F),T||y||(T=!0,I||(I=!0,nt()))),F},r.unstable_shouldYield=D,r.unstable_wrapCallback=function(F){var H=v;return function(){var $=v;v=H;try{return F.apply(this,arguments)}finally{v=$}}}})(lh)),lh}var X0;function QS(){return X0||(X0=1,oh.exports=JS()),oh.exports}var ch={exports:{}},Nn={};/**
 * @license React
...
void main() {
	...
	`}function o1(r){let t=new WeakMap,i=null;function s(d){if(d&&d.isTexture){const m=d.mapping,p=m===td||m===ed,g=m===Us||m===Or;if(p||g){let _=t.get(d);const v=_!==void 0?_.texture.pmremVersion:0;if(d.isRenderTargetTexture&&d.pmremVersion!==v)return i===null&&(i=new U_(r)),_=p?i.fromEquirectangular(d,_):i.fromCubemap(d,_),_.texture.pmremVersion=d.pmremVersion,t.set(d,_),_.texture;if(_!==void 0)return _.texture;{const y=d.image;return p&&y&&y.height>0||g&&y&&l(y)?(i===null&&(i=new U_(r)),_=p?i.fromEquirectangular(d):i.fromCubemap(d),_.texture.pmremVersion=d.pmremVersion,t.set(d,_),d.addEventListener("dispose",c),_.texture):null}}}return d}function l(d){let m=0;const p=6;for(let g=0;g<p;g++)d[g]!==void 0&&m++;return m===p}function c(d){const m=d.target;m.removeEventListener("dispose",c);const p=t.get(m);p!==void 0&&(t.delete(m),p.dispose())}function f(){t=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:s,dispose:f}}function l1(r){const t={};function i(s){if(t[s]!==void 0)return t[s];const l=r.getExtension(s);return t[s]=l,l}return{has:function(s){return i(s)!==null},init:function(){i("EXT_color_buffer_float"),i("WEBGL_clip_cull_distance"),i("OES_texture_float_linear"),i("EXT_color_buffer_half_float"),i("WEBGL_multisampled_render_to_texture"),i("WEBGL_render_shared_exponent")},get:function(s){const l=i(s);return l===null&&Jo("WebGLRenderer: "+s+" extension not supported."),l}}}function c1(r,t,i,s){const l={},c=new WeakMap;function f(_){const v=_.target;v.index!==null&&t.remove(v.index);for(const T in v.attributes)t.remove(v.attributes[T]);v.removeEventListener("dispose",f),delete l[v.id];const y=c.get(v);y&&(t.remove(y),c.delete(v)),s.releaseStatesOfGeometry(v),v.isInstancedBufferGeometry===!0&&delete v._maxInstanceCount,i.memory.geometries--}function d(_,v){return l[v.id]===!0||(v.addEventListener("dispose",f),l[v.id]=!0,i.memory.geometries++),v}function m(_){const v=_.attributes;for(const y in v)t.update(v[y],r.ARRAY_BUFFER)}function p(_){const v=[],y=_.index,T=_.attributes.position;let R=0;if(y!==null){const B=y.array;R=y.version;for(let N=0,w=B.length;N<w;N+=3){const z=B[N+0],I=B[N+1],P=B[N+2];v.push(z,I,I,P,P,z)}}else if(T!==void 0){const B=T.array;R=T.version;for(let N=0,w=B.length/3-1;N<w;N+=3){const z=N+0,I=N+1,P=N+2;v.push(z,I,I,P,P,z)}}else return;const M=new(vv(v)?Ev:Mv)(v,1);M.version=R;const S=c.get(_);S&&t.remove(S),c.set(_,M)}function g(_){const v=c.get(_);if(v){const y=_.index;y!==null&&v.version<y.version&&p(_)}else p(_);return c.get(_)}return{get:d,update:m,getWireframeAttribute:g}}function u1(r,t,i){let s;function l(v){s=v}let c,f;function d(v){c=v.type,f=v.bytesPerElement}function m(v,y){r.drawElements(s,y,c,v*f),i.update(y,s,1)}function p(v,y,T){T!==0&&(r.drawElementsInstanced(s,y,c,v*f,T),i.update(y,s,T))}function g(v,y,T){if(T===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(s,y,0,c,v,0,T);let M=0;for(let S=0;S<T;S++)M+=y[S];i.update(M,s,1)}function _(v,y,T,R){if(T===0)return;const M=t.get("WEBGL_multi_draw");if(M===null)for(let S=0;S<v.length;S++)p(v[S]/f,y[S],R[S]);else{M.multiDrawElementsInstancedWEBGL(s,y,0,c,v,0,R,0,T);let S=0;for(let B=0;B<T;B++)S+=y[B]*R[B];i.update(S,s,1)}}this.setMode=l,this.setIndex=d,this.render=m,this.renderInstances=p,this.renderMultiDraw=g,this.renderMultiDrawInstances=_}function f1(r){const t={geometries:0,textures:0},i={frame:0,calls:0,triangles:0,points:0,lines:0};function s(c,f,d){switch(i.calls++,f){case r.TRIANGLES:i.triangles+=d*(c/3);break;case r.LINES:i.lines+=d*(c/2);break;case r.LINE_STRIP:i.lines+=d*(c-1);break;case r.LINE_LOOP:i.lines+=d*c;break;case r.POINTS:i.points+=d*c;break;default:we("WebGLInfo: Unknown draw mode:",f);break}}function l(){i.calls=0,i.triangles=0,i.points=0,i.lines=0}return{memory:t,render:i,programs:null,autoReset:!0,reset:l,update:s}}function h1(r,t,i){const s=new WeakMap,l=new an;function c(f,d,m){const p=f.morphTargetInfluences,g=d.morphAttributes.position||d.morphAttributes.normal||d.morphAttributes.color,_=g!==void 0?g.length:0;let v=s.get(d);if(v===void 0||v.count!==_){let D=function(){q.dispose(),s.delete(d),d.removeEventListener("dispose",D)};var y=D;v!==void 0&&v.texture.dispose();const T=d.morphAttributes.position!==void 0,R=d.morphAttributes.normal!==void 0,M=d.morphAttributes.color!==void 0,S=d.morphAttributes.position||[],B=d.morphAttributes.normal||[],N=d.morphAttributes.color||[];let w=0;T===!0&&(w=1),R===!0&&(w=2),M===!0&&(w=3);let z=d.attributes.position.count*w,I=1;z>t.maxTextureSize&&(I=Math.ceil(z/t.maxTextureSize),z=t.maxTextureSize);const P=new Float32Array(z*I*4*_),q=new xv(P,z,I,_);q.type=zi,q.needsUpdate=!0;const C=w*4;for(let V=0;V<_;V++){const nt=S[V],it=B[V],dt=N[V],rt=z*I*4*V;for(let F=0;F<nt.count;F++){const H=F*C;T===!0&&(l.fromBufferAttribute(nt,F),P[rt+H+0]=l.x,P[rt+H+1]=l.y,P[rt+H+2]=l.z,P[rt+H+3]=0),R===!0&&(l.fromBufferAttribute(it,F),P[rt+H+4]=l.x,P[rt+H+5]=l.y,P[rt+H+6]=l.z,P[rt+H+7]=0),M===!0&&(l.fromBufferAttribute(dt,F),P[rt+H+8]=l.x,P[rt+H+9]=l.y,P[rt+H+10]=l.z,P[rt+H+11]=dt.itemSize===4?l.w:1)}}v={count:_,texture:q,size:new Wt(z,I)},s.set(d,v),d.addEventListener("dispose",D)}if(f.isInstancedMesh===!0&&f.morphTexture!==null)m.getUniforms().setValue(r,"morphTexture",f.morphTexture,i);else{let T=0;for(let M=0;M<p.length;M++)T+=p[M];const R=d.morphTargetsRelative?1:1-T;m.getUniforms().setValue(r,"morphTargetBaseInfluence",R),m.getUniforms().setValue(r,"morphTargetInfluences",p)}m.getUniforms().setValue(r,"morphTargetsTexture",v.texture,i),m.getUniforms().setValue(r,"morphTargetsTextureSize",v.size)}return{update:c}}function d1(r,t,i,s){let l=new WeakMap;function c(m){const p=s.render.frame,g=m.geometry,_=t.get(m,g);if(l.get(_)!==p&&(t.update(_),l.set(_,p)),m.isInstancedMesh&&(m.hasEventListener("dispose",d)===!1&&m.addEventListener("dispose",d),l.get(m)!==p&&(i.update(m.instanceMatrix,r.ARRAY_BUFFER),m.instanceColor!==null&&i.update(m.instanceColor,r.ARRAY_BUFFER),l.set(m,p))),m.isSkinnedMesh){const v=m.skeleton;l.get(v)!==p&&(v.update(),l.set(v,p))}return _}function f(){l=new WeakMap}function d(m){const p=m.target;p.removeEventListener("dispose",d),i.remove(p.instanceMatrix),p.instanceColor!==null&&i.remove(p.instanceColor)}return{update:c,dispose:f}}const p1={[nv]:"LINEAR_TONE_MAPPING",[iv]:"REINHARD_TONE_MAPPING",[av]:"CINEON_TONE_MAPPING",[sv]:"ACES_FILMIC_TONE_MAPPING",[ov]:"AGX_TONE_MAPPING",[lv]:"NEUTRAL_TONE_MAPPING",[rv]:"CUSTOM_TONE_MAPPING"};function m1(r,t,i,s,l){const c=new Ii(t,i,{type:r,depthBuffer:s,stencilBuffer:l}),f=new Ii(t,i,{type:xa,depthBuffer:!1,stencilBuffer:!1}),d=new ki;d.setAttribute("position",new Ri([-1,3,0,-1,-1,0,3,-1,0],3)),d.setAttribute("uv",new Ri([0,2,0,0,2,0],2));const m=new sE({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
`].filter(qo).join(`
`)),f=Gd(f),f=k_(f,i),f=W_(f,i),d=Gd(d),d=k_(d,i),d=W_(d,i),f=q_(f),d=q_(d),i.isRawShaderMaterial!==!0&&(B=`#version 300 es
...
`)+`
`+S);const N=B+M+f,w=B+S+d,z=G_(l,l.VERTEX_SHADER,N),I=G_(l,l.FRAGMENT_SHADER,w);l.attachShader(R,z),l.attachShader(R,I),i.index0AttributeName!==void 0?l.bindAttribLocation(R,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(R,0,"position"),l.linkProgram(R);function P(V){if(r.debug.checkShaderErrors){const nt=l.getProgramInfoLog(R)||"",it=l.getShaderInfoLog(z)||"",dt=l.getShaderInfoLog(I)||"",rt=nt.trim(),F=it.trim(),H=dt.trim();let $=!0,yt=!0;if(l.getProgramParameter(R,l.LINK_STATUS)===!1)if($=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(l,R,z,I);else{const xt=X_(l,z,"vertex"),L=X_(l,I,"fragment");we("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(R,l.VALIDATE_STATUS)+`
...
Program Info Log: `+rt+`
`+xt+`
`+L)}else rt!==""?pe("WebGLProgram: Program Info Log:",rt):(F===""||H==="")&&(yt=!1);yt&&(V.diagnostics={runnable:$,programLog:rt,vertexShader:{log:F,prefix:M},fragmentShader:{log:H,prefix:S}})}l.deleteShader(z),l.deleteShader(I),q=new Yc(l,R),C=gA(l,R)}let q;this.getUniforms=function(){return q===void 0&&P(this),q};let C;this.getAttributes=function(){return C===void 0&&P(this),C};let D=i.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return D===!1&&(D=l.getProgramParameter(R,rA)),D},this.destroy=function(){s.releaseStatesOfProgram(this),l.deleteProgram(R),this.program=void 0},this.type=i.shaderType,this.name=i.shaderName,this.id=oA++,this.cacheKey=t,this.usedTimes=1,this.program=R,this.vertexShader=z,this.fragmentShader=I,this}let NA=0;class LA{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(t){const i=t.vertexShader,s=t.fragmentShader,l=this._getShaderStage(i),c=this._getShaderStage(s),f=this._getShaderCacheForMaterial(t);return f.has(l)===!1&&(f.add(l),l.usedTimes++),f.has(c)===!1&&(f.add(c),c.usedTimes++),this}remove(t){const i=this.materialCache.get(t);for(const s of i)s.usedTimes--,s.usedTimes===0&&this.shaderCache.delete(s.code);return this.materialCache.delete(t),this}getVertexShaderID(t){return this._getShaderStage(t.vertexShader).id}getFragmentShaderID(t){return this._getShaderStage(t.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(t){const i=this.materialCache;let s=i.get(t);return s===void 0&&(s=new Set,i.set(t,s)),s}_getShaderStage(t){const i=this.shaderCache;let s=i.get(t);return s===void 0&&(s=new OA(t),i.set(t,s)),s}}class OA{constructor(t){this.id=NA++,this.code=t,this.usedTimes=0}}function PA(r,t,i,s,l,c,f){const d=new Sv,m=new LA,p=new Set,g=[],_=new Map,v=l.logarithmicDepthBuffer;let y=l.precision;const T={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function R(C){return p.add(C),C===0?"uv":`uv${C}`}function M(C,D,V,nt,it){const dt=nt.fog,rt=it.geometry,F=C.isMeshStandardMaterial?nt.environment:null,H=(C.isMeshStandardMaterial?i:t).get(C.envMap||F),$=H&&H.mapping===Jc?H.image.height:null,yt=T[C.type];C.precision!==null&&(y=l.getMaxPrecision(C.precision),y!==C.precision&&pe("WebGLProgram.getParameters:",C.precision,"not supported, using",y,"instead."));const xt=rt.morphAttributes.position||rt.morphAttributes.normal||rt.morphAttributes.color,L=xt!==void 0?xt.length:0;let K=0;rt.morphAttributes.position!==void 0&&(K=1),rt.morphAttributes.normal!==void 0&&(K=2),rt.morphAttributes.color!==void 0&&(K=3);let ft,Et,Rt,Q;if(yt){const Ce=Pi[yt];ft=Ce.vertexShader,Et=Ce.fragmentShader}else ft=C.vertexShader,Et=C.fragmentShader,m.update(C),Rt=m.getVertexShaderID(C),Q=m.getFragmentShaderID(C);const ct=r.getRenderTarget(),Dt=r.state.buffers.depth.getReversed(),Vt=it.isInstancedMesh===!0,qt=it.isBatchedMesh===!0,ye=!!C.map,Ue=!!C.matcap,fe=!!H,gt=!!C.aoMap,At=!!C.lightMap,Mt=!!C.bumpMap,Bt=!!C.normalMap,O=!!C.displacementMap,ne=!!C.emissiveMap,Gt=!!C.metalnessMap,ae=!!C.roughnessMap,Ut=C.anisotropy>0,U=C.clearcoat>0,E=C.dispersion>0,W=C.iridescence>0,ut=C.sheen>0,St=C.transmission>0,ht=Ut&&!!C.anisotropyMap,Qt=U&&!!C.clearcoatMap,Lt=U&&!!C.clearcoatNormalMap,Jt=U&&!!C.clearcoatRoughnessMap,le=W&&!!C.iridescenceMap,Tt=W&&!!C.iridescenceThicknessMap,Ct=ut&&!!C.sheenColorMap,Yt=ut&&!!C.sheenRoughnessMap,Xt=!!C.specularMap,Ot=!!C.specularColorMap,_e=!!C.specularIntensityMap,k=St&&!!C.transmissionMap,Ft=St&&!!C.thicknessMap,wt=!!C.gradientMap,kt=!!C.alphaMap,bt=C.alphaTest>0,vt=!!C.alphaHash,Nt=!!C.extensions;let he=Bi;C.toneMapped&&(ct===null||ct.isXRRenderTarget===!0)&&(he=r.toneMapping);const Ie={shaderID:yt,shaderType:C.type,shaderName:C.name,vertexShader:ft,fragmentShader:Et,defines:C.defines,customVertexShaderID:Rt,customFragmentShaderID:Q,isRawShaderMaterial:C.isRawShaderMaterial===!0,glslVersion:C.glslVersion,precision:y,batching:qt,batchingColor:qt&&it._colorsTexture!==null,instancing:Vt,instancingColor:Vt&&it.instanceColor!==null,instancingMorph:Vt&&it.morphTexture!==null,outputColorSpace:ct===null?r.outputColorSpace:ct.isXRRenderTarget===!0?ct.texture.colorSpace:zr,alphaToCoverage:!!C.alphaToCoverage,map:ye,matcap:Ue,envMap:fe,envMapMode:fe&&H.mapping,envMapCubeUVHeight:$,aoMap:gt,lightMap:At,bumpMap:Mt,normalMap:Bt,displacementMap:O,emissiveMap:ne,normalMapObjectSpace:Bt&&C.normalMapType===Iy,normalMapTangentSpace:Bt&&C.normalMapType===_v,metalnessMap:Gt,roughnessMap:ae,anisotropy:Ut,anisotropyMap:ht,clearcoat:U,clearcoatMap:Qt,clearcoatNormalMap:Lt,clearcoatRoughnessMap:Jt,dispersion:E,iridescence:W,iridescenceMap:le,iridescenceThicknessMap:Tt,sheen:ut,sheenColorMap:Ct,sheenRoughnessMap:Yt,specularMap:Xt,specularColorMap:Ot,specularIntensityMap:_e,transmission:St,transmissionMap:k,thicknessMap:Ft,gradientMap:wt,opaque:C.transparent===!1&&C.blending===Ur&&C.alphaToCoverage===!1,alphaMap:kt,alphaTest:bt,alphaHash:vt,combine:C.combine,mapUv:ye&&R(C.map.channel),aoMapUv:gt&&R(C.aoMap.channel),lightMapUv:At&&R(C.lightMap.channel),bumpMapUv:Mt&&R(C.bumpMap.channel),normalMapUv:Bt&&R(C.normalMap.channel),displacementMapUv:O&&R(C.displacementMap.channel),emissiveMapUv:ne&&R(C.emissiveMap.channel),metalnessMapUv:Gt&&R(C.metalnessMap.channel),roughnessMapUv:ae&&R(C.roughnessMap.channel),anisotropyMapUv:ht&&R(C.anisotropyMap.channel),clearcoatMapUv:Qt&&R(C.clearcoatMap.channel),clearcoatNormalMapUv:Lt&&R(C.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:Jt&&R(C.clearcoatRoughnessMap.channel),iridescenceMapUv:le&&R(C.iridescenceMap.channel),iridescenceThicknessMapUv:Tt&&R(C.iridescenceThicknessMap.channel),sheenColorMapUv:Ct&&R(C.sheenColorMap.channel),sheenRoughnessMapUv:Yt&&R(C.sheenRoughnessMap.channel),specularMapUv:Xt&&R(C.specularMap.channel),specularColorMapUv:Ot&&R(C.specularColorMap.channel),specularIntensityMapUv:_e&&R(C.specularIntensityMap.channel),transmissionMapUv:k&&R(C.transmissionMap.channel),thicknessMapUv:Ft&&R(C.thicknessMap.channel),alphaMapUv:kt&&R(C.alphaMap.channel),vertexTangents:!!rt.attributes.tangent&&(Bt||Ut),vertexColors:C.vertexColors,vertexAlphas:C.vertexColors===!0&&!!rt.attributes.color&&rt.attributes.color.itemSize===4,pointsUvs:it.isPoints===!0&&!!rt.attributes.uv&&(ye||kt),fog:!!dt,useFog:C.fog===!0,fogExp2:!!dt&&dt.isFogExp2,flatShading:C.flatShading===!0&&C.wireframe===!1,sizeAttenuation:C.sizeAttenuation===!0,logarithmicDepthBuffer:v,reversedDepthBuffer:Dt,skinning:it.isSkinnedMesh===!0,morphTargets:rt.morphAttributes.position!==void 0,morphNormals:rt.morphAttributes.normal!==void 0,morphColors:rt.morphAttributes.color!==void 0,morphTargetsCount:L,morphTextureStride:K,numDirLights:D.directional.length,numPointLights:D.point.length,numSpotLights:D.spot.length,numSpotLightMaps:D.spotLightMap.length,numRectAreaLights:D.rectArea.length,numHemiLights:D.hemi.length,numDirLightShadows:D.directionalShadowMap.length,numPointLightShadows:D.pointShadowMap.length,numSpotLightShadows:D.spotShadowMap.length,numSpotLightShadowsWithMaps:D.numSpotLightShadowsWithMaps,numLightProbes:D.numLightProbes,numClippingPlanes:f.numPlanes,numClipIntersection:f.numIntersection,dithering:C.dithering,shadowMapEnabled:r.shadowMap.enabled&&V.length>0,shadowMapType:r.shadowMap.type,toneMapping:he,decodeVideoTexture:ye&&C.map.isVideoTexture===!0&&De.getTransfer(C.map.colorSpace)===Xe,decodeVideoTextureEmissive:ne&&C.emissiveMap.isVideoTexture===!0&&De.getTransfer(C.emissiveMap.colorSpace)===Xe,premultipliedAlpha:C.premultipliedAlpha,doubleSided:C.side===ma,flipSided:C.side===qn,useDepthPacking:C.depthPacking>=0,depthPacking:C.depthPacking||0,index0AttributeName:C.index0AttributeName,extensionClipCullDistance:Nt&&C.extensions.clipCullDistance===!0&&s.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(Nt&&C.extensions.multiDraw===!0||qt)&&s.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:s.has("KHR_parallel_shader_compile"),customProgramCacheKey:C.customProgramCacheKey()};return Ie.vertexUv1s=p.has(1),Ie.vertexUv2s=p.has(2),Ie.vertexUv3s=p.has(3),p.clear(),Ie}function S(C){const D=[];if(C.shaderID?D.push(C.shaderID):(D.push(C.customVertexShaderID),D.push(C.customFragmentShaderID)),C.defines!==void 0)for(const V in C.defines)D.push(V),D.push(C.defines[V]);return C.isRawShaderMaterial===!1&&(B(D,C),N(D,C),D.push(r.outputColorSpace)),D.push(C.customProgramCacheKey),D.join()}function B(C,D){C.push(D.precision),C.push(D.outputColorSpace),C.push(D.envMapMode),C.push(D.envMapCubeUVHeight),C.push(D.mapUv),C.push(D.alphaMapUv),C.push(D.lightMapUv),C.push(D.aoMapUv),C.push(D.bumpMapUv),C.push(D.normalMapUv),C.push(D.displacementMapUv),C.push(D.emissiveMapUv),C.push(D.metalnessMapUv),C.push(D.roughnessMapUv),C.push(D.anisotropyMapUv),C.push(D.clearcoatMapUv),C.push(D.clearcoatNormalMapUv),C.push(D.clearcoatRoughnessMapUv),C.push(D.iridescenceMapUv),C.push(D.iridescenceThicknessMapUv),C.push(D.sheenColorMapUv),C.push(D.sheenRoughnessMapUv),C.push(D.specularMapUv),C.push(D.specularColorMapUv),C.push(D.specularIntensityMapUv),C.push(D.transmissionMapUv),C.push(D.thicknessMapUv),C.push(D.combine),C.push(D.fogExp2),C.push(D.sizeAttenuation),C.push(D.morphTargetsCount),C.push(D.morphAttributeCount),C.push(D.numDirLights),C.push(D.numPointLights),C.push(D.numSpotLights),C.push(D.numSpotLightMaps),C.push(D.numHemiLights),C.push(D.numRectAreaLights),C.push(D.numDirLightShadows),C.push(D.numPointLightShadows),C.push(D.numSpotLightShadows),C.push(D.numSpotLightShadowsWithMaps),C.push(D.numLightProbes),C.push(D.shadowMapType),C.push(D.toneMapping),C.push(D.numClippingPlanes),C.push(D.numClipIntersection),C.push(D.depthPacking)}function N(C,D){d.disableAll(),D.instancing&&d.enable(0),D.instancingColor&&d.enable(1),D.instancingMorph&&d.enable(2),D.matcap&&d.enable(3),D.envMap&&d.enable(4),D.normalMapObjectSpace&&d.enable(5),D.normalMapTangentSpace&&d.enable(6),D.clearcoat&&d.enable(7),D.iridescence&&d.enable(8),D.alphaTest&&d.enable(9),D.vertexColors&&d.enable(10),D.vertexAlphas&&d.enable(11),D.vertexUv1s&&d.enable(12),D.vertexUv2s&&d.enable(13),D.vertexUv3s&&d.enable(14),D.vertexTangents&&d.enable(15),D.anisotropy&&d.enable(16),D.alphaHash&&d.enable(17),D.batching&&d.enable(18),D.dispersion&&d.enable(19),D.batchingColor&&d.enable(20),D.gradientMap&&d.enable(21),C.push(d.mask),d.disableAll(),D.fog&&d.enable(0),D.useFog&&d.enable(1),D.flatShading&&d.enable(2),D.logarithmicDepthBuffer&&d.enable(3),D.reversedDepthBuffer&&d.enable(4),D.skinning&&d.enable(5),D.morphTargets&&d.enable(6),D.morphNormals&&d.enable(7),D.morphColors&&d.enable(8),D.premultipliedAlpha&&d.enable(9),D.shadowMapEnabled&&d.enable(10),D.doubleSided&&d.enable(11),D.flipSided&&d.enable(12),D.useDepthPacking&&d.enable(13),D.dithering&&d.enable(14),D.transmission&&d.enable(15),D.sheen&&d.enable(16),D.opaque&&d.enable(17),D.pointsUvs&&d.enable(18),D.decodeVideoTexture&&d.enable(19),D.decodeVideoTextureEmissive&&d.enable(20),D.alphaToCoverage&&d.enable(21),C.push(d.mask)}function w(C){const D=T[C.type];let V;if(D){const nt=Pi[D];V=pM.clone(nt.uniforms)}else V=C.uniforms;return V}function z(C,D){let V=_.get(D);return V!==void 0?++V.usedTimes:(V=new UA(r,D,C,c),g.push(V),_.set(D,V)),V}function I(C){if(--C.usedTimes===0){const D=g.indexOf(C);g[D]=g[g.length-1],g.pop(),_.delete(C.cacheKey),C.destroy()}}function P(C){m.remove(C)}function q(){m.dispose()}return{getParameters:M,getProgramCacheKey:S,getUniforms:w,acquireProgram:z,releaseProgram:I,releaseShaderCache:P,programs:g,dispose:q}}function zA(){let r=new WeakMap;function t(f){return r.has(f)}function i(f){let d=r.get(f);return d===void 0&&(d={},r.set(f,d)),d}function s(f){r.delete(f)}function l(f,d,m){r.get(f)[d]=m}function c(){r=new WeakMap}return{has:t,get:i,remove:s,update:l,dispose:c}}function FA(r,t){return r.groupOrder!==t.groupOrder?r.groupOrder-t.groupOrder:r.renderOrder!==t.renderOrder?r.renderOrder-t.renderOrder:r.material.id!==t.material.id?r.material.id-t.material.id:r.z!==t.z?r.z-t.z:r.id-t.id}function Z_(r,t){return r.groupOrder!==t.groupOrder?r.groupOrder-t.groupOrder:r.renderOrder!==t.renderOrder?r.renderOrder-t.renderOrder:r.z!==t.z?t.z-r.z:r.id-t.id}function j_(){const r=[];let t=0;const i=[],s=[],l=[];function c(){t=0,i.length=0,s.length=0,l.length=0}function f(_,v,y,T,R,M){let S=r[t];return S===void 0?(S={id:_.id,object:_,geometry:v,material:y,groupOrder:T,renderOrder:_.renderOrder,z:R,group:M},r[t]=S):(S.id=_.id,S.object=_,S.geometry=v,S.material=y,S.groupOrder=T,S.renderOrder=_.renderOrder,S.z=R,S.group=M),t++,S}function d(_,v,y,T,R,M){const S=f(_,v,y,T,R,M);y.transmission>0?s.push(S):y.transparent===!0?l.push(S):i.push(S)}function m(_,v,y,T,R,M){const S=f(_,v,y,T,R,M);y.transmission>0?s.unshift(S):y.transparent===!0?l.unshift(S):i.unshift(S)}function p(_,v){i.length>1&&i.sort(_||FA),s.length>1&&s.sort(v||Z_),l.length>1&&l.sort(v||Z_)}function g(){for(let _=t,v=r.length;_<v;_++){const y=r[_];if(y.id===null)break;y.id=null,y.object=null,y.geometry=null,y.material=null,y.group=null}}return{opaque:i,transmissive:s,transparent:l,init:c,push:d,unshift:m,finish:g,sort:p}}function BA(){let r=new WeakMap;function t(s,l){const c=r.get(s);let f;return c===void 0?(f=new j_,r.set(s,[f])):l>=c.length?(f=new j_,c.push(f)):f=c[l],f}function i(){r=new WeakMap}return{get:t,dispose:i}}function IA(){const r={};return{get:function(t){if(r[t.id]!==void 0)return r[t.id];let i;switch(t.type){case"DirectionalLight":i={direction:new j,color:new Fe};break;case"SpotLight":i={position:new j,direction:new j,color:new Fe,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":i={position:new j,color:new Fe,distance:0,decay:0};break;case"HemisphereLight":i={direction:new j,skyColor:new Fe,groundColor:new Fe};break;case"RectAreaLight":i={color:new Fe,position:new j,halfWidth:new j,halfHeight:new j};break}return r[t.id]=i,i}}}function HA(){const r={};return{get:function(t){if(r[t.id]!==void 0)return r[t.id];let i;switch(t.type){case"DirectionalLight":i={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Wt};break;case"SpotLight":i={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Wt};break;case"PointLight":i={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Wt,shadowCameraNear:1,shadowCameraFar:1e3};break}return r[t.id]=i,i}}}let GA=0;function VA(r,t){return(t.castShadow?2:0)-(r.castShadow?2:0)+(t.map?1:0)-(r.map?1:0)}function XA(r){const t=new IA,i=HA(),s={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let p=0;p<9;p++)s.probe.push(new j);const l=new j,c=new tn,f=new tn;function d(p){let g=0,_=0,v=0;for(let C=0;C<9;C++)s.probe[C].set(0,0,0);let y=0,T=0,R=0,M=0,S=0,B=0,N=0,w=0,z=0,I=0,P=0;p.sort(VA);for(let C=0,D=p.length;C<D;C++){const V=p[C],nt=V.color,it=V.intensity,dt=V.distance;let rt=null;if(V.shadow&&V.shadow.map&&(V.shadow.map.texture.format===Pr?rt=V.shadow.map.texture:rt=V.shadow.map.depthTexture||V.shadow.map.texture),V.isAmbientLight)g+=nt.r*it,_+=nt.g*it,v+=nt.b*it;else if(V.isLightProbe){for(let F=0;F<9;F++)s.probe[F].addScaledVector(V.sh.coefficients[F],it);P++}else if(V.isDirectionalLight){const F=t.get(V);if(F.color.copy(V.color).multiplyScalar(V.intensity),V.castShadow){const H=V.shadow,$=i.get(V);$.shadowIntensity=H.intensity,$.shadowBias=H.bias,$.shadowNormalBias=H.normalBias,$.shadowRadius=H.radius,$.shadowMapSize=H.mapSize,s.directionalShadow[y]=$,s.directionalShadowMap[y]=rt,s.directionalShadowMatrix[y]=V.shadow.matrix,B++}s.directional[y]=F,y++}else if(V.isSpotLight){const F=t.get(V);F.position.setFromMatrixPosition(V.matrixWorld),F.color.copy(nt).multiplyScalar(it),F.distance=dt,F.coneCos=Math.cos(V.angle),F.penumbraCos=Math.cos(V.angle*(1-V.penumbra)),F.decay=V.decay,s.spot[R]=F;const H=V.shadow;if(V.map&&(s.spotLightMap[z]=V.map,z++,H.updateMatrices(V),V.castShadow&&I++),s.spotLightMatrix[R]=H.matrix,V.castShadow){const $=i.get(V);$.shadowIntensity=H.intensity,$.shadowBias=H.bias,$.shadowNormalBias=H.normalBias,$.shadowRadius=H.radius,$.shadowMapSize=H.mapSize,s.spotShadow[R]=$,s.spotShadowMap[R]=rt,w++}R++}else if(V.isRectAreaLight){const F=t.get(V);F.color.copy(nt).multiplyScalar(it),F.halfWidth.set(V.width*.5,0,0),F.halfHeight.set(0,V.height*.5,0),s.rectArea[M]=F,M++}else if(V.isPointLight){const F=t.get(V);if(F.color.copy(V.color).multiplyScalar(V.intensity),F.distance=V.distance,F.decay=V.decay,V.castShadow){const H=V.shadow,$=i.get(V);$.shadowIntensity=H.intensity,$.shadowBias=H.bias,$.shadowNormalBias=H.normalBias,$.shadowRadius=H.radius,$.shadowMapSize=H.mapSize,$.shadowCameraNear=H.camera.near,$.shadowCameraFar=H.camera.far,s.pointShadow[T]=$,s.pointShadowMap[T]=rt,s.pointShadowMatrix[T]=V.shadow.matrix,N++}s.point[T]=F,T++}else if(V.isHemisphereLight){const F=t.get(V);F.skyColor.copy(V.color).multiplyScalar(it),F.groundColor.copy(V.groundColor).multiplyScalar(it),s.hemi[S]=F,S++}}M>0&&(r.has("OES_texture_float_linear")===!0?(s.rectAreaLTC1=Ht.LTC_FLOAT_1,s.rectAreaLTC2=Ht.LTC_FLOAT_2):(s.rectAreaLTC1=Ht.LTC_HALF_1,s.rectAreaLTC2=Ht.LTC_HALF_2)),s.ambient[0]=g,s.ambient[1]=_,s.ambient[2]=v;const q=s.hash;(q.directionalLength!==y||q.pointLength!==T||q.spotLength!==R||q.rectAreaLength!==M||q.hemiLength!==S||q.numDirectionalShadows!==B||q.numPointShadows!==N||q.numSpotShadows!==w||q.numSpotMaps!==z||q.numLightProbes!==P)&&(s.directional.length=y,s.spot.length=R,s.rectArea.length=M,s.point.length=T,s.hemi.length=S,s.directionalShadow.length=B,s.directionalShadowMap.length=B,s.pointShadow.length=N,s.pointShadowMap.length=N,s.spotShadow.length=w,s.spotShadowMap.length=w,s.directionalShadowMatrix.length=B,s.pointShadowMatrix.length=N,s.spotLightMatrix.length=w+z-I,s.spotLightMap.length=z,s.numSpotLightShadowsWithMaps=I,s.numLightProbes=P,q.directionalLength=y,q.pointLength=T,q.spotLength=R,q.rectAreaLength=M,q.hemiLength=S,q.numDirectionalShadows=B,q.numPointShadows=N,q.numSpotShadows=w,q.numSpotMaps=z,q.numLightProbes=P,s.version=GA++)}function m(p,g){let _=0,v=0,y=0,T=0,R=0;const M=g.matrixWorldInverse;for(let S=0,B=p.length;S<B;S++){const N=p[S];if(N.isDirectionalLight){const w=s.directional[_];w.direction.setFromMatrixPosition(N.matrixWorld),l.setFromMatrixPosition(N.target.matrixWorld),w.direction.sub(l),w.direction.transformDirection(M),_++}else if(N.isSpotLight){const w=s.spot[y];w.position.setFromMatrixPosition(N.matrixWorld),w.position.applyMatrix4(M),w.direction.setFromMatrixPosition(N.matrixWorld),l.setFromMatrixPosition(N.target.matrixWorld),w.direction.sub(l),w.direction.transformDirection(M),y++}else if(N.isRectAreaLight){const w=s.rectArea[T];w.position.setFromMatrixPosition(N.matrixWorld),w.position.applyMatrix4(M),f.identity(),c.copy(N.matrixWorld),c.premultiply(M),f.extractRotation(c),w.halfWidth.set(N.width*.5,0,0),w.halfHeight.set(0,N.height*.5,0),w.halfWidth.applyMatrix4(f),w.halfHeight.applyMatrix4(f),T++}else if(N.isPointLight){const w=s.point[v];w.position.setFromMatrixPosition(N.matrixWorld),w.position.applyMatrix4(M),v++}else if(N.isHemisphereLight){const w=s.hemi[R];w.direction.setFromMatrixPosition(N.matrixWorld),w.direction.transformDirection(M),R++}}}return{setup:d,setupView:m,state:s}}function K_(r){const t=new XA(r),i=[],s=[];function l(g){p.camera=g,i.length=0,s.length=0}function c(g){i.push(g)}function f(g){s.push(g)}function d(){t.setup(i)}function m(g){t.setupView(i,g)}const p={lightsArray:i,shadowsArray:s,camera:null,lights:t,transmissionRenderTarget:{}};return{init:l,state:p,setupLights:d,setupLightsView:m,pushLight:c,pushShadow:f}}function kA(r){let t=new WeakMap;function i(l,c=0){const f=t.get(l);let d;return f===void 0?(d=new K_(r),t.set(l,[d])):c>=f.length?(d=new K_(r),f.push(d)):d=f[c],d}function s(){t=new WeakMap}return{get:i,dispose:s}}const WA=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,YA=[new j(1,0,0),new j(-1,0,0),new j(0,1,0),new j(0,-1,0),new j(0,0,1),new j(0,0,-1)],ZA=[new j(0,-1,0),new j(0,-1,0),new j(0,0,1),new j(0,0,-1),new j(0,-1,0),new j(0,-1,0)],J_=new tn,Xo=new j,kh=new j;function jA(r,t,i){let s=new ep;const l=new Wt,c=new Wt,f=new an,d=new oE,m=new lE,p={},g=i.maxTextureSize,_={[es]:qn,[qn]:es,[ma]:ma},v=new Xi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Wt},radius:{value:4}},vertexShader:WA,fragmentShader:qA}),y=v.clone();y.defines.HORIZONTAL_PASS=1;const T=new ki;T.setAttribute("position",new Hi(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const R=new Ci(T,v),M=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Vc;let S=this.type;this.render=function(I,P,q){if(M.enabled===!1||M.autoUpdate===!1&&M.needsUpdate===!1||I.length===0)return;I.type===gy&&(pe("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),I.type=Vc);const C=r.getRenderTarget(),D=r.getActiveCubeFace(),V=r.getActiveMipmapLevel(),nt=r.state;nt.setBlending(_a),nt.buffers.depth.getReversed()===!0?nt.buffers.color.setClear(0,0,0,0):nt.buffers.color.setClear(1,1,1,1),nt.buffers.depth.setTest(!0),nt.setScissorTest(!1);const it=S!==this.type;it&&P.traverse(function(dt){dt.material&&(Array.isArray(dt.material)?dt.material.forEach(rt=>rt.needsUpdate=!0):dt.material.needsUpdate=!0)});for(let dt=0,rt=I.length;dt<rt;dt++){const F=I[dt],H=F.shadow;if(H===void 0){pe("WebGLShadowMap:",F,"has no shadow.");continue}if(H.autoUpdate===!1&&H.needsUpdate===!1)continue;l.copy(H.mapSize);const $=H.getFrameExtents();if(l.multiply($),c.copy(H.mapSize),(l.x>g||l.y>g)&&(l.x>g&&(c.x=Math.floor(g/$.x),l.x=c.x*$.x,H.mapSize.x=c.x),l.y>g&&(c.y=Math.floor(g/$.y),l.y=c.y*$.y,H.mapSize.y=c.y)),H.map===null||it===!0){if(H.map!==null&&(H.map.depthTexture!==null&&(H.map.depthTexture.dispose(),H.map.depthTexture=null),H.map.dispose()),this.type===ko){if(F.isPointLight){pe("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}H.map=new Ii(l.x,l.y,{format:Pr,type:xa,minFilter:xn,magFilter:xn,generateMipmaps:!1}),H.map.texture.name=F.name+".shadowMap",H.map.depthTexture=new Qo(l.x,l.y,zi),H.map.depthTexture.name=F.name+".shadowMapDepth",H.map.depthTexture.format=Sa,H.map.depthTexture.compareFunction=null,H.map.depthTexture.minFilter=Dn,H.map.depthTexture.magFilter=Dn}else{F.isPointLight?(H.map=new Rv(l.x),H.map.depthTexture=new bM(l.x,Gi)):(H.map=new Ii(l.x,l.y),H.map.depthTexture=new Qo(l.x,l.y,Gi)),H.map.depthTexture.name=F.name+".shadowMap",H.map.depthTexture.format=Sa;const xt=r.state.buffers.depth.getReversed();this.type===Vc?(H.map.depthTexture.compareFunction=xt?Jd:Kd,H.map.depthTexture.minFilter=xn,H.map.depthTexture.magFilter=xn):(H.map.depthTexture.compareFunction=null,H.map.depthTexture.minFilter=Dn,H.map.depthTexture.magFilter=Dn)}H.camera.updateProjectionMatrix()}const yt=H.map.isWebGLCubeRenderTarget?6:1;for(let xt=0;xt<yt;xt++){if(H.map.isWebGLCubeRenderTarget)r.setRenderTarget(H.map,xt),r.clear();else{xt===0&&(r.setRenderTarget(H.map),r.clear());const L=H.getViewport(xt);f.set(c.x*L.x,c.y*L.y,c.x*L.z,c.y*L.w),nt.viewport(f)}if(F.isPointLight){const L=H.camera,K=H.matrix,ft=F.distance||L.far;ft!==L.far&&(L.far=ft,L.updateProjectionMatrix()),Xo.setFromMatrixPosition(F.matrixWorld),L.position.copy(Xo),kh.copy(L.position),kh.add(YA[xt]),L.up.copy(ZA[xt]),L.lookAt(kh),L.updateMatrixWorld(),K.makeTranslation(-Xo.x,-Xo.y,-Xo.z),J_.multiplyMatrices(L.projectionMatrix,L.matrixWorldInverse),H._frustum.setFromProjectionMatrix(J_,L.coordinateSystem,L.reversedDepth)}else H.updateMatrices(F);s=H.getFrustum(),w(P,q,H.camera,F,this.type)}H.isPointLightShadow!==!0&&this.type===ko&&B(H,q),H.needsUpdate=!1}S=this.type,M.needsUpdate=!1,r.setRenderTarget(C,D,V)};function B(I,P){const q=t.update(R);v.defines.VSM_SAMPLES!==I.blurSamples&&(v.defines.VSM_SAMPLES=I.blurSamples,y.defines.VSM_SAMPLES=I.blurSamples,v.needsUpdate=!0,y.needsUpdate=!0),I.mapPass===null&&(I.mapPass=new Ii(l.x,l.y,{format:Pr,type:xa})),v.uniforms.shadow_pass.value=I.map.depthTexture,v.uniforms.resolution.value=I.mapSize,v.uniforms.radius.value=I.radius,r.setRenderTarget(I.mapPass),r.clear(),r.renderBufferDirect(P,null,q,v,R,null),y.uniforms.shadow_pass.value=I.mapPass.texture,y.uniforms.resolution.value=I.mapSize,y.uniforms.radius.value=I.radius,r.setRenderTarget(I.map),r.clear(),r.renderBufferDirect(P,null,q,y,R,null)}function N(I,P,q,C){let D=null;const V=q.isPointLight===!0?I.customDistanceMaterial:I.customDepthMaterial;if(V!==void 0)D=V;else if(D=q.isPointLight===!0?m:d,r.localClippingEnabled&&P.clipShadows===!0&&Array.isArray(P.clippingPlanes)&&P.clippingPlanes.length!==0||P.displacementMap&&P.displacementScale!==0||P.alphaMap&&P.alphaTest>0||P.map&&P.alphaTest>0||P.alphaToCoverage===!0){const nt=D.uuid,it=P.uuid;let dt=p[nt];dt===void 0&&(dt={},p[nt]=dt);let rt=dt[it];rt===void 0&&(rt=D.clone(),dt[it]=rt,P.addEventListener("dispose",z)),D=rt}if(D.visible=P.visible,D.wireframe=P.wireframe,C===ko?D.side=P.shadowSide!==null?P.shadowSide:P.side:D.side=P.shadowSide!==null?P.shadowSide:_[P.side],D.alphaMap=P.alphaMap,D.alphaTest=P.alphaToCoverage===!0?.5:P.alphaTest,D.map=P.map,D.clipShadows=P.clipShadows,D.clippingPlanes=P.clippingPlanes,D.clipIntersection=P.clipIntersection,D.displacementMap=P.displacementMap,D.displacementScale=P.displacementScale,D.displacementBias=P.displacementBias,D.wireframeLinewidth=P.wireframeLinewidth,D.linewidth=P.linewidth,q.isPointLight===!0&&D.isMeshDistanceMaterial===!0){const nt=r.properties.get(D);nt.light=q}return D}function w(I,P,q,C,D){if(I.visible===!1)return;if(I.layers.test(P.layers)&&(I.isMesh||I.isLine||I.isPoints)&&(I.castShadow||I.receiveShadow&&D===ko)&&(!I.frustumCulled||s.intersectsObject(I))){I.modelViewMatrix.multiplyMatrices(q.matrixWorldInverse,I.matrixWorld);const it=t.update(I),dt=I.material;if(Array.isArray(dt)){const rt=it.groups;for(let F=0,H=rt.length;F<H;F++){const $=rt[F],yt=dt[$.materialIndex];if(yt&&yt.visible){const xt=N(I,yt,C,D);I.onBeforeShadow(r,I,P,q,it,xt,$),r.renderBufferDirect(q,null,it,xt,I,$),I.onAfterShadow(r,I,P,q,it,xt,$)}}}else if(dt.visible){const rt=N(I,dt,C,D);I.onBeforeShadow(r,I,P,q,it,rt,null),r.renderBufferDirect(q,null,it,rt,I,null),I.onAfterShadow(r,I,P,q,it,rt,null)}}const nt=I.children;for(let it=0,dt=nt.length;it<dt;it++)w(nt[it],P,q,C,D)}function z(I){I.target.removeEventListener("dispose",z);for(const q in p){const C=p[q],D=I.target.uuid;D in C&&(C[D].dispose(),delete C[D])}}}const KA={[Yh]:Zh,[jh]:Qh,[Kh]:$h,[Lr]:Jh,[Zh]:Yh,[Qh]:jh,[$h]:Kh,[Jh]:Lr};function JA(r,t){function i(){let k=!1;const Ft=new an;let wt=null;const kt=new an(0,0,0,0);return{setMask:function(bt){wt!==bt&&!k&&(r.colorMask(bt,bt,bt,bt),wt=bt)},setLocked:function(bt){k=bt},setClear:function(bt,vt,Nt,he,Ie){Ie===!0&&(bt*=he,vt*=he,Nt*=he),Ft.set(bt,vt,Nt,he),kt.equals(Ft)===!1&&(r.clearColor(bt,vt,Nt,he),kt.copy(Ft))},reset:function(){k=!1,wt=null,kt.set(-1,0,0,0)}}}function s(){let k=!1,Ft=!1,wt=null,kt=null,bt=null;return{setReversed:function(vt){if(Ft!==vt){const Nt=t.get("EXT_clip_control");vt?Nt.clipControlEXT(Nt.LOWER_LEFT_EXT,Nt.ZERO_TO_ONE_EXT):Nt.clipControlEXT(Nt.LOWER_LEFT_EXT,Nt.NEGATIVE_ONE_TO_ONE_EXT),Ft=vt;const he=bt;bt=null,this.setClear(he)}},getReversed:function(){return Ft},setTest:function(vt){vt?ct(r.DEPTH_TEST):Dt(r.DEPTH_TEST)},setMask:function(vt){wt!==vt&&!k&&(r.depthMask(vt),wt=vt)},setFunc:function(vt){if(Ft&&(vt=KA[vt]),kt!==vt){switch(vt){case Yh:r.depthFunc(r.NEVER);break;case Zh:r.depthFunc(r.ALWAYS);break;case jh:r.depthFunc(r.LESS);break;case Lr:r.depthFunc(r.LEQUAL);break;case Kh:r.depthFunc(r.EQUAL);break;case Jh:r.depthFunc(r.GEQUAL);break;case Qh:r.depthFunc(r.GREATER);break;case $h:r.depthFunc(r.NOTEQUAL);break;default:r.depthFunc(r.LEQUAL)}kt=vt}},setLocked:function(vt){k=vt},setClear:function(vt){bt!==vt&&(Ft&&(vt=1-vt),r.clearDepth(vt),bt=vt)},reset:function(){k=!1,wt=null,kt=null,bt=null,Ft=!1}}}function l(){let k=!1,Ft=null,wt=null,kt=null,bt=null,vt=null,Nt=null,he=null,Ie=null;return{setTest:function(Ce){k||(Ce?ct(r.STENCIL_TEST):Dt(r.STENCIL_TEST))},setMask:function(Ce){Ft!==Ce&&!k&&(r.stencilMask(Ce),Ft=Ce)},setFunc:function(Ce,Un,gi){(wt!==Ce||kt!==Un||bt!==gi)&&(r.stencilFunc(Ce,Un,gi),wt=Ce,kt=Un,bt=gi)},setOp:function(Ce,Un,gi){(vt!==Ce||Nt!==Un||he!==gi)&&(r.stencilOp(Ce,Un,gi),vt=Ce,Nt=Un,he=gi)},setLocked:function(Ce){k=Ce},setClear:function(Ce){Ie!==Ce&&(r.clearStencil(Ce),Ie=Ce)},reset:function(){k=!1,Ft=null,wt=null,kt=null,bt=null,vt=null,Nt=null,he=null,Ie=null}}}const c=new i,f=new s,d=new l,m=new WeakMap,p=new WeakMap;let g={},_={},v=new WeakMap,y=[],T=null,R=!1,M=null,S=null,B=null,N=null,w=null,z=null,I=null,P=new Fe(0,0,0),q=0,C=!1,D=null,V=null,nt=null,it=null,dt=null;const rt=r.getParameter(r.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let F=!1,H=0;const $=r.getParameter(r.VERSION);$.indexOf("WebGL")!==-1?(H=parseFloat(/^WebGL (\d)/.exec($)[1]),F=H>=1):$.indexOf("OpenGL ES")!==-1&&(H=parseFloat(/^OpenGL ES (\d)/.exec($)[1]),F=H>=2);let yt=null,xt={};const L=r.getParameter(r.SCISSOR_BOX),K=r.getParameter(r.VIEWPORT),ft=new an().fromArray(L),Et=new an().fromArray(K);function Rt(k,Ft,wt,kt){const bt=new Uint8Array(4),vt=r.createTexture();r.bindTexture(k,vt),r.texParameteri(k,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(k,r.TEXTURE_MAG_FILTER,r.NEAREST);for(let Nt=0;Nt<wt;Nt++)k===r.TEXTURE_3D||k===r.TEXTURE_2D_ARRAY?r.texImage3D(Ft,0,r.RGBA,1,1,kt,0,r.RGBA,r.UNSIGNED_BYTE,bt):r.texImage2D(Ft+Nt,0,r.RGBA,1,1,0,r.RGBA,r.UNSIGNED_BYTE,bt);return vt}const Q={};Q[r.TEXTURE_2D]=Rt(r.TEXTURE_2D,r.TEXTURE_2D,1),Q[r.TEXTURE_CUBE_MAP]=Rt(r.TEXTURE_CUBE_MAP,r.TEXTURE_CUBE_MAP_POSITIVE_X,6),Q[r.TEXTURE_2D_ARRAY]=Rt(r.TEXTURE_2D_ARRAY,r.TEXTURE_2D_ARRAY,1,1),Q[r.TEXTURE_3D]=Rt(r.TEXTURE_3D,r.TEXTURE_3D,1,1),c.setClear(0,0,0,1),f.setClear(1),d.setClear(0),ct(r.DEPTH_TEST),f.setFunc(Lr),Mt(!1),Bt(K0),ct(r.CULL_FACE),gt(_a);function ct(k){g[k]!==!0&&(r.enable(k),g[k]=!0)}function Dt(k){g[k]!==!1&&(r.disable(k),g[k]=!1)}function Vt(k,Ft){return _[k]!==Ft?(r.bindFramebuffer(k,Ft),_[k]=Ft,k===r.DRAW_FRAMEBUFFER&&(_[r.FRAMEBUFFER]=Ft),k===r.FRAMEBUFFER&&(_[r.DRAW_FRAMEBUFFER]=Ft),!0):!1}function qt(k,Ft){let wt=y,kt=!1;if(k){wt=v.get(Ft),wt===void 0&&(wt=[],v.set(Ft,wt));const bt=k.textures;if(wt.length!==bt.length||wt[0]!==r.COLOR_ATTACHMENT0){for(let vt=0,Nt=bt.length;vt<Nt;vt++)wt[vt]=r.COLOR_ATTACHMENT0+vt;wt.length=bt.length,kt=!0}}else wt[0]!==r.BACK&&(wt[0]=r.BACK,kt=!0);kt&&r.drawBuffers(wt)}function ye(k){return T!==k?(r.useProgram(k),T=k,!0):!1}const Ue={[Rs]:r.FUNC_ADD,[vy]:r.FUNC_SUBTRACT,[xy]:r.FUNC_REVERSE_SUBTRACT};Ue[Sy]=r.MIN,Ue[yy]=r.MAX;const fe={[My]:r.ZERO,[Ey]:r.ONE,[Ty]:r.SRC_COLOR,[Wh]:r.SRC_ALPHA,[Dy]:r.SRC_ALPHA_SATURATE,[Cy]:r.DST_COLOR,[Ay]:r.DST_ALPHA,[by]:r.ONE_MINUS_SRC_COLOR,[qh]:r.ONE_MINUS_SRC_ALPHA,[wy]:r.ONE_MINUS_DST_COLOR,[Ry]:r.ONE_MINUS_DST_ALPHA,[Uy]:r.CONSTANT_COLOR,[Ny]:r.ONE_MINUS_CONSTANT_COLOR,[Ly]:r.CONSTANT_ALPHA,[Oy]:r.ONE_MINUS_CONSTANT_ALPHA};function gt(k,Ft,wt,kt,bt,vt,Nt,he,Ie,Ce){if(k===_a){R===!0&&(Dt(r.BLEND),R=!1);return}if(R===!1&&(ct(r.BLEND),R=!0),k!==_y){if(k!==M||Ce!==C){if((S!==Rs||w!==Rs)&&(r.blendEquation(r.FUNC_ADD),S=Rs,w=Rs),Ce)switch(k){case Ur:r.blendFuncSeparate(r.ONE,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case J0:r.blendFunc(r.ONE,r.ONE);break;case Q0:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case $0:r.blendFuncSeparate(r.DST_COLOR,r.ONE_MINUS_SRC_ALPHA,r.ZERO,r.ONE);break;default:we("WebGLState: Invalid blending: ",k);break}else switch(k){case Ur:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case J0:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE,r.ONE,r.ONE);break;case Q0:we("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case $0:we("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:we("WebGLState: Invalid blending: ",k);break}B=null,N=null,z=null,I=null,P.set(0,0,0),q=0,M=k,C=Ce}return}bt=bt||Ft,vt=vt||wt,Nt=Nt||kt,(Ft!==S||bt!==w)&&(r.blendEquationSeparate(Ue[Ft],Ue[bt]),S=Ft,w=bt),(wt!==B||kt!==N||vt!==z||Nt!==I)&&(r.blendFuncSeparate(fe[wt],fe[kt],fe[vt],fe[Nt]),B=wt,N=kt,z=vt,I=Nt),(he.equals(P)===!1||Ie!==q)&&(r.blendColor(he.r,he.g,he.b,Ie),P.copy(he),q=Ie),M=k,C=!1}function At(k,Ft){k.side===ma?Dt(r.CULL_FACE):ct(r.CULL_FACE);let wt=k.side===qn;Ft&&(wt=!wt),Mt(wt),k.blending===Ur&&k.transparent===!1?gt(_a):gt(k.blending,k.blendEquation,k.blendSrc,k.blendDst,k.blendEquationAlpha,k.blendSrcAlpha,k.blendDstAlpha,k.blendColor,k.blendAlpha,k.premultipliedAlpha),f.setFunc(k.depthFunc),f.setTest(k.depthTest),f.setMask(k.depthWrite),c.setMask(k.colorWrite);const kt=k.stencilWrite;d.setTest(kt),kt&&(d.setMask(k.stencilWriteMask),d.setFunc(k.stencilFunc,k.stencilRef,k.stencilFuncMask),d.setOp(k.stencilFail,k.stencilZFail,k.stencilZPass)),ne(k.polygonOffset,k.polygonOffsetFactor,k.polygonOffsetUnits),k.alphaToCoverage===!0?ct(r.SAMPLE_ALPHA_TO_COVERAGE):Dt(r.SAMPLE_ALPHA_TO_COVERAGE)}function Mt(k){D!==k&&(k?r.frontFace(r.CW):r.frontFace(r.CCW),D=k)}function Bt(k){k!==py?(ct(r.CULL_FACE),k!==V&&(k===K0?r.cullFace(r.BACK):k===my?r.cullFace(r.FRONT):r.cullFace(r.FRONT_AND_BACK))):Dt(r.CULL_FACE),V=k}function O(k){k!==nt&&(F&&r.lineWidth(k),nt=k)}function ne(k,Ft,wt){k?(ct(r.POLYGON_OFFSET_FILL),(it!==Ft||dt!==wt)&&(r.polygonOffset(Ft,wt),it=Ft,dt=wt)):Dt(r.POLYGON_OFFSET_FILL)}function Gt(k){k?ct(r.SCISSOR_TEST):Dt(r.SCISSOR_TEST)}function ae(k){k===void 0&&(k=r.TEXTURE0+rt-1),yt!==k&&(r.activeTexture(k),yt=k)}function Ut(k,Ft,wt){wt===void 0&&(yt===null?wt=r.TEXTURE0+rt-1:wt=yt);let kt=xt[wt];kt===void 0&&(kt={type:void 0,texture:void 0},xt[wt]=kt),(kt.type!==k||kt.texture!==Ft)&&(yt!==wt&&(r.activeTexture(wt),yt=wt),r.bindTexture(k,Ft||Q[k]),kt.type=k,kt.texture=Ft)}function U(){const k=xt[yt];k!==void 0&&k.type!==void 0&&(r.bindTexture(k.type,null),k.type=void 0,k.texture=void 0)}function E(){try{r.compressedTexImage2D(...arguments)}catch(k){we("WebGLState:",k)}}function W(){try{r.compressedTexImage3D(...arguments)}catch(k){we("WebGLState:",k)}}function ut(){try{r.texSubImage2D(...arguments)}catch(k){we("WebGLState:",k)}}function St(){try{r.texSubImage3D(...arguments)}catch(k){we("WebGLState:",k)}}function ht(){try{r.compressedTexSubImage2D(...arguments)}catch(k){we("WebGLState:",k)}}function Qt(){try{r.compressedTexSubImage3D(...arguments)}catch(k){we("WebGLState:",k)}}function Lt(){try{r.texStorage2D(...arguments)}catch(k){we("WebGLState:",k)}}function Jt(){try{r.texStorage3D(...arguments)}catch(k){we("WebGLState:",k)}}function le(){try{r.texImage2D(...arguments)}catch(k){we("WebGLState:",k)}}function Tt(){try{r.texImage3D(...arguments)}catch(k){we("WebGLState:",k)}}function Ct(k){ft.equals(k)===!1&&(r.scissor(k.x,k.y,k.z,k.w),ft.copy(k))}function Yt(k){Et.equals(k)===!1&&(r.viewport(k.x,k.y,k.z,k.w),Et.copy(k))}function Xt(k,Ft){let wt=p.get(Ft);wt===void 0&&(wt=new WeakMap,p.set(Ft,wt));let kt=wt.get(k);kt===void 0&&(kt=r.getUniformBlockIndex(Ft,k.name),wt.set(k,kt))}function Ot(k,Ft){const kt=p.get(Ft).get(k);m.get(Ft)!==kt&&(r.uniformBlockBinding(Ft,kt,k.__bindingPointIndex),m.set(Ft,kt))}function _e(){r.disable(r.BLEND),r.disable(r.CULL_FACE),r.disable(r.DEPTH_TEST),r.disable(r.POLYGON_OFFSET_FILL),r.disable(r.SCISSOR_TEST),r.disable(r.STENCIL_TEST),r.disable(r.SAMPLE_ALPHA_TO_COVERAGE),r.blendEquation(r.FUNC_ADD),r.blendFunc(r.ONE,r.ZERO),r.blendFuncSeparate(r.ONE,r.ZERO,r.ONE,r.ZERO),r.blendColor(0,0,0,0),r.colorMask(!0,!0,!0,!0),r.clearColor(0,0,0,0),r.depthMask(!0),r.depthFunc(r.LESS),f.setReversed(!1),r.clearDepth(1),r.stencilMask(4294967295),r.stencilFunc(r.ALWAYS,0,4294967295),r.stencilOp(r.KEEP,r.KEEP,r.KEEP),r.clearStencil(0),r.cullFace(r.BACK),r.frontFace(r.CCW),r.polygonOffset(0,0),r.activeTexture(r.TEXTURE0),r.bindFramebuffer(r.FRAMEBUFFER,null),r.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),r.bindFramebuffer(r.READ_FRAMEBUFFER,null),r.useProgram(null),r.lineWidth(1),r.scissor(0,0,r.canvas.width,r.canvas.height),r.viewport(0,0,r.canvas.width,r.canvas.height),g={},yt=null,xt={},_={},v=new WeakMap,y=[],T=null,R=!1,M=null,S=null,B=null,N=null,w=null,z=null,I=null,P=new Fe(0,0,0),q=0,C=!1,D=null,V=null,nt=null,it=null,dt=null,ft.set(0,0,r.canvas.width,r.canvas.height),Et.set(0,0,r.canvas.width,r.canvas.height),c.reset(),f.reset(),d.reset()}return{buffers:{color:c,depth:f,stencil:d},enable:ct,disable:Dt,bindFramebuffer:Vt,drawBuffers:qt,useProgram:ye,setBlending:gt,setMaterial:At,setFlipSided:Mt,setCullFace:Bt,setLineWidth:O,setPolygonOffset:ne,setScissorTest:Gt,activeTexture:ae,bindTexture:Ut,unbindTexture:U,compressedTexImage2D:E,compressedTexImage3D:W,texImage2D:le,texImage3D:Tt,updateUBOMapping:Xt,uniformBlockBinding:Ot,texStorage2D:Lt,texStorage3D:Jt,texSubImage2D:ut,texSubImage3D:St,compressedTexSubImage2D:ht,compressedTexSubImage3D:Qt,scissor:Ct,viewport:Yt,reset:_e}}function QA(r,t,i,s,l,c,f){const d=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,m=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),p=new Wt,g=new WeakMap;let _;const v=new WeakMap;let y=!1;try{y=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function T(U,E){return y?new OffscreenCanvas(U,E):Kc("canvas")}function R(U,E,W){let ut=1;const St=Ut(U);if((St.width>W||St.height>W)&&(ut=W/Math.max(St.width,St.height)),ut<1)if(typeof HTMLImageElement<"u"&&U instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&U instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&U instanceof ImageBitmap||typeof VideoFrame<"u"&&U instanceof VideoFrame){const ht=Math.floor(ut*St.width),Qt=Math.floor(ut*St.height);_===void 0&&(_=T(ht,Qt));const Lt=E?T(ht,Qt):_;return Lt.width=ht,Lt.height=Qt,Lt.getContext("2d").drawImage(U,0,0,ht,Qt),pe("WebGLRenderer: Texture has been resized from ("+St.width+"x"+St.height+") to ("+ht+"x"+Qt+")."),Lt}else return"data"in U&&pe("WebGLRenderer: Image in DataTexture is too big ("+St.width+"x"+St.height+")."),U;return U}function M(U){return U.generateMipmaps}function S(U){r.generateMipmap(U)}function B(U){return U.isWebGLCubeRenderTarget?r.TEXTURE_CUBE_MAP:U.isWebGL3DRenderTarget?r.TEXTURE_3D:U.isWebGLArrayRenderTarget||U.isCompressedArrayTexture?r.TEXTURE_2D_ARRAY:r.TEXTURE_2D}function N(U,E,W,ut,St=!1){if(U!==null){if(r[U]!==void 0)return r[U];pe("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+U+"'")}let ht=E;if(E===r.RED&&(W===r.FLOAT&&(ht=r.R32F),W===r.HALF_FLOAT&&(ht=r.R16F),W===r.UNSIGNED_BYTE&&(ht=r.R8)),E===r.RED_INTEGER&&(W===r.UNSIGNED_BYTE&&(ht=r.R8UI),W===r.UNSIGNED_SHORT&&(ht=r.R16UI),W===r.UNSIGNED_INT&&(ht=r.R32UI),W===r.BYTE&&(ht=r.R8I),W===r.SHORT&&(ht=r.R16I),W===r.INT&&(ht=r.R32I)),E===r.RG&&(W===r.FLOAT&&(ht=r.RG32F),W===r.HALF_FLOAT&&(ht=r.RG16F),W===r.UNSIGNED_BYTE&&(ht=r.RG8)),E===r.RG_INTEGER&&(W===r.UNSIGNED_BYTE&&(ht=r.RG8UI),W===r.UNSIGNED_SHORT&&(ht=r.RG16UI),W===r.UNSIGNED_INT&&(ht=r.RG32UI),W===r.BYTE&&(ht=r.RG8I),W===r.SHORT&&(ht=r.RG16I),W===r.INT&&(ht=r.RG32I)),E===r.RGB_INTEGER&&(W===r.UNSIGNED_BYTE&&(ht=r.RGB8UI),W===r.UNSIGNED_SHORT&&(ht=r.RGB16UI),W===r.UNSIGNED_INT&&(ht=r.RGB32UI),W===r.BYTE&&(ht=r.RGB8I),W===r.SHORT&&(ht=r.RGB16I),W===r.INT&&(ht=r.RGB32I)),E===r.RGBA_INTEGER&&(W===r.UNSIGNED_BYTE&&(ht=r.RGBA8UI),W===r.UNSIGNED_SHORT&&(ht=r.RGBA16UI),W===r.UNSIGNED_INT&&(ht=r.RGBA32UI),W===r.BYTE&&(ht=r.RGBA8I),W===r.SHORT&&(ht=r.RGBA16I),W===r.INT&&(ht=r.RGBA32I)),E===r.RGB&&(W===r.UNSIGNED_INT_5_9_9_9_REV&&(ht=r.RGB9_E5),W===r.UNSIGNED_INT_10F_11F_11F_REV&&(ht=r.R11F_G11F_B10F)),E===r.RGBA){const Qt=St?Zc:De.getTransfer(ut);W===r.FLOAT&&(ht=r.RGBA32F),W===r.HALF_FLOAT&&(ht=r.RGBA16F),W===r.UNSIGNED_BYTE&&(ht=Qt===Xe?r.SRGB8_ALPHA8:r.RGBA8),W===r.UNSIGNED_SHORT_4_4_4_4&&(ht=r.RGBA4),W===r.UNSIGNED_SHORT_5_5_5_1&&(ht=r.RGB5_A1)}return(ht===r.R16F||ht===r.R32F||ht===r.RG16F||ht===r.RG32F||ht===r.RGBA16F||ht===r.RGBA32F)&&t.get("EXT_color_buffer_float"),ht}function w(U,E){let W;return U?E===null||E===Gi||E===Ko?W=r.DEPTH24_STENCIL8:E===zi?W=r.DEPTH32F_STENCIL8:E===jo&&(W=r.DEPTH24_STENCIL8,pe("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):E===null||E===Gi||E===Ko?W=r.DEPTH_COMPONENT24:E===zi?W=r.DEPTH_COMPONENT32F:E===jo&&(W=r.DEPTH_COMPONENT16),W}function z(U,E){return M(U)===!0||U.isFramebufferTexture&&U.minFilter!==Dn&&U.minFilter!==xn?Math.log2(Math.max(E.width,E.height))+1:U.mipmaps!==void 0&&U.mipmaps.length>0?U.mipmaps.length:U.isCompressedTexture&&Array.isArray(U.image)?E.mipmaps.length:1}function I(U){const E=U.target;E.removeEventListener("dispose",I),q(E),E.isVideoTexture&&g.delete(E)}function P(U){const E=U.target;E.removeEventListener("dispose",P),D(E)}function q(U){const E=s.get(U);if(E.__webglInit===void 0)return;const W=U.source,ut=v.get(W);if(ut){const St=ut[E.__cacheKey];St.usedTimes--,St.usedTimes===0&&C(U),Object.keys(ut).length===0&&v.delete(W)}s.remove(U)}function C(U){const E=s.get(U);r.deleteTexture(E.__webglTexture);const W=U.source,ut=v.get(W);delete ut[E.__cacheKey],f.memory.textures--}function D(U){const E=s.get(U);if(U.depthTexture&&(U.depthTexture.dispose(),s.remove(U.depthTexture)),U.isWebGLCubeRenderTarget)for(let ut=0;ut<6;ut++){if(Array.isArray(E.__webglFramebuffer[ut]))for(let St=0;St<E.__webglFramebuffer[ut].length;St++)r.deleteFramebuffer(E.__webglFramebuffer[ut][St]);else r.deleteFramebuffer(E.__webglFramebuffer[ut]);E.__webglDepthbuffer&&r.deleteRenderbuffer(E.__webglDepthbuffer[ut])}else{if(Array.isArray(E.__webglFramebuffer))for(let ut=0;ut<E.__webglFramebuffer.length;ut++)r.deleteFramebuffer(E.__webglFramebuffer[ut]);else r.deleteFramebuffer(E.__webglFramebuffer);if(E.__webglDepthbuffer&&r.deleteRenderbuffer(E.__webglDepthbuffer),E.__webglMultisampledFramebuffer&&r.deleteFramebuffer(E.__webglMultisampledFramebuffer),E.__webglColorRenderbuffer)for(let ut=0;ut<E.__webglColorRenderbuffer.length;ut++)E.__webglColorRenderbuffer[ut]&&r.deleteRenderbuffer(E.__webglColorRenderbuffer[ut]);E.__webglDepthRenderbuffer&&r.deleteRenderbuffer(E.__webglDepthRenderbuffer)}const W=U.textures;for(let ut=0,St=W.length;ut<St;ut++){const ht=s.get(W[ut]);ht.__webglTexture&&(r.deleteTexture(ht.__webglTexture),f.memory.textures--),s.remove(W[ut])}s.remove(U)}let V=0;function nt(){V=0}function it(){const U=V;return U>=l.maxTextures&&pe("WebGLTextures: Trying to use "+U+" texture units while this GPU supports only "+l.maxTextures),V+=1,U}function dt(U){const E=[];return E.push(U.wrapS),E.push(U.wrapT),E.push(U.wrapR||0),E.push(U.magFilter),E.push(U.minFilter),E.push(U.anisotropy),E.push(U.internalFormat),E.push(U.format),E.push(U.type),E.push(U.generateMipmaps),E.push(U.premultiplyAlpha),E.push(U.flipY),E.push(U.unpackAlignment),E.push(U.colorSpace),E.join()}function rt(U,E){const W=s.get(U);if(U.isVideoTexture&&Gt(U),U.isRenderTargetTexture===!1&&U.isExternalTexture!==!0&&U.version>0&&W.__version!==U.version){const ut=U.image;if(ut===null)pe("WebGLRenderer: Texture marked for update but no image data found.");else if(ut.complete===!1)pe("WebGLRenderer: Texture marked for update but image is incomplete");else{Q(W,U,E);return}}else U.isExternalTexture&&(W.__webglTexture=U.sourceTexture?U.sourceTexture:null);i.bindTexture(r.TEXTURE_2D,W.__webglTexture,r.TEXTURE0+E)}function F(U,E){const W=s.get(U);if(U.isRenderTargetTexture===!1&&U.version>0&&W.__version!==U.version){Q(W,U,E);return}else U.isExternalTexture&&(W.__webglTexture=U.sourceTexture?U.sourceTexture:null);i.bindTexture(r.TEXTURE_2D_ARRAY,W.__webglTexture,r.TEXTURE0+E)}function H(U,E){const W=s.get(U);if(U.isRenderTargetTexture===!1&&U.version>0&&W.__version!==U.version){Q(W,U,E);return}i.bindTexture(r.TEXTURE_3D,W.__webglTexture,r.TEXTURE0+E)}function $(U,E){const W=s.get(U);if(U.isCubeDepthTexture!==!0&&U.version>0&&W.__version!==U.version){ct(W,U,E);return}i.bindTexture(r.TEXTURE_CUBE_MAP,W.__webglTexture,r.TEXTURE0+E)}const yt={[nd]:r.REPEAT,[ga]:r.CLAMP_TO_EDGE,[id]:r.MIRRORED_REPEAT},xt={[Dn]:r.NEAREST,[Fy]:r.NEAREST_MIPMAP_NEAREST,[vc]:r.NEAREST_MIPMAP_LINEAR,[xn]:r.LINEAR,[uh]:r.LINEAR_MIPMAP_NEAREST,[ws]:r.LINEAR_MIPMAP_LINEAR},L={[Hy]:r.NEVER,[Wy]:r.ALWAYS,[Gy]:r.LESS,[Kd]:r.LEQUAL,[Vy]:r.EQUAL,[Jd]:r.GEQUAL,[Xy]:r.GREATER,[ky]:r.NOTEQUAL};function K(U,E){if(E.type===zi&&t.has("OES_texture_float_linear")===!1&&(E.magFilter===xn||E.magFilter===uh||E.magFilter===vc||E.magFilter===ws||E.minFilter===xn||E.minFilter===uh||E.minFilter===vc||E.minFilter===ws)&&pe("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),r.texParameteri(U,r.TEXTURE_WRAP_S,yt[E.wrapS]),r.texParameteri(U,r.TEXTURE_WRAP_T,yt[E.wrapT]),(U===r.TEXTURE_3D||U===r.TEXTURE_2D_ARRAY)&&r.texParameteri(U,r.TEXTURE_WRAP_R,yt[E.wrapR]),r.texParameteri(U,r.TEXTURE_MAG_FILTER,xt[E.magFilter]),r.texParameteri(U,r.TEXTURE_MIN_FILTER,xt[E.minFilter]),E.compareFunction&&(r.texParameteri(U,r.TEXTURE_COMPARE_MODE,r.COMPARE_REF_TO_TEXTURE),r.texParameteri(U,r.TEXTURE_COMPARE_FUNC,L[E.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(E.magFilter===Dn||E.minFilter!==vc&&E.minFilter!==ws||E.type===zi&&t.has("OES_texture_float_linear")===!1)return;if(E.anisotropy>1||s.get(E).__currentAnisotropy){const W=t.get("EXT_texture_filter_anisotropic");r.texParameterf(U,W.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(E.anisotropy,l.getMaxAnisotropy())),s.get(E).__currentAnisotropy=E.anisotropy}}}function ft(U,E){let W=!1;U.__webglInit===void 0&&(U.__webglInit=!0,E.addEventListener("dispose",I));const ut=E.source;let St=v.get(ut);St===void 0&&(St={},v.set(ut,St));const ht=dt(E);if(ht!==U.__cacheKey){St[ht]===void 0&&(St[ht]={texture:r.createTexture(),usedTimes:0},f.memory.textures++,W=!0),St[ht].usedTimes++;const Qt=St[U.__cacheKey];Qt!==void 0&&(St[U.__cacheKey].usedTimes--,Qt.usedTimes===0&&C(E)),U.__cacheKey=ht,U.__webglTexture=St[ht].texture}return W}function Et(U,E,W){return Math.floor(Math.floor(U/W)/E)}function Rt(U,E,W,ut){const ht=U.updateRanges;if(ht.length===0)i.texSubImage2D(r.TEXTURE_2D,0,0,0,E.width,E.height,W,ut,E.data);else{ht.sort((Tt,Ct)=>Tt.start-Ct.start);let Qt=0;for(let Tt=1;Tt<ht.length;Tt++){const Ct=ht[Qt],Yt=ht[Tt],Xt=Ct.start+Ct.count,Ot=Et(Yt.start,E.width,4),_e=Et(Ct.start,E.width,4);Yt.start<=Xt+1&&Ot===_e&&Et(Yt.start+Yt.count-1,E.width,4)===Ot?Ct.count=Math.max(Ct.count,Yt.start+Yt.count-Ct.start):(++Qt,ht[Qt]=Yt)}ht.length=Qt+1;const Lt=r.getParameter(r.UNPACK_ROW_LENGTH),Jt=r.getParameter(r.UNPACK_SKIP_PIXELS),le=r.getParameter(r.UNPACK_SKIP_ROWS);r.pixelStorei(r.UNPACK_ROW_LENGTH,E.width);for(let Tt=0,Ct=ht.length;Tt<Ct;Tt++){const Yt=ht[Tt],Xt=Math.floor(Yt.start/4),Ot=Math.ceil(Yt.count/4),_e=Xt%E.width,k=Math.floor(Xt/E.width),Ft=Ot,wt=1;r.pixelStorei(r.UNPACK_SKIP_PIXELS,_e),r.pixelStorei(r.UNPACK_SKIP_ROWS,k),i.texSubImage2D(r.TEXTURE_2D,0,_e,k,Ft,wt,W,ut,E.data)}U.clearUpdateRanges(),r.pixelStorei(r.UNPACK_ROW_LENGTH,Lt),r.pixelStorei(r.UNPACK_SKIP_PIXELS,Jt),r.pixelStorei(r.UNPACK_SKIP_ROWS,le)}}function Q(U,E,W){let ut=r.TEXTURE_2D;(E.isDataArrayTexture||E.isCompressedArrayTexture)&&(ut=r.TEXTURE_2D_ARRAY),E.isData3DTexture&&(ut=r.TEXTURE_3D);const St=ft(U,E),ht=E.source;i.bindTexture(ut,U.__webglTexture,r.TEXTURE0+W);const Qt=s.get(ht);if(ht.version!==Qt.__version||St===!0){i.activeTexture(r.TEXTURE0+W);const Lt=De.getPrimaries(De.workingColorSpace),Jt=E.colorSpace===$a?null:De.getPrimaries(E.colorSpace),le=E.colorSpace===$a||Lt===Jt?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,E.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,E.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,le);let Tt=R(E.image,!1,l.maxTextureSize);Tt=ae(E,Tt);const Ct=c.convert(E.format,E.colorSpace),Yt=c.convert(E.type);let Xt=N(E.internalFormat,Ct,Yt,E.colorSpace,E.isVideoTexture);K(ut,E);let Ot;const _e=E.mipmaps,k=E.isVideoTexture!==!0,Ft=Qt.__version===void 0||St===!0,wt=ht.dataReady,kt=z(E,Tt);if(E.isDepthTexture)Xt=w(E.format===Ds,E.type),Ft&&(k?i.texStorage2D(r.TEXTURE_2D,1,Xt,Tt.width,Tt.height):i.texImage2D(r.TEXTURE_2D,0,Xt,Tt.width,Tt.height,0,Ct,Yt,null));else if(E.isDataTexture)if(_e.length>0){k&&Ft&&i.texStorage2D(r.TEXTURE_2D,kt,Xt,_e[0].width,_e[0].height);for(let bt=0,vt=_e.length;bt<vt;bt++)Ot=_e[bt],k?wt&&i.texSubImage2D(r.TEXTURE_2D,bt,0,0,Ot.width,Ot.height,Ct,Yt,Ot.data):i.texImage2D(r.TEXTURE_2D,bt,Xt,Ot.width,Ot.height,0,Ct,Yt,Ot.data);E.generateMipmaps=!1}else k?(Ft&&i.texStorage2D(r.TEXTURE_2D,kt,Xt,Tt.width,Tt.height),wt&&Rt(E,Tt,Ct,Yt)):i.texImage2D(r.TEXTURE_2D,0,Xt,Tt.width,Tt.height,0,Ct,Yt,Tt.data);else if(E.isCompressedTexture)if(E.isCompressedArrayTexture){k&&Ft&&i.texStorage3D(r.TEXTURE_2D_ARRAY,kt,Xt,_e[0].width,_e[0].height,Tt.depth);for(let bt=0,vt=_e.length;bt<vt;bt++)if(Ot=_e[bt],E.format!==Ai)if(Ct!==null)if(k){if(wt)if(E.layerUpdates.size>0){const Nt=C_(Ot.width,Ot.height,E.format,E.type);for(const he of E.layerUpdates){const Ie=Ot.data.subarray(he*Nt/Ot.data.BYTES_PER_ELEMENT,(he+1)*Nt/Ot.data.BYTES_PER_ELEMENT);i.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,bt,0,0,he,Ot.width,Ot.height,1,Ct,Ie)}E.clearLayerUpdates()}else i.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,bt,0,0,0,Ot.width,Ot.height,Tt.depth,Ct,Ot.data)}else i.compressedTexImage3D(r.TEXTURE_2D_ARRAY,bt,Xt,Ot.width,Ot.height,Tt.depth,0,Ot.data,0,0);else pe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else k?wt&&i.texSubImage3D(r.TEXTURE_2D_ARRAY,bt,0,0,0,Ot.width,Ot.height,Tt.depth,Ct,Yt,Ot.data):i.texImage3D(r.TEXTURE_2D_ARRAY,bt,Xt,Ot.width,Ot.height,Tt.depth,0,Ct,Yt,Ot.data)}else{k&&Ft&&i.texStorage2D(r.TEXTURE_2D,kt,Xt,_e[0].width,_e[0].height);for(let bt=0,vt=_e.length;bt<vt;bt++)Ot=_e[bt],E.format!==Ai?Ct!==null?k?wt&&i.compressedTexSubImage2D(r.TEXTURE_2D,bt,0,0,Ot.width,Ot.height,Ct,Ot.data):i.compressedTexImage2D(r.TEXTURE_2D,bt,Xt,Ot.width,Ot.height,0,Ot.data):pe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):k?wt&&i.texSubImage2D(r.TEXTURE_2D,bt,0,0,Ot.width,Ot.height,Ct,Yt,Ot.data):i.texImage2D(r.TEXTURE_2D,bt,Xt,Ot.width,Ot.height,0,Ct,Yt,Ot.data)}else if(E.isDataArrayTexture)if(k){if(Ft&&i.texStorage3D(r.TEXTURE_2D_ARRAY,kt,Xt,Tt.width,Tt.height,Tt.depth),wt)if(E.layerUpdates.size>0){const bt=C_(Tt.width,Tt.height,E.format,E.type);for(const vt of E.layerUpdates){const Nt=Tt.data.subarray(vt*bt/Tt.data.BYTES_PER_ELEMENT,(vt+1)*bt/Tt.data.BYTES_PER_ELEMENT);i.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,vt,Tt.width,Tt.height,1,Ct,Yt,Nt)}E.clearLayerUpdates()}else i.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,0,Tt.width,Tt.height,Tt.depth,Ct,Yt,Tt.data)}else i.texImage3D(r.TEXTURE_2D_ARRAY,0,Xt,Tt.width,Tt.height,Tt.depth,0,Ct,Yt,Tt.data);else if(E.isData3DTexture)k?(Ft&&i.texStorage3D(r.TEXTURE_3D,kt,Xt,Tt.width,Tt.height,Tt.depth),wt&&i.texSubImage3D(r.TEXTURE_3D,0,0,0,0,Tt.width,Tt.height,Tt.depth,Ct,Yt,Tt.data)):i.texImage3D(r.TEXTURE_3D,0,Xt,Tt.width,Tt.height,Tt.depth,0,Ct,Yt,Tt.data);else if(E.isFramebufferTexture){if(Ft)if(k)i.texStorage2D(r.TEXTURE_2D,kt,Xt,Tt.width,Tt.height);else{let bt=Tt.width,vt=Tt.height;for(let Nt=0;Nt<kt;Nt++)i.texImage2D(r.TEXTURE_2D,Nt,Xt,bt,vt,0,Ct,Yt,null),bt>>=1,vt>>=1}}else if(_e.length>0){if(k&&Ft){const bt=Ut(_e[0]);i.texStorage2D(r.TEXTURE_2D,kt,Xt,bt.width,bt.height)}for(let bt=0,vt=_e.length;bt<vt;bt++)Ot=_e[bt],k?wt&&i.texSubImage2D(r.TEXTURE_2D,bt,0,0,Ct,Yt,Ot):i.texImage2D(r.TEXTURE_2D,bt,Xt,Ct,Yt,Ot);E.generateMipmaps=!1}else if(k){if(Ft){const bt=Ut(Tt);i.texStorage2D(r.TEXTURE_2D,kt,Xt,bt.width,bt.height)}wt&&i.texSubImage2D(r.TEXTURE_2D,0,0,0,Ct,Yt,Tt)}else i.texImage2D(r.TEXTURE_2D,0,Xt,Ct,Yt,Tt);M(E)&&S(ut),Qt.__version=ht.version,E.onUpdate&&E.onUpdate(E)}U.__version=E.version}function ct(U,E,W){if(E.image.length!==6)return;const ut=ft(U,E),St=E.source;i.bindTexture(r.TEXTURE_CUBE_MAP,U.__webglTexture,r.TEXTURE0+W);const ht=s.get(St);if(St.version!==ht.__version||ut===!0){i.activeTexture(r.TEXTURE0+W);const Qt=De.getPrimaries(De.workingColorSpace),Lt=E.colorSpace===$a?null:De.getPrimaries(E.colorSpace),Jt=E.colorSpace===$a||Qt===Lt?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,E.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,E.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,Jt);const le=E.isCompressedTexture||E.image[0].isCompressedTexture,Tt=E.image[0]&&E.image[0].isDataTexture,Ct=[];for(let vt=0;vt<6;vt++)!le&&!Tt?Ct[vt]=R(E.image[vt],!0,l.maxCubemapSize):Ct[vt]=Tt?E.image[vt].image:E.image[vt],Ct[vt]=ae(E,Ct[vt]);const Yt=Ct[0],Xt=c.convert(E.format,E.colorSpace),Ot=c.convert(E.type),_e=N(E.internalFormat,Xt,Ot,E.colorSpace),k=E.isVideoTexture!==!0,Ft=ht.__version===void 0||ut===!0,wt=St.dataReady;let kt=z(E,Yt);K(r.TEXTURE_CUBE_MAP,E);let bt;if(le){k&&Ft&&i.texStorage2D(r.TEXTURE_CUBE_MAP,kt,_e,Yt.width,Yt.height);for(let vt=0;vt<6;vt++){bt=Ct[vt].mipmaps;for(let Nt=0;Nt<bt.length;Nt++){const he=bt[Nt];E.format!==Ai?Xt!==null?k?wt&&i.compressedTexSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+vt,Nt,0,0,he.width,he.height,Xt,he.data):i.compressedTexImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+vt,Nt,_e,he.width,he.height,0,he.data):pe("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):k?wt&&i.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+vt,Nt,0,0,he.width,he.height,Xt,Ot,he.data):i.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+vt,Nt,_e,he.width,he.height,0,Xt,Ot,he.data)}}}else{if(bt=E.mipmaps,k&&Ft){bt.length>0&&kt++;const vt=Ut(Ct[0]);i.texStorage2D(r.TEXTURE_CUBE_MAP,kt,_e,vt.width,vt.height)}for(let vt=0;vt<6;vt++)if(Tt){k?wt&&i.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+vt,0,0,0,Ct[vt].width,Ct[vt].height,Xt,Ot,Ct[vt].data):i.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+vt,0,_e,Ct[vt].width,Ct[vt].height,0,Xt,Ot,Ct[vt].data);for(let Nt=0;Nt<bt.length;Nt++){const Ie=bt[Nt].image[vt].image;k?wt&&i.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+vt,Nt+1,0,0,Ie.width,Ie.height,Xt,Ot,Ie.data):i.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+vt,Nt+1,_e,Ie.width,Ie.height,0,Xt,Ot,Ie.data)}}else{k?wt&&i.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+vt,0,0,0,Xt,Ot,Ct[vt]):i.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+vt,0,_e,Xt,Ot,Ct[vt]);for(let Nt=0;Nt<bt.length;Nt++){const he=bt[Nt];k?wt&&i.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+vt,Nt+1,0,0,Xt,Ot,he.image[vt]):i.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+vt,Nt+1,_e,Xt,Ot,he.image[vt])}}}M(E)&&S(r.TEXTURE_CUBE_MAP),ht.__version=St.version,E.onUpdate&&E.onUpdate(E)}U.__version=E.version}function Dt(U,E,W,ut,St,ht){const Qt=c.convert(W.format,W.colorSpace),Lt=c.convert(W.type),Jt=N(W.internalFormat,Qt,Lt,W.colorSpace),le=s.get(E),Tt=s.get(W);if(Tt.__renderTarget=E,!le.__hasExternalTextures){const Ct=Math.max(1,E.width>>ht),Yt=Math.max(1,E.height>>ht);St===r.TEXTURE_3D||St===r.TEXTURE_2D_ARRAY?i.texImage3D(St,ht,Jt,Ct,Yt,E.depth,0,Qt,Lt,null):i.texImage2D(St,ht,Jt,Ct,Yt,0,Qt,Lt,null)}i.bindFramebuffer(r.FRAMEBUFFER,U),ne(E)?d.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,ut,St,Tt.__webglTexture,0,O(E)):(St===r.TEXTURE_2D||St>=r.TEXTURE_CUBE_MAP_POSITIVE_X&&St<=r.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&r.framebufferTexture2D(r.FRAMEBUFFER,ut,St,Tt.__webglTexture,ht),i.bindFramebuffer(r.FRAMEBUFFER,null)}function Vt(U,E,W){if(r.bindRenderbuffer(r.RENDERBUFFER,U),E.depthBuffer){const ut=E.depthTexture,St=ut&&ut.isDepthTexture?ut.type:null,ht=w(E.stencilBuffer,St),Qt=E.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;ne(E)?d.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,O(E),ht,E.width,E.height):W?r.renderbufferStorageMultisample(r.RENDERBUFFER,O(E),ht,E.width,E.height):r.renderbufferStorage(r.RENDERBUFFER,ht,E.width,E.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,Qt,r.RENDERBUFFER,U)}else{const ut=E.textures;for(let St=0;St<ut.length;St++){const ht=ut[St],Qt=c.convert(ht.format,ht.colorSpace),Lt=c.convert(ht.type),Jt=N(ht.internalFormat,Qt,Lt,ht.colorSpace);ne(E)?d.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,O(E),Jt,E.width,E.height):W?r.renderbufferStorageMultisample(r.RENDERBUFFER,O(E),Jt,E.width,E.height):r.renderbufferStorage(r.RENDERBUFFER,Jt,E.width,E.height)}}r.bindRenderbuffer(r.RENDERBUFFER,null)}function qt(U,E,W){const ut=E.isWebGLCubeRenderTarget===!0;if(i.bindFramebuffer(r.FRAMEBUFFER,U),!(E.depthTexture&&E.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const St=s.get(E.depthTexture);if(St.__renderTarget=E,(!St.__webglTexture||E.depthTexture.image.width!==E.width||E.depthTexture.image.height!==E.height)&&(E.depthTexture.image.width=E.width,E.depthTexture.image.height=E.height,E.depthTexture.needsUpdate=!0),ut){if(St.__webglInit===void 0&&(St.__webglInit=!0,E.depthTexture.addEventListener("dispose",I)),St.__webglTexture===void 0){St.__webglTexture=r.createTexture(),i.bindTexture(r.TEXTURE_CUBE_MAP,St.__webglTexture),K(r.TEXTURE_CUBE_MAP,E.depthTexture);const le=c.convert(E.depthTexture.format),Tt=c.convert(E.depthTexture.type);let Ct;E.depthTexture.format===Sa?Ct=r.DEPTH_COMPONENT24:E.depthTexture.format===Ds&&(Ct=r.DEPTH24_STENCIL8);for(let Yt=0;Yt<6;Yt++)r.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Yt,0,Ct,E.width,E.height,0,le,Tt,null)}}else rt(E.depthTexture,0);const ht=St.__webglTexture,Qt=O(E),Lt=ut?r.TEXTURE_CUBE_MAP_POSITIVE_X+W:r.TEXTURE_2D,Jt=E.depthTexture.format===Ds?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;if(E.depthTexture.format===Sa)ne(E)?d.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,Jt,Lt,ht,0,Qt):r.framebufferTexture2D(r.FRAMEBUFFER,Jt,Lt,ht,0);else if(E.depthTexture.format===Ds)ne(E)?d.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,Jt,Lt,ht,0,Qt):r.framebufferTexture2D(r.FRAMEBUFFER,Jt,Lt,ht,0);else throw new Error("Unknown depthTexture format")}function ye(U){const E=s.get(U),W=U.isWebGLCubeRenderTarget===!0;if(E.__boundDepthTexture!==U.depthTexture){const ut=U.depthTexture;if(E.__depthDisposeCallback&&E.__depthDisposeCallback(),ut){const St=()=>{delete E.__boundDepthTexture,delete E.__depthDisposeCallback,ut.removeEventListener("dispose",St)};ut.addEventListener("dispose",St),E.__depthDisposeCallback=St}E.__boundDepthTexture=ut}if(U.depthTexture&&!E.__autoAllocateDepthBuffer)if(W)for(let ut=0;ut<6;ut++)qt(E.__webglFramebuffer[ut],U,ut);else{const ut=U.texture.mipmaps;ut&&ut.length>0?qt(E.__webglFramebuffer[0],U,0):qt(E.__webglFramebuffer,U,0)}else if(W){E.__webglDepthbuffer=[];for(let ut=0;ut<6;ut++)if(i.bindFramebuffer(r.FRAMEBUFFER,E.__webglFramebuffer[ut]),E.__webglDepthbuffer[ut]===void 0)E.__webglDepthbuffer[ut]=r.createRenderbuffer(),Vt(E.__webglDepthbuffer[ut],U,!1);else{const St=U.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,ht=E.__webglDepthbuffer[ut];r.bindRenderbuffer(r.RENDERBUFFER,ht),r.framebufferRenderbuffer(r.FRAMEBUFFER,St,r.RENDERBUFFER,ht)}}else{const ut=U.texture.mipmaps;if(ut&&ut.length>0?i.bindFramebuffer(r.FRAMEBUFFER,E.__webglFramebuffer[0]):i.bindFramebuffer(r.FRAMEBUFFER,E.__webglFramebuffer),E.__webglDepthbuffer===void 0)E.__webglDepthbuffer=r.createRenderbuffer(),Vt(E.__webglDepthbuffer,U,!1);else{const St=U.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,ht=E.__webglDepthbuffer;r.bindRenderbuffer(r.RENDERBUFFER,ht),r.framebufferRenderbuffer(r.FRAMEBUFFER,St,r.RENDERBUFFER,ht)}}i.bindFramebuffer(r.FRAMEBUFFER,null)}function Ue(U,E,W){const ut=s.get(U);E!==void 0&&Dt(ut.__webglFramebuffer,U,U.texture,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,0),W!==void 0&&ye(U)}function fe(U){const E=U.texture,W=s.get(U),ut=s.get(E);U.addEventListener("dispose",P);const St=U.textures,ht=U.isWebGLCubeRenderTarget===!0,Qt=St.length>1;if(Qt||(ut.__webglTexture===void 0&&(ut.__webglTexture=r.createTexture()),ut.__version=E.version,f.memory.textures++),ht){W.__webglFramebuffer=[];for(let Lt=0;Lt<6;Lt++)if(E.mipmaps&&E.mipmaps.length>0){W.__webglFramebuffer[Lt]=[];for(let Jt=0;Jt<E.mipmaps.length;Jt++)W.__webglFramebuffer[Lt][Jt]=r.createFramebuffer()}else W.__webglFramebuffer[Lt]=r.createFramebuffer()}else{if(E.mipmaps&&E.mipmaps.length>0){W.__webglFramebuffer=[];for(let Lt=0;Lt<E.mipmaps.length;Lt++)W.__webglFramebuffer[Lt]=r.createFramebuffer()}else W.__webglFramebuffer=r.createFramebuffer();if(Qt)for(let Lt=0,Jt=St.length;Lt<Jt;Lt++){const le=s.get(St[Lt]);le.__webglTexture===void 0&&(le.__webglTexture=r.createTexture(),f.memory.textures++)}if(U.samples>0&&ne(U)===!1){W.__webglMultisampledFramebuffer=r.createFramebuffer(),W.__webglColorRenderbuffer=[],i.bindFramebuffer(r.FRAMEBUFFER,W.__webglMultisampledFramebuffer);for(let Lt=0;Lt<St.length;Lt++){const Jt=St[Lt];W.__webglColorRenderbuffer[Lt]=r.createRenderbuffer(),r.bindRenderbuffer(r.RENDERBUFFER,W.__webglColorRenderbuffer[Lt]);const le=c.convert(Jt.format,Jt.colorSpace),Tt=c.convert(Jt.type),Ct=N(Jt.internalFormat,le,Tt,Jt.colorSpace,U.isXRRenderTarget===!0),Yt=O(U);r.renderbufferStorageMultisample(r.RENDERBUFFER,Yt,Ct,U.width,U.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+Lt,r.RENDERBUFFER,W.__webglColorRenderbuffer[Lt])}r.bindRenderbuffer(r.RENDERBUFFER,null),U.depthBuffer&&(W.__webglDepthRenderbuffer=r.createRenderbuffer(),Vt(W.__webglDepthRenderbuffer,U,!0)),i.bindFramebuffer(r.FRAMEBUFFER,null)}}if(ht){i.bindTexture(r.TEXTURE_CUBE_MAP,ut.__webglTexture),K(r.TEXTURE_CUBE_MAP,E);for(let Lt=0;Lt<6;Lt++)if(E.mipmaps&&E.mipmaps.length>0)for(let Jt=0;Jt<E.mipmaps.length;Jt++)Dt(W.__webglFramebuffer[Lt][Jt],U,E,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+Lt,Jt);else Dt(W.__webglFramebuffer[Lt],U,E,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+Lt,0);M(E)&&S(r.TEXTURE_CUBE_MAP),i.unbindTexture()}else if(Qt){for(let Lt=0,Jt=St.length;Lt<Jt;Lt++){const le=St[Lt],Tt=s.get(le);let Ct=r.TEXTURE_2D;(U.isWebGL3DRenderTarget||U.isWebGLArrayRenderTarget)&&(Ct=U.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),i.bindTexture(Ct,Tt.__webglTexture),K(Ct,le),Dt(W.__webglFramebuffer,U,le,r.COLOR_ATTACHMENT0+Lt,Ct,0),M(le)&&S(Ct)}i.unbindTexture()}else{let Lt=r.TEXTURE_2D;if((U.isWebGL3DRenderTarget||U.isWebGLArrayRenderTarget)&&(Lt=U.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),i.bindTexture(Lt,ut.__webglTexture),K(Lt,E),E.mipmaps&&E.mipmaps.length>0)for(let Jt=0;Jt<E.mipmaps.length;Jt++)Dt(W.__webglFramebuffer[Jt],U,E,r.COLOR_ATTACHMENT0,Lt,Jt);else Dt(W.__webglFramebuffer,U,E,r.COLOR_ATTACHMENT0,Lt,0);M(E)&&S(Lt),i.unbindTexture()}U.depthBuffer&&ye(U)}function gt(U){const E=U.textures;for(let W=0,ut=E.length;W<ut;W++){const St=E[W];if(M(St)){const ht=B(U),Qt=s.get(St).__webglTexture;i.bindTexture(ht,Qt),S(ht),i.unbindTexture()}}}const At=[],Mt=[];function Bt(U){if(U.samples>0){if(ne(U)===!1){const E=U.textures,W=U.width,ut=U.height;let St=r.COLOR_BUFFER_BIT;const ht=U.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,Qt=s.get(U),Lt=E.length>1;if(Lt)for(let le=0;le<E.length;le++)i.bindFramebuffer(r.FRAMEBUFFER,Qt.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+le,r.RENDERBUFFER,null),i.bindFramebuffer(r.FRAMEBUFFER,Qt.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+le,r.TEXTURE_2D,null,0);i.bindFramebuffer(r.READ_FRAMEBUFFER,Qt.__webglMultisampledFramebuffer);const Jt=U.texture.mipmaps;Jt&&Jt.length>0?i.bindFramebuffer(r.DRAW_FRAMEBUFFER,Qt.__webglFramebuffer[0]):i.bindFramebuffer(r.DRAW_FRAMEBUFFER,Qt.__webglFramebuffer);for(let le=0;le<E.length;le++){if(U.resolveDepthBuffer&&(U.depthBuffer&&(St|=r.DEPTH_BUFFER_BIT),U.stencilBuffer&&U.resolveStencilBuffer&&(St|=r.STENCIL_BUFFER_BIT)),Lt){r.framebufferRenderbuffer(r.READ_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.RENDERBUFFER,Qt.__webglColorRenderbuffer[le]);const Tt=s.get(E[le]).__webglTexture;r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,Tt,0)}r.blitFramebuffer(0,0,W,ut,0,0,W,ut,St,r.NEAREST),m===!0&&(At.length=0,Mt.length=0,At.push(r.COLOR_ATTACHMENT0+le),U.depthBuffer&&U.resolveDepthBuffer===!1&&(At.push(ht),Mt.push(ht),r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,Mt)),r.invalidateFramebuffer(r.READ_FRAMEBUFFER,At))}if(i.bindFramebuffer(r.READ_FRAMEBUFFER,null),i.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),Lt)for(let le=0;le<E.length;le++){i.bindFramebuffer(r.FRAMEBUFFER,Qt.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+le,r.RENDERBUFFER,Qt.__webglColorRenderbuffer[le]);const Tt=s.get(E[le]).__webglTexture;i.bindFramebuffer(r.FRAMEBUFFER,Qt.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+le,r.TEXTURE_2D,Tt,0)}i.bindFramebuffer(r.DRAW_FRAMEBUFFER,Qt.__webglMultisampledFramebuffer)}else if(U.depthBuffer&&U.resolveDepthBuffer===!1&&m){const E=U.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,[E])}}}function O(U){return Math.min(l.maxSamples,U.samples)}function ne(U){const E=s.get(U);return U.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&E.__useRenderToTexture!==!1}function Gt(U){const E=f.render.frame;g.get(U)!==E&&(g.set(U,E),U.update())}function ae(U,E){const W=U.colorSpace,ut=U.format,St=U.type;return U.isCompressedTexture===!0||U.isVideoTexture===!0||W!==zr&&W!==$a&&(De.getTransfer(W)===Xe?(ut!==Ai||St!==ii)&&pe("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):we("WebGLTextures: Unsupported texture color space:",W)),E}function Ut(U){return typeof HTMLImageElement<"u"&&U instanceof HTMLImageElement?(p.width=U.naturalWidth||U.width,p.height=U.naturalHeight||U.height):typeof VideoFrame<"u"&&U instanceof VideoFrame?(p.width=U.displayWidth,p.height=U.displayHeight):(p.width=U.width,p.height=U.height),p}this.allocateTextureUnit=it,this.resetTextureUnits=nt,this.setTexture2D=rt,this.setTexture2DArray=F,this.setTexture3D=H,this.setTextureCube=$,this.rebindTextures=Ue,this.setupRenderTarget=fe,this.updateRenderTargetMipmap=gt,this.updateMultisampleRenderTarget=Bt,this.setupDepthRenderbuffer=ye,this.setupFrameBufferTexture=Dt,this.useMultisampledRTT=ne,this.isReversedDepthBuffer=function(){return i.buffers.depth.getReversed()}}function $A(r,t){function i(s,l=$a){let c;const f=De.getTransfer(l);if(s===ii)return r.UNSIGNED_BYTE;if(s===Wd)return r.UNSIGNED_SHORT_4_4_4_4;if(s===qd)return r.UNSIGNED_SHORT_5_5_5_1;if(s===hv)return r.UNSIGNED_INT_5_9_9_9_REV;if(s===dv)return r.UNSIGNED_INT_10F_11F_11F_REV;if(s===uv)return r.BYTE;if(s===fv)return r.SHORT;if(s===jo)return r.UNSIGNED_SHORT;if(s===kd)return r.INT;if(s===Gi)return r.UNSIGNED_INT;if(s===zi)return r.FLOAT;if(s===xa)return r.HALF_FLOAT;if(s===pv)return r.ALPHA;if(s===mv)return r.RGB;if(s===Ai)return r.RGBA;if(s===Sa)return r.DEPTH_COMPONENT;if(s===Ds)return r.DEPTH_STENCIL;if(s===gv)return r.RED;if(s===Yd)return r.RED_INTEGER;if(s===Pr)return r.RG;if(s===Zd)return r.RG_INTEGER;if(s===jd)return r.RGBA_INTEGER;if(s===Xc||s===kc||s===Wc||s===qc)if(f===Xe)if(c=t.get("WEBGL_compressed_texture_s3tc_srgb"),c!==null){if(s===Xc)return c.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(s===kc)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(s===Wc)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(s===qc)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(c=t.get("WEBGL_compressed_texture_s3tc"),c!==null){if(s===Xc)return c.COMPRESSED_RGB_S3TC_DXT1_EXT;if(s===kc)return c.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(s===Wc)return c.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(s===qc)return c.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(s===ad||s===sd||s===rd||s===od)if(c=t.get("WEBGL_compressed_texture_pvrtc"),c!==null){if(s===ad)return c.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(s===sd)return c.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(s===rd)return c.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(s===od)return c.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(s===ld||s===cd||s===ud||s===fd||s===hd||s===dd||s===pd)if(c=t.get("WEBGL_compressed_texture_etc"),c!==null){if(s===ld||s===cd)return f===Xe?c.COMPRESSED_SRGB8_ETC2:c.COMPRESSED_RGB8_ETC2;if(s===ud)return f===Xe?c.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:c.COMPRESSED_RGBA8_ETC2_EAC;if(s===fd)return c.COMPRESSED_R11_EAC;if(s===hd)return c.COMPRESSED_SIGNED_R11_EAC;if(s===dd)return c.COMPRESSED_RG11_EAC;if(s===pd)return c.COMPRESSED_SIGNED_RG11_EAC}else return null;if(s===md||s===gd||s===_d||s===vd||s===xd||s===Sd||s===yd||s===Md||s===Ed||s===Td||s===bd||s===Ad||s===Rd||s===Cd)if(c=t.get("WEBGL_compressed_texture_astc"),c!==null){if(s===md)return f===Xe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:c.COMPRESSED_RGBA_ASTC_4x4_KHR;if(s===gd)return f===Xe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:c.COMPRESSED_RGBA_ASTC_5x4_KHR;if(s===_d)return f===Xe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:c.COMPRESSED_RGBA_ASTC_5x5_KHR;if(s===vd)return f===Xe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:c.COMPRESSED_RGBA_ASTC_6x5_KHR;if(s===xd)return f===Xe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:c.COMPRESSED_RGBA_ASTC_6x6_KHR;if(s===Sd)return f===Xe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:c.COMPRESSED_RGBA_ASTC_8x5_KHR;if(s===yd)return f===Xe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:c.COMPRESSED_RGBA_ASTC_8x6_KHR;if(s===Md)return f===Xe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:c.COMPRESSED_RGBA_ASTC_8x8_KHR;if(s===Ed)return f===Xe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:c.COMPRESSED_RGBA_ASTC_10x5_KHR;if(s===Td)return f===Xe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:c.COMPRESSED_RGBA_ASTC_10x6_KHR;if(s===bd)return f===Xe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:c.COMPRESSED_RGBA_ASTC_10x8_KHR;if(s===Ad)return f===Xe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:c.COMPRESSED_RGBA_ASTC_10x10_KHR;if(s===Rd)return f===Xe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:c.COMPRESSED_RGBA_ASTC_12x10_KHR;if(s===Cd)return f===Xe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:c.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(s===wd||s===Dd||s===Ud)if(c=t.get("EXT_texture_compression_bptc"),c!==null){if(s===wd)return f===Xe?c.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:c.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(s===Dd)return c.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(s===Ud)return c.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(s===Nd||s===Ld||s===Od||s===Pd)if(c=t.get("EXT_texture_compression_rgtc"),c!==null){if(s===Nd)return c.COMPRESSED_RED_RGTC1_EXT;if(s===Ld)return c.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(s===Od)return c.COMPRESSED_RED_GREEN_RGTC2_EXT;if(s===Pd)return c.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return s===Ko?r.UNSIGNED_INT_24_8:r[s]!==void 0?r[s]:null}return{convert:i}}const tR=`
void main() {
...
}`;class nR{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,i){if(this.texture===null){const s=new Cv(t.texture);(t.depthNear!==i.depthNear||t.depthFar!==i.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=s}}getMesh(t){if(this.texture!==null&&this.mesh===null){const i=t.cameras[0].viewport,s=new Xi({vertexShader:tR,fragmentShader:eR,uniforms:{depthColor:{value:this.texture},depthWidth:{value:i.z},depthHeight:{value:i.w}}});this.mesh=new Ci(new rl(20,20),s)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class iR extends Ir{constructor(t,i){super();const s=this;let l=null,c=1,f=null,d="local-floor",m=1,p=null,g=null,_=null,v=null,y=null,T=null;const R=typeof XRWebGLBinding<"u",M=new nR,S={},B=i.getContextAttributes();let N=null,w=null;const z=[],I=[],P=new Wt;let q=null;const C=new mi;C.viewport=new an;const D=new mi;D.viewport=new an;const V=[C,D],nt=new dE;let it=null,dt=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Q){let ct=z[Q];return ct===void 0&&(ct=new Lh,z[Q]=ct),ct.getTargetRaySpace()},this.getControllerGrip=function(Q){let ct=z[Q];return ct===void 0&&(ct=new Lh,z[Q]=ct),ct.getGripSpace()},this.getHand=function(Q){let ct=z[Q];return ct===void 0&&(ct=new Lh,z[Q]=ct),ct.getHandSpace()};function rt(Q){const ct=I.indexOf(Q.inputSource);if(ct===-1)return;const Dt=z[ct];Dt!==void 0&&(Dt.update(Q.inputSource,Q.frame,p||f),Dt.dispatchEvent({type:Q.type,data:Q.inputSource}))}function F(){l.removeEventListener("select",rt),l.removeEventListener("selectstart",rt),l.removeEventListener("selectend",rt),l.removeEventListener("squeeze",rt),l.removeEventListener("squeezestart",rt),l.removeEventListener("squeezeend",rt),l.removeEventListener("end",F),l.removeEventListener("inputsourceschange",H);for(let Q=0;Q<z.length;Q++){const ct=I[Q];ct!==null&&(I[Q]=null,z[Q].disconnect(ct))}it=null,dt=null,M.reset();for(const Q in S)delete S[Q];t.setRenderTarget(N),y=null,v=null,_=null,l=null,w=null,Rt.stop(),s.isPresenting=!1,t.setPixelRatio(q),t.setSize(P.width,P.height,!1),s.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Q){c=Q,s.isPresenting===!0&&pe("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Q){d=Q,s.isPresenting===!0&&pe("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return p||f},this.setReferenceSpace=function(Q){p=Q},this.getBaseLayer=function(){return v!==null?v:y},this.getBinding=function(){return _===null&&R&&(_=new XRWebGLBinding(l,i)),_},this.getFrame=function(){return T},this.getSession=function(){return l},this.setSession=async function(Q){if(l=Q,l!==null){if(N=t.getRenderTarget(),l.addEventListener("select",rt),l.addEventListener("selectstart",rt),l.addEventListener("selectend",rt),l.addEventListener("squeeze",rt),l.addEventListener("squeezestart",rt),l.addEventListener("squeezeend",rt),l.addEventListener("end",F),l.addEventListener("inputsourceschange",H),B.xrCompatible!==!0&&await i.makeXRCompatible(),q=t.getPixelRatio(),t.getSize(P),R&&"createProjectionLayer"in XRWebGLBinding.prototype){let Dt=null,Vt=null,qt=null;B.depth&&(qt=B.stencil?i.DEPTH24_STENCIL8:i.DEPTH_COMPONENT24,Dt=B.stencil?Ds:Sa,Vt=B.stencil?Ko:Gi);const ye={colorFormat:i.RGBA8,depthFormat:qt,scaleFactor:c};_=this.getBinding(),v=_.createProjectionLayer(ye),l.updateRenderState({layers:[v]}),t.setPixelRatio(1),t.setSize(v.textureWidth,v.textureHeight,!1),w=new Ii(v.textureWidth,v.textureHeight,{format:Ai,type:ii,depthTexture:new Qo(v.textureWidth,v.textureHeight,Vt,void 0,void 0,void 0,void 0,void 0,void 0,Dt),stencilBuffer:B.stencil,colorSpace:t.outputColorSpace,samples:B.antialias?4:0,resolveDepthBuffer:v.ignoreDepthValues===!1,resolveStencilBuffer:v.ignoreDepthValues===!1})}else{const Dt={antialias:B.antialias,alpha:!0,depth:B.depth,stencil:B.stencil,framebufferScaleFactor:c};y=new XRWebGLLayer(l,i,Dt),l.updateRenderState({baseLayer:y}),t.setPixelRatio(1),t.setSize(y.framebufferWidth,y.framebufferHeight,!1),w=new Ii(y.framebufferWidth,y.framebufferHeight,{format:Ai,type:ii,colorSpace:t.outputColorSpace,stencilBuffer:B.stencil,resolveDepthBuffer:y.ignoreDepthValues===!1,resolveStencilBuffer:y.ignoreDepthValues===!1})}w.isXRRenderTarget=!0,this.setFoveation(m),p=null,f=await l.requestReferenceSpace(d),Rt.setContext(l),Rt.start(),s.isPresenting=!0,s.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(l!==null)return l.environmentBlendMode},this.getDepthTexture=function(){return M.getDepthTexture()};function H(Q){for(let ct=0;ct<Q.removed.length;ct++){const Dt=Q.removed[ct],Vt=I.indexOf(Dt);Vt>=0&&(I[Vt]=null,z[Vt].disconnect(Dt))}for(let ct=0;ct<Q.added.length;ct++){const Dt=Q.added[ct];let Vt=I.indexOf(Dt);if(Vt===-1){for(let ye=0;ye<z.length;ye++)if(ye>=I.length){I.push(Dt),Vt=ye;break}else if(I[ye]===null){I[ye]=Dt,Vt=ye;break}if(Vt===-1)break}const qt=z[Vt];qt&&qt.connect(Dt)}}const $=new j,yt=new j;function xt(Q,ct,Dt){$.setFromMatrixPosition(ct.matrixWorld),yt.setFromMatrixPosition(Dt.matrixWorld);const Vt=$.distanceTo(yt),qt=ct.projectionMatrix.elements,ye=Dt.projectionMatrix.elements,Ue=qt[14]/(qt[10]-1),fe=qt[14]/(qt[10]+1),gt=(qt[9]+1)/qt[5],At=(qt[9]-1)/qt[5],Mt=(qt[8]-1)/qt[0],Bt=(ye[8]+1)/ye[0],O=Ue*Mt,ne=Ue*Bt,Gt=Vt/(-Mt+Bt),ae=Gt*-Mt;if(ct.matrixWorld.decompose(Q.position,Q.quaternion,Q.scale),Q.translateX(ae),Q.translateZ(Gt),Q.matrixWorld.compose(Q.position,Q.quaternion,Q.scale),Q.matrixWorldInverse.copy(Q.matrixWorld).invert(),qt[10]===-1)Q.projectionMatrix.copy(ct.projectionMatrix),Q.projectionMatrixInverse.copy(ct.projectionMatrixInverse);else{const Ut=Ue+Gt,U=fe+Gt,E=O-ae,W=ne+(Vt-ae),ut=gt*fe/U*Ut,St=At*fe/U*Ut;Q.projectionMatrix.makePerspective(E,W,ut,St,Ut,U),Q.projectionMatrixInverse.copy(Q.projectionMatrix).invert()}}function L(Q,ct){ct===null?Q.matrixWorld.copy(Q.matrix):Q.matrixWorld.multiplyMatrices(ct.matrixWorld,Q.matrix),Q.matrixWorldInverse.copy(Q.matrixWorld).invert()}this.updateCamera=function(Q){if(l===null)return;let ct=Q.near,Dt=Q.far;M.texture!==null&&(M.depthNear>0&&(ct=M.depthNear),M.depthFar>0&&(Dt=M.depthFar)),nt.near=D.near=C.near=ct,nt.far=D.far=C.far=Dt,(it!==nt.near||dt!==nt.far)&&(l.updateRenderState({depthNear:nt.near,depthFar:nt.far}),it=nt.near,dt=nt.far),nt.layers.mask=Q.layers.mask|6,C.layers.mask=nt.layers.mask&3,D.layers.mask=nt.layers.mask&5;const Vt=Q.parent,qt=nt.cameras;L(nt,Vt);for(let ye=0;ye<qt.length;ye++)L(qt[ye],Vt);qt.length===2?xt(nt,C,D):nt.projectionMatrix.copy(C.projectionMatrix),K(Q,nt,Vt)};function K(Q,ct,Dt){Dt===null?Q.matrix.copy(ct.matrixWorld):(Q.matrix.copy(Dt.matrixWorld),Q.matrix.invert(),Q.matrix.multiply(ct.matrixWorld)),Q.matrix.decompose(Q.position,Q.quaternion,Q.scale),Q.updateMatrixWorld(!0),Q.projectionMatrix.copy(ct.projectionMatrix),Q.projectionMatrixInverse.copy(ct.projectionMatrixInverse),Q.isPerspectiveCamera&&(Q.fov=zd*2*Math.atan(1/Q.projectionMatrix.elements[5]),Q.zoom=1)}this.getCamera=function(){return nt},this.getFoveation=function(){if(!(v===null&&y===null))return m},this.setFoveation=function(Q){m=Q,v!==null&&(v.fixedFoveation=Q),y!==null&&y.fixedFoveation!==void 0&&(y.fixedFoveation=Q)},this.hasDepthSensing=function(){return M.texture!==null},this.getDepthSensingMesh=function(){return M.getMesh(nt)},this.getCameraTexture=function(Q){return S[Q]};let ft=null;function Et(Q,ct){if(g=ct.getViewerPose(p||f),T=ct,g!==null){const Dt=g.views;y!==null&&(t.setRenderTargetFramebuffer(w,y.framebuffer),t.setRenderTarget(w));let Vt=!1;Dt.length!==nt.cameras.length&&(nt.cameras.length=0,Vt=!0);for(let fe=0;fe<Dt.length;fe++){const gt=Dt[fe];let At=null;if(y!==null)At=y.getViewport(gt);else{const Bt=_.getViewSubImage(v,gt);At=Bt.viewport,fe===0&&(t.setRenderTargetTextures(w,Bt.colorTexture,Bt.depthStencilTexture),t.setRenderTarget(w))}let Mt=V[fe];Mt===void 0&&(Mt=new mi,Mt.layers.enable(fe),Mt.viewport=new an,V[fe]=Mt),Mt.matrix.fromArray(gt.transform.matrix),Mt.matrix.decompose(Mt.position,Mt.quaternion,Mt.scale),Mt.projectionMatrix.fromArray(gt.projectionMatrix),Mt.projectionMatrixInverse.copy(Mt.projectionMatrix).invert(),Mt.viewport.set(At.x,At.y,At.width,At.height),fe===0&&(nt.matrix.copy(Mt.matrix),nt.matrix.decompose(nt.position,nt.quaternion,nt.scale)),Vt===!0&&nt.cameras.push(Mt)}const qt=l.enabledFeatures;if(qt&&qt.includes("depth-sensing")&&l.depthUsage=="gpu-optimized"&&R){_=s.getBinding();const fe=_.getDepthInformation(Dt[0]);fe&&fe.isValid&&fe.texture&&M.init(fe,l.renderState)}if(qt&&qt.includes("camera-access")&&R){t.state.unbindTexture(),_=s.getBinding();for(let fe=0;fe<Dt.length;fe++){const gt=Dt[fe].camera;if(gt){let At=S[gt];At||(At=new Cv,S[gt]=At);const Mt=_.getCameraImage(gt);At.sourceTexture=Mt}}}}for(let Dt=0;Dt<z.length;Dt++){const Vt=I[Dt],qt=z[Dt];Vt!==null&&qt!==void 0&&qt.update(Vt,ct,p||f)}ft&&ft(Q,ct),ct.detectedPlanes&&s.dispatchEvent({type:"planesdetected",data:ct}),T=null}const Rt=new Iv;Rt.setAnimationLoop(Et),this.setAnimationLoop=function(Q){ft=Q},this.dispose=function(){}}}const bs=new Vi,aR=new tn;function sR(r,t){function i(M,S){M.matrixAutoUpdate===!0&&M.updateMatrix(),S.value.copy(M.matrix)}function s(M,S){S.color.getRGB(M.fogColor.value,Tv(r)),S.isFog?(M.fogNear.value=S.near,M.fogFar.value=S.far):S.isFogExp2&&(M.fogDensity.value=S.density)}function l(M,S,B,N,w){S.isMeshBasicMaterial||S.isMeshLambertMaterial?c(M,S):S.isMeshToonMaterial?(c(M,S),_(M,S)):S.isMeshPhongMaterial?(c(M,S),g(M,S)):S.isMeshStandardMaterial?(c(M,S),v(M,S),S.isMeshPhysicalMaterial&&y(M,S,w)):S.isMeshMatcapMaterial?(c(M,S),T(M,S)):S.isMeshDepthMaterial?c(M,S):S.isMeshDistanceMaterial?(c(M,S),R(M,S)):S.isMeshNormalMaterial?c(M,S):S.isLineBasicMaterial?(f(M,S),S.isLineDashedMaterial&&d(M,S)):S.isPointsMaterial?m(M,S,B,N):S.isSpriteMaterial?p(M,S):S.isShadowMaterial?(M.color.value.copy(S.color),M.opacity.value=S.opacity):S.isShaderMaterial&&(S.uniformsNeedUpdate=!1)}function c(M,S){M.opacity.value=S.opacity,S.color&&M.diffuse.value.copy(S.color),S.emissive&&M.emissive.value.copy(S.emissive).multiplyScalar(S.emissiveIntensity),S.map&&(M.map.value=S.map,i(S.map,M.mapTransform)),S.alphaMap&&(M.alphaMap.value=S.alphaMap,i(S.alphaMap,M.alphaMapTransform)),S.bumpMap&&(M.bumpMap.value=S.bumpMap,i(S.bumpMap,M.bumpMapTransform),M.bumpScale.value=S.bumpScale,S.side===qn&&(M.bumpScale.value*=-1)),S.normalMap&&(M.normalMap.value=S.normalMap,i(S.normalMap,M.normalMapTransform),M.normalScale.value.copy(S.normalScale),S.side===qn&&M.normalScale.value.negate()),S.displacementMap&&(M.displacementMap.value=S.displacementMap,i(S.displacementMap,M.displacementMapTransform),M.displacementScale.value=S.displacementScale,M.displacementBias.value=S.displacementBias),S.emissiveMap&&(M.emissiveMap.value=S.emissiveMap,i(S.emissiveMap,M.emissiveMapTransform)),S.specularMap&&(M.specularMap.value=S.specularMap,i(S.specularMap,M.specularMapTransform)),S.alphaTest>0&&(M.alphaTest.value=S.alphaTest);const B=t.get(S),N=B.envMap,w=B.envMapRotation;N&&(M.envMap.value=N,bs.copy(w),bs.x*=-1,bs.y*=-1,bs.z*=-1,N.isCubeTexture&&N.isRenderTargetTexture===!1&&(bs.y*=-1,bs.z*=-1),M.envMapRotation.value.setFromMatrix4(aR.makeRotationFromEuler(bs)),M.flipEnvMap.value=N.isCubeTexture&&N.isRenderTargetTexture===!1?-1:1,M.reflectivity.value=S.reflectivity,M.ior.value=S.ior,M.refractionRatio.value=S.refractionRatio),S.lightMap&&(M.lightMap.value=S.lightMap,M.lightMapIntensity.value=S.lightMapIntensity,i(S.lightMap,M.lightMapTransform)),S.aoMap&&(M.aoMap.value=S.aoMap,M.aoMapIntensity.value=S.aoMapIntensity,i(S.aoMap,M.aoMapTransform))}function f(M,S){M.diffuse.value.copy(S.color),M.opacity.value=S.opacity,S.map&&(M.map.value=S.map,i(S.map,M.mapTransform))}function d(M,S){M.dashSize.value=S.dashSize,M.totalSize.value=S.dashSize+S.gapSize,M.scale.value=S.scale}function m(M,S,B,N){M.diffuse.value.copy(S.color),M.opacity.value=S.opacity,M.size.value=S.size*B,M.scale.value=N*.5,S.map&&(M.map.value=S.map,i(S.map,M.uvTransform)),S.alphaMap&&(M.alphaMap.value=S.alphaMap,i(S.alphaMap,M.alphaMapTransform)),S.alphaTest>0&&(M.alphaTest.value=S.alphaTest)}function p(M,S){M.diffuse.value.copy(S.color),M.opacity.value=S.opacity,M.rotation.value=S.rotation,S.map&&(M.map.value=S.map,i(S.map,M.mapTransform)),S.alphaMap&&(M.alphaMap.value=S.alphaMap,i(S.alphaMap,M.alphaMapTransform)),S.alphaTest>0&&(M.alphaTest.value=S.alphaTest)}function g(M,S){M.specular.value.copy(S.specular),M.shininess.value=Math.max(S.shininess,1e-4)}function _(M,S){S.gradientMap&&(M.gradientMap.value=S.gradientMap)}function v(M,S){M.metalness.value=S.metalness,S.metalnessMap&&(M.metalnessMap.value=S.metalnessMap,i(S.metalnessMap,M.metalnessMapTransform)),M.roughness.value=S.roughness,S.roughnessMap&&(M.roughnessMap.value=S.roughnessMap,i(S.roughnessMap,M.roughnessMapTransform)),S.envMap&&(M.envMapIntensity.value=S.envMapIntensity)}function y(M,S,B){M.ior.value=S.ior,S.sheen>0&&(M.sheenColor.value.copy(S.sheenColor).multiplyScalar(S.sheen),M.sheenRoughness.value=S.sheenRoughness,S.sheenColorMap&&(M.sheenColorMap.value=S.sheenColorMap,i(S.sheenColorMap,M.sheenColorMapTransform)),S.sheenRoughnessMap&&(M.sheenRoughnessMap.value=S.sheenRoughnessMap,i(S.sheenRoughnessMap,M.sheenRoughnessMapTransform))),S.clearcoat>0&&(M.clearcoat.value=S.clearcoat,M.clearcoatRoughness.value=S.clearcoatRoughness,S.clearcoatMap&&(M.clearcoatMap.value=S.clearcoatMap,i(S.clearcoatMap,M.clearcoatMapTransform)),S.clearcoatRoughnessMap&&(M.clearcoatRoughnessMap.value=S.clearcoatRoughnessMap,i(S.clearcoatRoughnessMap,M.clearcoatRoughnessMapTransform)),S.clearcoatNormalMap&&(M.clearcoatNormalMap.value=S.clearcoatNormalMap,i(S.clearcoatNormalMap,M.clearcoatNormalMapTransform),M.clearcoatNormalScale.value.copy(S.clearcoatNormalScale),S.side===qn&&M.clearcoatNormalScale.value.negate())),S.dispersion>0&&(M.dispersion.value=S.dispersion),S.iridescence>0&&(M.iridescence.value=S.iridescence,M.iridescenceIOR.value=S.iridescenceIOR,M.iridescenceThicknessMinimum.value=S.iridescenceThicknessRange[0],M.iridescenceThicknessMaximum.value=S.iridescenceThicknessRange[1],S.iridescenceMap&&(M.iridescenceMap.value=S.iridescenceMap,i(S.iridescenceMap,M.iridescenceMapTransform)),S.iridescenceThicknessMap&&(M.iridescenceThicknessMap.value=S.iridescenceThicknessMap,i(S.iridescenceThicknessMap,M.iridescenceThicknessMapTransform))),S.transmission>0&&(M.transmission.value=S.transmission,M.transmissionSamplerMap.value=B.texture,M.transmissionSamplerSize.value.set(B.width,B.height),S.transmissionMap&&(M.transmissionMap.value=S.transmissionMap,i(S.transmissionMap,M.transmissionMapTransform)),M.thickness.value=S.thickness,S.thicknessMap&&(M.thicknessMap.value=S.thicknessMap,i(S.thicknessMap,M.thicknessMapTransform)),M.attenuationDistance.value=S.attenuationDistance,M.attenuationColor.value.copy(S.attenuationColor)),S.anisotropy>0&&(M.anisotropyVector.value.set(S.anisotropy*Math.cos(S.anisotropyRotation),S.anisotropy*Math.sin(S.anisotropyRotation)),S.anisotropyMap&&(M.anisotropyMap.value=S.anisotropyMap,i(S.anisotropyMap,M.anisotropyMapTransform))),M.specularIntensity.value=S.specularIntensity,M.specularColor.value.copy(S.specularColor),S.specularColorMap&&(M.specularColorMap.value=S.specularColorMap,i(S.specularColorMap,M.specularColorMapTransform)),S.specularIntensityMap&&(M.specularIntensityMap.value=S.specularIntensityMap,i(S.specularIntensityMap,M.specularIntensityMapTransform))}function T(M,S){S.matcap&&(M.matcap.value=S.matcap)}function R(M,S){const B=t.get(S).light;M.referencePosition.value.setFromMatrixPosition(B.matrixWorld),M.nearDistance.value=B.shadow.camera.near,M.farDistance.value=B.shadow.camera.far}return{refreshFogUniforms:s,refreshMaterialUniforms:l}}function rR(r,t,i,s){let l={},c={},f=[];const d=r.getParameter(r.MAX_UNIFORM_BUFFER_BINDINGS);function m(B,N){const w=N.program;s.uniformBlockBinding(B,w)}function p(B,N){let w=l[B.id];w===void 0&&(T(B),w=g(B),l[B.id]=w,B.addEventListener("dispose",M));const z=N.program;s.updateUBOMapping(B,z);const I=t.render.frame;c[B.id]!==I&&(v(B),c[B.id]=I)}function g(B){const N=_();B.__bindingPointIndex=N;const w=r.createBuffer(),z=B.__size,I=B.usage;return r.bindBuffer(r.UNIFORM_BUFFER,w),r.bufferData(r.UNIFORM_BUFFER,z,I),r.bindBuffer(r.UNIFORM_BUFFER,null),r.bindBufferBase(r.UNIFORM_BUFFER,N,w),w}function _(){for(let B=0;B<d;B++)if(f.indexOf(B)===-1)return f.push(B),B;return we("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function v(B){const N=l[B.id],w=B.uniforms,z=B.__cache;r.bindBuffer(r.UNIFORM_BUFFER,N);for(let I=0,P=w.length;I<P;I++){const q=Array.isArray(w[I])?w[I]:[w[I]];for(let C=0,D=q.length;C<D;C++){const V=q[C];if(y(V,I,C,z)===!0){const nt=V.__offset,it=Array.isArray(V.value)?V.value:[V.value];let dt=0;for(let rt=0;rt<it.length;rt++){const F=it[rt],H=R(F);typeof F=="number"||typeof F=="boolean"?(V.__data[0]=F,r.bufferSubData(r.UNIFORM_BUFFER,nt+dt,V.__data)):F.isMatrix3?(V.__data[0]=F.elements[0],V.__data[1]=F.elements[1],V.__data[2]=F.elements[2],V.__data[3]=0,V.__data[4]=F.elements[3],V.__data[5]=F.elements[4],V.__data[6]=F.elements[5],V.__data[7]=0,V.__data[8]=F.elements[6],V.__data[9]=F.elements[7],V.__data[10]=F.elements[8],V.__data[11]=0):(F.toArray(V.__data,dt),dt+=H.storage/Float32Array.BYTES_PER_ELEMENT)}r.bufferSubData(r.UNIFORM_BUFFER,nt,V.__data)}}}r.bindBuffer(r.UNIFORM_BUFFER,null)}function y(B,N,w,z){const I=B.value,P=N+"_"+w;if(z[P]===void 0)return typeof I=="number"||typeof I=="boolean"?z[P]=I:z[P]=I.clone(),!0;{const q=z[P];if(typeof I=="number"||typeof I=="boolean"){if(q!==I)return z[P]=I,!0}else if(q.equals(I)===!1)return q.copy(I),!0}return!1}function T(B){const N=B.uniforms;let w=0;const z=16;for(let P=0,q=N.length;P<q;P++){const C=Array.isArray(N[P])?N[P]:[N[P]];for(let D=0,V=C.length;D<V;D++){const nt=C[D],it=Array.isArray(nt.value)?nt.value:[nt.value];for(let dt=0,rt=it.length;dt<rt;dt++){const F=it[dt],H=R(F),$=w%z,yt=$%H.boundary,xt=$+yt;w+=yt,xt!==0&&z-xt<H.storage&&(w+=z-xt),nt.__data=new Float32Array(H.storage/Float32Array.BYTES_PER_ELEMENT),nt.__offset=w,w+=H.storage}}}const I=w%z;return I>0&&(w+=z-I),B.__size=w,B.__cache={},this}function R(B){const N={boundary:0,storage:0};return typeof B=="number"||typeof B=="boolean"?(N.boundary=4,N.storage=4):B.isVector2?(N.boundary=8,N.storage=8):B.isVector3||B.isColor?(N.boundary=16,N.storage=12):B.isVector4?(N.boundary=16,N.storage=16):B.isMatrix3?(N.boundary=48,N.storage=48):B.isMatrix4?(N.boundary=64,N.storage=64):B.isTexture?pe("WebGLRenderer: Texture samplers can not be part of an uniforms group."):pe("WebGLRenderer: Unsupported uniform value type.",B),N}function M(B){const N=B.target;N.removeEventListener("dispose",M);const w=f.indexOf(N.__bindingPointIndex);f.splice(w,1),r.deleteBuffer(l[N.id]),delete l[N.id],delete c[N.id]}function S(){for(const B in l)r.deleteBuffer(l[B]);f=[],l={},c={}}return{bind:m,update:p,dispose:S}}const oR=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let Oi=null;function lR(){return Oi===null&&(Oi=new SM(oR,16,16,Pr,xa),Oi.name="DFG_LUT",Oi.minFilter=xn,Oi.magFilter=xn,Oi.wrapS=ga,Oi.wrapT=ga,Oi.generateMipmaps=!1,Oi.needsUpdate=!0),Oi}class cR{constructor(t={}){const{canvas:i=qy(),context:s=null,depth:l=!0,stencil:c=!1,alpha:f=!1,antialias:d=!1,premultipliedAlpha:m=!0,preserveDrawingBuffer:p=!1,powerPreference:g="default",failIfMajorPerformanceCaveat:_=!1,reversedDepthBuffer:v=!1,outputBufferType:y=ii}=t;this.isWebGLRenderer=!0;let T;if(s!==null){if(typeof WebGLRenderingContext<"u"&&s instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");T=s.getContextAttributes().alpha}else T=f;const R=y,M=new Set([jd,Zd,Yd]),S=new Set([ii,Gi,jo,Ko,Wd,qd]),B=new Uint32Array(4),N=new Int32Array(4);let w=null,z=null;const I=[],P=[];let q=null;this.domElement=i,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Bi,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const C=this;let D=!1;this._outputColorSpace=ni;let V=0,nt=0,it=null,dt=-1,rt=null;const F=new an,H=new an;let $=null;const yt=new Fe(0);let xt=0,L=i.width,K=i.height,ft=1,Et=null,Rt=null;const Q=new an(0,0,L,K),ct=new an(0,0,L,K);let Dt=!1;const Vt=new ep;let qt=!1,ye=!1;const Ue=new tn,fe=new j,gt=new an,At={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Mt=!1;function Bt(){return it===null?ft:1}let O=s;function ne(A,Y){return i.getContext(A,Y)}try{const A={alpha:!0,depth:l,stencil:c,antialias:d,premultipliedAlpha:m,preserveDrawingBuffer:p,powerPreference:g,failIfMajorPerformanceCaveat:_};if("setAttribute"in i&&i.setAttribute("data-engine",`three.js r${Xd}`),i.addEventListener("webglcontextlost",he,!1),i.addEventListener("webglcontextrestored",Ie,!1),i.addEventListener("webglcontextcreationerror",Ce,!1),O===null){const Y="webgl2";if(O=ne(Y,A),O===null)throw ne(Y)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(A){throw we("WebGLRenderer: "+A.message),A}let Gt,ae,Ut,U,E,W,ut,St,ht,Qt,Lt,Jt,le,Tt,Ct,Yt,Xt,Ot,_e,k,Ft,wt,kt,bt;function vt(){Gt=new l1(O),Gt.init(),wt=new $A(O,Gt),ae=new $b(O,Gt,t,wt),Ut=new JA(O,Gt),ae.reversedDepthBuffer&&v&&Ut.buffers.depth.setReversed(!0),U=new f1(O),E=new zA,W=new QA(O,Gt,Ut,E,ae,wt,U),ut=new e1(C),St=new o1(C),ht=new mE(O),kt=new Jb(O,ht),Qt=new c1(O,ht,U,kt),Lt=new d1(O,Qt,ht,U),_e=new h1(O,ae,W),Yt=new t1(E),Jt=new PA(C,ut,St,Gt,ae,kt,Yt),le=new sR(C,E),Tt=new BA,Ct=new kA(Gt),Ot=new Kb(C,ut,St,Ut,Lt,T,m),Xt=new jA(C,Lt,ae),bt=new rR(O,U,ae,Ut),k=new Qb(O,Gt,U),Ft=new u1(O,Gt,U),U.programs=Jt.programs,C.capabilities=ae,C.extensions=Gt,C.properties=E,C.renderLists=Tt,C.shadowMap=Xt,C.state=Ut,C.info=U}vt(),R!==ii&&(q=new m1(R,i.width,i.height,l,c));const Nt=new iR(C,O);this.xr=Nt,this.getContext=function(){return O},this.getContextAttributes=function(){return O.getContextAttributes()},this.forceContextLoss=function(){const A=Gt.get("WEBGL_lose_context");A&&A.loseContext()},this.forceContextRestore=function(){const A=Gt.get("WEBGL_lose_context");A&&A.restoreContext()},this.getPixelRatio=function(){return ft},this.setPixelRatio=function(A){A!==void 0&&(ft=A,this.setSize(L,K,!1))},this.getSize=function(A){return A.set(L,K)},this.setSize=function(A,Y,ot=!0){if(Nt.isPresenting){pe("WebGLRenderer: Can't change size while VR device is presenting.");return}L=A,K=Y,i.width=Math.floor(A*ft),i.height=Math.floor(Y*ft),ot===!0&&(i.style.width=A+"px",i.style.height=Y+"px"),q!==null&&q.setSize(i.width,i.height),this.setViewport(0,0,A,Y)},this.getDrawingBufferSize=function(A){return A.set(L*ft,K*ft).floor()},this.setDrawingBufferSize=function(A,Y,ot){L=A,K=Y,ft=ot,i.width=Math.floor(A*ot),i.height=Math.floor(Y*ot),this.setViewport(0,0,A,Y)},this.setEffects=function(A){if(R===ii){console.error("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(A){for(let Y=0;Y<A.length;Y++)if(A[Y].isOutputPass===!0){console.warn("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}q.setEffects(A||[])},this.getCurrentViewport=function(A){return A.copy(F)},this.getViewport=function(A){return A.copy(Q)},this.setViewport=function(A,Y,ot,at){A.isVector4?Q.set(A.x,A.y,A.z,A.w):Q.set(A,Y,ot,at),Ut.viewport(F.copy(Q).multiplyScalar(ft).round())},this.getScissor=function(A){return A.copy(ct)},this.setScissor=function(A,Y,ot,at){A.isVector4?ct.set(A.x,A.y,A.z,A.w):ct.set(A,Y,ot,at),Ut.scissor(H.copy(ct).multiplyScalar(ft).round())},this.getScissorTest=function(){return Dt},this.setScissorTest=function(A){Ut.setScissorTest(Dt=A)},this.setOpaqueSort=function(A){Et=A},this.setTransparentSort=function(A){Rt=A},this.getClearColor=function(A){return A.copy(Ot.getClearColor())},this.setClearColor=function(){Ot.setClearColor(...arguments)},this.getClearAlpha=function(){return Ot.getClearAlpha()},this.setClearAlpha=function(){Ot.setClearAlpha(...arguments)},this.clear=function(A=!0,Y=!0,ot=!0){let at=0;if(A){let J=!1;if(it!==null){const zt=it.texture.format;J=M.has(zt)}if(J){const zt=it.texture.type,Zt=S.has(zt),It=Ot.getClearColor(),jt=Ot.getClearAlpha(),$t=It.r,re=It.g,te=It.b;Zt?(B[0]=$t,B[1]=re,B[2]=te,B[3]=jt,O.clearBufferuiv(O.COLOR,0,B)):(N[0]=$t,N[1]=re,N[2]=te,N[3]=jt,O.clearBufferiv(O.COLOR,0,N))}else at|=O.COLOR_BUFFER_BIT}Y&&(at|=O.DEPTH_BUFFER_BIT),ot&&(at|=O.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),O.clear(at)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){i.removeEventListener("webglcontextlost",he,!1),i.removeEventListener("webglcontextrestored",Ie,!1),i.removeEventListener("webglcontextcreationerror",Ce,!1),Ot.dispose(),Tt.dispose(),Ct.dispose(),E.dispose(),ut.dispose(),St.dispose(),Lt.dispose(),kt.dispose(),bt.dispose(),Jt.dispose(),Nt.dispose(),Nt.removeEventListener("sessionstart",Os),Nt.removeEventListener("sessionend",kr),wi.stop()};function he(A){A.preventDefault(),a_("WebGLRenderer: Context Lost."),D=!0}function Ie(){a_("WebGLRenderer: Context Restored."),D=!1;const A=U.autoReset,Y=Xt.enabled,ot=Xt.autoUpdate,at=Xt.needsUpdate,J=Xt.type;vt(),U.autoReset=A,Xt.enabled=Y,Xt.autoUpdate=ot,Xt.needsUpdate=at,Xt.type=J}function Ce(A){we("WebGLRenderer: A WebGL context could not be created. Reason: ",A.statusMessage)}function Un(A){const Y=A.target;Y.removeEventListener("dispose",Un),gi(Y)}function gi(A){ol(A),E.remove(A)}function ol(A){const Y=E.get(A).programs;Y!==void 0&&(Y.forEach(function(ot){Jt.releaseProgram(ot)}),A.isShaderMaterial&&Jt.releaseShaderCache(A))}this.renderBufferDirect=function(A,Y,ot,at,J,zt){Y===null&&(Y=At);const Zt=J.isMesh&&J.matrixWorld.determinant()<0,It=ns(A,Y,ot,at,J);Ut.setMaterial(at,Zt);let jt=ot.index,$t=1;if(at.wireframe===!0){if(jt=Qt.getWireframeAttribute(ot),jt===void 0)return;$t=2}const re=ot.drawRange,te=ot.attributes.position;let ce=re.start*$t,Oe=(re.start+re.count)*$t;zt!==null&&(ce=Math.max(ce,zt.start*$t),Oe=Math.min(Oe,(zt.start+zt.count)*$t)),jt!==null?(ce=Math.max(ce,0),Oe=Math.min(Oe,jt.count)):te!=null&&(ce=Math.max(ce,0),Oe=Math.min(Oe,te.count));const Je=Oe-ce;if(Je<0||Je===1/0)return;kt.setup(J,at,It,ot,jt);let Ze,Be=k;if(jt!==null&&(Ze=ht.get(jt),Be=Ft,Be.setIndex(Ze)),J.isMesh)at.wireframe===!0?(Ut.setLineWidth(at.wireframeLinewidth*Bt()),Be.setMode(O.LINES)):Be.setMode(O.TRIANGLES);else if(J.isLine){let ie=at.linewidth;ie===void 0&&(ie=1),Ut.setLineWidth(ie*Bt()),J.isLineSegments?Be.setMode(O.LINES):J.isLineLoop?Be.setMode(O.LINE_LOOP):Be.setMode(O.LINE_STRIP)}else J.isPoints?Be.setMode(O.POINTS):J.isSprite&&Be.setMode(O.TRIANGLES);if(J.isBatchedMesh)if(J._multiDrawInstances!==null)Jo("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),Be.renderMultiDrawInstances(J._multiDrawStarts,J._multiDrawCounts,J._multiDrawCount,J._multiDrawInstances);else if(Gt.get("WEBGL_multi_draw"))Be.renderMultiDraw(J._multiDrawStarts,J._multiDrawCounts,J._multiDrawCount);else{const ie=J._multiDrawStarts,Pe=J._multiDrawCounts,de=J._multiDrawCount,yn=jt?ht.get(jt).bytesPerElement:1,qi=E.get(at).currentProgram.getUniforms();for(let Mn=0;Mn<de;Mn++)qi.setValue(O,"_gl_DrawID",Mn),Be.render(ie[Mn]/yn,Pe[Mn])}else if(J.isInstancedMesh)Be.renderInstances(ce,Je,J.count);else if(ot.isInstancedBufferGeometry){const ie=ot._maxInstanceCount!==void 0?ot._maxInstanceCount:1/0,Pe=Math.min(ot.instanceCount,ie);Be.renderInstances(ce,Je,Pe)}else Be.render(ce,Je)};function Vr(A,Y,ot){A.transparent===!0&&A.side===ma&&A.forceSinglePass===!1?(A.side=qn,A.needsUpdate=!0,zs(A,Y,ot),A.side=es,A.needsUpdate=!0,zs(A,Y,ot),A.side=ma):zs(A,Y,ot)}this.compile=function(A,Y,ot=null){ot===null&&(ot=A),z=Ct.get(ot),z.init(Y),P.push(z),ot.traverseVisible(function(J){J.isLight&&J.layers.test(Y.layers)&&(z.pushLight(J),J.castShadow&&z.pushShadow(J))}),A!==ot&&A.traverseVisible(function(J){J.isLight&&J.layers.test(Y.layers)&&(z.pushLight(J),J.castShadow&&z.pushShadow(J))}),z.setupLights();const at=new Set;return A.traverse(function(J){if(!(J.isMesh||J.isPoints||J.isLine||J.isSprite))return;const zt=J.material;if(zt)if(Array.isArray(zt))for(let Zt=0;Zt<zt.length;Zt++){const It=zt[Zt];Vr(It,ot,J),at.add(It)}else Vr(zt,ot,J),at.add(zt)}),z=P.pop(),at},this.compileAsync=function(A,Y,ot=null){const at=this.compile(A,Y,ot);return new Promise(J=>{function zt(){if(at.forEach(function(Zt){E.get(Zt).currentProgram.isReady()&&at.delete(Zt)}),at.size===0){J(A);return}setTimeout(zt,10)}Gt.get("KHR_parallel_shader_compile")!==null?zt():setTimeout(zt,10)})};let Ls=null;function Xr(A){Ls&&Ls(A)}function Os(){wi.stop()}function kr(){wi.start()}const wi=new Iv;wi.setAnimationLoop(Xr),typeof self<"u"&&wi.setContext(self),this.setAnimationLoop=function(A){Ls=A,Nt.setAnimationLoop(A),A===null?wi.stop():wi.start()},Nt.addEventListener("sessionstart",Os),Nt.addEventListener("sessionend",kr),this.render=function(A,Y){if(Y!==void 0&&Y.isCamera!==!0){we("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(D===!0)return;const ot=Nt.enabled===!0&&Nt.isPresenting===!0,at=q!==null&&(it===null||ot)&&q.begin(C,it);if(A.matrixWorldAutoUpdate===!0&&A.updateMatrixWorld(),Y.parent===null&&Y.matrixWorldAutoUpdate===!0&&Y.updateMatrixWorld(),Nt.enabled===!0&&Nt.isPresenting===!0&&(q===null||q.isCompositing()===!1)&&(Nt.cameraAutoUpdate===!0&&Nt.updateCamera(Y),Y=Nt.getCamera()),A.isScene===!0&&A.onBeforeRender(C,A,Y,it),z=Ct.get(A,P.length),z.init(Y),P.push(z),Ue.multiplyMatrices(Y.projectionMatrix,Y.matrixWorldInverse),Vt.setFromProjectionMatrix(Ue,Fi,Y.reversedDepth),ye=this.localClippingEnabled,qt=Yt.init(this.clippingPlanes,ye),w=Tt.get(A,I.length),w.init(),I.push(w),Nt.enabled===!0&&Nt.isPresenting===!0){const Zt=C.xr.getDepthSensingMesh();Zt!==null&&ai(Zt,Y,-1/0,C.sortObjects)}ai(A,Y,0,C.sortObjects),w.finish(),C.sortObjects===!0&&w.sort(Et,Rt),Mt=Nt.enabled===!1||Nt.isPresenting===!1||Nt.hasDepthSensing()===!1,Mt&&Ot.addToRenderList(w,A),this.info.render.frame++,qt===!0&&Yt.beginShadows();const J=z.state.shadowsArray;if(Xt.render(J,A,Y),qt===!0&&Yt.endShadows(),this.info.autoReset===!0&&this.info.reset(),(at&&q.hasRenderPass())===!1){const Zt=w.opaque,It=w.transmissive;if(z.setupLights(),Y.isArrayCamera){const jt=Y.cameras;if(It.length>0)for(let $t=0,re=jt.length;$t<re;$t++){const te=jt[$t];Sn(Zt,It,A,te)}Mt&&Ot.render(A);for(let $t=0,re=jt.length;$t<re;$t++){const te=jt[$t];on(w,A,te,te.viewport)}}else It.length>0&&Sn(Zt,It,A,Y),Mt&&Ot.render(A),on(w,A,Y)}it!==null&&nt===0&&(W.updateMultisampleRenderTarget(it),W.updateRenderTargetMipmap(it)),at&&q.end(C),A.isScene===!0&&A.onAfterRender(C,A,Y),kt.resetDefaultState(),dt=-1,rt=null,P.pop(),P.length>0?(z=P[P.length-1],qt===!0&&Yt.setGlobalState(C.clippingPlanes,z.state.camera)):z=null,I.pop(),I.length>0?w=I[I.length-1]:w=null};function ai(A,Y,ot,at){if(A.visible===!1)return;if(A.layers.test(Y.layers)){if(A.isGroup)ot=A.renderOrder;else if(A.isLOD)A.autoUpdate===!0&&A.update(Y);else if(A.isLight)z.pushLight(A),A.castShadow&&z.pushShadow(A);else if(A.isSprite){if(!A.frustumCulled||Vt.intersectsSprite(A)){at&&gt.setFromMatrixPosition(A.matrixWorld).applyMatrix4(Ue);const Zt=Lt.update(A),It=A.material;It.visible&&w.push(A,Zt,It,ot,gt.z,null)}}else if((A.isMesh||A.isLine||A.isPoints)&&(!A.frustumCulled||Vt.intersectsObject(A))){const Zt=Lt.update(A),It=A.material;if(at&&(A.boundingSphere!==void 0?(A.boundingSphere===null&&A.computeBoundingSphere(),gt.copy(A.boundingSphere.center)):(Zt.boundingSphere===null&&Zt.computeBoundingSphere(),gt.copy(Zt.boundingSphere.center)),gt.applyMatrix4(A.matrixWorld).applyMatrix4(Ue)),Array.isArray(It)){const jt=Zt.groups;for(let $t=0,re=jt.length;$t<re;$t++){const te=jt[$t],ce=It[te.materialIndex];ce&&ce.visible&&w.push(A,Zt,ce,ot,gt.z,te)}}else It.visible&&w.push(A,Zt,It,ot,gt.z,null)}}const zt=A.children;for(let Zt=0,It=zt.length;Zt<It;Zt++)ai(zt[Zt],Y,ot,at)}function on(A,Y,ot,at){const{opaque:J,transmissive:zt,transparent:Zt}=A;z.setupLightsView(ot),qt===!0&&Yt.setGlobalState(C.clippingPlanes,ot),at&&Ut.viewport(F.copy(at)),J.length>0&&_i(J,Y,ot),zt.length>0&&_i(zt,Y,ot),Zt.length>0&&_i(Zt,Y,ot),Ut.buffers.depth.setTest(!0),Ut.buffers.depth.setMask(!0),Ut.buffers.color.setMask(!0),Ut.setPolygonOffset(!1)}function Sn(A,Y,ot,at){if((ot.isScene===!0?ot.overrideMaterial:null)!==null)return;if(z.state.transmissionRenderTarget[at.id]===void 0){const ce=Gt.has("EXT_color_buffer_half_float")||Gt.has("EXT_color_buffer_float");z.state.transmissionRenderTarget[at.id]=new Ii(1,1,{generateMipmaps:!0,type:ce?xa:ii,minFilter:ws,samples:ae.samples,stencilBuffer:c,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:De.workingColorSpace})}const zt=z.state.transmissionRenderTarget[at.id],Zt=at.viewport||F;zt.setSize(Zt.z*C.transmissionResolutionScale,Zt.w*C.transmissionResolutionScale);const It=C.getRenderTarget(),jt=C.getActiveCubeFace(),$t=C.getActiveMipmapLevel();C.setRenderTarget(zt),C.getClearColor(yt),xt=C.getClearAlpha(),xt<1&&C.setClearColor(16777215,.5),C.clear(),Mt&&Ot.render(ot);const re=C.toneMapping;C.toneMapping=Bi;const te=at.viewport;if(at.viewport!==void 0&&(at.viewport=void 0),z.setupLightsView(at),qt===!0&&Yt.setGlobalState(C.clippingPlanes,at),_i(A,ot,at),W.updateMultisampleRenderTarget(zt),W.updateRenderTargetMipmap(zt),Gt.has("WEBGL_multisampled_render_to_texture")===!1){let ce=!1;for(let Oe=0,Je=Y.length;Oe<Je;Oe++){const Ze=Y[Oe],{object:Be,geometry:ie,material:Pe,group:de}=Ze;if(Pe.side===ma&&Be.layers.test(at.layers)){const yn=Pe.side;Pe.side=qn,Pe.needsUpdate=!0,Ps(Be,ot,at,ie,Pe,de),Pe.side=yn,Pe.needsUpdate=!0,ce=!0}}ce===!0&&(W.updateMultisampleRenderTarget(zt),W.updateRenderTargetMipmap(zt))}C.setRenderTarget(It,jt,$t),C.setClearColor(yt,xt),te!==void 0&&(at.viewport=te),C.toneMapping=re}function _i(A,Y,ot){const at=Y.isScene===!0?Y.overrideMaterial:null;for(let J=0,zt=A.length;J<zt;J++){const Zt=A[J],{object:It,geometry:jt,group:$t}=Zt;let re=Zt.material;re.allowOverride===!0&&at!==null&&(re=at),It.layers.test(ot.layers)&&Ps(It,Y,ot,jt,re,$t)}}function Ps(A,Y,ot,at,J,zt){A.onBeforeRender(C,Y,ot,at,J,zt),A.modelViewMatrix.multiplyMatrices(ot.matrixWorldInverse,A.matrixWorld),A.normalMatrix.getNormalMatrix(A.modelViewMatrix),J.onBeforeRender(C,Y,ot,at,A,zt),J.transparent===!0&&J.side===ma&&J.forceSinglePass===!1?(J.side=qn,J.needsUpdate=!0,C.renderBufferDirect(ot,Y,at,J,A,zt),J.side=es,J.needsUpdate=!0,C.renderBufferDirect(ot,Y,at,J,A,zt),J.side=ma):C.renderBufferDirect(ot,Y,at,J,A,zt),A.onAfterRender(C,Y,ot,at,J,zt)}function zs(A,Y,ot){Y.isScene!==!0&&(Y=At);const at=E.get(A),J=z.state.lights,zt=z.state.shadowsArray,Zt=J.state.version,It=Jt.getParameters(A,J.state,zt,Y,ot),jt=Jt.getProgramCacheKey(It);let $t=at.programs;at.environment=A.isMeshStandardMaterial?Y.environment:null,at.fog=Y.fog,at.envMap=(A.isMeshStandardMaterial?St:ut).get(A.envMap||at.environment),at.envMapRotation=at.environment!==null&&A.envMap===null?Y.environmentRotation:A.envMapRotation,$t===void 0&&(A.addEventListener("dispose",Un),$t=new Map,at.programs=$t);let re=$t.get(jt);if(re!==void 0){if(at.currentProgram===re&&at.lightsStateVersion===Zt)return Wr(A,It),re}else It.uniforms=Jt.getUniforms(A),A.onBeforeCompile(It,C),re=Jt.acquireProgram(It,jt),$t.set(jt,re),at.uniforms=It.uniforms;const te=at.uniforms;return(!A.isShaderMaterial&&!A.isRawShaderMaterial||A.clipping===!0)&&(te.clippingPlanes=Yt.uniform),Wr(A,It),at.needsLights=ya(A),at.lightsStateVersion=Zt,at.needsLights&&(te.ambientLightColor.value=J.state.ambient,te.lightProbe.value=J.state.probe,te.directionalLights.value=J.state.directional,te.directionalLightShadows.value=J.state.directionalShadow,te.spotLights.value=J.state.spot,te.spotLightShadows.value=J.state.spotShadow,te.rectAreaLights.value=J.state.rectArea,te.ltc_1.value=J.state.rectAreaLTC1,te.ltc_2.value=J.state.rectAreaLTC2,te.pointLights.value=J.state.point,te.pointLightShadows.value=J.state.pointShadow,te.hemisphereLights.value=J.state.hemi,te.directionalShadowMap.value=J.state.directionalShadowMap,te.directionalShadowMatrix.value=J.state.directionalShadowMatrix,te.spotShadowMap.value=J.state.spotShadowMap,te.spotLightMatrix.value=J.state.spotLightMatrix,te.spotLightMap.value=J.state.spotLightMap,te.pointShadowMap.value=J.state.pointShadowMap,te.pointShadowMatrix.value=J.state.pointShadowMatrix),at.currentProgram=re,at.uniformsList=null,re}function ll(A){if(A.uniformsList===null){const Y=A.currentProgram.getUniforms();A.uniformsList=Yc.seqWithValue(Y.seq,A.uniforms)}return A.uniformsList}function Wr(A,Y){const ot=E.get(A);ot.outputColorSpace=Y.outputColorSpace,ot.batching=Y.batching,ot.batchingColor=Y.batchingColor,ot.instancing=Y.instancing,ot.instancingColor=Y.instancingColor,ot.instancingMorph=Y.instancingMorph,ot.skinning=Y.skinning,ot.morphTargets=Y.morphTargets,ot.morphNormals=Y.morphNormals,ot.morphColors=Y.morphColors,ot.morphTargetsCount=Y.morphTargetsCount,ot.numClippingPlanes=Y.numClippingPlanes,ot.numIntersection=Y.numClipIntersection,ot.vertexAlphas=Y.vertexAlphas,ot.vertexTangents=Y.vertexTangents,ot.toneMapping=Y.toneMapping}function ns(A,Y,ot,at,J){Y.isScene!==!0&&(Y=At),W.resetTextureUnits();const zt=Y.fog,Zt=at.isMeshStandardMaterial?Y.environment:null,It=it===null?C.outputColorSpace:it.isXRRenderTarget===!0?it.texture.colorSpace:zr,jt=(at.isMeshStandardMaterial?St:ut).get(at.envMap||Zt),$t=at.vertexColors===!0&&!!ot.attributes.color&&ot.attributes.color.itemSize===4,re=!!ot.attributes.tangent&&(!!at.normalMap||at.anisotropy>0),te=!!ot.morphAttributes.position,ce=!!ot.morphAttributes.normal,Oe=!!ot.morphAttributes.color;let Je=Bi;at.toneMapped&&(it===null||it.isXRRenderTarget===!0)&&(Je=C.toneMapping);const Ze=ot.morphAttributes.position||ot.morphAttributes.normal||ot.morphAttributes.color,Be=Ze!==void 0?Ze.length:0,ie=E.get(at),Pe=z.state.lights;if(qt===!0&&(ye===!0||A!==rt)){const Tn=A===rt&&at.id===dt;Yt.setState(at,A,Tn)}let de=!1;at.version===ie.__version?(ie.needsLights&&ie.lightsStateVersion!==Pe.state.version||ie.outputColorSpace!==It||J.isBatchedMesh&&ie.batching===!1||!J.isBatchedMesh&&ie.batching===!0||J.isBatchedMesh&&ie.batchingColor===!0&&J.colorTexture===null||J.isBatchedMesh&&ie.batchingColor===!1&&J.colorTexture!==null||J.isInstancedMesh&&ie.instancing===!1||!J.isInstancedMesh&&ie.instancing===!0||J.isSkinnedMesh&&ie.skinning===!1||!J.isSkinnedMesh&&ie.skinning===!0||J.isInstancedMesh&&ie.instancingColor===!0&&J.instanceColor===null||J.isInstancedMesh&&ie.instancingColor===!1&&J.instanceColor!==null||J.isInstancedMesh&&ie.instancingMorph===!0&&J.morphTexture===null||J.isInstancedMesh&&ie.instancingMorph===!1&&J.morphTexture!==null||ie.envMap!==jt||at.fog===!0&&ie.fog!==zt||ie.numClippingPlanes!==void 0&&(ie.numClippingPlanes!==Yt.numPlanes||ie.numIntersection!==Yt.numIntersection)||ie.vertexAlphas!==$t||ie.vertexTangents!==re||ie.morphTargets!==te||ie.morphNormals!==ce||ie.morphColors!==Oe||ie.toneMapping!==Je||ie.morphTargetsCount!==Be)&&(de=!0):(de=!0,ie.__version=at.version);let yn=ie.currentProgram;de===!0&&(yn=zs(at,Y,J));let qi=!1,Mn=!1,si=!1;const He=yn.getUniforms(),En=ie.uniforms;if(Ut.useProgram(yn.program)&&(qi=!0,Mn=!0,si=!0),at.id!==dt&&(dt=at.id,Mn=!0),qi||rt!==A){Ut.buffers.depth.getReversed()&&A.reversedDepth!==!0&&(A._reversedDepth=!0,A.updateProjectionMatrix()),He.setValue(O,"projectionMatrix",A.projectionMatrix),He.setValue(O,"viewMatrix",A.matrixWorldInverse);const bn=He.map.cameraPosition;bn!==void 0&&bn.setValue(O,fe.setFromMatrixPosition(A.matrixWorld)),ae.logarithmicDepthBuffer&&He.setValue(O,"logDepthBufFC",2/(Math.log(A.far+1)/Math.LN2)),(at.isMeshPhongMaterial||at.isMeshToonMaterial||at.isMeshLambertMaterial||at.isMeshBasicMaterial||at.isMeshStandardMaterial||at.isShaderMaterial)&&He.setValue(O,"isOrthographic",A.isOrthographicCamera===!0),rt!==A&&(rt=A,Mn=!0,si=!0)}if(ie.needsLights&&(Pe.state.directionalShadowMap.length>0&&He.setValue(O,"directionalShadowMap",Pe.state.directionalShadowMap,W),Pe.state.spotShadowMap.length>0&&He.setValue(O,"spotShadowMap",Pe.state.spotShadowMap,W),Pe.state.pointShadowMap.length>0&&He.setValue(O,"pointShadowMap",Pe.state.pointShadowMap,W)),J.isSkinnedMesh){He.setOptional(O,J,"bindMatrix"),He.setOptional(O,J,"bindMatrixInverse");const Tn=J.skeleton;Tn&&(Tn.boneTexture===null&&Tn.computeBoneTexture(),He.setValue(O,"boneTexture",Tn.boneTexture,W))}J.isBatchedMesh&&(He.setOptional(O,J,"batchingTexture"),He.setValue(O,"batchingTexture",J._matricesTexture,W),He.setOptional(O,J,"batchingIdTexture"),He.setValue(O,"batchingIdTexture",J._indirectTexture,W),He.setOptional(O,J,"batchingColorTexture"),J._colorsTexture!==null&&He.setValue(O,"batchingColorTexture",J._colorsTexture,W));const dn=ot.morphAttributes;if((dn.position!==void 0||dn.normal!==void 0||dn.color!==void 0)&&_e.update(J,ot,yn),(Mn||ie.receiveShadow!==J.receiveShadow)&&(ie.receiveShadow=J.receiveShadow,He.setValue(O,"receiveShadow",J.receiveShadow)),at.isMeshGouraudMaterial&&at.envMap!==null&&(En.envMap.value=jt,En.flipEnvMap.value=jt.isCubeTexture&&jt.isRenderTargetTexture===!1?-1:1),at.isMeshStandardMaterial&&at.envMap===null&&Y.environment!==null&&(En.envMapIntensity.value=Y.environmentIntensity),En.dfgLUT!==void 0&&(En.dfgLUT.value=lR()),Mn&&(He.setValue(O,"toneMappingExposure",C.toneMappingExposure),ie.needsLights&&qr(En,si),zt&&at.fog===!0&&le.refreshFogUniforms(En,zt),le.refreshMaterialUniforms(En,at,ft,K,z.state.transmissionRenderTarget[A.id]),Yc.upload(O,ll(ie),En,W)),at.isShaderMaterial&&at.uniformsNeedUpdate===!0&&(Yc.upload(O,ll(ie),En,W),at.uniformsNeedUpdate=!1),at.isSpriteMaterial&&He.setValue(O,"center",J.center),He.setValue(O,"modelViewMatrix",J.modelViewMatrix),He.setValue(O,"normalMatrix",J.normalMatrix),He.setValue(O,"modelMatrix",J.matrixWorld),at.isShaderMaterial||at.isRawShaderMaterial){const Tn=at.uniformsGroups;for(let bn=0,Fs=Tn.length;bn<Fs;bn++){const vi=Tn[bn];bt.update(vi,yn),bt.bind(vi,yn)}}return yn}function qr(A,Y){A.ambientLightColor.needsUpdate=Y,A.lightProbe.needsUpdate=Y,A.directionalLights.needsUpdate=Y,A.directionalLightShadows.needsUpdate=Y,A.pointLights.needsUpdate=Y,A.pointLightShadows.needsUpdate=Y,A.spotLights.needsUpdate=Y,A.spotLightShadows.needsUpdate=Y,A.rectAreaLights.needsUpdate=Y,A.hemisphereLights.needsUpdate=Y}function ya(A){return A.isMeshLambertMaterial||A.isMeshToonMaterial||A.isMeshPhongMaterial||A.isMeshStandardMaterial||A.isShadowMaterial||A.isShaderMaterial&&A.lights===!0}this.getActiveCubeFace=function(){return V},this.getActiveMipmapLevel=function(){return nt},this.getRenderTarget=function(){return it},this.setRenderTargetTextures=function(A,Y,ot){const at=E.get(A);at.__autoAllocateDepthBuffer=A.resolveDepthBuffer===!1,at.__autoAllocateDepthBuffer===!1&&(at.__useRenderToTexture=!1),E.get(A.texture).__webglTexture=Y,E.get(A.depthTexture).__webglTexture=at.__autoAllocateDepthBuffer?void 0:ot,at.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(A,Y){const ot=E.get(A);ot.__webglFramebuffer=Y,ot.__useDefaultFramebuffer=Y===void 0};const Ma=O.createFramebuffer();this.setRenderTarget=function(A,Y=0,ot=0){it=A,V=Y,nt=ot;let at=null,J=!1,zt=!1;if(A){const It=E.get(A);if(It.__useDefaultFramebuffer!==void 0){Ut.bindFramebuffer(O.FRAMEBUFFER,It.__webglFramebuffer),F.copy(A.viewport),H.copy(A.scissor),$=A.scissorTest,Ut.viewport(F),Ut.scissor(H),Ut.setScissorTest($),dt=-1;return}else if(It.__webglFramebuffer===void 0)W.setupRenderTarget(A);else if(It.__hasExternalTextures)W.rebindTextures(A,E.get(A.texture).__webglTexture,E.get(A.depthTexture).__webglTexture);else if(A.depthBuffer){const re=A.depthTexture;if(It.__boundDepthTexture!==re){if(re!==null&&E.has(re)&&(A.width!==re.image.width||A.height!==re.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");W.setupDepthRenderbuffer(A)}}const jt=A.texture;(jt.isData3DTexture||jt.isDataArrayTexture||jt.isCompressedArrayTexture)&&(zt=!0);const $t=E.get(A).__webglFramebuffer;A.isWebGLCubeRenderTarget?(Array.isArray($t[Y])?at=$t[Y][ot]:at=$t[Y],J=!0):A.samples>0&&W.useMultisampledRTT(A)===!1?at=E.get(A).__webglMultisampledFramebuffer:Array.isArray($t)?at=$t[ot]:at=$t,F.copy(A.viewport),H.copy(A.scissor),$=A.scissorTest}else F.copy(Q).multiplyScalar(ft).floor(),H.copy(ct).multiplyScalar(ft).floor(),$=Dt;if(ot!==0&&(at=Ma),Ut.bindFramebuffer(O.FRAMEBUFFER,at)&&Ut.drawBuffers(A,at),Ut.viewport(F),Ut.scissor(H),Ut.setScissorTest($),J){const It=E.get(A.texture);O.framebufferTexture2D(O.FRAMEBUFFER,O.COLOR_ATTACHMENT0,O.TEXTURE_CUBE_MAP_POSITIVE_X+Y,It.__webglTexture,ot)}else if(zt){const It=Y;for(let jt=0;jt<A.textures.length;jt++){const $t=E.get(A.textures[jt]);O.framebufferTextureLayer(O.FRAMEBUFFER,O.COLOR_ATTACHMENT0+jt,$t.__webglTexture,ot,It)}}else if(A!==null&&ot!==0){const It=E.get(A.texture);O.framebufferTexture2D(O.FRAMEBUFFER,O.COLOR_ATTACHMENT0,O.TEXTURE_2D,It.__webglTexture,ot)}dt=-1},this.readRenderTargetPixels=function(A,Y,ot,at,J,zt,Zt,It=0){if(!(A&&A.isWebGLRenderTarget)){we("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let jt=E.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&Zt!==void 0&&(jt=jt[Zt]),jt){Ut.bindFramebuffer(O.FRAMEBUFFER,jt);try{const $t=A.textures[It],re=$t.format,te=$t.type;if(!ae.textureFormatReadable(re)){we("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!ae.textureTypeReadable(te)){we("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}Y>=0&&Y<=A.width-at&&ot>=0&&ot<=A.height-J&&(A.textures.length>1&&O.readBuffer(O.COLOR_ATTACHMENT0+It),O.readPixels(Y,ot,at,J,wt.convert(re),wt.convert(te),zt))}finally{const $t=it!==null?E.get(it).__webglFramebuffer:null;Ut.bindFramebuffer(O.FRAMEBUFFER,$t)}}},this.readRenderTargetPixelsAsync=async function(A,Y,ot,at,J,zt,Zt,It=0){if(!(A&&A.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let jt=E.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&Zt!==void 0&&(jt=jt[Zt]),jt)if(Y>=0&&Y<=A.width-at&&ot>=0&&ot<=A.height-J){Ut.bindFramebuffer(O.FRAMEBUFFER,jt);const $t=A.textures[It],re=$t.format,te=$t.type;if(!ae.textureFormatReadable(re))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!ae.textureTypeReadable(te))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const ce=O.createBuffer();O.bindBuffer(O.PIXEL_PACK_BUFFER,ce),O.bufferData(O.PIXEL_PACK_BUFFER,zt.byteLength,O.STREAM_READ),A.textures.length>1&&O.readBuffer(O.COLOR_ATTACHMENT0+It),O.readPixels(Y,ot,at,J,wt.convert(re),wt.convert(te),0);const Oe=it!==null?E.get(it).__webglFramebuffer:null;Ut.bindFramebuffer(O.FRAMEBUFFER,Oe);const Je=O.fenceSync(O.SYNC_GPU_COMMANDS_COMPLETE,0);return O.flush(),await Yy(O,Je,4),O.bindBuffer(O.PIXEL_PACK_BUFFER,ce),O.getBufferSubData(O.PIXEL_PACK_BUFFER,0,zt),O.deleteBuffer(ce),O.deleteSync(Je),zt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(A,Y=null,ot=0){const at=Math.pow(2,-ot),J=Math.floor(A.image.width*at),zt=Math.floor(A.image.height*at),Zt=Y!==null?Y.x:0,It=Y!==null?Y.y:0;W.setTexture2D(A,0),O.copyTexSubImage2D(O.TEXTURE_2D,ot,0,0,Zt,It,J,zt),Ut.unbindTexture()};const is=O.createFramebuffer(),Ea=O.createFramebuffer();this.copyTextureToTexture=function(A,Y,ot=null,at=null,J=0,zt=null){zt===null&&(J!==0?(Jo("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),zt=J,J=0):zt=0);let Zt,It,jt,$t,re,te,ce,Oe,Je;const Ze=A.isCompressedTexture?A.mipmaps[zt]:A.image;if(ot!==null)Zt=ot.max.x-ot.min.x,It=ot.max.y-ot.min.y,jt=ot.isBox3?ot.max.z-ot.min.z:1,$t=ot.min.x,re=ot.min.y,te=ot.isBox3?ot.min.z:0;else{const dn=Math.pow(2,-J);Zt=Math.floor(Ze.width*dn),It=Math.floor(Ze.height*dn),A.isDataArrayTexture?jt=Ze.depth:A.isData3DTexture?jt=Math.floor(Ze.depth*dn):jt=1,$t=0,re=0,te=0}at!==null?(ce=at.x,Oe=at.y,Je=at.z):(ce=0,Oe=0,Je=0);const Be=wt.convert(Y.format),ie=wt.convert(Y.type);let Pe;Y.isData3DTexture?(W.setTexture3D(Y,0),Pe=O.TEXTURE_3D):Y.isDataArrayTexture||Y.isCompressedArrayTexture?(W.setTexture2DArray(Y,0),Pe=O.TEXTURE_2D_ARRAY):(W.setTexture2D(Y,0),Pe=O.TEXTURE_2D),O.pixelStorei(O.UNPACK_FLIP_Y_WEBGL,Y.flipY),O.pixelStorei(O.UNPACK_PREMULTIPLY_ALPHA_WEBGL,Y.premultiplyAlpha),O.pixelStorei(O.UNPACK_ALIGNMENT,Y.unpackAlignment);const de=O.getParameter(O.UNPACK_ROW_LENGTH),yn=O.getParameter(O.UNPACK_IMAGE_HEIGHT),qi=O.getParameter(O.UNPACK_SKIP_PIXELS),Mn=O.getParameter(O.UNPACK_SKIP_ROWS),si=O.getParameter(O.UNPACK_SKIP_IMAGES);O.pixelStorei(O.UNPACK_ROW_LENGTH,Ze.width),O.pixelStorei(O.UNPACK_IMAGE_HEIGHT,Ze.height),O.pixelStorei(O.UNPACK_SKIP_PIXELS,$t),O.pixelStorei(O.UNPACK_SKIP_ROWS,re),O.pixelStorei(O.UNPACK_SKIP_IMAGES,te);const He=A.isDataArrayTexture||A.isData3DTexture,En=Y.isDataArrayTexture||Y.isData3DTexture;if(A.isDepthTexture){const dn=E.get(A),Tn=E.get(Y),bn=E.get(dn.__renderTarget),Fs=E.get(Tn.__renderTarget);Ut.bindFramebuffer(O.READ_FRAMEBUFFER,bn.__webglFramebuffer),Ut.bindFramebuffer(O.DRAW_FRAMEBUFFER,Fs.__webglFramebuffer);for(let vi=0;vi<jt;vi++)He&&(O.framebufferTextureLayer(O.READ_FRAMEBUFFER,O.COLOR_ATTACHMENT0,E.get(A).__webglTexture,J,te+vi),O.framebufferTextureLayer(O.DRAW_FRAMEBUFFER,O.COLOR_ATTACHMENT0,E.get(Y).__webglTexture,zt,Je+vi)),O.blitFramebuffer($t,re,Zt,It,ce,Oe,Zt,It,O.DEPTH_BUFFER_BIT,O.NEAREST);Ut.bindFramebuffer(O.READ_FRAMEBUFFER,null),Ut.bindFramebuffer(O.DRAW_FRAMEBUFFER,null)}else if(J!==0||A.isRenderTargetTexture||E.has(A)){const dn=E.get(A),Tn=E.get(Y);Ut.bindFramebuffer(O.READ_FRAMEBUFFER,is),Ut.bindFramebuffer(O.DRAW_FRAMEBUFFER,Ea);for(let bn=0;bn<jt;bn++)He?O.framebufferTextureLayer(O.READ_FRAMEBUFFER,O.COLOR_ATTACHMENT0,dn.__webglTexture,J,te+bn):O.framebufferTexture2D(O.READ_FRAMEBUFFER,O.COLOR_ATTACHMENT0,O.TEXTURE_2D,dn.__webglTexture,J),En?O.framebufferTextureLayer(O.DRAW_FRAMEBUFFER,O.COLOR_ATTACHMENT0,Tn.__webglTexture,zt,Je+bn):O.framebufferTexture2D(O.DRAW_FRAMEBUFFER,O.COLOR_ATTACHMENT0,O.TEXTURE_2D,Tn.__webglTexture,zt),J!==0?O.blitFramebuffer($t,re,Zt,It,ce,Oe,Zt,It,O.COLOR_BUFFER_BIT,O.NEAREST):En?O.copyTexSubImage3D(Pe,zt,ce,Oe,Je+bn,$t,re,Zt,It):O.copyTexSubImage2D(Pe,zt,ce,Oe,$t,re,Zt,It);Ut.bindFramebuffer(O.READ_FRAMEBUFFER,null),Ut.bindFramebuffer(O.DRAW_FRAMEBUFFER,null)}else En?A.isDataTexture||A.isData3DTexture?O.texSubImage3D(Pe,zt,ce,Oe,Je,Zt,It,jt,Be,ie,Ze.data):Y.isCompressedArrayTexture?O.compressedTexSubImage3D(Pe,zt,ce,Oe,Je,Zt,It,jt,Be,Ze.data):O.texSubImage3D(Pe,zt,ce,Oe,Je,Zt,It,jt,Be,ie,Ze):A.isDataTexture?O.texSubImage2D(O.TEXTURE_2D,zt,ce,Oe,Zt,It,Be,ie,Ze.data):A.isCompressedTexture?O.compressedTexSubImage2D(O.TEXTURE_2D,zt,ce,Oe,Ze.width,Ze.height,Be,Ze.data):O.texSubImage2D(O.TEXTURE_2D,zt,ce,Oe,Zt,It,Be,ie,Ze);O.pixelStorei(O.UNPACK_ROW_LENGTH,de),O.pixelStorei(O.UNPACK_IMAGE_HEIGHT,yn),O.pixelStorei(O.UNPACK_SKIP_PIXELS,qi),O.pixelStorei(O.UNPACK_SKIP_ROWS,Mn),O.pixelStorei(O.UNPACK_SKIP_IMAGES,si),zt===0&&Y.generateMipmaps&&O.generateMipmap(Pe),Ut.unbindTexture()},this.initRenderTarget=function(A){E.get(A).__webglFramebuffer===void 0&&W.setupRenderTarget(A)},this.initTexture=function(A){A.isCubeTexture?W.setTextureCube(A,0):A.isData3DTexture?W.setTexture3D(A,0):A.isDataArrayTexture||A.isCompressedArrayTexture?W.setTexture2DArray(A,0):W.setTexture2D(A,0),Ut.unbindTexture()},this.resetState=function(){V=0,nt=0,it=null,Ut.reset(),kt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Fi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const i=this.getContext();i.drawingBufferColorSpace=De._getDrawingBufferColorSpace(t),i.unpackColorSpace=De._getUnpackColorSpace()}}const uR=2e3,Q_=2.4,Gc=5,$_=.25,fR=.3,tv=.15;function hR(r,t,i){const s=new Lv,l=r/2,c=t/2;return s.moveTo(-l+i,-c),s.lineTo(l-i,-c),s.quadraticCurveTo(l,-c,l,-c+i),s.lineTo(l,c-i),s.quadraticCurveTo(l,c,l-i,c),s.lineTo(-l+i,c),s.quadraticCurveTo(-l,c,-l,c-i),s.lineTo(-l,-c+i),s.quadraticCurveTo(-l,-c,-l+i,-c),s}function dR({selectedSession:r}){const t=oe.useRef(null),i=oe.useRef(null);return oe.useEffect(()=>{const s=i.current;s&&s.readyState===WebSocket.OPEN&&s.send(JSON.stringify({type:"select",session:r}))},[r]),oe.useEffect(()=>{const s=t.current;if(!s)return;const l=new xM,c=new mi(35,3/4,.1,100);c.position.set(0,0,10),c.lookAt(0,0,0);const f=new cR({antialias:!0,alpha:!0});f.setPixelRatio(Math.min(window.devicePixelRatio,2)),s.appendChild(f.domElement),l.add(new hE(16777215,.6));const d=new fE(16777215,.8);d.position.set(3,5,8),l.add(d);const m=new wr;l.add(m);const p=new wr;m.add(p);const g=document.createElement("canvas");g.width=540,g.height=1170;const _=g.getContext("2d");_.fillStyle="#111",_.fillRect(0,0,g.width,g.height);const v=new TM(g);v.colorSpace=ni,v.minFilter=xn,v.magFilter=xn;const y=new rE({color:1710638,metalness:.3,roughness:.7}),T=new tp({map:v});let R=null,M=null,S=null,B=null,N=Q_,w=Gc;function z(K,ft){R&&(p.remove(R),S.dispose()),M&&(p.remove(M),B.dispose()),N=K,w=ft;const Et=hR(K,ft,fR);S=new ap(Et,{depth:$_,bevelEnabled:!0,bevelThickness:.04,bevelSize:.04,bevelSegments:3}),S.center(),R=new Ci(S,y),p.add(R);const Rt=K-tv*2,Q=ft-tv*2;B=new rl(Rt,Q),M=new Ci(B,T),M.position.z=($_+.08)/2+.01,p.add(M),g.width=Math.round(Rt*200),g.height=Math.round(Q*200),_.fillStyle="#111",_.fillRect(0,0,g.width,g.height),v.dispose(),v.needsUpdate=!0,nt()}const I=.85;let P=0,q=0,C=0;const D=[0,Math.PI/2,Math.PI,-Math.PI/2];let V=10;function nt(){const ft=(P===1||P===3?w:N)*I,Et=Math.atan(Math.tan(c.fov/2*Math.PI/180)*c.aspect);V=ft/2/Math.tan(Et)}z(Q_,Gc),p.scale.setScalar(I);function it(){const K=s.clientWidth,ft=s.clientHeight;K===0||ft===0||(c.aspect=K/ft,c.updateProjectionMatrix(),f.setSize(K,ft),nt())}it();const dt=new ResizeObserver(it);dt.observe(s);let rt=performance.now(),F=0;function H(){F=requestAnimationFrame(H);const K=performance.now(),ft=Math.min((K-rt)/1e3,.1);rt=K;const Et=1-Math.exp(-8*ft);let Rt=q-C;Rt>Math.PI&&(Rt-=2*Math.PI),Rt<-Math.PI&&(Rt+=2*Math.PI),C+=Rt*Et,m.rotation.z=C,c.position.z+=(V-c.position.z)*Et,f.render(l,c)}H();let $=null,yt=null,xt=!1;function L(){if(xt)return;const ft=`${window.location.protocol==="https:"?"wss:":"ws:"}//${window.location.host}/ws/preview`;$=new WebSocket(ft),i.current=$,$.binaryType="arraybuffer",$.onopen=()=>{$.send(JSON.stringify({type:"select",session:r}))},$.onclose=()=>{i.current=null,xt||(yt=setTimeout(L,uR))},$.onerror=()=>{},$.onmessage=Et=>{if(typeof Et.data=="string")try{const Rt=JSON.parse(Et.data);if(Rt.type==="device"){const Q=Math.min(Rt.w,Rt.h),ct=Math.max(Rt.w,Rt.h),Dt=Q/ct;z(Gc*Dt,Gc)}if(Rt.type==="orient"&&Rt.o!==void 0){const Q=Rt.o;if(Q!==P){P=Q,q=D[P],nt();const ct=P===1||P===3,Dt=s==null?void 0:s.closest(".preview-column");Dt&&(Dt.style.width=ct?`${Math.round(400*w/N)}px`:"400px")}}}catch{}else{const Rt=new Blob([Et.data],{type:"image/jpeg"});createImageBitmap(Rt).then(Q=>{const ct=P===1||P===3;if(_.clearRect(0,0,g.width,g.height),ct){const Dt=D[P];_.save(),_.translate(g.width/2,g.height/2),_.rotate(Dt),_.drawImage(Q,-g.height/2,-g.width/2,g.height,g.width),_.restore()}else P===2?(_.save(),_.translate(g.width/2,g.height/2),_.rotate(D[2]),_.drawImage(Q,-g.width/2,-g.height/2,g.width,g.height),_.restore()):_.drawImage(Q,0,0,g.width,g.height);v.needsUpdate=!0,Q.close()})}}}return L(),()=>{xt=!0,yt&&clearTimeout(yt),$&&($.onclose=null,$.close(),i.current=null),cancelAnimationFrame(F),dt.disconnect(),f.dispose(),S&&S.dispose(),y.dispose(),B&&B.dispose(),T.dispose(),v.dispose(),s.contains(f.domElement)&&s.removeChild(f.domElement)}},[]),Pt.jsx("div",{className:"phone-preview",ref:t})}function pR({sessions:r,selected:t,onSelect:i}){return r.length===0?null:Pt.jsxs("div",{className:"session-list",children:[Pt.jsx("h2",{className:"session-title",children:"Sessions"}),Pt.jsxs("div",{className:"session-items",children:[Pt.jsxs("button",{className:`session-item ${t===null?"selected":""}`,onClick:()=>i(null),children:[Pt.jsx("span",{className:"session-dot all"}),Pt.jsx("span",{className:"session-name",children:"All"})]}),r.map(s=>Pt.jsxs("button",{className:`session-item ${t===s.id?"selected":""} ${s.active?"":"inactive"}`,onClick:()=>i(s.id),children:[Pt.jsx("span",{className:`session-dot ${s.active?"active":"dead"}`}),Pt.jsx("span",{className:"session-name",children:s.id})]},s.id))]})]})}function mR({servers:r,onSelect:t}){return r.length===0?null:Pt.jsxs("div",{className:"server-list",children:[Pt.jsx("h2",{className:"server-title",children:"Servers"}),Pt.jsx("div",{className:"server-items",children:r.map(i=>Pt.jsxs("button",{className:`server-item ${i.active?"active":""}`,onClick:()=>{i.active||t(i.id)},children:[Pt.jsx("span",{className:`server-dot ${i.active?"active":"inactive"}`}),Pt.jsx("span",{className:"server-name",children:i.name}),Pt.jsxs("span",{className:"server-pid",children:[":",i.pid]})]},i.id))})]})}function gR(){const[r,t]=oe.useState(!1),[i,s]=oe.useState(!1),[l,c]=oe.useState(!1),f=oe.useRef(!1),[d,m]=oe.useState("ge"),p=oe.useRef(!1),[g,_]=oe.useState([]),[v,y]=oe.useState(null),[T,R]=oe.useState([]),M=oe.useCallback(w=>{if(w.buildId&&w.buildId!=="mm3e65my"){location.reload();return}const z=w.servers.map(q=>({id:q.id,name:q.name,pid:q.pid,active:q.active}));R(z);const I=new Set(w.sessions);_(w.sessions.map(q=>({id:q,active:!0}))),y(q=>q!==null&&!I.has(q)?null:q);const P=w.servers.find(q=>q.active);if(P){m(P.name);const q=window.location.port;document.title=q?`${P.name} :${q}`:P.name}else m("ge")},[]),S=oe.useCallback(w=>{fetch(`/api/servers/${w}/select`,{method:"POST"}).catch(()=>{})},[]),B=oe.useCallback(()=>{c(!0),p.current=!0,s(!1),fetch("/api/stop",{method:"POST"}).catch(()=>{})},[]);oe.useEffect(()=>{const w=()=>{p.current||navigator.sendBeacon("/api/stop")};return window.addEventListener("pagehide",w),()=>window.removeEventListener("pagehide",w)},[]);const N=oe.useCallback(w=>{f.current=w,s(!0)},[]);return oe.useEffect(()=>{const w=z=>{if(z.key==="c"&&(z.ctrlKey||z.metaKey)){if(z.preventDefault(),l)return;i&&f.current?B():i||N(!0)}else z.key==="Escape"&&i&&s(!1)};return window.addEventListener("keydown",w),()=>window.removeEventListener("keydown",w)},[i,l,B,N]),Pt.jsxs("div",{className:"app",children:[Pt.jsxs("header",{className:"header",children:[Pt.jsx("h1",{className:"title",children:d}),Pt.jsx("button",{className:"stop-btn",onClick:()=>N(!1),disabled:l,title:"Stop server (Ctrl-C)",children:l?"Stopped":"Stop"}),Pt.jsx("span",{className:`status-dot ${r?"connected":"disconnected"}`}),Pt.jsx("span",{className:"status-text",children:r?"connected":"disconnected"})]}),Pt.jsxs("div",{className:"layout",children:[Pt.jsxs("aside",{className:"sidebar",children:[Pt.jsx(ay,{}),Pt.jsx(mR,{servers:T,onSelect:S}),Pt.jsx(pR,{sessions:g,selected:v,onSelect:y}),Pt.jsx(dy,{})]}),Pt.jsx("main",{className:"main",children:Pt.jsx(uy,{onConnectionChange:t,sessionFilter:v,onState:M})}),Pt.jsx("aside",{className:"preview-column",children:Pt.jsx(dR,{selectedSession:v})})]}),i&&Pt.jsx("div",{className:"confirm-overlay",onClick:()=>s(!1),children:Pt.jsxs("div",{className:"confirm-dialog",onClick:w=>w.stopPropagation(),children:[Pt.jsx("p",{className:"confirm-text",children:"Stop the game server?"}),f.current&&Pt.jsx("p",{className:"confirm-hint",children:"Ctrl-C again to confirm"}),Pt.jsxs("div",{className:"confirm-actions",children:[Pt.jsx("button",{className:"confirm-btn confirm-btn-stop",onClick:B,children:"Stop Server"}),Pt.jsx("button",{className:"confirm-btn confirm-btn-cancel",onClick:()=>s(!1),children:"Cancel"})]})]})})]})}iy.createRoot(document.getElementById("root")).render(Pt.jsx(oe.StrictMode,{children:Pt.jsx(gR,{})}));
