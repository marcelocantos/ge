 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var H0;function KS(){if(H0)return me;H0=1;var r=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),c=Symbol.for("react.consumer"),f=Symbol.for("react.context"),d=Symbol.for("react.forward_ref"),m=Symbol.for("react.suspense"),p=Symbol.for("react.memo"),_=Symbol.for("react.lazy"),g=Symbol.for("react.activity"),v=Symbol.iterator;function y(O){return O===null||typeof O!="object"?null:(O=v&&O[v]||O["@@iterator"],typeof O=="function"?O:null)}var T={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},R=Object.assign,M={};function S(O,K,ft){this.props=O,this.context=K,this.refs=M,this.updater=ft||T}S.prototype.isReactComponent={},S.prototype.setState=function(O,K){if(typeof O!="object"&&typeof O!="function"&&O!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,O,K,"setState")},S.prototype.forceUpdate=function(O){this.updater.enqueueForceUpdate(this,O,"forceUpdate")};function L(){}L.prototype=S.prototype;function D(O,K,ft){this.props=O,this.context=K,this.refs=M,this.updater=ft||T}var U=D.prototype=new L;U.constructor=D,R(U,S.prototype),U.isPureReactComponent=!0;var z=Array.isArray;function I(){}var F={H:null,A:null,T:null,S:null},Z=Object.prototype.hasOwnProperty;function C(O,K,ft){var Et=ft.ref;return{$$typeof:r,type:O,key:K,ref:Et!==void 0?Et:null,props:ft}}function w(O,K){return C(O.type,K,O.props)}function V(O){return typeof O=="object"&&O!==null&&O.$$typeof===r}function nt(O){var K={"=":"=0",":":"=2"};return"$"+O.replace(/[=:]/g,function(ft){return K[ft]})}var it=/\/+/g;function dt(O,K){return typeof O=="object"&&O!==null&&O.key!=null?nt(""+O.key):K.toString(36)}function rt(O){switch(O.status){case"fulfilled":return O.value;case"rejected":throw O.reason;default:switch(typeof O.status=="string"?O.then(I,I):(O.status="pending",O.then(function(K){O.status==="pending"&&(O.status="fulfilled",O.value=K)},function(K){O.status==="pending"&&(O.status="rejected",O.reason=K)})),O.status){case"fulfilled":return O.value;case"rejected":throw O.reason}}throw O}function B(O,K,ft,Et,Rt){var Q=typeof O;(Q==="undefined"||Q==="boolean")&&(O=null);var ct=!1;if(O===null)ct=!0;else switch(Q){case"bigint":case"string":case"number":ct=!0;break;case"object":switch(O.$$typeof){case r:case t:ct=!0;break;case _:return ct=O._init,B(ct(O._payload),K,ft,Et,Rt)}}if(ct)return Rt=Rt(O),ct=Et===""?"."+dt(O,0):Et,z(Rt)?(ft="",ct!=null&&(ft=ct.replace(it,"$&/")+"/"),B(Rt,K,ft,"",function(qt){return qt})):Rt!=null&&(V(Rt)&&(Rt=w(Rt,ft+(Rt.key==null||O&&O.key===Rt.key?"":(""+Rt.key).replace(it,"$&/")+"/")+ct)),K.push(Rt)),1;ct=0;var Dt=Et===""?".":Et+":";if(z(O))for(var Gt=0;Gt<O.length;Gt++)Et=O[Gt],Q=Dt+dt(Et,Gt),ct+=B(Et,K,ft,Q,Rt);else if(Gt=y(O),typeof Gt=="function")for(O=Gt.call(O),Gt=0;!(Et=O.next()).done;)Et=Et.value,Q=Dt+dt(Et,Gt++),ct+=B(Et,K,ft,Q,Rt);else if(Q==="object"){if(typeof O.then=="function")return B(rt(O),K,ft,Et,Rt);throw K=String(O),Error("Objects are not valid as a React child (found: "+(K==="[object Object]"?"object with keys {"+Object.keys(O).join(", ")+"}":K)+"). If you meant to render a collection of children, use an array instead.")}return ct}function H(O,K,ft){if(O==null)return O;var Et=[],Rt=0;return B(O,Et,"","",function(Q){return K.call(ft,Q,Rt++)}),Et}function $(O){if(O._status===-1){var K=O._result;K=K(),K.then(function(ft){(O._status===0||O._status===-1)&&(O._status=1,O._result=ft)},function(ft){(O._status===0||O._status===-1)&&(O._status=2,O._result=ft)}),O._status===-1&&(O._status=0,O._result=K)}if(O._status===1)return O._result.default;throw O._result}var yt=typeof reportError=="function"?reportError:function(O){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var K=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof O=="object"&&O!==null&&typeof O.message=="string"?String(O.message):String(O),error:O});if(!window.dispatchEvent(K))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",O);return}console.error(O)},xt={map:H,forEach:function(O,K,ft){H(O,function(){K.apply(this,arguments)},ft)},count:function(O){var K=0;return H(O,function(){K++}),K},toArray:function(O){return H(O,function(K){return K})||[]},only:function(O){if(!V(O))throw Error("React.Children.only expected to receive a single React element child.");return O}};return me.Activity=g,me.Children=xt,me.Component=S,me.Fragment=i,me.Profiler=l,me.PureComponent=D,me.StrictMode=s,me.Suspense=m,me.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=F,me.__COMPILER_RUNTIME={__proto__:null,c:function(O){return F.H.useMemoCache(O)}},me.cache=function(O){return function(){return O.apply(null,arguments)}},me.cacheSignal=function(){return null},me.cloneElement=function(O,K,ft){if(O==null)throw Error("The argument must be a React element, but you passed "+O+".");var Et=R({},O.props),Rt=O.key;if(K!=null)for(Q in K.key!==void 0&&(Rt=""+K.key),K)!Z.call(K,Q)||Q==="key"||Q==="__self"||Q==="__source"||Q==="ref"&&K.ref===void 0||(Et[Q]=K[Q]);var Q=arguments.length-2;if(Q===1)Et.children=ft;else if(1<Q){for(var ct=Array(Q),Dt=0;Dt<Q;Dt++)ct[Dt]=arguments[Dt+2];Et.children=ct}return C(O.type,Rt,Et)},me.createContext=function(O){return O={$$typeof:f,_currentValue:O,_currentValue2:O,_threadCount:0,Provider:null,Consumer:null},O.Provider=O,O.Consumer={$$typeof:c,_context:O},O},me.createElement=function(O,K,ft){var Et,Rt={},Q=null;if(K!=null)for(Et in K.key!==void 0&&(Q=""+K.key),K)Z.call(K,Et)&&Et!=="key"&&Et!=="__self"&&Et!=="__source"&&(Rt[Et]=K[Et]);var ct=arguments.length-2;if(ct===1)Rt.children=ft;else if(1<ct){for(var Dt=Array(ct),Gt=0;Gt<ct;Gt++)Dt[Gt]=arguments[Gt+2];Rt.children=Dt}if(O&&O.defaultProps)for(Et in ct=O.defaultProps,ct)Rt[Et]===void 0&&(Rt[Et]=ct[Et]);return C(O,Q,Rt)},me.createRef=function(){return{current:null}},me.forwardRef=function(O){return{$$typeof:d,render:O}},me.isValidElement=V,me.lazy=function(O){return{$$typeof:_,_payload:{_status:-1,_result:O},_init:$}},me.memo=function(O,K){return{$$typeof:p,type:O,compare:K===void 0?null:K}},me.startTransition=function(O){var K=F.T,ft={};F.T=ft;try{var Et=O(),Rt=F.S;Rt!==null&&Rt(ft,Et),typeof Et=="object"&&Et!==null&&typeof Et.then=="function"&&Et.then(I,yt)}catch(Q){yt(Q)}finally{K!==null&&ft.types!==null&&(K.types=ft.types),F.T=K}},me.unstable_useCacheRefresh=function(){return F.H.useCacheRefresh()},me.use=function(O){return F.H.use(O)},me.useActionState=function(O,K,ft){return F.H.useActionState(O,K,ft)},me.useCallback=function(O,K){return F.H.useCallback(O,K)},me.useContext=function(O){return F.H.useContext(O)},me.useDebugValue=function(){},me.useDeferredValue=function(O,K){return F.H.useDeferredValue(O,K)},me.useEffect=function(O,K){return F.H.useEffect(O,K)},me.useEffectEvent=function(O){return F.H.useEffectEvent(O)},me.useId=function(){return F.H.useId()},me.useImperativeHandle=function(O,K,ft){return F.H.useImperativeHandle(O,K,ft)},me.useInsertionEffect=function(O,K){return F.H.useInsertionEffect(O,K)},me.useLayoutEffect=function(O,K){return F.H.useLayoutEffect(O,K)},me.useMemo=function(O,K){return F.H.useMemo(O,K)},me.useOptimistic=function(O,K){return F.H.useOptimistic(O,K)},me.useReducer=function(O,K,ft){return F.H.useReducer(O,K,ft)},me.useRef=function(O){return F.H.useRef(O)},me.useState=function(O){return F.H.useState(O)},me.useSyncExternalStore=function(O,K,ft){return F.H.useSyncExternalStore(O,K,ft)},me.useTransition=function(){return F.H.useTransition()},me.version="19.2.4",me}var G0;function Vd(){return G0||(G0=1,sh.exports=KS()),sh.exports}var oe=Vd(),rh={exports:{}},zo={},oh={exports:{}},lh={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var V0;function JS(){return V0||(V0=1,(function(r){function t(B,H){var $=B.length;B.push(H);t:for(;0<$;){var yt=$-1>>>1,xt=B[yt];if(0<l(xt,H))B[yt]=H,B[$]=xt,$=yt;else break t}}function i(B){return B.length===0?null:B[0]}function s(B){if(B.length===0)return null;var H=B[0],$=B.pop();if($!==H){B[0]=$;t:for(var yt=0,xt=B.length,O=xt>>>1;yt<O;){var K=2*(yt+1)-1,ft=B[K],Et=K+1,Rt=B[Et];if(0>l(ft,$))Et<xt&&0>l(Rt,ft)?(B[yt]=Rt,B[Et]=$,yt=Et):(B[yt]=ft,B[K]=$,yt=K);else if(Et<xt&&0>l(Rt,$))B[yt]=Rt,B[Et]=$,yt=Et;else break t}}return H}function l(B,H){var $=B.sortIndex-H.sortIndex;return $!==0?$:B.id-H.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;r.unstable_now=function(){return c.now()}}else{var f=Date,d=f.now();r.unstable_now=function(){return f.now()-d}}var m=[],p=[],_=1,g=null,v=3,y=!1,T=!1,R=!1,M=!1,S=typeof setTimeout=="function"?setTimeout:null,L=typeof clearTimeout=="function"?clearTimeout:null,D=typeof setImmediate<"u"?setImmediate:null;function U(B){for(var H=i(p);H!==null;){if(H.callback===null)s(p);else if(H.startTime<=B)s(p),H.sortIndex=H.expirationTime,t(m,H);else break;H=i(p)}}function z(B){if(R=!1,U(B),!T)if(i(m)!==null)T=!0,I||(I=!0,nt());else{var H=i(p);H!==null&&rt(z,H.startTime-B)}}var I=!1,F=-1,Z=5,C=-1;function w(){return M?!0:!(r.unstable_now()-C<Z)}function V(){if(M=!1,I){var B=r.unstable_now();C=B;var H=!0;try{t:{T=!1,R&&(R=!1,L(F),F=-1),y=!0;var $=v;try{e:{for(U(B),g=i(m);g!==null&&!(g.expirationTime>B&&w());){var yt=g.callback;if(typeof yt=="function"){g.callback=null,v=g.priorityLevel;var xt=yt(g.expirationTime<=B);if(B=r.unstable_now(),typeof xt=="function"){g.callback=xt,U(B),H=!0;break e}g===i(m)&&s(m),U(B)}else s(m);g=i(m)}if(g!==null)H=!0;else{var O=i(p);O!==null&&rt(z,O.startTime-B),H=!1}}break t}finally{g=null,v=$,y=!1}H=void 0}}finally{H?nt():I=!1}}}var nt;if(typeof D=="function")nt=function(){D(V)};else if(typeof MessageChannel<"u"){var it=new MessageChannel,dt=it.port2;it.port1.onmessage=V,nt=function(){dt.postMessage(null)}}else nt=function(){S(V,0)};function rt(B,H){F=S(function(){B(r.unstable_now())},H)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(B){B.callback=null},r.unstable_forceFrameRate=function(B){0>B||125<B?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Z=0<B?Math.floor(1e3/B):5},r.unstable_getCurrentPriorityLevel=function(){return v},r.unstable_next=function(B){switch(v){case 1:case 2:case 3:var H=3;break;default:H=v}var $=v;v=H;try{return B()}finally{v=$}},r.unstable_requestPaint=function(){M=!0},r.unstable_runWithPriority=function(B,H){switch(B){case 1:case 2:case 3:case 4:case 5:break;default:B=3}var $=v;v=B;try{return H()}finally{v=$}},r.unstable_scheduleCallback=function(B,H,$){var yt=r.unstable_now();switch(typeof $=="object"&&$!==null?($=$.delay,$=typeof $=="number"&&0<$?yt+$:yt):$=yt,B){case 1:var xt=-1;break;case 2:xt=250;break;case 5:xt=1073741823;break;case 4:xt=1e4;break;default:xt=5e3}return xt=$+xt,B={id:_++,callback:H,priorityLevel:B,startTime:$,expirationTime:xt,sortIndex:-1},$>yt?(B.sortIndex=$,t(p,B),i(m)===null&&B===i(p)&&(R?(L(F),F=-1):R=!0,rt(z,$-yt))):(B.sortIndex=xt,t(m,B),T||y||(T=!0,I||(I=!0,nt()))),B},r.unstable_shouldYield=w,r.unstable_wrapCallback=function(B){var H=v;return function(){var $=v;v=H;try{return B.apply(this,arguments)}finally{v=$}}}})(lh)),lh}var X0;function QS(){return X0||(X0=1,oh.exports=JS()),oh.exports}var ch={exports:{}},Nn={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var q0;function ey(){if(q0)return zo;q0=1;var r=QS(),t=Vd(),i=ty();function s(e){var n="https://react.dev/errors/"+e;if(1<arguments.length){n+="?args[]="+encodeURIComponent(arguments[1]);for(var a=2;a<arguments.length;a++)n+="&args[]="+encodeURIComponent(arguments[a])}return"Minified React error #"+e+"; visit "+n+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function l(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)}function c(e){var n=e,a=e;if(e.alternate)for(;n.return;)n=n.return;else{e=n;do n=e,(n.flags&4098)!==0&&(a=n.return),e=n.return;while(e)}return n.tag===3?a:null}function f(e){if(e.tag===13){var n=e.memoizedState;if(n===null&&(e=e.alternate,e!==null&&(n=e.memoizedState)),n!==null)return n.dehydrated}return null}function d(e){if(e.tag===31){var n=e.memoizedState;if(n===null&&(e=e.alternate,e!==null&&(n=e.memoizedState)),n!==null)return n.dehydrated}return null}function m(e){if(c(e)!==e)throw Error(s(188))}function p(e){var n=e.alternate;if(!n){if(n=c(e),n===null)throw Error(s(188));return n!==e?null:e}for(var a=e,o=n;;){var u=a.return;if(u===null)break;var h=u.alternate;if(h===null){if(o=u.return,o!==null){a=o;continue}break}if(u.child===h.child){for(h=u.child;h;){if(h===a)return m(u),e;if(h===o)return m(u),n;h=h.sibling}throw Error(s(188))}if(a.return!==o.return)a=u,o=h;else{for(var x=!1,b=u.child;b;){if(b===a){x=!0,a=u,o=h;break}if(b===o){x=!0,o=u,a=h;break}b=b.sibling}if(!x){for(b=h.child;b;){if(b===a){x=!0,a=h,o=u;break}if(b===o){x=!0,o=h,a=u;break}b=b.sibling}if(!x)throw Error(s(189))}}if(a.alternate!==o)throw Error(s(190))}if(a.tag!==3)throw Error(s(188));return a.stateNode.current===a?e:n}function _(e){var n=e.tag;if(n===5||n===26||n===27||n===6)return e;for(e=e.child;e!==null;){if(n=_(e),n!==null)return n;e=e.sibling}return null}var g=Object.assign,v=Symbol.for("react.element"),y=Symbol.for("react.transitional.element"),T=Symbol.for("react.portal"),R=Symbol.for("react.fragment"),M=Symbol.for("react.strict_mode"),S=Symbol.for("react.profiler"),L=Symbol.for("react.consumer"),D=Symbol.for("react.context"),U=Symbol.for("react.forward_ref"),z=Symbol.for("react.suspense"),I=Symbol.for("react.suspense_list"),F=Symbol.for("react.memo"),Z=Symbol.for("react.lazy"),C=Symbol.for("react.activity"),w=Symbol.for("react.memo_cache_sentinel"),V=Symbol.iterator;function nt(e){return e===null||typeof e!="object"?null:(e=V&&e[V]||e["@@iterator"],typeof e=="function"?e:null)}var it=Symbol.for("react.client.reference");function dt(e){if(e==null)return null;if(typeof e=="function")return e.$$typeof===it?null:e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case R:return"Fragment";case S:return"Profiler";case M:return"StrictMode";case z:return"Suspense";case I:return"SuspenseList";case C:return"Activity"}if(typeof e=="object")switch(e.$$typeof){case T:return"Portal";case D:return e.displayName||"Context";case L:return(e._context.displayName||"Context")+".Consumer";case U:var n=e.render;return e=e.displayName,e||(e=n.displayName||n.name||"",e=e!==""?"ForwardRef("+e+")":"ForwardRef"),e;case F:return n=e.displayName||null,n!==null?n:dt(e.type)||"Memo";case Z:n=e._payload,e=e._init;try{return dt(e(n))}catch{}}return null}var rt=Array.isArray,B=t.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,H=i.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,$={pending:!1,data:null,method:null,action:null},yt=[],xt=-1;function O(e){return{current:e}}function K(e){0>xt||(e.current=yt[xt],yt[xt]=null,xt--)}function ft(e,n){xt++,yt[xt]=e.current,e.current=n}var Et=O(null),Rt=O(null),Q=O(null),ct=O(null);function Dt(e,n){switch(ft(Q,n),ft(Rt,e),ft(Et,null),n.nodeType){case 9:case 11:e=(e=n.documentElement)&&(e=e.namespaceURI)?o0(e):0;break;default:if(e=n.tagName,n=n.namespaceURI)n=o0(n),e=l0(n,e);else switch(e){case"svg":e=1;break;case"math":e=2;break;default:e=0}}K(Et),ft(Et,e)}function Gt(){K(Et),K(Rt),K(Q)}function qt(e){e.memoizedState!==null&&ft(ct,e);var n=Et.current,a=l0(n,e.type);n!==a&&(ft(Rt,e),ft(Et,a))}function ye(e){Rt.current===e&&(K(Et),K(Rt)),ct.current===e&&(K(ct),Uo._currentValue=$)}var Ue,fe;function gt(e){if(Ue===void 0)try{throw Error()}catch(a){var n=a.stack.trim().match(/\n( *(at )?)/);Ue=n&&n[1]||"",fe=-1<a.stack.indexOf(`
...
void main() {
	...
	`}function o1(r){let t=new WeakMap,i=null;function s(d){if(d&&d.isTexture){const m=d.mapping,p=m===td||m===ed,_=m===Us||m===Or;if(p||_){let g=t.get(d);const v=g!==void 0?g.texture.pmremVersion:0;if(d.isRenderTargetTexture&&d.pmremVersion!==v)return i===null&&(i=new U_(r)),g=p?i.fromEquirectangular(d,g):i.fromCubemap(d,g),g.texture.pmremVersion=d.pmremVersion,t.set(d,g),g.texture;if(g!==void 0)return g.texture;{const y=d.image;return p&&y&&y.height>0||_&&y&&l(y)?(i===null&&(i=new U_(r)),g=p?i.fromEquirectangular(d):i.fromCubemap(d),g.texture.pmremVersion=d.pmremVersion,t.set(d,g),d.addEventListener("dispose",c),g.texture):null}}}return d}function l(d){let m=0;const p=6;for(let _=0;_<p;_++)d[_]!==void 0&&m++;return m===p}function c(d){const m=d.target;m.removeEventListener("dispose",c);const p=t.get(m);p!==void 0&&(t.delete(m),p.dispose())}function f(){t=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:s,dispose:f}}function l1(r){const t={};function i(s){if(t[s]!==void 0)return t[s];const l=r.getExtension(s);return t[s]=l,l}return{has:function(s){return i(s)!==null},init:function(){i("EXT_color_buffer_float"),i("WEBGL_clip_cull_distance"),i("OES_texture_float_linear"),i("EXT_color_buffer_half_float"),i("WEBGL_multisampled_render_to_texture"),i("WEBGL_render_shared_exponent")},get:function(s){const l=i(s);return l===null&&Jo("WebGLRenderer: "+s+" extension not supported."),l}}}function c1(r,t,i,s){const l={},c=new WeakMap;function f(g){const v=g.target;v.index!==null&&t.remove(v.index);for(const T in v.attributes)t.remove(v.attributes[T]);v.removeEventListener("dispose",f),delete l[v.id];const y=c.get(v);y&&(t.remove(y),c.delete(v)),s.releaseStatesOfGeometry(v),v.isInstancedBufferGeometry===!0&&delete v._maxInstanceCount,i.memory.geometries--}function d(g,v){return l[v.id]===!0||(v.addEventListener("dispose",f),l[v.id]=!0,i.memory.geometries++),v}function m(g){const v=g.attributes;for(const y in v)t.update(v[y],r.ARRAY_BUFFER)}function p(g){const v=[],y=g.index,T=g.attributes.position;let R=0;if(y!==null){const L=y.array;R=y.version;for(let D=0,U=L.length;D<U;D+=3){const z=L[D+0],I=L[D+1],F=L[D+2];v.push(z,I,I,F,F,z)}}else if(T!==void 0){const L=T.array;R=T.version;for(let D=0,U=L.length/3-1;D<U;D+=3){const z=D+0,I=D+1,F=D+2;v.push(z,I,I,F,F,z)}}else return;const M=new(vv(v)?Ev:Mv)(v,1);M.version=R;const S=c.get(g);S&&t.remove(S),c.set(g,M)}function _(g){const v=c.get(g);if(v){const y=g.index;y!==null&&v.version<y.version&&p(g)}else p(g);return c.get(g)}return{get:d,update:m,getWireframeAttribute:_}}function u1(r,t,i){let s;function l(v){s=v}let c,f;function d(v){c=v.type,f=v.bytesPerElement}function m(v,y){r.drawElements(s,y,c,v*f),i.update(y,s,1)}function p(v,y,T){T!==0&&(r.drawElementsInstanced(s,y,c,v*f,T),i.update(y,s,T))}function _(v,y,T){if(T===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(s,y,0,c,v,0,T);let M=0;for(let S=0;S<T;S++)M+=y[S];i.update(M,s,1)}function g(v,y,T,R){if(T===0)return;const M=t.get("WEBGL_multi_draw");if(M===null)for(let S=0;S<v.length;S++)p(v[S]/f,y[S],R[S]);else{M.multiDrawElementsInstancedWEBGL(s,y,0,c,v,0,R,0,T);let S=0;for(let L=0;L<T;L++)S+=y[L]*R[L];i.update(S,s,1)}}this.setMode=l,this.setIndex=d,this.render=m,this.renderInstances=p,this.renderMultiDraw=_,this.renderMultiDrawInstances=g}function f1(r){const t={geometries:0,textures:0},i={frame:0,calls:0,triangles:0,points:0,lines:0};function s(c,f,d){switch(i.calls++,f){case r.TRIANGLES:i.triangles+=d*(c/3);break;case r.LINES:i.lines+=d*(c/2);break;case r.LINE_STRIP:i.lines+=d*(c-1);break;case r.LINE_LOOP:i.lines+=d*c;break;case r.POINTS:i.points+=d*c;break;default:we("WebGLInfo: Unknown draw mode:",f);break}}function l(){i.calls=0,i.triangles=0,i.points=0,i.lines=0}return{memory:t,render:i,programs:null,autoReset:!0,reset:l,update:s}}function h1(r,t,i){const s=new WeakMap,l=new an;function c(f,d,m){const p=f.morphTargetInfluences,_=d.morphAttributes.position||d.morphAttributes.normal||d.morphAttributes.color,g=_!==void 0?_.length:0;let v=s.get(d);if(v===void 0||v.count!==g){let w=function(){Z.dispose(),s.delete(d),d.removeEventListener("dispose",w)};var y=w;v!==void 0&&v.texture.dispose();const T=d.morphAttributes.position!==void 0,R=d.morphAttributes.normal!==void 0,M=d.morphAttributes.color!==void 0,S=d.morphAttributes.position||[],L=d.morphAttributes.normal||[],D=d.morphAttributes.color||[];let U=0;T===!0&&(U=1),R===!0&&(U=2),M===!0&&(U=3);let z=d.attributes.position.count*U,I=1;z>t.maxTextureSize&&(I=Math.ceil(z/t.maxTextureSize),z=t.maxTextureSize);const F=new Float32Array(z*I*4*g),Z=new xv(F,z,I,g);Z.type=zi,Z.needsUpdate=!0;const C=U*4;for(let V=0;V<g;V++){const nt=S[V],it=L[V],dt=D[V],rt=z*I*4*V;for(let B=0;B<nt.count;B++){const H=B*C;T===!0&&(l.fromBufferAttribute(nt,B),F[rt+H+0]=l.x,F[rt+H+1]=l.y,F[rt+H+2]=l.z,F[rt+H+3]=0),R===!0&&(l.fromBufferAttribute(it,B),F[rt+H+4]=l.x,F[rt+H+5]=l.y,F[rt+H+6]=l.z,F[rt+H+7]=0),M===!0&&(l.fromBufferAttribute(dt,B),F[rt+H+8]=l.x,F[rt+H+9]=l.y,F[rt+H+10]=l.z,F[rt+H+11]=dt.itemSize===4?l.w:1)}}v={count:g,texture:Z,size:new Wt(z,I)},s.set(d,v),d.addEventListener("dispose",w)}if(f.isInstancedMesh===!0&&f.morphTexture!==null)m.getUniforms().setValue(r,"morphTexture",f.morphTexture,i);else{let T=0;for(let M=0;M<p.length;M++)T+=p[M];const R=d.morphTargetsRelative?1:1-T;m.getUniforms().setValue(r,"morphTargetBaseInfluence",R),m.getUniforms().setValue(r,"morphTargetInfluences",p)}m.getUniforms().setValue(r,"morphTargetsTexture",v.texture,i),m.getUniforms().setValue(r,"morphTargetsTextureSize",v.size)}return{update:c}}function d1(r,t,i,s){let l=new WeakMap;function c(m){const p=s.render.frame,_=m.geometry,g=t.get(m,_);if(l.get(g)!==p&&(t.update(g),l.set(g,p)),m.isInstancedMesh&&(m.hasEventListener("dispose",d)===!1&&m.addEventListener("dispose",d),l.get(m)!==p&&(i.update(m.instanceMatrix,r.ARRAY_BUFFER),m.instanceColor!==null&&i.update(m.instanceColor,r.ARRAY_BUFFER),l.set(m,p))),m.isSkinnedMesh){const v=m.skeleton;l.get(v)!==p&&(v.update(),l.set(v,p))}return g}function f(){l=new WeakMap}function d(m){const p=m.target;p.removeEventListener("dispose",d),i.remove(p.instanceMatrix),p.instanceColor!==null&&i.remove(p.instanceColor)}return{update:c,dispose:f}}const p1={[nv]:"LINEAR_TONE_MAPPING",[iv]:"REINHARD_TONE_MAPPING",[av]:"CINEON_TONE_MAPPING",[sv]:"ACES_FILMIC_TONE_MAPPING",[ov]:"AGX_TONE_MAPPING",[lv]:"NEUTRAL_TONE_MAPPING",[rv]:"CUSTOM_TONE_MAPPING"};function m1(r,t,i,s,l){const c=new Ii(t,i,{type:r,depthBuffer:s,stencilBuffer:l}),f=new Ii(t,i,{type:xa,depthBuffer:!1,stencilBuffer:!1}),d=new ki;d.setAttribute("position",new Ri([-1,3,0,-1,-1,0,3,-1,0],3)),d.setAttribute("uv",new Ri([0,2,0,0,2,0],2));const m=new sE({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
`].filter(qo).join(`
`)),f=Gd(f),f=k_(f,i),f=W_(f,i),d=Gd(d),d=k_(d,i),d=W_(d,i),f=q_(f),d=q_(d),i.isRawShaderMaterial!==!0&&(L=`#version 300 es
...
`)+`
`+S);const D=L+M+f,U=L+S+d,z=G_(l,l.VERTEX_SHADER,D),I=G_(l,l.FRAGMENT_SHADER,U);l.attachShader(R,z),l.attachShader(R,I),i.index0AttributeName!==void 0?l.bindAttribLocation(R,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(R,0,"position"),l.linkProgram(R);function F(V){if(r.debug.checkShaderErrors){const nt=l.getProgramInfoLog(R)||"",it=l.getShaderInfoLog(z)||"",dt=l.getShaderInfoLog(I)||"",rt=nt.trim(),B=it.trim(),H=dt.trim();let $=!0,yt=!0;if(l.getProgramParameter(R,l.LINK_STATUS)===!1)if($=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(l,R,z,I);else{const xt=X_(l,z,"vertex"),O=X_(l,I,"fragment");we("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(R,l.VALIDATE_STATUS)+`
...
Program Info Log: `+rt+`
`+xt+`
`+O)}else rt!==""?pe("WebGLProgram: Program Info Log:",rt):(B===""||H==="")&&(yt=!1);yt&&(V.diagnostics={runnable:$,programLog:rt,vertexShader:{log:B,prefix:M},fragmentShader:{log:H,prefix:S}})}l.deleteShader(z),l.deleteShader(I),Z=new Yc(l,R),C=gA(l,R)}let Z;this.getUniforms=function(){return Z===void 0&&F(this),Z};let C;this.getAttributes=function(){return C===void 0&&F(this),C};let w=i.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return w===!1&&(w=l.getProgramParameter(R,rA)),w},this.destroy=function(){s.releaseStatesOfProgram(this),l.deleteProgram(R),this.program=void 0},this.type=i.shaderType,this.name=i.shaderName,this.id=oA++,this.cacheKey=t,this.usedTimes=1,this.program=R,this.vertexShader=z,this.fragmentShader=I,this}let NA=0;class LA{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(t){const i=t.vertexShader,s=t.fragmentShader,l=this._getShaderStage(i),c=this._getShaderStage(s),f=this._getShaderCacheForMaterial(t);return f.has(l)===!1&&(f.add(l),l.usedTimes++),f.has(c)===!1&&(f.add(c),c.usedTimes++),this}remove(t){const i=this.materialCache.get(t);for(const s of i)s.usedTimes--,s.usedTimes===0&&this.shaderCache.delete(s.code);return this.materialCache.delete(t),this}getVertexShaderID(t){return this._getShaderStage(t.vertexShader).id}getFragmentShaderID(t){return this._getShaderStage(t.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(t){const i=this.materialCache;let s=i.get(t);return s===void 0&&(s=new Set,i.set(t,s)),s}_getShaderStage(t){const i=this.shaderCache;let s=i.get(t);return s===void 0&&(s=new OA(t),i.set(t,s)),s}}class OA{constructor(t){this.id=NA++,this.code=t,this.usedTimes=0}}function PA(r,t,i,s,l,c,f){const d=new Sv,m=new LA,p=new Set,_=[],g=new Map,v=l.logarithmicDepthBuffer;let y=l.precision;const T={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function R(C){return p.add(C),C===0?"uv":`uv${C}`}function M(C,w,V,nt,it){const dt=nt.fog,rt=it.geometry,B=C.isMeshStandardMaterial?nt.environment:null,H=(C.isMeshStandardMaterial?i:t).get(C.envMap||B),$=H&&H.mapping===Jc?H.image.height:null,yt=T[C.type];C.precision!==null&&(y=l.getMaxPrecision(C.precision),y!==C.precision&&pe("WebGLProgram.getParameters:",C.precision,"not supported, using",y,"instead."));const xt=rt.morphAttributes.position||rt.morphAttributes.normal||rt.morphAttributes.color,O=xt!==void 0?xt.length:0;let K=0;rt.morphAttributes.position!==void 0&&(K=1),rt.morphAttributes.normal!==void 0&&(K=2),rt.morphAttributes.color!==void 0&&(K=3);let ft,Et,Rt,Q;if(yt){const Ce=Pi[yt];ft=Ce.vertexShader,Et=Ce.fragmentShader}else ft=C.vertexShader,Et=C.fragmentShader,m.update(C),Rt=m.getVertexShaderID(C),Q=m.getFragmentShaderID(C);const ct=r.getRenderTarget(),Dt=r.state.buffers.depth.getReversed(),Gt=it.isInstancedMesh===!0,qt=it.isBatchedMesh===!0,ye=!!C.map,Ue=!!C.matcap,fe=!!H,gt=!!C.aoMap,At=!!C.lightMap,Mt=!!C.bumpMap,Ft=!!C.normalMap,P=!!C.displacementMap,ne=!!C.emissiveMap,Ht=!!C.metalnessMap,ae=!!C.roughnessMap,Ut=C.anisotropy>0,N=C.clearcoat>0,E=C.dispersion>0,W=C.iridescence>0,ut=C.sheen>0,St=C.transmission>0,ht=Ut&&!!C.anisotropyMap,Qt=N&&!!C.clearcoatMap,Lt=N&&!!C.clearcoatNormalMap,Jt=N&&!!C.clearcoatRoughnessMap,le=W&&!!C.iridescenceMap,Tt=W&&!!C.iridescenceThicknessMap,Ct=ut&&!!C.sheenColorMap,Yt=ut&&!!C.sheenRoughnessMap,Vt=!!C.specularMap,Ot=!!C.specularColorMap,_e=!!C.specularIntensityMap,k=St&&!!C.transmissionMap,zt=St&&!!C.thicknessMap,wt=!!C.gradientMap,Xt=!!C.alphaMap,bt=C.alphaTest>0,vt=!!C.alphaHash,Nt=!!C.extensions;let he=Bi;C.toneMapped&&(ct===null||ct.isXRRenderTarget===!0)&&(he=r.toneMapping);const Ie={shaderID:yt,shaderType:C.type,shaderName:C.name,vertexShader:ft,fragmentShader:Et,defines:C.defines,customVertexShaderID:Rt,customFragmentShaderID:Q,isRawShaderMaterial:C.isRawShaderMaterial===!0,glslVersion:C.glslVersion,precision:y,batching:qt,batchingColor:qt&&it._colorsTexture!==null,instancing:Gt,instancingColor:Gt&&it.instanceColor!==null,instancingMorph:Gt&&it.morphTexture!==null,outputColorSpace:ct===null?r.outputColorSpace:ct.isXRRenderTarget===!0?ct.texture.colorSpace:zr,alphaToCoverage:!!C.alphaToCoverage,map:ye,matcap:Ue,envMap:fe,envMapMode:fe&&H.mapping,envMapCubeUVHeight:$,aoMap:gt,lightMap:At,bumpMap:Mt,normalMap:Ft,displacementMap:P,emissiveMap:ne,normalMapObjectSpace:Ft&&C.normalMapType===Iy,normalMapTangentSpace:Ft&&C.normalMapType===_v,metalnessMap:Ht,roughnessMap:ae,anisotropy:Ut,anisotropyMap:ht,clearcoat:N,clearcoatMap:Qt,clearcoatNormalMap:Lt,clearcoatRoughnessMap:Jt,dispersion:E,iridescence:W,iridescenceMap:le,iridescenceThicknessMap:Tt,sheen:ut,sheenColorMap:Ct,sheenRoughnessMap:Yt,specularMap:Vt,specularColorMap:Ot,specularIntensityMap:_e,transmission:St,transmissionMap:k,thicknessMap:zt,gradientMap:wt,opaque:C.transparent===!1&&C.blending===Ur&&C.alphaToCoverage===!1,alphaMap:Xt,alphaTest:bt,alphaHash:vt,combine:C.combine,mapUv:ye&&R(C.map.channel),aoMapUv:gt&&R(C.aoMap.channel),lightMapUv:At&&R(C.lightMap.channel),bumpMapUv:Mt&&R(C.bumpMap.channel),normalMapUv:Ft&&R(C.normalMap.channel),displacementMapUv:P&&R(C.displacementMap.channel),emissiveMapUv:ne&&R(C.emissiveMap.channel),metalnessMapUv:Ht&&R(C.metalnessMap.channel),roughnessMapUv:ae&&R(C.roughnessMap.channel),anisotropyMapUv:ht&&R(C.anisotropyMap.channel),clearcoatMapUv:Qt&&R(C.clearcoatMap.channel),clearcoatNormalMapUv:Lt&&R(C.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:Jt&&R(C.clearcoatRoughnessMap.channel),iridescenceMapUv:le&&R(C.iridescenceMap.channel),iridescenceThicknessMapUv:Tt&&R(C.iridescenceThicknessMap.channel),sheenColorMapUv:Ct&&R(C.sheenColorMap.channel),sheenRoughnessMapUv:Yt&&R(C.sheenRoughnessMap.channel),specularMapUv:Vt&&R(C.specularMap.channel),specularColorMapUv:Ot&&R(C.specularColorMap.channel),specularIntensityMapUv:_e&&R(C.specularIntensityMap.channel),transmissionMapUv:k&&R(C.transmissionMap.channel),thicknessMapUv:zt&&R(C.thicknessMap.channel),alphaMapUv:Xt&&R(C.alphaMap.channel),vertexTangents:!!rt.attributes.tangent&&(Ft||Ut),vertexColors:C.vertexColors,vertexAlphas:C.vertexColors===!0&&!!rt.attributes.color&&rt.attributes.color.itemSize===4,pointsUvs:it.isPoints===!0&&!!rt.attributes.uv&&(ye||Xt),fog:!!dt,useFog:C.fog===!0,fogExp2:!!dt&&dt.isFogExp2,flatShading:C.flatShading===!0&&C.wireframe===!1,sizeAttenuation:C.sizeAttenuation===!0,logarithmicDepthBuffer:v,reversedDepthBuffer:Dt,skinning:it.isSkinnedMesh===!0,morphTargets:rt.morphAttributes.position!==void 0,morphNormals:rt.morphAttributes.normal!==void 0,morphColors:rt.morphAttributes.color!==void 0,morphTargetsCount:O,morphTextureStride:K,numDirLights:w.directional.length,numPointLights:w.point.length,numSpotLights:w.spot.length,numSpotLightMaps:w.spotLightMap.length,numRectAreaLights:w.rectArea.length,numHemiLights:w.hemi.length,numDirLightShadows:w.directionalShadowMap.length,numPointLightShadows:w.pointShadowMap.length,numSpotLightShadows:w.spotShadowMap.length,numSpotLightShadowsWithMaps:w.numSpotLightShadowsWithMaps,numLightProbes:w.numLightProbes,numClippingPlanes:f.numPlanes,numClipIntersection:f.numIntersection,dithering:C.dithering,shadowMapEnabled:r.shadowMap.enabled&&V.length>0,shadowMapType:r.shadowMap.type,toneMapping:he,decodeVideoTexture:ye&&C.map.isVideoTexture===!0&&De.getTransfer(C.map.colorSpace)===Xe,decodeVideoTextureEmissive:ne&&C.emissiveMap.isVideoTexture===!0&&De.getTransfer(C.emissiveMap.colorSpace)===Xe,premultipliedAlpha:C.premultipliedAlpha,doubleSided:C.side===ma,flipSided:C.side===qn,useDepthPacking:C.depthPacking>=0,depthPacking:C.depthPacking||0,index0AttributeName:C.index0AttributeName,extensionClipCullDistance:Nt&&C.extensions.clipCullDistance===!0&&s.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(Nt&&C.extensions.multiDraw===!0||qt)&&s.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:s.has("KHR_parallel_shader_compile"),customProgramCacheKey:C.customProgramCacheKey()};return Ie.vertexUv1s=p.has(1),Ie.vertexUv2s=p.has(2),Ie.vertexUv3s=p.has(3),p.clear(),Ie}function S(C){const w=[];if(C.shaderID?w.push(C.shaderID):(w.push(C.customVertexShaderID),w.push(C.customFragmentShaderID)),C.defines!==void 0)for(const V in C.defines)w.push(V),w.push(C.defines[V]);return C.isRawShaderMaterial===!1&&(L(w,C),D(w,C),w.push(r.outputColorSpace)),w.push(C.customProgramCacheKey),w.join()}function L(C,w){C.push(w.precision),C.push(w.outputColorSpace),C.push(w.envMapMode),C.push(w.envMapCubeUVHeight),C.push(w.mapUv),C.push(w.alphaMapUv),C.push(w.lightMapUv),C.push(w.aoMapUv),C.push(w.bumpMapUv),C.push(w.normalMapUv),C.push(w.displacementMapUv),C.push(w.emissiveMapUv),C.push(w.metalnessMapUv),C.push(w.roughnessMapUv),C.push(w.anisotropyMapUv),C.push(w.clearcoatMapUv),C.push(w.clearcoatNormalMapUv),C.push(w.clearcoatRoughnessMapUv),C.push(w.iridescenceMapUv),C.push(w.iridescenceThicknessMapUv),C.push(w.sheenColorMapUv),C.push(w.sheenRoughnessMapUv),C.push(w.specularMapUv),C.push(w.specularColorMapUv),C.push(w.specularIntensityMapUv),C.push(w.transmissionMapUv),C.push(w.thicknessMapUv),C.push(w.combine),C.push(w.fogExp2),C.push(w.sizeAttenuation),C.push(w.morphTargetsCount),C.push(w.morphAttributeCount),C.push(w.numDirLights),C.push(w.numPointLights),C.push(w.numSpotLights),C.push(w.numSpotLightMaps),C.push(w.numHemiLights),C.push(w.numRectAreaLights),C.push(w.numDirLightShadows),C.push(w.numPointLightShadows),C.push(w.numSpotLightShadows),C.push(w.numSpotLightShadowsWithMaps),C.push(w.numLightProbes),C.push(w.shadowMapType),C.push(w.toneMapping),C.push(w.numClippingPlanes),C.push(w.numClipIntersection),C.push(w.depthPacking)}function D(C,w){d.disableAll(),w.instancing&&d.enable(0),w.instancingColor&&d.enable(1),w.instancingMorph&&d.enable(2),w.matcap&&d.enable(3),w.envMap&&d.enable(4),w.normalMapObjectSpace&&d.enable(5),w.normalMapTangentSpace&&d.enable(6),w.clearcoat&&d.enable(7),w.iridescence&&d.enable(8),w.alphaTest&&d.enable(9),w.vertexColors&&d.enable(10),w.vertexAlphas&&d.enable(11),w.vertexUv1s&&d.enable(12),w.vertexUv2s&&d.enable(13),w.vertexUv3s&&d.enable(14),w.vertexTangents&&d.enable(15),w.anisotropy&&d.enable(16),w.alphaHash&&d.enable(17),w.batching&&d.enable(18),w.dispersion&&d.enable(19),w.batchingColor&&d.enable(20),w.gradientMap&&d.enable(21),C.push(d.mask),d.disableAll(),w.fog&&d.enable(0),w.useFog&&d.enable(1),w.flatShading&&d.enable(2),w.logarithmicDepthBuffer&&d.enable(3),w.reversedDepthBuffer&&d.enable(4),w.skinning&&d.enable(5),w.morphTargets&&d.enable(6),w.morphNormals&&d.enable(7),w.morphColors&&d.enable(8),w.premultipliedAlpha&&d.enable(9),w.shadowMapEnabled&&d.enable(10),w.doubleSided&&d.enable(11),w.flipSided&&d.enable(12),w.useDepthPacking&&d.enable(13),w.dithering&&d.enable(14),w.transmission&&d.enable(15),w.sheen&&d.enable(16),w.opaque&&d.enable(17),w.pointsUvs&&d.enable(18),w.decodeVideoTexture&&d.enable(19),w.decodeVideoTextureEmissive&&d.enable(20),w.alphaToCoverage&&d.enable(21),C.push(d.mask)}function U(C){const w=T[C.type];let V;if(w){const nt=Pi[w];V=pM.clone(nt.uniforms)}else V=C.uniforms;return V}function z(C,w){let V=g.get(w);return V!==void 0?++V.usedTimes:(V=new UA(r,w,C,c),_.push(V),g.set(w,V)),V}function I(C){if(--C.usedTimes===0){const w=_.indexOf(C);_[w]=_[_.length-1],_.pop(),g.delete(C.cacheKey),C.destroy()}}function F(C){m.remove(C)}function Z(){m.dispose()}return{getParameters:M,getProgramCacheKey:S,getUniforms:U,acquireProgram:z,releaseProgram:I,releaseShaderCache:F,programs:_,dispose:Z}}function zA(){let r=new WeakMap;function t(f){return r.has(f)}function i(f){let d=r.get(f);return d===void 0&&(d={},r.set(f,d)),d}function s(f){r.delete(f)}function l(f,d,m){r.get(f)[d]=m}function c(){r=new WeakMap}return{has:t,get:i,remove:s,update:l,dispose:c}}function FA(r,t){return r.groupOrder!==t.groupOrder?r.groupOrder-t.groupOrder:r.renderOrder!==t.renderOrder?r.renderOrder-t.renderOrder:r.material.id!==t.material.id?r.material.id-t.material.id:r.z!==t.z?r.z-t.z:r.id-t.id}function Z_(r,t){return r.groupOrder!==t.groupOrder?r.groupOrder-t.groupOrder:r.renderOrder!==t.renderOrder?r.renderOrder-t.renderOrder:r.z!==t.z?t.z-r.z:r.id-t.id}function j_(){const r=[];let t=0;const i=[],s=[],l=[];function c(){t=0,i.length=0,s.length=0,l.length=0}function f(g,v,y,T,R,M){let S=r[t];return S===void 0?(S={id:g.id,object:g,geometry:v,material:y,groupOrder:T,renderOrder:g.renderOrder,z:R,group:M},r[t]=S):(S.id=g.id,S.object=g,S.geometry=v,S.material=y,S.groupOrder=T,S.renderOrder=g.renderOrder,S.z=R,S.group=M),t++,S}function d(g,v,y,T,R,M){const S=f(g,v,y,T,R,M);y.transmission>0?s.push(S):y.transparent===!0?l.push(S):i.push(S)}function m(g,v,y,T,R,M){const S=f(g,v,y,T,R,M);y.transmission>0?s.unshift(S):y.transparent===!0?l.unshift(S):i.unshift(S)}function p(g,v){i.length>1&&i.sort(g||FA),s.length>1&&s.sort(v||Z_),l.length>1&&l.sort(v||Z_)}function _(){for(let g=t,v=r.length;g<v;g++){const y=r[g];if(y.id===null)break;y.id=null,y.object=null,y.geometry=null,y.material=null,y.group=null}}return{opaque:i,transmissive:s,transparent:l,init:c,push:d,unshift:m,finish:_,sort:p}}function BA(){let r=new WeakMap;function t(s,l){const c=r.get(s);let f;return c===void 0?(f=new j_,r.set(s,[f])):l>=c.length?(f=new j_,c.push(f)):f=c[l],f}function i(){r=new WeakMap}return{get:t,dispose:i}}function IA(){const r={};return{get:function(t){if(r[t.id]!==void 0)return r[t.id];let i;switch(t.type){case"DirectionalLight":i={direction:new j,color:new Fe};break;case"SpotLight":i={position:new j,direction:new j,color:new Fe,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":i={position:new j,color:new Fe,distance:0,decay:0};break;case"HemisphereLight":i={direction:new j,skyColor:new Fe,groundColor:new Fe};break;case"RectAreaLight":i={color:new Fe,position:new j,halfWidth:new j,halfHeight:new j};break}return r[t.id]=i,i}}}function HA(){const r={};return{get:function(t){if(r[t.id]!==void 0)return r[t.id];let i;switch(t.type){case"DirectionalLight":i={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Wt};break;case"SpotLight":i={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Wt};break;case"PointLight":i={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Wt,shadowCameraNear:1,shadowCameraFar:1e3};break}return r[t.id]=i,i}}}let GA=0;function VA(r,t){return(t.castShadow?2:0)-(r.castShadow?2:0)+(t.map?1:0)-(r.map?1:0)}function XA(r){const t=new IA,i=HA(),s={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let p=0;p<9;p++)s.probe.push(new j);const l=new j,c=new tn,f=new tn;function d(p){let _=0,g=0,v=0;for(let C=0;C<9;C++)s.probe[C].set(0,0,0);let y=0,T=0,R=0,M=0,S=0,L=0,D=0,U=0,z=0,I=0,F=0;p.sort(VA);for(let C=0,w=p.length;C<w;C++){const V=p[C],nt=V.color,it=V.intensity,dt=V.distance;let rt=null;if(V.shadow&&V.shadow.map&&(V.shadow.map.texture.format===Pr?rt=V.shadow.map.texture:rt=V.shadow.map.depthTexture||V.shadow.map.texture),V.isAmbientLight)_+=nt.r*it,g+=nt.g*it,v+=nt.b*it;else if(V.isLightProbe){for(let B=0;B<9;B++)s.probe[B].addScaledVector(V.sh.coefficients[B],it);F++}else if(V.isDirectionalLight){const B=t.get(V);if(B.color.copy(V.color).multiplyScalar(V.intensity),V.castShadow){const H=V.shadow,$=i.get(V);$.shadowIntensity=H.intensity,$.shadowBias=H.bias,$.shadowNormalBias=H.normalBias,$.shadowRadius=H.radius,$.shadowMapSize=H.mapSize,s.directionalShadow[y]=$,s.directionalShadowMap[y]=rt,s.directionalShadowMatrix[y]=V.shadow.matrix,L++}s.directional[y]=B,y++}else if(V.isSpotLight){const B=t.get(V);B.position.setFromMatrixPosition(V.matrixWorld),B.color.copy(nt).multiplyScalar(it),B.distance=dt,B.coneCos=Math.cos(V.angle),B.penumbraCos=Math.cos(V.angle*(1-V.penumbra)),B.decay=V.decay,s.spot[R]=B;const H=V.shadow;if(V.map&&(s.spotLightMap[z]=V.map,z++,H.updateMatrices(V),V.castShadow&&I++),s.spotLightMatrix[R]=H.matrix,V.castShadow){const $=i.get(V);$.shadowIntensity=H.intensity,$.shadowBias=H.bias,$.shadowNormalBias=H.normalBias,$.shadowRadius=H.radius,$.shadowMapSize=H.mapSize,s.spotShadow[R]=$,s.spotShadowMap[R]=rt,U++}R++}else if(V.isRectAreaLight){const B=t.get(V);B.color.copy(nt).multiplyScalar(it),B.halfWidth.set(V.width*.5,0,0),B.halfHeight.set(0,V.height*.5,0),s.rectArea[M]=B,M++}else if(V.isPointLight){const B=t.get(V);if(B.color.copy(V.color).multiplyScalar(V.intensity),B.distance=V.distance,B.decay=V.decay,V.castShadow){const H=V.shadow,$=i.get(V);$.shadowIntensity=H.intensity,$.shadowBias=H.bias,$.shadowNormalBias=H.normalBias,$.shadowRadius=H.radius,$.shadowMapSize=H.mapSize,$.shadowCameraNear=H.camera.near,$.shadowCameraFar=H.camera.far,s.pointShadow[T]=$,s.pointShadowMap[T]=rt,s.pointShadowMatrix[T]=V.shadow.matrix,D++}s.point[T]=B,T++}else if(V.isHemisphereLight){const B=t.get(V);B.skyColor.copy(V.color).multiplyScalar(it),B.groundColor.copy(V.groundColor).multiplyScalar(it),s.hemi[S]=B,S++}}M>0&&(r.has("OES_texture_float_linear")===!0?(s.rectAreaLTC1=It.LTC_FLOAT_1,s.rectAreaLTC2=It.LTC_FLOAT_2):(s.rectAreaLTC1=It.LTC_HALF_1,s.rectAreaLTC2=It.LTC_HALF_2)),s.ambient[0]=_,s.ambient[1]=g,s.ambient[2]=v;const Z=s.hash;(Z.directionalLength!==y||Z.pointLength!==T||Z.spotLength!==R||Z.rectAreaLength!==M||Z.hemiLength!==S||Z.numDirectionalShadows!==L||Z.numPointShadows!==D||Z.numSpotShadows!==U||Z.numSpotMaps!==z||Z.numLightProbes!==F)&&(s.directional.length=y,s.spot.length=R,s.rectArea.length=M,s.point.length=T,s.hemi.length=S,s.directionalShadow.length=L,s.directionalShadowMap.length=L,s.pointShadow.length=D,s.pointShadowMap.length=D,s.spotShadow.length=U,s.spotShadowMap.length=U,s.directionalShadowMatrix.length=L,s.pointShadowMatrix.length=D,s.spotLightMatrix.length=U+z-I,s.spotLightMap.length=z,s.numSpotLightShadowsWithMaps=I,s.numLightProbes=F,Z.directionalLength=y,Z.pointLength=T,Z.spotLength=R,Z.rectAreaLength=M,Z.hemiLength=S,Z.numDirectionalShadows=L,Z.numPointShadows=D,Z.numSpotShadows=U,Z.numSpotMaps=z,Z.numLightProbes=F,s.version=GA++)}function m(p,_){let g=0,v=0,y=0,T=0,R=0;const M=_.matrixWorldInverse;for(let S=0,L=p.length;S<L;S++){const D=p[S];if(D.isDirectionalLight){const U=s.directional[g];U.direction.setFromMatrixPosition(D.matrixWorld),l.setFromMatrixPosition(D.target.matrixWorld),U.direction.sub(l),U.direction.transformDirection(M),g++}else if(D.isSpotLight){const U=s.spot[y];U.position.setFromMatrixPosition(D.matrixWorld),U.position.applyMatrix4(M),U.direction.setFromMatrixPosition(D.matrixWorld),l.setFromMatrixPosition(D.target.matrixWorld),U.direction.sub(l),U.direction.transformDirection(M),y++}else if(D.isRectAreaLight){const U=s.rectArea[T];U.position.setFromMatrixPosition(D.matrixWorld),U.position.applyMatrix4(M),f.identity(),c.copy(D.matrixWorld),c.premultiply(M),f.extractRotation(c),U.halfWidth.set(D.width*.5,0,0),U.halfHeight.set(0,D.height*.5,0),U.halfWidth.applyMatrix4(f),U.halfHeight.applyMatrix4(f),T++}else if(D.isPointLight){const U=s.point[v];U.position.setFromMatrixPosition(D.matrixWorld),U.position.applyMatrix4(M),v++}else if(D.isHemisphereLight){const U=s.hemi[R];U.direction.setFromMatrixPosition(D.matrixWorld),U.direction.transformDirection(M),R++}}}return{setup:d,setupView:m,state:s}}function K_(r){const t=new XA(r),i=[],s=[];function l(_){p.camera=_,i.length=0,s.length=0}function c(_){i.push(_)}function f(_){s.push(_)}function d(){t.setup(i)}function m(_){t.setupView(i,_)}const p={lightsArray:i,shadowsArray:s,camera:null,lights:t,transmissionRenderTarget:{}};return{init:l,state:p,setupLights:d,setupLightsView:m,pushLight:c,pushShadow:f}}function kA(r){let t=new WeakMap;function i(l,c=0){const f=t.get(l);let d;return f===void 0?(d=new K_(r),t.set(l,[d])):c>=f.length?(d=new K_(r),f.push(d)):d=f[c],d}function s(){t=new WeakMap}return{get:i,dispose:s}}const WA=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,YA=[new j(1,0,0),new j(-1,0,0),new j(0,1,0),new j(0,-1,0),new j(0,0,1),new j(0,0,-1)],ZA=[new j(0,-1,0),new j(0,-1,0),new j(0,0,1),new j(0,0,-1),new j(0,-1,0),new j(0,-1,0)],J_=new tn,Xo=new j,kh=new j;function jA(r,t,i){let s=new ep;const l=new Wt,c=new Wt,f=new an,d=new oE,m=new lE,p={},_=i.maxTextureSize,g={[es]:qn,[qn]:es,[ma]:ma},v=new Xi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Wt},radius:{value:4}},vertexShader:WA,fragmentShader:qA}),y=v.clone();y.defines.HORIZONTAL_PASS=1;const T=new ki;T.setAttribute("position",new Hi(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const R=new Ci(T,v),M=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Vc;let S=this.type;this.render=function(I,F,Z){if(M.enabled===!1||M.autoUpdate===!1&&M.needsUpdate===!1||I.length===0)return;I.type===gy&&(pe("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),I.type=Vc);const C=r.getRenderTarget(),w=r.getActiveCubeFace(),V=r.getActiveMipmapLevel(),nt=r.state;nt.setBlending(_a),nt.buffers.depth.getReversed()===!0?nt.buffers.color.setClear(0,0,0,0):nt.buffers.color.setClear(1,1,1,1),nt.buffers.depth.setTest(!0),nt.setScissorTest(!1);const it=S!==this.type;it&&F.traverse(function(dt){dt.material&&(Array.isArray(dt.material)?dt.material.forEach(rt=>rt.needsUpdate=!0):dt.material.needsUpdate=!0)});for(let dt=0,rt=I.length;dt<rt;dt++){const B=I[dt],H=B.shadow;if(H===void 0){pe("WebGLShadowMap:",B,"has no shadow.");continue}if(H.autoUpdate===!1&&H.needsUpdate===!1)continue;l.copy(H.mapSize);const $=H.getFrameExtents();if(l.multiply($),c.copy(H.mapSize),(l.x>_||l.y>_)&&(l.x>_&&(c.x=Math.floor(_/$.x),l.x=c.x*$.x,H.mapSize.x=c.x),l.y>_&&(c.y=Math.floor(_/$.y),l.y=c.y*$.y,H.mapSize.y=c.y)),H.map===null||it===!0){if(H.map!==null&&(H.map.depthTexture!==null&&(H.map.depthTexture.dispose(),H.map.depthTexture=null),H.map.dispose()),this.type===ko){if(B.isPointLight){pe("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}H.map=new Ii(l.x,l.y,{format:Pr,type:xa,minFilter:xn,magFilter:xn,generateMipmaps:!1}),H.map.texture.name=B.name+".shadowMap",H.map.depthTexture=new Qo(l.x,l.y,zi),H.map.depthTexture.name=B.name+".shadowMapDepth",H.map.depthTexture.format=Sa,H.map.depthTexture.compareFunction=null,H.map.depthTexture.minFilter=Dn,H.map.depthTexture.magFilter=Dn}else{B.isPointLight?(H.map=new Rv(l.x),H.map.depthTexture=new bM(l.x,Gi)):(H.map=new Ii(l.x,l.y),H.map.depthTexture=new Qo(l.x,l.y,Gi)),H.map.depthTexture.name=B.name+".shadowMap",H.map.depthTexture.format=Sa;const xt=r.state.buffers.depth.getReversed();this.type===Vc?(H.map.depthTexture.compareFunction=xt?Jd:Kd,H.map.depthTexture.minFilter=xn,H.map.depthTexture.magFilter=xn):(H.map.depthTexture.compareFunction=null,H.map.depthTexture.minFilter=Dn,H.map.depthTexture.magFilter=Dn)}H.camera.updateProjectionMatrix()}const yt=H.map.isWebGLCubeRenderTarget?6:1;for(let xt=0;xt<yt;xt++){if(H.map.isWebGLCubeRenderTarget)r.setRenderTarget(H.map,xt),r.clear();else{xt===0&&(r.setRenderTarget(H.map),r.clear());const O=H.getViewport(xt);f.set(c.x*O.x,c.y*O.y,c.x*O.z,c.y*O.w),nt.viewport(f)}if(B.isPointLight){const O=H.camera,K=H.matrix,ft=B.distance||O.far;ft!==O.far&&(O.far=ft,O.updateProjectionMatrix()),Xo.setFromMatrixPosition(B.matrixWorld),O.position.copy(Xo),kh.copy(O.position),kh.add(YA[xt]),O.up.copy(ZA[xt]),O.lookAt(kh),O.updateMatrixWorld(),K.makeTranslation(-Xo.x,-Xo.y,-Xo.z),J_.multiplyMatrices(O.projectionMatrix,O.matrixWorldInverse),H._frustum.setFromProjectionMatrix(J_,O.coordinateSystem,O.reversedDepth)}else H.updateMatrices(B);s=H.getFrustum(),U(F,Z,H.camera,B,this.type)}H.isPointLightShadow!==!0&&this.type===ko&&L(H,Z),H.needsUpdate=!1}S=this.type,M.needsUpdate=!1,r.setRenderTarget(C,w,V)};function L(I,F){const Z=t.update(R);v.defines.VSM_SAMPLES!==I.blurSamples&&(v.defines.VSM_SAMPLES=I.blurSamples,y.defines.VSM_SAMPLES=I.blurSamples,v.needsUpdate=!0,y.needsUpdate=!0),I.mapPass===null&&(I.mapPass=new Ii(l.x,l.y,{format:Pr,type:xa})),v.uniforms.shadow_pass.value=I.map.depthTexture,v.uniforms.resolution.value=I.mapSize,v.uniforms.radius.value=I.radius,r.setRenderTarget(I.mapPass),r.clear(),r.renderBufferDirect(F,null,Z,v,R,null),y.uniforms.shadow_pass.value=I.mapPass.texture,y.uniforms.resolution.value=I.mapSize,y.uniforms.radius.value=I.radius,r.setRenderTarget(I.map),r.clear(),r.renderBufferDirect(F,null,Z,y,R,null)}function D(I,F,Z,C){let w=null;const V=Z.isPointLight===!0?I.customDistanceMaterial:I.customDepthMaterial;if(V!==void 0)w=V;else if(w=Z.isPointLight===!0?m:d,r.localClippingEnabled&&F.clipShadows===!0&&Array.isArray(F.clippingPlanes)&&F.clippingPlanes.length!==0||F.displacementMap&&F.displacementScale!==0||F.alphaMap&&F.alphaTest>0||F.map&&F.alphaTest>0||F.alphaToCoverage===!0){const nt=w.uuid,it=F.uuid;let dt=p[nt];dt===void 0&&(dt={},p[nt]=dt);let rt=dt[it];rt===void 0&&(rt=w.clone(),dt[it]=rt,F.addEventListener("dispose",z)),w=rt}if(w.visible=F.visible,w.wireframe=F.wireframe,C===ko?w.side=F.shadowSide!==null?F.shadowSide:F.side:w.side=F.shadowSide!==null?F.shadowSide:g[F.side],w.alphaMap=F.alphaMap,w.alphaTest=F.alphaToCoverage===!0?.5:F.alphaTest,w.map=F.map,w.clipShadows=F.clipShadows,w.clippingPlanes=F.clippingPlanes,w.clipIntersection=F.clipIntersection,w.displacementMap=F.displacementMap,w.displacementScale=F.displacementScale,w.displacementBias=F.displacementBias,w.wireframeLinewidth=F.wireframeLinewidth,w.linewidth=F.linewidth,Z.isPointLight===!0&&w.isMeshDistanceMaterial===!0){const nt=r.properties.get(w);nt.light=Z}return w}function U(I,F,Z,C,w){if(I.visible===!1)return;if(I.layers.test(F.layers)&&(I.isMesh||I.isLine||I.isPoints)&&(I.castShadow||I.receiveShadow&&w===ko)&&(!I.frustumCulled||s.intersectsObject(I))){I.modelViewMatrix.multiplyMatrices(Z.matrixWorldInverse,I.matrixWorld);const it=t.update(I),dt=I.material;if(Array.isArray(dt)){const rt=it.groups;for(let B=0,H=rt.length;B<H;B++){const $=rt[B],yt=dt[$.materialIndex];if(yt&&yt.visible){const xt=D(I,yt,C,w);I.onBeforeShadow(r,I,F,Z,it,xt,$),r.renderBufferDirect(Z,null,it,xt,I,$),I.onAfterShadow(r,I,F,Z,it,xt,$)}}}else if(dt.visible){const rt=D(I,dt,C,w);I.onBeforeShadow(r,I,F,Z,it,rt,null),r.renderBufferDirect(Z,null,it,rt,I,null),I.onAfterShadow(r,I,F,Z,it,rt,null)}}const nt=I.children;for(let it=0,dt=nt.length;it<dt;it++)U(nt[it],F,Z,C,w)}function z(I){I.target.removeEventListener("dispose",z);for(const Z in p){const C=p[Z],w=I.target.uuid;w in C&&(C[w].dispose(),delete C[w])}}}const KA={[Yh]:Zh,[jh]:Qh,[Kh]:$h,[Lr]:Jh,[Zh]:Yh,[Qh]:jh,[$h]:Kh,[Jh]:Lr};function JA(r,t){function i(){let k=!1;const zt=new an;let wt=null;const Xt=new an(0,0,0,0);return{setMask:function(bt){wt!==bt&&!k&&(r.colorMask(bt,bt,bt,bt),wt=bt)},setLocked:function(bt){k=bt},setClear:function(bt,vt,Nt,he,Ie){Ie===!0&&(bt*=he,vt*=he,Nt*=he),zt.set(bt,vt,Nt,he),Xt.equals(zt)===!1&&(r.clearColor(bt,vt,Nt,he),Xt.copy(zt))},reset:function(){k=!1,wt=null,Xt.set(-1,0,0,0)}}}function s(){let k=!1,zt=!1,wt=null,Xt=null,bt=null;return{setReversed:function(vt){if(zt!==vt){const Nt=t.get("EXT_clip_control");vt?Nt.clipControlEXT(Nt.LOWER_LEFT_EXT,Nt.ZERO_TO_ONE_EXT):Nt.clipControlEXT(Nt.LOWER_LEFT_EXT,Nt.NEGATIVE_ONE_TO_ONE_EXT),zt=vt;const he=bt;bt=null,this.setClear(he)}},getReversed:function(){return zt},setTest:function(vt){vt?ct(r.DEPTH_TEST):Dt(r.DEPTH_TEST)},setMask:function(vt){wt!==vt&&!k&&(r.depthMask(vt),wt=vt)},setFunc:function(vt){if(zt&&(vt=KA[vt]),Xt!==vt){switch(vt){case Yh:r.depthFunc(r.NEVER);break;case Zh:r.depthFunc(r.ALWAYS);break;case jh:r.depthFunc(r.LESS);break;case Lr:r.depthFunc(r.LEQUAL);break;case Kh:r.depthFunc(r.EQUAL);break;case Jh:r.depthFunc(r.GEQUAL);break;case Qh:r.depthFunc(r.GREATER);break;case $h:r.depthFunc(r.NOTEQUAL);break;default:r.depthFunc(r.LEQUAL)}Xt=vt}},setLocked:function(vt){k=vt},setClear:function(vt){bt!==vt&&(zt&&(vt=1-vt),r.clearDepth(vt),bt=vt)},reset:function(){k=!1,wt=null,Xt=null,bt=null,zt=!1}}}function l(){let k=!1,zt=null,wt=null,Xt=null,bt=null,vt=null,Nt=null,he=null,Ie=null;return{setTest:function(Ce){k||(Ce?ct(r.STENCIL_TEST):Dt(r.STENCIL_TEST))},setMask:function(Ce){zt!==Ce&&!k&&(r.stencilMask(Ce),zt=Ce)},setFunc:function(Ce,Un,gi){(wt!==Ce||Xt!==Un||bt!==gi)&&(r.stencilFunc(Ce,Un,gi),wt=Ce,Xt=Un,bt=gi)},setOp:function(Ce,Un,gi){(vt!==Ce||Nt!==Un||he!==gi)&&(r.stencilOp(Ce,Un,gi),vt=Ce,Nt=Un,he=gi)},setLocked:function(Ce){k=Ce},setClear:function(Ce){Ie!==Ce&&(r.clearStencil(Ce),Ie=Ce)},reset:function(){k=!1,zt=null,wt=null,Xt=null,bt=null,vt=null,Nt=null,he=null,Ie=null}}}const c=new i,f=new s,d=new l,m=new WeakMap,p=new WeakMap;let _={},g={},v=new WeakMap,y=[],T=null,R=!1,M=null,S=null,L=null,D=null,U=null,z=null,I=null,F=new Fe(0,0,0),Z=0,C=!1,w=null,V=null,nt=null,it=null,dt=null;const rt=r.getParameter(r.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let B=!1,H=0;const $=r.getParameter(r.VERSION);$.indexOf("WebGL")!==-1?(H=parseFloat(/^WebGL (\d)/.exec($)[1]),B=H>=1):$.indexOf("OpenGL ES")!==-1&&(H=parseFloat(/^OpenGL ES (\d)/.exec($)[1]),B=H>=2);let yt=null,xt={};const O=r.getParameter(r.SCISSOR_BOX),K=r.getParameter(r.VIEWPORT),ft=new an().fromArray(O),Et=new an().fromArray(K);function Rt(k,zt,wt,Xt){const bt=new Uint8Array(4),vt=r.createTexture();r.bindTexture(k,vt),r.texParameteri(k,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(k,r.TEXTURE_MAG_FILTER,r.NEAREST);for(let Nt=0;Nt<wt;Nt++)k===r.TEXTURE_3D||k===r.TEXTURE_2D_ARRAY?r.texImage3D(zt,0,r.RGBA,1,1,Xt,0,r.RGBA,r.UNSIGNED_BYTE,bt):r.texImage2D(zt+Nt,0,r.RGBA,1,1,0,r.RGBA,r.UNSIGNED_BYTE,bt);return vt}const Q={};Q[r.TEXTURE_2D]=Rt(r.TEXTURE_2D,r.TEXTURE_2D,1),Q[r.TEXTURE_CUBE_MAP]=Rt(r.TEXTURE_CUBE_MAP,r.TEXTURE_CUBE_MAP_POSITIVE_X,6),Q[r.TEXTURE_2D_ARRAY]=Rt(r.TEXTURE_2D_ARRAY,r.TEXTURE_2D_ARRAY,1,1),Q[r.TEXTURE_3D]=Rt(r.TEXTURE_3D,r.TEXTURE_3D,1,1),c.setClear(0,0,0,1),f.setClear(1),d.setClear(0),ct(r.DEPTH_TEST),f.setFunc(Lr),Mt(!1),Ft(K0),ct(r.CULL_FACE),gt(_a);function ct(k){_[k]!==!0&&(r.enable(k),_[k]=!0)}function Dt(k){_[k]!==!1&&(r.disable(k),_[k]=!1)}function Gt(k,zt){return g[k]!==zt?(r.bindFramebuffer(k,zt),g[k]=zt,k===r.DRAW_FRAMEBUFFER&&(g[r.FRAMEBUFFER]=zt),k===r.FRAMEBUFFER&&(g[r.DRAW_FRAMEBUFFER]=zt),!0):!1}function qt(k,zt){let wt=y,Xt=!1;if(k){wt=v.get(zt),wt===void 0&&(wt=[],v.set(zt,wt));const bt=k.textures;if(wt.length!==bt.length||wt[0]!==r.COLOR_ATTACHMENT0){for(let vt=0,Nt=bt.length;vt<Nt;vt++)wt[vt]=r.COLOR_ATTACHMENT0+vt;wt.length=bt.length,Xt=!0}}else wt[0]!==r.BACK&&(wt[0]=r.BACK,Xt=!0);Xt&&r.drawBuffers(wt)}function ye(k){return T!==k?(r.useProgram(k),T=k,!0):!1}const Ue={[Rs]:r.FUNC_ADD,[vy]:r.FUNC_SUBTRACT,[xy]:r.FUNC_REVERSE_SUBTRACT};Ue[Sy]=r.MIN,Ue[yy]=r.MAX;const fe={[My]:r.ZERO,[Ey]:r.ONE,[Ty]:r.SRC_COLOR,[Wh]:r.SRC_ALPHA,[Dy]:r.SRC_ALPHA_SATURATE,[Cy]:r.DST_COLOR,[Ay]:r.DST_ALPHA,[by]:r.ONE_MINUS_SRC_COLOR,[qh]:r.ONE_MINUS_SRC_ALPHA,[wy]:r.ONE_MINUS_DST_COLOR,[Ry]:r.ONE_MINUS_DST_ALPHA,[Uy]:r.CONSTANT_COLOR,[Ny]:r.ONE_MINUS_CONSTANT_COLOR,[Ly]:r.CONSTANT_ALPHA,[Oy]:r.ONE_MINUS_CONSTANT_ALPHA};function gt(k,zt,wt,Xt,bt,vt,Nt,he,Ie,Ce){if(k===_a){R===!0&&(Dt(r.BLEND),R=!1);return}if(R===!1&&(ct(r.BLEND),R=!0),k!==_y){if(k!==M||Ce!==C){if((S!==Rs||U!==Rs)&&(r.blendEquation(r.FUNC_ADD),S=Rs,U=Rs),Ce)switch(k){case Ur:r.blendFuncSeparate(r.ONE,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case J0:r.blendFunc(r.ONE,r.ONE);break;case Q0:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case $0:r.blendFuncSeparate(r.DST_COLOR,r.ONE_MINUS_SRC_ALPHA,r.ZERO,r.ONE);break;default:we("WebGLState: Invalid blending: ",k);break}else switch(k){case Ur:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case J0:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE,r.ONE,r.ONE);break;case Q0:we("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case $0:we("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:we("WebGLState: Invalid blending: ",k);break}L=null,D=null,z=null,I=null,F.set(0,0,0),Z=0,M=k,C=Ce}return}bt=bt||zt,vt=vt||wt,Nt=Nt||Xt,(zt!==S||bt!==U)&&(r.blendEquationSeparate(Ue[zt],Ue[bt]),S=zt,U=bt),(wt!==L||Xt!==D||vt!==z||Nt!==I)&&(r.blendFuncSeparate(fe[wt],fe[Xt],fe[vt],fe[Nt]),L=wt,D=Xt,z=vt,I=Nt),(he.equals(F)===!1||Ie!==Z)&&(r.blendColor(he.r,he.g,he.b,Ie),F.copy(he),Z=Ie),M=k,C=!1}function At(k,zt){k.side===ma?Dt(r.CULL_FACE):ct(r.CULL_FACE);let wt=k.side===qn;zt&&(wt=!wt),Mt(wt),k.blending===Ur&&k.transparent===!1?gt(_a):gt(k.blending,k.blendEquation,k.blendSrc,k.blendDst,k.blendEquationAlpha,k.blendSrcAlpha,k.blendDstAlpha,k.blendColor,k.blendAlpha,k.premultipliedAlpha),f.setFunc(k.depthFunc),f.setTest(k.depthTest),f.setMask(k.depthWrite),c.setMask(k.colorWrite);const Xt=k.stencilWrite;d.setTest(Xt),Xt&&(d.setMask(k.stencilWriteMask),d.setFunc(k.stencilFunc,k.stencilRef,k.stencilFuncMask),d.setOp(k.stencilFail,k.stencilZFail,k.stencilZPass)),ne(k.polygonOffset,k.polygonOffsetFactor,k.polygonOffsetUnits),k.alphaToCoverage===!0?ct(r.SAMPLE_ALPHA_TO_COVERAGE):Dt(r.SAMPLE_ALPHA_TO_COVERAGE)}function Mt(k){w!==k&&(k?r.frontFace(r.CW):r.frontFace(r.CCW),w=k)}function Ft(k){k!==py?(ct(r.CULL_FACE),k!==V&&(k===K0?r.cullFace(r.BACK):k===my?r.cullFace(r.FRONT):r.cullFace(r.FRONT_AND_BACK))):Dt(r.CULL_FACE),V=k}function P(k){k!==nt&&(B&&r.lineWidth(k),nt=k)}function ne(k,zt,wt){k?(ct(r.POLYGON_OFFSET_FILL),(it!==zt||dt!==wt)&&(r.polygonOffset(zt,wt),it=zt,dt=wt)):Dt(r.POLYGON_OFFSET_FILL)}function Ht(k){k?ct(r.SCISSOR_TEST):Dt(r.SCISSOR_TEST)}function ae(k){k===void 0&&(k=r.TEXTURE0+rt-1),yt!==k&&(r.activeTexture(k),yt=k)}function Ut(k,zt,wt){wt===void 0&&(yt===null?wt=r.TEXTURE0+rt-1:wt=yt);let Xt=xt[wt];Xt===void 0&&(Xt={type:void 0,texture:void 0},xt[wt]=Xt),(Xt.type!==k||Xt.texture!==zt)&&(yt!==wt&&(r.activeTexture(wt),yt=wt),r.bindTexture(k,zt||Q[k]),Xt.type=k,Xt.texture=zt)}function N(){const k=xt[yt];k!==void 0&&k.type!==void 0&&(r.bindTexture(k.type,null),k.type=void 0,k.texture=void 0)}function E(){try{r.compressedTexImage2D(...arguments)}catch(k){we("WebGLState:",k)}}function W(){try{r.compressedTexImage3D(...arguments)}catch(k){we("WebGLState:",k)}}function ut(){try{r.texSubImage2D(...arguments)}catch(k){we("WebGLState:",k)}}function St(){try{r.texSubImage3D(...arguments)}catch(k){we("WebGLState:",k)}}function ht(){try{r.compressedTexSubImage2D(...arguments)}catch(k){we("WebGLState:",k)}}function Qt(){try{r.compressedTexSubImage3D(...arguments)}catch(k){we("WebGLState:",k)}}function Lt(){try{r.texStorage2D(...arguments)}catch(k){we("WebGLState:",k)}}function Jt(){try{r.texStorage3D(...arguments)}catch(k){we("WebGLState:",k)}}function le(){try{r.texImage2D(...arguments)}catch(k){we("WebGLState:",k)}}function Tt(){try{r.texImage3D(...arguments)}catch(k){we("WebGLState:",k)}}function Ct(k){ft.equals(k)===!1&&(r.scissor(k.x,k.y,k.z,k.w),ft.copy(k))}function Yt(k){Et.equals(k)===!1&&(r.viewport(k.x,k.y,k.z,k.w),Et.copy(k))}function Vt(k,zt){let wt=p.get(zt);wt===void 0&&(wt=new WeakMap,p.set(zt,wt));let Xt=wt.get(k);Xt===void 0&&(Xt=r.getUniformBlockIndex(zt,k.name),wt.set(k,Xt))}function Ot(k,zt){const Xt=p.get(zt).get(k);m.get(zt)!==Xt&&(r.uniformBlockBinding(zt,Xt,k.__bindingPointIndex),m.set(zt,Xt))}function _e(){r.disable(r.BLEND),r.disable(r.CULL_FACE),r.disable(r.DEPTH_TEST),r.disable(r.POLYGON_OFFSET_FILL),r.disable(r.SCISSOR_TEST),r.disable(r.STENCIL_TEST),r.disable(r.SAMPLE_ALPHA_TO_COVERAGE),r.blendEquation(r.FUNC_ADD),r.blendFunc(r.ONE,r.ZERO),r.blendFuncSeparate(r.ONE,r.ZERO,r.ONE,r.ZERO),r.blendColor(0,0,0,0),r.colorMask(!0,!0,!0,!0),r.clearColor(0,0,0,0),r.depthMask(!0),r.depthFunc(r.LESS),f.setReversed(!1),r.clearDepth(1),r.stencilMask(4294967295),r.stencilFunc(r.ALWAYS,0,4294967295),r.stencilOp(r.KEEP,r.KEEP,r.KEEP),r.clearStencil(0),r.cullFace(r.BACK),r.frontFace(r.CCW),r.polygonOffset(0,0),r.activeTexture(r.TEXTURE0),r.bindFramebuffer(r.FRAMEBUFFER,null),r.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),r.bindFramebuffer(r.READ_FRAMEBUFFER,null),r.useProgram(null),r.lineWidth(1),r.scissor(0,0,r.canvas.width,r.canvas.height),r.viewport(0,0,r.canvas.width,r.canvas.height),_={},yt=null,xt={},g={},v=new WeakMap,y=[],T=null,R=!1,M=null,S=null,L=null,D=null,U=null,z=null,I=null,F=new Fe(0,0,0),Z=0,C=!1,w=null,V=null,nt=null,it=null,dt=null,ft.set(0,0,r.canvas.width,r.canvas.height),Et.set(0,0,r.canvas.width,r.canvas.height),c.reset(),f.reset(),d.reset()}return{buffers:{color:c,depth:f,stencil:d},enable:ct,disable:Dt,bindFramebuffer:Gt,drawBuffers:qt,useProgram:ye,setBlending:gt,setMaterial:At,setFlipSided:Mt,setCullFace:Ft,setLineWidth:P,setPolygonOffset:ne,setScissorTest:Ht,activeTexture:ae,bindTexture:Ut,unbindTexture:N,compressedTexImage2D:E,compressedTexImage3D:W,texImage2D:le,texImage3D:Tt,updateUBOMapping:Vt,uniformBlockBinding:Ot,texStorage2D:Lt,texStorage3D:Jt,texSubImage2D:ut,texSubImage3D:St,compressedTexSubImage2D:ht,compressedTexSubImage3D:Qt,scissor:Ct,viewport:Yt,reset:_e}}function QA(r,t,i,s,l,c,f){const d=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,m=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),p=new Wt,_=new WeakMap;let g;const v=new WeakMap;let y=!1;try{y=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function T(N,E){return y?new OffscreenCanvas(N,E):Kc("canvas")}function R(N,E,W){let ut=1;const St=Ut(N);if((St.width>W||St.height>W)&&(ut=W/Math.max(St.width,St.height)),ut<1)if(typeof HTMLImageElement<"u"&&N instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&N instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&N instanceof ImageBitmap||typeof VideoFrame<"u"&&N instanceof VideoFrame){const ht=Math.floor(ut*St.width),Qt=Math.floor(ut*St.height);g===void 0&&(g=T(ht,Qt));const Lt=E?T(ht,Qt):g;return Lt.width=ht,Lt.height=Qt,Lt.getContext("2d").drawImage(N,0,0,ht,Qt),pe("WebGLRenderer: Texture has been resized from ("+St.width+"x"+St.height+") to ("+ht+"x"+Qt+")."),Lt}else return"data"in N&&pe("WebGLRenderer: Image in DataTexture is too big ("+St.width+"x"+St.height+")."),N;return N}function M(N){return N.generateMipmaps}function S(N){r.generateMipmap(N)}function L(N){return N.isWebGLCubeRenderTarget?r.TEXTURE_CUBE_MAP:N.isWebGL3DRenderTarget?r.TEXTURE_3D:N.isWebGLArrayRenderTarget||N.isCompressedArrayTexture?r.TEXTURE_2D_ARRAY:r.TEXTURE_2D}function D(N,E,W,ut,St=!1){if(N!==null){if(r[N]!==void 0)return r[N];pe("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+N+"'")}let ht=E;if(E===r.RED&&(W===r.FLOAT&&(ht=r.R32F),W===r.HALF_FLOAT&&(ht=r.R16F),W===r.UNSIGNED_BYTE&&(ht=r.R8)),E===r.RED_INTEGER&&(W===r.UNSIGNED_BYTE&&(ht=r.R8UI),W===r.UNSIGNED_SHORT&&(ht=r.R16UI),W===r.UNSIGNED_INT&&(ht=r.R32UI),W===r.BYTE&&(ht=r.R8I),W===r.SHORT&&(ht=r.R16I),W===r.INT&&(ht=r.R32I)),E===r.RG&&(W===r.FLOAT&&(ht=r.RG32F),W===r.HALF_FLOAT&&(ht=r.RG16F),W===r.UNSIGNED_BYTE&&(ht=r.RG8)),E===r.RG_INTEGER&&(W===r.UNSIGNED_BYTE&&(ht=r.RG8UI),W===r.UNSIGNED_SHORT&&(ht=r.RG16UI),W===r.UNSIGNED_INT&&(ht=r.RG32UI),W===r.BYTE&&(ht=r.RG8I),W===r.SHORT&&(ht=r.RG16I),W===r.INT&&(ht=r.RG32I)),E===r.RGB_INTEGER&&(W===r.UNSIGNED_BYTE&&(ht=r.RGB8UI),W===r.UNSIGNED_SHORT&&(ht=r.RGB16UI),W===r.UNSIGNED_INT&&(ht=r.RGB32UI),W===r.BYTE&&(ht=r.RGB8I),W===r.SHORT&&(ht=r.RGB16I),W===r.INT&&(ht=r.RGB32I)),E===r.RGBA_INTEGER&&(W===r.UNSIGNED_BYTE&&(ht=r.RGBA8UI),W===r.UNSIGNED_SHORT&&(ht=r.RGBA16UI),W===r.UNSIGNED_INT&&(ht=r.RGBA32UI),W===r.BYTE&&(ht=r.RGBA8I),W===r.SHORT&&(ht=r.RGBA16I),W===r.INT&&(ht=r.RGBA32I)),E===r.RGB&&(W===r.UNSIGNED_INT_5_9_9_9_REV&&(ht=r.RGB9_E5),W===r.UNSIGNED_INT_10F_11F_11F_REV&&(ht=r.R11F_G11F_B10F)),E===r.RGBA){const Qt=St?Zc:De.getTransfer(ut);W===r.FLOAT&&(ht=r.RGBA32F),W===r.HALF_FLOAT&&(ht=r.RGBA16F),W===r.UNSIGNED_BYTE&&(ht=Qt===Xe?r.SRGB8_ALPHA8:r.RGBA8),W===r.UNSIGNED_SHORT_4_4_4_4&&(ht=r.RGBA4),W===r.UNSIGNED_SHORT_5_5_5_1&&(ht=r.RGB5_A1)}return(ht===r.R16F||ht===r.R32F||ht===r.RG16F||ht===r.RG32F||ht===r.RGBA16F||ht===r.RGBA32F)&&t.get("EXT_color_buffer_float"),ht}function U(N,E){let W;return N?E===null||E===Gi||E===Ko?W=r.DEPTH24_STENCIL8:E===zi?W=r.DEPTH32F_STENCIL8:E===jo&&(W=r.DEPTH24_STENCIL8,pe("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):E===null||E===Gi||E===Ko?W=r.DEPTH_COMPONENT24:E===zi?W=r.DEPTH_COMPONENT32F:E===jo&&(W=r.DEPTH_COMPONENT16),W}function z(N,E){return M(N)===!0||N.isFramebufferTexture&&N.minFilter!==Dn&&N.minFilter!==xn?Math.log2(Math.max(E.width,E.height))+1:N.mipmaps!==void 0&&N.mipmaps.length>0?N.mipmaps.length:N.isCompressedTexture&&Array.isArray(N.image)?E.mipmaps.length:1}function I(N){const E=N.target;E.removeEventListener("dispose",I),Z(E),E.isVideoTexture&&_.delete(E)}function F(N){const E=N.target;E.removeEventListener("dispose",F),w(E)}function Z(N){const E=s.get(N);if(E.__webglInit===void 0)return;const W=N.source,ut=v.get(W);if(ut){const St=ut[E.__cacheKey];St.usedTimes--,St.usedTimes===0&&C(N),Object.keys(ut).length===0&&v.delete(W)}s.remove(N)}function C(N){const E=s.get(N);r.deleteTexture(E.__webglTexture);const W=N.source,ut=v.get(W);delete ut[E.__cacheKey],f.memory.textures--}function w(N){const E=s.get(N);if(N.depthTexture&&(N.depthTexture.dispose(),s.remove(N.depthTexture)),N.isWebGLCubeRenderTarget)for(let ut=0;ut<6;ut++){if(Array.isArray(E.__webglFramebuffer[ut]))for(let St=0;St<E.__webglFramebuffer[ut].length;St++)r.deleteFramebuffer(E.__webglFramebuffer[ut][St]);else r.deleteFramebuffer(E.__webglFramebuffer[ut]);E.__webglDepthbuffer&&r.deleteRenderbuffer(E.__webglDepthbuffer[ut])}else{if(Array.isArray(E.__webglFramebuffer))for(let ut=0;ut<E.__webglFramebuffer.length;ut++)r.deleteFramebuffer(E.__webglFramebuffer[ut]);else r.deleteFramebuffer(E.__webglFramebuffer);if(E.__webglDepthbuffer&&r.deleteRenderbuffer(E.__webglDepthbuffer),E.__webglMultisampledFramebuffer&&r.deleteFramebuffer(E.__webglMultisampledFramebuffer),E.__webglColorRenderbuffer)for(let ut=0;ut<E.__webglColorRenderbuffer.length;ut++)E.__webglColorRenderbuffer[ut]&&r.deleteRenderbuffer(E.__webglColorRenderbuffer[ut]);E.__webglDepthRenderbuffer&&r.deleteRenderbuffer(E.__webglDepthRenderbuffer)}const W=N.textures;for(let ut=0,St=W.length;ut<St;ut++){const ht=s.get(W[ut]);ht.__webglTexture&&(r.deleteTexture(ht.__webglTexture),f.memory.textures--),s.remove(W[ut])}s.remove(N)}let V=0;function nt(){V=0}function it(){const N=V;return N>=l.maxTextures&&pe("WebGLTextures: Trying to use "+N+" texture units while this GPU supports only "+l.maxTextures),V+=1,N}function dt(N){const E=[];return E.push(N.wrapS),E.push(N.wrapT),E.push(N.wrapR||0),E.push(N.magFilter),E.push(N.minFilter),E.push(N.anisotropy),E.push(N.internalFormat),E.push(N.format),E.push(N.type),E.push(N.generateMipmaps),E.push(N.premultiplyAlpha),E.push(N.flipY),E.push(N.unpackAlignment),E.push(N.colorSpace),E.join()}function rt(N,E){const W=s.get(N);if(N.isVideoTexture&&Ht(N),N.isRenderTargetTexture===!1&&N.isExternalTexture!==!0&&N.version>0&&W.__version!==N.version){const ut=N.image;if(ut===null)pe("WebGLRenderer: Texture marked for update but no image data found.");else if(ut.complete===!1)pe("WebGLRenderer: Texture marked for update but image is incomplete");else{Q(W,N,E);return}}else N.isExternalTexture&&(W.__webglTexture=N.sourceTexture?N.sourceTexture:null);i.bindTexture(r.TEXTURE_2D,W.__webglTexture,r.TEXTURE0+E)}function B(N,E){const W=s.get(N);if(N.isRenderTargetTexture===!1&&N.version>0&&W.__version!==N.version){Q(W,N,E);return}else N.isExternalTexture&&(W.__webglTexture=N.sourceTexture?N.sourceTexture:null);i.bindTexture(r.TEXTURE_2D_ARRAY,W.__webglTexture,r.TEXTURE0+E)}function H(N,E){const W=s.get(N);if(N.isRenderTargetTexture===!1&&N.version>0&&W.__version!==N.version){Q(W,N,E);return}i.bindTexture(r.TEXTURE_3D,W.__webglTexture,r.TEXTURE0+E)}function $(N,E){const W=s.get(N);if(N.isCubeDepthTexture!==!0&&N.version>0&&W.__version!==N.version){ct(W,N,E);return}i.bindTexture(r.TEXTURE_CUBE_MAP,W.__webglTexture,r.TEXTURE0+E)}const yt={[nd]:r.REPEAT,[ga]:r.CLAMP_TO_EDGE,[id]:r.MIRRORED_REPEAT},xt={[Dn]:r.NEAREST,[Fy]:r.NEAREST_MIPMAP_NEAREST,[vc]:r.NEAREST_MIPMAP_LINEAR,[xn]:r.LINEAR,[uh]:r.LINEAR_MIPMAP_NEAREST,[ws]:r.LINEAR_MIPMAP_LINEAR},O={[Hy]:r.NEVER,[Wy]:r.ALWAYS,[Gy]:r.LESS,[Kd]:r.LEQUAL,[Vy]:r.EQUAL,[Jd]:r.GEQUAL,[Xy]:r.GREATER,[ky]:r.NOTEQUAL};function K(N,E){if(E.type===zi&&t.has("OES_texture_float_linear")===!1&&(E.magFilter===xn||E.magFilter===uh||E.magFilter===vc||E.magFilter===ws||E.minFilter===xn||E.minFilter===uh||E.minFilter===vc||E.minFilter===ws)&&pe("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),r.texParameteri(N,r.TEXTURE_WRAP_S,yt[E.wrapS]),r.texParameteri(N,r.TEXTURE_WRAP_T,yt[E.wrapT]),(N===r.TEXTURE_3D||N===r.TEXTURE_2D_ARRAY)&&r.texParameteri(N,r.TEXTURE_WRAP_R,yt[E.wrapR]),r.texParameteri(N,r.TEXTURE_MAG_FILTER,xt[E.magFilter]),r.texParameteri(N,r.TEXTURE_MIN_FILTER,xt[E.minFilter]),E.compareFunction&&(r.texParameteri(N,r.TEXTURE_COMPARE_MODE,r.COMPARE_REF_TO_TEXTURE),r.texParameteri(N,r.TEXTURE_COMPARE_FUNC,O[E.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(E.magFilter===Dn||E.minFilter!==vc&&E.minFilter!==ws||E.type===zi&&t.has("OES_texture_float_linear")===!1)return;if(E.anisotropy>1||s.get(E).__currentAnisotropy){const W=t.get("EXT_texture_filter_anisotropic");r.texParameterf(N,W.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(E.anisotropy,l.getMaxAnisotropy())),s.get(E).__currentAnisotropy=E.anisotropy}}}function ft(N,E){let W=!1;N.__webglInit===void 0&&(N.__webglInit=!0,E.addEventListener("dispose",I));const ut=E.source;let St=v.get(ut);St===void 0&&(St={},v.set(ut,St));const ht=dt(E);if(ht!==N.__cacheKey){St[ht]===void 0&&(St[ht]={texture:r.createTexture(),usedTimes:0},f.memory.textures++,W=!0),St[ht].usedTimes++;const Qt=St[N.__cacheKey];Qt!==void 0&&(St[N.__cacheKey].usedTimes--,Qt.usedTimes===0&&C(E)),N.__cacheKey=ht,N.__webglTexture=St[ht].texture}return W}function Et(N,E,W){return Math.floor(Math.floor(N/W)/E)}function Rt(N,E,W,ut){const ht=N.updateRanges;if(ht.length===0)i.texSubImage2D(r.TEXTURE_2D,0,0,0,E.width,E.height,W,ut,E.data);else{ht.sort((Tt,Ct)=>Tt.start-Ct.start);let Qt=0;for(let Tt=1;Tt<ht.length;Tt++){const Ct=ht[Qt],Yt=ht[Tt],Vt=Ct.start+Ct.count,Ot=Et(Yt.start,E.width,4),_e=Et(Ct.start,E.width,4);Yt.start<=Vt+1&&Ot===_e&&Et(Yt.start+Yt.count-1,E.width,4)===Ot?Ct.count=Math.max(Ct.count,Yt.start+Yt.count-Ct.start):(++Qt,ht[Qt]=Yt)}ht.length=Qt+1;const Lt=r.getParameter(r.UNPACK_ROW_LENGTH),Jt=r.getParameter(r.UNPACK_SKIP_PIXELS),le=r.getParameter(r.UNPACK_SKIP_ROWS);r.pixelStorei(r.UNPACK_ROW_LENGTH,E.width);for(let Tt=0,Ct=ht.length;Tt<Ct;Tt++){const Yt=ht[Tt],Vt=Math.floor(Yt.start/4),Ot=Math.ceil(Yt.count/4),_e=Vt%E.width,k=Math.floor(Vt/E.width),zt=Ot,wt=1;r.pixelStorei(r.UNPACK_SKIP_PIXELS,_e),r.pixelStorei(r.UNPACK_SKIP_ROWS,k),i.texSubImage2D(r.TEXTURE_2D,0,_e,k,zt,wt,W,ut,E.data)}N.clearUpdateRanges(),r.pixelStorei(r.UNPACK_ROW_LENGTH,Lt),r.pixelStorei(r.UNPACK_SKIP_PIXELS,Jt),r.pixelStorei(r.UNPACK_SKIP_ROWS,le)}}function Q(N,E,W){let ut=r.TEXTURE_2D;(E.isDataArrayTexture||E.isCompressedArrayTexture)&&(ut=r.TEXTURE_2D_ARRAY),E.isData3DTexture&&(ut=r.TEXTURE_3D);const St=ft(N,E),ht=E.source;i.bindTexture(ut,N.__webglTexture,r.TEXTURE0+W);const Qt=s.get(ht);if(ht.version!==Qt.__version||St===!0){i.activeTexture(r.TEXTURE0+W);const Lt=De.getPrimaries(De.workingColorSpace),Jt=E.colorSpace===$a?null:De.getPrimaries(E.colorSpace),le=E.colorSpace===$a||Lt===Jt?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,E.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,E.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,le);let Tt=R(E.image,!1,l.maxTextureSize);Tt=ae(E,Tt);const Ct=c.convert(E.format,E.colorSpace),Yt=c.convert(E.type);let Vt=D(E.internalFormat,Ct,Yt,E.colorSpace,E.isVideoTexture);K(ut,E);let Ot;const _e=E.mipmaps,k=E.isVideoTexture!==!0,zt=Qt.__version===void 0||St===!0,wt=ht.dataReady,Xt=z(E,Tt);if(E.isDepthTexture)Vt=U(E.format===Ds,E.type),zt&&(k?i.texStorage2D(r.TEXTURE_2D,1,Vt,Tt.width,Tt.height):i.texImage2D(r.TEXTURE_2D,0,Vt,Tt.width,Tt.height,0,Ct,Yt,null));else if(E.isDataTexture)if(_e.length>0){k&&zt&&i.texStorage2D(r.TEXTURE_2D,Xt,Vt,_e[0].width,_e[0].height);for(let bt=0,vt=_e.length;bt<vt;bt++)Ot=_e[bt],k?wt&&i.texSubImage2D(r.TEXTURE_2D,bt,0,0,Ot.width,Ot.height,Ct,Yt,Ot.data):i.texImage2D(r.TEXTURE_2D,bt,Vt,Ot.width,Ot.height,0,Ct,Yt,Ot.data);E.generateMipmaps=!1}else k?(zt&&i.texStorage2D(r.TEXTURE_2D,Xt,Vt,Tt.width,Tt.height),wt&&Rt(E,Tt,Ct,Yt)):i.texImage2D(r.TEXTURE_2D,0,Vt,Tt.width,Tt.height,0,Ct,Yt,Tt.data);else if(E.isCompressedTexture)if(E.isCompressedArrayTexture){k&&zt&&i.texStorage3D(r.TEXTURE_2D_ARRAY,Xt,Vt,_e[0].width,_e[0].height,Tt.depth);for(let bt=0,vt=_e.length;bt<vt;bt++)if(Ot=_e[bt],E.format!==Ai)if(Ct!==null)if(k){if(wt)if(E.layerUpdates.size>0){const Nt=C_(Ot.width,Ot.height,E.format,E.type);for(const he of E.layerUpdates){const Ie=Ot.data.subarray(he*Nt/Ot.data.BYTES_PER_ELEMENT,(he+1)*Nt/Ot.data.BYTES_PER_ELEMENT);i.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,bt,0,0,he,Ot.width,Ot.height,1,Ct,Ie)}E.clearLayerUpdates()}else i.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,bt,0,0,0,Ot.width,Ot.height,Tt.depth,Ct,Ot.data)}else i.compressedTexImage3D(r.TEXTURE_2D_ARRAY,bt,Vt,Ot.width,Ot.height,Tt.depth,0,Ot.data,0,0);else pe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else k?wt&&i.texSubImage3D(r.TEXTURE_2D_ARRAY,bt,0,0,0,Ot.width,Ot.height,Tt.depth,Ct,Yt,Ot.data):i.texImage3D(r.TEXTURE_2D_ARRAY,bt,Vt,Ot.width,Ot.height,Tt.depth,0,Ct,Yt,Ot.data)}else{k&&zt&&i.texStorage2D(r.TEXTURE_2D,Xt,Vt,_e[0].width,_e[0].height);for(let bt=0,vt=_e.length;bt<vt;bt++)Ot=_e[bt],E.format!==Ai?Ct!==null?k?wt&&i.compressedTexSubImage2D(r.TEXTURE_2D,bt,0,0,Ot.width,Ot.height,Ct,Ot.data):i.compressedTexImage2D(r.TEXTURE_2D,bt,Vt,Ot.width,Ot.height,0,Ot.data):pe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):k?wt&&i.texSubImage2D(r.TEXTURE_2D,bt,0,0,Ot.width,Ot.height,Ct,Yt,Ot.data):i.texImage2D(r.TEXTURE_2D,bt,Vt,Ot.width,Ot.height,0,Ct,Yt,Ot.data)}else if(E.isDataArrayTexture)if(k){if(zt&&i.texStorage3D(r.TEXTURE_2D_ARRAY,Xt,Vt,Tt.width,Tt.height,Tt.depth),wt)if(E.layerUpdates.size>0){const bt=C_(Tt.width,Tt.height,E.format,E.type);for(const vt of E.layerUpdates){const Nt=Tt.data.subarray(vt*bt/Tt.data.BYTES_PER_ELEMENT,(vt+1)*bt/Tt.data.BYTES_PER_ELEMENT);i.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,vt,Tt.width,Tt.height,1,Ct,Yt,Nt)}E.clearLayerUpdates()}else i.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,0,Tt.width,Tt.height,Tt.depth,Ct,Yt,Tt.data)}else i.texImage3D(r.TEXTURE_2D_ARRAY,0,Vt,Tt.width,Tt.height,Tt.depth,0,Ct,Yt,Tt.data);else if(E.isData3DTexture)k?(zt&&i.texStorage3D(r.TEXTURE_3D,Xt,Vt,Tt.width,Tt.height,Tt.depth),wt&&i.texSubImage3D(r.TEXTURE_3D,0,0,0,0,Tt.width,Tt.height,Tt.depth,Ct,Yt,Tt.data)):i.texImage3D(r.TEXTURE_3D,0,Vt,Tt.width,Tt.height,Tt.depth,0,Ct,Yt,Tt.data);else if(E.isFramebufferTexture){if(zt)if(k)i.texStorage2D(r.TEXTURE_2D,Xt,Vt,Tt.width,Tt.height);else{let bt=Tt.width,vt=Tt.height;for(let Nt=0;Nt<Xt;Nt++)i.texImage2D(r.TEXTURE_2D,Nt,Vt,bt,vt,0,Ct,Yt,null),bt>>=1,vt>>=1}}else if(_e.length>0){if(k&&zt){const bt=Ut(_e[0]);i.texStorage2D(r.TEXTURE_2D,Xt,Vt,bt.width,bt.height)}for(let bt=0,vt=_e.length;bt<vt;bt++)Ot=_e[bt],k?wt&&i.texSubImage2D(r.TEXTURE_2D,bt,0,0,Ct,Yt,Ot):i.texImage2D(r.TEXTURE_2D,bt,Vt,Ct,Yt,Ot);E.generateMipmaps=!1}else if(k){if(zt){const bt=Ut(Tt);i.texStorage2D(r.TEXTURE_2D,Xt,Vt,bt.width,bt.height)}wt&&i.texSubImage2D(r.TEXTURE_2D,0,0,0,Ct,Yt,Tt)}else i.texImage2D(r.TEXTURE_2D,0,Vt,Ct,Yt,Tt);M(E)&&S(ut),Qt.__version=ht.version,E.onUpdate&&E.onUpdate(E)}N.__version=E.version}function ct(N,E,W){if(E.image.length!==6)return;const ut=ft(N,E),St=E.source;i.bindTexture(r.TEXTURE_CUBE_MAP,N.__webglTexture,r.TEXTURE0+W);const ht=s.get(St);if(St.version!==ht.__version||ut===!0){i.activeTexture(r.TEXTURE0+W);const Qt=De.getPrimaries(De.workingColorSpace),Lt=E.colorSpace===$a?null:De.getPrimaries(E.colorSpace),Jt=E.colorSpace===$a||Qt===Lt?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,E.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,E.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,Jt);const le=E.isCompressedTexture||E.image[0].isCompressedTexture,Tt=E.image[0]&&E.image[0].isDataTexture,Ct=[];for(let vt=0;vt<6;vt++)!le&&!Tt?Ct[vt]=R(E.image[vt],!0,l.maxCubemapSize):Ct[vt]=Tt?E.image[vt].image:E.image[vt],Ct[vt]=ae(E,Ct[vt]);const Yt=Ct[0],Vt=c.convert(E.format,E.colorSpace),Ot=c.convert(E.type),_e=D(E.internalFormat,Vt,Ot,E.colorSpace),k=E.isVideoTexture!==!0,zt=ht.__version===void 0||ut===!0,wt=St.dataReady;let Xt=z(E,Yt);K(r.TEXTURE_CUBE_MAP,E);let bt;if(le){k&&zt&&i.texStorage2D(r.TEXTURE_CUBE_MAP,Xt,_e,Yt.width,Yt.height);for(let vt=0;vt<6;vt++){bt=Ct[vt].mipmaps;for(let Nt=0;Nt<bt.length;Nt++){const he=bt[Nt];E.format!==Ai?Vt!==null?k?wt&&i.compressedTexSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+vt,Nt,0,0,he.width,he.height,Vt,he.data):i.compressedTexImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+vt,Nt,_e,he.width,he.height,0,he.data):pe("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):k?wt&&i.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+vt,Nt,0,0,he.width,he.height,Vt,Ot,he.data):i.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+vt,Nt,_e,he.width,he.height,0,Vt,Ot,he.data)}}}else{if(bt=E.mipmaps,k&&zt){bt.length>0&&Xt++;const vt=Ut(Ct[0]);i.texStorage2D(r.TEXTURE_CUBE_MAP,Xt,_e,vt.width,vt.height)}for(let vt=0;vt<6;vt++)if(Tt){k?wt&&i.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+vt,0,0,0,Ct[vt].width,Ct[vt].height,Vt,Ot,Ct[vt].data):i.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+vt,0,_e,Ct[vt].width,Ct[vt].height,0,Vt,Ot,Ct[vt].data);for(let Nt=0;Nt<bt.length;Nt++){const Ie=bt[Nt].image[vt].image;k?wt&&i.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+vt,Nt+1,0,0,Ie.width,Ie.height,Vt,Ot,Ie.data):i.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+vt,Nt+1,_e,Ie.width,Ie.height,0,Vt,Ot,Ie.data)}}else{k?wt&&i.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+vt,0,0,0,Vt,Ot,Ct[vt]):i.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+vt,0,_e,Vt,Ot,Ct[vt]);for(let Nt=0;Nt<bt.length;Nt++){const he=bt[Nt];k?wt&&i.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+vt,Nt+1,0,0,Vt,Ot,he.image[vt]):i.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+vt,Nt+1,_e,Vt,Ot,he.image[vt])}}}M(E)&&S(r.TEXTURE_CUBE_MAP),ht.__version=St.version,E.onUpdate&&E.onUpdate(E)}N.__version=E.version}function Dt(N,E,W,ut,St,ht){const Qt=c.convert(W.format,W.colorSpace),Lt=c.convert(W.type),Jt=D(W.internalFormat,Qt,Lt,W.colorSpace),le=s.get(E),Tt=s.get(W);if(Tt.__renderTarget=E,!le.__hasExternalTextures){const Ct=Math.max(1,E.width>>ht),Yt=Math.max(1,E.height>>ht);St===r.TEXTURE_3D||St===r.TEXTURE_2D_ARRAY?i.texImage3D(St,ht,Jt,Ct,Yt,E.depth,0,Qt,Lt,null):i.texImage2D(St,ht,Jt,Ct,Yt,0,Qt,Lt,null)}i.bindFramebuffer(r.FRAMEBUFFER,N),ne(E)?d.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,ut,St,Tt.__webglTexture,0,P(E)):(St===r.TEXTURE_2D||St>=r.TEXTURE_CUBE_MAP_POSITIVE_X&&St<=r.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&r.framebufferTexture2D(r.FRAMEBUFFER,ut,St,Tt.__webglTexture,ht),i.bindFramebuffer(r.FRAMEBUFFER,null)}function Gt(N,E,W){if(r.bindRenderbuffer(r.RENDERBUFFER,N),E.depthBuffer){const ut=E.depthTexture,St=ut&&ut.isDepthTexture?ut.type:null,ht=U(E.stencilBuffer,St),Qt=E.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;ne(E)?d.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,P(E),ht,E.width,E.height):W?r.renderbufferStorageMultisample(r.RENDERBUFFER,P(E),ht,E.width,E.height):r.renderbufferStorage(r.RENDERBUFFER,ht,E.width,E.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,Qt,r.RENDERBUFFER,N)}else{const ut=E.textures;for(let St=0;St<ut.length;St++){const ht=ut[St],Qt=c.convert(ht.format,ht.colorSpace),Lt=c.convert(ht.type),Jt=D(ht.internalFormat,Qt,Lt,ht.colorSpace);ne(E)?d.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,P(E),Jt,E.width,E.height):W?r.renderbufferStorageMultisample(r.RENDERBUFFER,P(E),Jt,E.width,E.height):r.renderbufferStorage(r.RENDERBUFFER,Jt,E.width,E.height)}}r.bindRenderbuffer(r.RENDERBUFFER,null)}function qt(N,E,W){const ut=E.isWebGLCubeRenderTarget===!0;if(i.bindFramebuffer(r.FRAMEBUFFER,N),!(E.depthTexture&&E.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const St=s.get(E.depthTexture);if(St.__renderTarget=E,(!St.__webglTexture||E.depthTexture.image.width!==E.width||E.depthTexture.image.height!==E.height)&&(E.depthTexture.image.width=E.width,E.depthTexture.image.height=E.height,E.depthTexture.needsUpdate=!0),ut){if(St.__webglInit===void 0&&(St.__webglInit=!0,E.depthTexture.addEventListener("dispose",I)),St.__webglTexture===void 0){St.__webglTexture=r.createTexture(),i.bindTexture(r.TEXTURE_CUBE_MAP,St.__webglTexture),K(r.TEXTURE_CUBE_MAP,E.depthTexture);const le=c.convert(E.depthTexture.format),Tt=c.convert(E.depthTexture.type);let Ct;E.depthTexture.format===Sa?Ct=r.DEPTH_COMPONENT24:E.depthTexture.format===Ds&&(Ct=r.DEPTH24_STENCIL8);for(let Yt=0;Yt<6;Yt++)r.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Yt,0,Ct,E.width,E.height,0,le,Tt,null)}}else rt(E.depthTexture,0);const ht=St.__webglTexture,Qt=P(E),Lt=ut?r.TEXTURE_CUBE_MAP_POSITIVE_X+W:r.TEXTURE_2D,Jt=E.depthTexture.format===Ds?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;if(E.depthTexture.format===Sa)ne(E)?d.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,Jt,Lt,ht,0,Qt):r.framebufferTexture2D(r.FRAMEBUFFER,Jt,Lt,ht,0);else if(E.depthTexture.format===Ds)ne(E)?d.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,Jt,Lt,ht,0,Qt):r.framebufferTexture2D(r.FRAMEBUFFER,Jt,Lt,ht,0);else throw new Error("Unknown depthTexture format")}function ye(N){const E=s.get(N),W=N.isWebGLCubeRenderTarget===!0;if(E.__boundDepthTexture!==N.depthTexture){const ut=N.depthTexture;if(E.__depthDisposeCallback&&E.__depthDisposeCallback(),ut){const St=()=>{delete E.__boundDepthTexture,delete E.__depthDisposeCallback,ut.removeEventListener("dispose",St)};ut.addEventListener("dispose",St),E.__depthDisposeCallback=St}E.__boundDepthTexture=ut}if(N.depthTexture&&!E.__autoAllocateDepthBuffer)if(W)for(let ut=0;ut<6;ut++)qt(E.__webglFramebuffer[ut],N,ut);else{const ut=N.texture.mipmaps;ut&&ut.length>0?qt(E.__webglFramebuffer[0],N,0):qt(E.__webglFramebuffer,N,0)}else if(W){E.__webglDepthbuffer=[];for(let ut=0;ut<6;ut++)if(i.bindFramebuffer(r.FRAMEBUFFER,E.__webglFramebuffer[ut]),E.__webglDepthbuffer[ut]===void 0)E.__webglDepthbuffer[ut]=r.createRenderbuffer(),Gt(E.__webglDepthbuffer[ut],N,!1);else{const St=N.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,ht=E.__webglDepthbuffer[ut];r.bindRenderbuffer(r.RENDERBUFFER,ht),r.framebufferRenderbuffer(r.FRAMEBUFFER,St,r.RENDERBUFFER,ht)}}else{const ut=N.texture.mipmaps;if(ut&&ut.length>0?i.bindFramebuffer(r.FRAMEBUFFER,E.__webglFramebuffer[0]):i.bindFramebuffer(r.FRAMEBUFFER,E.__webglFramebuffer),E.__webglDepthbuffer===void 0)E.__webglDepthbuffer=r.createRenderbuffer(),Gt(E.__webglDepthbuffer,N,!1);else{const St=N.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,ht=E.__webglDepthbuffer;r.bindRenderbuffer(r.RENDERBUFFER,ht),r.framebufferRenderbuffer(r.FRAMEBUFFER,St,r.RENDERBUFFER,ht)}}i.bindFramebuffer(r.FRAMEBUFFER,null)}function Ue(N,E,W){const ut=s.get(N);E!==void 0&&Dt(ut.__webglFramebuffer,N,N.texture,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,0),W!==void 0&&ye(N)}function fe(N){const E=N.texture,W=s.get(N),ut=s.get(E);N.addEventListener("dispose",F);const St=N.textures,ht=N.isWebGLCubeRenderTarget===!0,Qt=St.length>1;if(Qt||(ut.__webglTexture===void 0&&(ut.__webglTexture=r.createTexture()),ut.__version=E.version,f.memory.textures++),ht){W.__webglFramebuffer=[];for(let Lt=0;Lt<6;Lt++)if(E.mipmaps&&E.mipmaps.length>0){W.__webglFramebuffer[Lt]=[];for(let Jt=0;Jt<E.mipmaps.length;Jt++)W.__webglFramebuffer[Lt][Jt]=r.createFramebuffer()}else W.__webglFramebuffer[Lt]=r.createFramebuffer()}else{if(E.mipmaps&&E.mipmaps.length>0){W.__webglFramebuffer=[];for(let Lt=0;Lt<E.mipmaps.length;Lt++)W.__webglFramebuffer[Lt]=r.createFramebuffer()}else W.__webglFramebuffer=r.createFramebuffer();if(Qt)for(let Lt=0,Jt=St.length;Lt<Jt;Lt++){const le=s.get(St[Lt]);le.__webglTexture===void 0&&(le.__webglTexture=r.createTexture(),f.memory.textures++)}if(N.samples>0&&ne(N)===!1){W.__webglMultisampledFramebuffer=r.createFramebuffer(),W.__webglColorRenderbuffer=[],i.bindFramebuffer(r.FRAMEBUFFER,W.__webglMultisampledFramebuffer);for(let Lt=0;Lt<St.length;Lt++){const Jt=St[Lt];W.__webglColorRenderbuffer[Lt]=r.createRenderbuffer(),r.bindRenderbuffer(r.RENDERBUFFER,W.__webglColorRenderbuffer[Lt]);const le=c.convert(Jt.format,Jt.colorSpace),Tt=c.convert(Jt.type),Ct=D(Jt.internalFormat,le,Tt,Jt.colorSpace,N.isXRRenderTarget===!0),Yt=P(N);r.renderbufferStorageMultisample(r.RENDERBUFFER,Yt,Ct,N.width,N.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+Lt,r.RENDERBUFFER,W.__webglColorRenderbuffer[Lt])}r.bindRenderbuffer(r.RENDERBUFFER,null),N.depthBuffer&&(W.__webglDepthRenderbuffer=r.createRenderbuffer(),Gt(W.__webglDepthRenderbuffer,N,!0)),i.bindFramebuffer(r.FRAMEBUFFER,null)}}if(ht){i.bindTexture(r.TEXTURE_CUBE_MAP,ut.__webglTexture),K(r.TEXTURE_CUBE_MAP,E);for(let Lt=0;Lt<6;Lt++)if(E.mipmaps&&E.mipmaps.length>0)for(let Jt=0;Jt<E.mipmaps.length;Jt++)Dt(W.__webglFramebuffer[Lt][Jt],N,E,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+Lt,Jt);else Dt(W.__webglFramebuffer[Lt],N,E,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+Lt,0);M(E)&&S(r.TEXTURE_CUBE_MAP),i.unbindTexture()}else if(Qt){for(let Lt=0,Jt=St.length;Lt<Jt;Lt++){const le=St[Lt],Tt=s.get(le);let Ct=r.TEXTURE_2D;(N.isWebGL3DRenderTarget||N.isWebGLArrayRenderTarget)&&(Ct=N.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),i.bindTexture(Ct,Tt.__webglTexture),K(Ct,le),Dt(W.__webglFramebuffer,N,le,r.COLOR_ATTACHMENT0+Lt,Ct,0),M(le)&&S(Ct)}i.unbindTexture()}else{let Lt=r.TEXTURE_2D;if((N.isWebGL3DRenderTarget||N.isWebGLArrayRenderTarget)&&(Lt=N.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),i.bindTexture(Lt,ut.__webglTexture),K(Lt,E),E.mipmaps&&E.mipmaps.length>0)for(let Jt=0;Jt<E.mipmaps.length;Jt++)Dt(W.__webglFramebuffer[Jt],N,E,r.COLOR_ATTACHMENT0,Lt,Jt);else Dt(W.__webglFramebuffer,N,E,r.COLOR_ATTACHMENT0,Lt,0);M(E)&&S(Lt),i.unbindTexture()}N.depthBuffer&&ye(N)}function gt(N){const E=N.textures;for(let W=0,ut=E.length;W<ut;W++){const St=E[W];if(M(St)){const ht=L(N),Qt=s.get(St).__webglTexture;i.bindTexture(ht,Qt),S(ht),i.unbindTexture()}}}const At=[],Mt=[];function Ft(N){if(N.samples>0){if(ne(N)===!1){const E=N.textures,W=N.width,ut=N.height;let St=r.COLOR_BUFFER_BIT;const ht=N.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,Qt=s.get(N),Lt=E.length>1;if(Lt)for(let le=0;le<E.length;le++)i.bindFramebuffer(r.FRAMEBUFFER,Qt.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+le,r.RENDERBUFFER,null),i.bindFramebuffer(r.FRAMEBUFFER,Qt.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+le,r.TEXTURE_2D,null,0);i.bindFramebuffer(r.READ_FRAMEBUFFER,Qt.__webglMultisampledFramebuffer);const Jt=N.texture.mipmaps;Jt&&Jt.length>0?i.bindFramebuffer(r.DRAW_FRAMEBUFFER,Qt.__webglFramebuffer[0]):i.bindFramebuffer(r.DRAW_FRAMEBUFFER,Qt.__webglFramebuffer);for(let le=0;le<E.length;le++){if(N.resolveDepthBuffer&&(N.depthBuffer&&(St|=r.DEPTH_BUFFER_BIT),N.stencilBuffer&&N.resolveStencilBuffer&&(St|=r.STENCIL_BUFFER_BIT)),Lt){r.framebufferRenderbuffer(r.READ_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.RENDERBUFFER,Qt.__webglColorRenderbuffer[le]);const Tt=s.get(E[le]).__webglTexture;r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,Tt,0)}r.blitFramebuffer(0,0,W,ut,0,0,W,ut,St,r.NEAREST),m===!0&&(At.length=0,Mt.length=0,At.push(r.COLOR_ATTACHMENT0+le),N.depthBuffer&&N.resolveDepthBuffer===!1&&(At.push(ht),Mt.push(ht),r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,Mt)),r.invalidateFramebuffer(r.READ_FRAMEBUFFER,At))}if(i.bindFramebuffer(r.READ_FRAMEBUFFER,null),i.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),Lt)for(let le=0;le<E.length;le++){i.bindFramebuffer(r.FRAMEBUFFER,Qt.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+le,r.RENDERBUFFER,Qt.__webglColorRenderbuffer[le]);const Tt=s.get(E[le]).__webglTexture;i.bindFramebuffer(r.FRAMEBUFFER,Qt.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+le,r.TEXTURE_2D,Tt,0)}i.bindFramebuffer(r.DRAW_FRAMEBUFFER,Qt.__webglMultisampledFramebuffer)}else if(N.depthBuffer&&N.resolveDepthBuffer===!1&&m){const E=N.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,[E])}}}function P(N){return Math.min(l.maxSamples,N.samples)}function ne(N){const E=s.get(N);return N.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&E.__useRenderToTexture!==!1}function Ht(N){const E=f.render.frame;_.get(N)!==E&&(_.set(N,E),N.update())}function ae(N,E){const W=N.colorSpace,ut=N.format,St=N.type;return N.isCompressedTexture===!0||N.isVideoTexture===!0||W!==zr&&W!==$a&&(De.getTransfer(W)===Xe?(ut!==Ai||St!==ii)&&pe("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):we("WebGLTextures: Unsupported texture color space:",W)),E}function Ut(N){return typeof HTMLImageElement<"u"&&N instanceof HTMLImageElement?(p.width=N.naturalWidth||N.width,p.height=N.naturalHeight||N.height):typeof VideoFrame<"u"&&N instanceof VideoFrame?(p.width=N.displayWidth,p.height=N.displayHeight):(p.width=N.width,p.height=N.height),p}this.allocateTextureUnit=it,this.resetTextureUnits=nt,this.setTexture2D=rt,this.setTexture2DArray=B,this.setTexture3D=H,this.setTextureCube=$,this.rebindTextures=Ue,this.setupRenderTarget=fe,this.updateRenderTargetMipmap=gt,this.updateMultisampleRenderTarget=Ft,this.setupDepthRenderbuffer=ye,this.setupFrameBufferTexture=Dt,this.useMultisampledRTT=ne,this.isReversedDepthBuffer=function(){return i.buffers.depth.getReversed()}}function $A(r,t){function i(s,l=$a){let c;const f=De.getTransfer(l);if(s===ii)return r.UNSIGNED_BYTE;if(s===Wd)return r.UNSIGNED_SHORT_4_4_4_4;if(s===qd)return r.UNSIGNED_SHORT_5_5_5_1;if(s===hv)return r.UNSIGNED_INT_5_9_9_9_REV;if(s===dv)return r.UNSIGNED_INT_10F_11F_11F_REV;if(s===uv)return r.BYTE;if(s===fv)return r.SHORT;if(s===jo)return r.UNSIGNED_SHORT;if(s===kd)return r.INT;if(s===Gi)return r.UNSIGNED_INT;if(s===zi)return r.FLOAT;if(s===xa)return r.HALF_FLOAT;if(s===pv)return r.ALPHA;if(s===mv)return r.RGB;if(s===Ai)return r.RGBA;if(s===Sa)return r.DEPTH_COMPONENT;if(s===Ds)return r.DEPTH_STENCIL;if(s===gv)return r.RED;if(s===Yd)return r.RED_INTEGER;if(s===Pr)return r.RG;if(s===Zd)return r.RG_INTEGER;if(s===jd)return r.RGBA_INTEGER;if(s===Xc||s===kc||s===Wc||s===qc)if(f===Xe)if(c=t.get("WEBGL_compressed_texture_s3tc_srgb"),c!==null){if(s===Xc)return c.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(s===kc)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(s===Wc)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(s===qc)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(c=t.get("WEBGL_compressed_texture_s3tc"),c!==null){if(s===Xc)return c.COMPRESSED_RGB_S3TC_DXT1_EXT;if(s===kc)return c.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(s===Wc)return c.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(s===qc)return c.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(s===ad||s===sd||s===rd||s===od)if(c=t.get("WEBGL_compressed_texture_pvrtc"),c!==null){if(s===ad)return c.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(s===sd)return c.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(s===rd)return c.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(s===od)return c.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(s===ld||s===cd||s===ud||s===fd||s===hd||s===dd||s===pd)if(c=t.get("WEBGL_compressed_texture_etc"),c!==null){if(s===ld||s===cd)return f===Xe?c.COMPRESSED_SRGB8_ETC2:c.COMPRESSED_RGB8_ETC2;if(s===ud)return f===Xe?c.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:c.COMPRESSED_RGBA8_ETC2_EAC;if(s===fd)return c.COMPRESSED_R11_EAC;if(s===hd)return c.COMPRESSED_SIGNED_R11_EAC;if(s===dd)return c.COMPRESSED_RG11_EAC;if(s===pd)return c.COMPRESSED_SIGNED_RG11_EAC}else return null;if(s===md||s===gd||s===_d||s===vd||s===xd||s===Sd||s===yd||s===Md||s===Ed||s===Td||s===bd||s===Ad||s===Rd||s===Cd)if(c=t.get("WEBGL_compressed_texture_astc"),c!==null){if(s===md)return f===Xe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:c.COMPRESSED_RGBA_ASTC_4x4_KHR;if(s===gd)return f===Xe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:c.COMPRESSED_RGBA_ASTC_5x4_KHR;if(s===_d)return f===Xe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:c.COMPRESSED_RGBA_ASTC_5x5_KHR;if(s===vd)return f===Xe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:c.COMPRESSED_RGBA_ASTC_6x5_KHR;if(s===xd)return f===Xe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:c.COMPRESSED_RGBA_ASTC_6x6_KHR;if(s===Sd)return f===Xe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:c.COMPRESSED_RGBA_ASTC_8x5_KHR;if(s===yd)return f===Xe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:c.COMPRESSED_RGBA_ASTC_8x6_KHR;if(s===Md)return f===Xe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:c.COMPRESSED_RGBA_ASTC_8x8_KHR;if(s===Ed)return f===Xe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:c.COMPRESSED_RGBA_ASTC_10x5_KHR;if(s===Td)return f===Xe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:c.COMPRESSED_RGBA_ASTC_10x6_KHR;if(s===bd)return f===Xe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:c.COMPRESSED_RGBA_ASTC_10x8_KHR;if(s===Ad)return f===Xe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:c.COMPRESSED_RGBA_ASTC_10x10_KHR;if(s===Rd)return f===Xe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:c.COMPRESSED_RGBA_ASTC_12x10_KHR;if(s===Cd)return f===Xe?c.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:c.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(s===wd||s===Dd||s===Ud)if(c=t.get("EXT_texture_compression_bptc"),c!==null){if(s===wd)return f===Xe?c.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:c.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(s===Dd)return c.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(s===Ud)return c.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(s===Nd||s===Ld||s===Od||s===Pd)if(c=t.get("EXT_texture_compression_rgtc"),c!==null){if(s===Nd)return c.COMPRESSED_RED_RGTC1_EXT;if(s===Ld)return c.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(s===Od)return c.COMPRESSED_RED_GREEN_RGTC2_EXT;if(s===Pd)return c.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return s===Ko?r.UNSIGNED_INT_24_8:r[s]!==void 0?r[s]:null}return{convert:i}}const tR=`
void main() {
...
}`;class nR{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,i){if(this.texture===null){const s=new Cv(t.texture);(t.depthNear!==i.depthNear||t.depthFar!==i.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=s}}getMesh(t){if(this.texture!==null&&this.mesh===null){const i=t.cameras[0].viewport,s=new Xi({vertexShader:tR,fragmentShader:eR,uniforms:{depthColor:{value:this.texture},depthWidth:{value:i.z},depthHeight:{value:i.w}}});this.mesh=new Ci(new rl(20,20),s)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class iR extends Ir{constructor(t,i){super();const s=this;let l=null,c=1,f=null,d="local-floor",m=1,p=null,_=null,g=null,v=null,y=null,T=null;const R=typeof XRWebGLBinding<"u",M=new nR,S={},L=i.getContextAttributes();let D=null,U=null;const z=[],I=[],F=new Wt;let Z=null;const C=new mi;C.viewport=new an;const w=new mi;w.viewport=new an;const V=[C,w],nt=new dE;let it=null,dt=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Q){let ct=z[Q];return ct===void 0&&(ct=new Lh,z[Q]=ct),ct.getTargetRaySpace()},this.getControllerGrip=function(Q){let ct=z[Q];return ct===void 0&&(ct=new Lh,z[Q]=ct),ct.getGripSpace()},this.getHand=function(Q){let ct=z[Q];return ct===void 0&&(ct=new Lh,z[Q]=ct),ct.getHandSpace()};function rt(Q){const ct=I.indexOf(Q.inputSource);if(ct===-1)return;const Dt=z[ct];Dt!==void 0&&(Dt.update(Q.inputSource,Q.frame,p||f),Dt.dispatchEvent({type:Q.type,data:Q.inputSource}))}function B(){l.removeEventListener("select",rt),l.removeEventListener("selectstart",rt),l.removeEventListener("selectend",rt),l.removeEventListener("squeeze",rt),l.removeEventListener("squeezestart",rt),l.removeEventListener("squeezeend",rt),l.removeEventListener("end",B),l.removeEventListener("inputsourceschange",H);for(let Q=0;Q<z.length;Q++){const ct=I[Q];ct!==null&&(I[Q]=null,z[Q].disconnect(ct))}it=null,dt=null,M.reset();for(const Q in S)delete S[Q];t.setRenderTarget(D),y=null,v=null,g=null,l=null,U=null,Rt.stop(),s.isPresenting=!1,t.setPixelRatio(Z),t.setSize(F.width,F.height,!1),s.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Q){c=Q,s.isPresenting===!0&&pe("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Q){d=Q,s.isPresenting===!0&&pe("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return p||f},this.setReferenceSpace=function(Q){p=Q},this.getBaseLayer=function(){return v!==null?v:y},this.getBinding=function(){return g===null&&R&&(g=new XRWebGLBinding(l,i)),g},this.getFrame=function(){return T},this.getSession=function(){return l},this.setSession=async function(Q){if(l=Q,l!==null){if(D=t.getRenderTarget(),l.addEventListener("select",rt),l.addEventListener("selectstart",rt),l.addEventListener("selectend",rt),l.addEventListener("squeeze",rt),l.addEventListener("squeezestart",rt),l.addEventListener("squeezeend",rt),l.addEventListener("end",B),l.addEventListener("inputsourceschange",H),L.xrCompatible!==!0&&await i.makeXRCompatible(),Z=t.getPixelRatio(),t.getSize(F),R&&"createProjectionLayer"in XRWebGLBinding.prototype){let Dt=null,Gt=null,qt=null;L.depth&&(qt=L.stencil?i.DEPTH24_STENCIL8:i.DEPTH_COMPONENT24,Dt=L.stencil?Ds:Sa,Gt=L.stencil?Ko:Gi);const ye={colorFormat:i.RGBA8,depthFormat:qt,scaleFactor:c};g=this.getBinding(),v=g.createProjectionLayer(ye),l.updateRenderState({layers:[v]}),t.setPixelRatio(1),t.setSize(v.textureWidth,v.textureHeight,!1),U=new Ii(v.textureWidth,v.textureHeight,{format:Ai,type:ii,depthTexture:new Qo(v.textureWidth,v.textureHeight,Gt,void 0,void 0,void 0,void 0,void 0,void 0,Dt),stencilBuffer:L.stencil,colorSpace:t.outputColorSpace,samples:L.antialias?4:0,resolveDepthBuffer:v.ignoreDepthValues===!1,resolveStencilBuffer:v.ignoreDepthValues===!1})}else{const Dt={antialias:L.antialias,alpha:!0,depth:L.depth,stencil:L.stencil,framebufferScaleFactor:c};y=new XRWebGLLayer(l,i,Dt),l.updateRenderState({baseLayer:y}),t.setPixelRatio(1),t.setSize(y.framebufferWidth,y.framebufferHeight,!1),U=new Ii(y.framebufferWidth,y.framebufferHeight,{format:Ai,type:ii,colorSpace:t.outputColorSpace,stencilBuffer:L.stencil,resolveDepthBuffer:y.ignoreDepthValues===!1,resolveStencilBuffer:y.ignoreDepthValues===!1})}U.isXRRenderTarget=!0,this.setFoveation(m),p=null,f=await l.requestReferenceSpace(d),Rt.setContext(l),Rt.start(),s.isPresenting=!0,s.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(l!==null)return l.environmentBlendMode},this.getDepthTexture=function(){return M.getDepthTexture()};function H(Q){for(let ct=0;ct<Q.removed.length;ct++){const Dt=Q.removed[ct],Gt=I.indexOf(Dt);Gt>=0&&(I[Gt]=null,z[Gt].disconnect(Dt))}for(let ct=0;ct<Q.added.length;ct++){const Dt=Q.added[ct];let Gt=I.indexOf(Dt);if(Gt===-1){for(let ye=0;ye<z.length;ye++)if(ye>=I.length){I.push(Dt),Gt=ye;break}else if(I[ye]===null){I[ye]=Dt,Gt=ye;break}if(Gt===-1)break}const qt=z[Gt];qt&&qt.connect(Dt)}}const $=new j,yt=new j;function xt(Q,ct,Dt){$.setFromMatrixPosition(ct.matrixWorld),yt.setFromMatrixPosition(Dt.matrixWorld);const Gt=$.distanceTo(yt),qt=ct.projectionMatrix.elements,ye=Dt.projectionMatrix.elements,Ue=qt[14]/(qt[10]-1),fe=qt[14]/(qt[10]+1),gt=(qt[9]+1)/qt[5],At=(qt[9]-1)/qt[5],Mt=(qt[8]-1)/qt[0],Ft=(ye[8]+1)/ye[0],P=Ue*Mt,ne=Ue*Ft,Ht=Gt/(-Mt+Ft),ae=Ht*-Mt;if(ct.matrixWorld.decompose(Q.position,Q.quaternion,Q.scale),Q.translateX(ae),Q.translateZ(Ht),Q.matrixWorld.compose(Q.position,Q.quaternion,Q.scale),Q.matrixWorldInverse.copy(Q.matrixWorld).invert(),qt[10]===-1)Q.projectionMatrix.copy(ct.projectionMatrix),Q.projectionMatrixInverse.copy(ct.projectionMatrixInverse);else{const Ut=Ue+Ht,N=fe+Ht,E=P-ae,W=ne+(Gt-ae),ut=gt*fe/N*Ut,St=At*fe/N*Ut;Q.projectionMatrix.makePerspective(E,W,ut,St,Ut,N),Q.projectionMatrixInverse.copy(Q.projectionMatrix).invert()}}function O(Q,ct){ct===null?Q.matrixWorld.copy(Q.matrix):Q.matrixWorld.multiplyMatrices(ct.matrixWorld,Q.matrix),Q.matrixWorldInverse.copy(Q.matrixWorld).invert()}this.updateCamera=function(Q){if(l===null)return;let ct=Q.near,Dt=Q.far;M.texture!==null&&(M.depthNear>0&&(ct=M.depthNear),M.depthFar>0&&(Dt=M.depthFar)),nt.near=w.near=C.near=ct,nt.far=w.far=C.far=Dt,(it!==nt.near||dt!==nt.far)&&(l.updateRenderState({depthNear:nt.near,depthFar:nt.far}),it=nt.near,dt=nt.far),nt.layers.mask=Q.layers.mask|6,C.layers.mask=nt.layers.mask&3,w.layers.mask=nt.layers.mask&5;const Gt=Q.parent,qt=nt.cameras;O(nt,Gt);for(let ye=0;ye<qt.length;ye++)O(qt[ye],Gt);qt.length===2?xt(nt,C,w):nt.projectionMatrix.copy(C.projectionMatrix),K(Q,nt,Gt)};function K(Q,ct,Dt){Dt===null?Q.matrix.copy(ct.matrixWorld):(Q.matrix.copy(Dt.matrixWorld),Q.matrix.invert(),Q.matrix.multiply(ct.matrixWorld)),Q.matrix.decompose(Q.position,Q.quaternion,Q.scale),Q.updateMatrixWorld(!0),Q.projectionMatrix.copy(ct.projectionMatrix),Q.projectionMatrixInverse.copy(ct.projectionMatrixInverse),Q.isPerspectiveCamera&&(Q.fov=zd*2*Math.atan(1/Q.projectionMatrix.elements[5]),Q.zoom=1)}this.getCamera=function(){return nt},this.getFoveation=function(){if(!(v===null&&y===null))return m},this.setFoveation=function(Q){m=Q,v!==null&&(v.fixedFoveation=Q),y!==null&&y.fixedFoveation!==void 0&&(y.fixedFoveation=Q)},this.hasDepthSensing=function(){return M.texture!==null},this.getDepthSensingMesh=function(){return M.getMesh(nt)},this.getCameraTexture=function(Q){return S[Q]};let ft=null;function Et(Q,ct){if(_=ct.getViewerPose(p||f),T=ct,_!==null){const Dt=_.views;y!==null&&(t.setRenderTargetFramebuffer(U,y.framebuffer),t.setRenderTarget(U));let Gt=!1;Dt.length!==nt.cameras.length&&(nt.cameras.length=0,Gt=!0);for(let fe=0;fe<Dt.length;fe++){const gt=Dt[fe];let At=null;if(y!==null)At=y.getViewport(gt);else{const Ft=g.getViewSubImage(v,gt);At=Ft.viewport,fe===0&&(t.setRenderTargetTextures(U,Ft.colorTexture,Ft.depthStencilTexture),t.setRenderTarget(U))}let Mt=V[fe];Mt===void 0&&(Mt=new mi,Mt.layers.enable(fe),Mt.viewport=new an,V[fe]=Mt),Mt.matrix.fromArray(gt.transform.matrix),Mt.matrix.decompose(Mt.position,Mt.quaternion,Mt.scale),Mt.projectionMatrix.fromArray(gt.projectionMatrix),Mt.projectionMatrixInverse.copy(Mt.projectionMatrix).invert(),Mt.viewport.set(At.x,At.y,At.width,At.height),fe===0&&(nt.matrix.copy(Mt.matrix),nt.matrix.decompose(nt.position,nt.quaternion,nt.scale)),Gt===!0&&nt.cameras.push(Mt)}const qt=l.enabledFeatures;if(qt&&qt.includes("depth-sensing")&&l.depthUsage=="gpu-optimized"&&R){g=s.getBinding();const fe=g.getDepthInformation(Dt[0]);fe&&fe.isValid&&fe.texture&&M.init(fe,l.renderState)}if(qt&&qt.includes("camera-access")&&R){t.state.unbindTexture(),g=s.getBinding();for(let fe=0;fe<Dt.length;fe++){const gt=Dt[fe].camera;if(gt){let At=S[gt];At||(At=new Cv,S[gt]=At);const Mt=g.getCameraImage(gt);At.sourceTexture=Mt}}}}for(let Dt=0;Dt<z.length;Dt++){const Gt=I[Dt],qt=z[Dt];Gt!==null&&qt!==void 0&&qt.update(Gt,ct,p||f)}ft&&ft(Q,ct),ct.detectedPlanes&&s.dispatchEvent({type:"planesdetected",data:ct}),T=null}const Rt=new Iv;Rt.setAnimationLoop(Et),this.setAnimationLoop=function(Q){ft=Q},this.dispose=function(){}}}const bs=new Vi,aR=new tn;function sR(r,t){function i(M,S){M.matrixAutoUpdate===!0&&M.updateMatrix(),S.value.copy(M.matrix)}function s(M,S){S.color.getRGB(M.fogColor.value,Tv(r)),S.isFog?(M.fogNear.value=S.near,M.fogFar.value=S.far):S.isFogExp2&&(M.fogDensity.value=S.density)}function l(M,S,L,D,U){S.isMeshBasicMaterial||S.isMeshLambertMaterial?c(M,S):S.isMeshToonMaterial?(c(M,S),g(M,S)):S.isMeshPhongMaterial?(c(M,S),_(M,S)):S.isMeshStandardMaterial?(c(M,S),v(M,S),S.isMeshPhysicalMaterial&&y(M,S,U)):S.isMeshMatcapMaterial?(c(M,S),T(M,S)):S.isMeshDepthMaterial?c(M,S):S.isMeshDistanceMaterial?(c(M,S),R(M,S)):S.isMeshNormalMaterial?c(M,S):S.isLineBasicMaterial?(f(M,S),S.isLineDashedMaterial&&d(M,S)):S.isPointsMaterial?m(M,S,L,D):S.isSpriteMaterial?p(M,S):S.isShadowMaterial?(M.color.value.copy(S.color),M.opacity.value=S.opacity):S.isShaderMaterial&&(S.uniformsNeedUpdate=!1)}function c(M,S){M.opacity.value=S.opacity,S.color&&M.diffuse.value.copy(S.color),S.emissive&&M.emissive.value.copy(S.emissive).multiplyScalar(S.emissiveIntensity),S.map&&(M.map.value=S.map,i(S.map,M.mapTransform)),S.alphaMap&&(M.alphaMap.value=S.alphaMap,i(S.alphaMap,M.alphaMapTransform)),S.bumpMap&&(M.bumpMap.value=S.bumpMap,i(S.bumpMap,M.bumpMapTransform),M.bumpScale.value=S.bumpScale,S.side===qn&&(M.bumpScale.value*=-1)),S.normalMap&&(M.normalMap.value=S.normalMap,i(S.normalMap,M.normalMapTransform),M.normalScale.value.copy(S.normalScale),S.side===qn&&M.normalScale.value.negate()),S.displacementMap&&(M.displacementMap.value=S.displacementMap,i(S.displacementMap,M.displacementMapTransform),M.displacementScale.value=S.displacementScale,M.displacementBias.value=S.displacementBias),S.emissiveMap&&(M.emissiveMap.value=S.emissiveMap,i(S.emissiveMap,M.emissiveMapTransform)),S.specularMap&&(M.specularMap.value=S.specularMap,i(S.specularMap,M.specularMapTransform)),S.alphaTest>0&&(M.alphaTest.value=S.alphaTest);const L=t.get(S),D=L.envMap,U=L.envMapRotation;D&&(M.envMap.value=D,bs.copy(U),bs.x*=-1,bs.y*=-1,bs.z*=-1,D.isCubeTexture&&D.isRenderTargetTexture===!1&&(bs.y*=-1,bs.z*=-1),M.envMapRotation.value.setFromMatrix4(aR.makeRotationFromEuler(bs)),M.flipEnvMap.value=D.isCubeTexture&&D.isRenderTargetTexture===!1?-1:1,M.reflectivity.value=S.reflectivity,M.ior.value=S.ior,M.refractionRatio.value=S.refractionRatio),S.lightMap&&(M.lightMap.value=S.lightMap,M.lightMapIntensity.value=S.lightMapIntensity,i(S.lightMap,M.lightMapTransform)),S.aoMap&&(M.aoMap.value=S.aoMap,M.aoMapIntensity.value=S.aoMapIntensity,i(S.aoMap,M.aoMapTransform))}function f(M,S){M.diffuse.value.copy(S.color),M.opacity.value=S.opacity,S.map&&(M.map.value=S.map,i(S.map,M.mapTransform))}function d(M,S){M.dashSize.value=S.dashSize,M.totalSize.value=S.dashSize+S.gapSize,M.scale.value=S.scale}function m(M,S,L,D){M.diffuse.value.copy(S.color),M.opacity.value=S.opacity,M.size.value=S.size*L,M.scale.value=D*.5,S.map&&(M.map.value=S.map,i(S.map,M.uvTransform)),S.alphaMap&&(M.alphaMap.value=S.alphaMap,i(S.alphaMap,M.alphaMapTransform)),S.alphaTest>0&&(M.alphaTest.value=S.alphaTest)}function p(M,S){M.diffuse.value.copy(S.color),M.opacity.value=S.opacity,M.rotation.value=S.rotation,S.map&&(M.map.value=S.map,i(S.map,M.mapTransform)),S.alphaMap&&(M.alphaMap.value=S.alphaMap,i(S.alphaMap,M.alphaMapTransform)),S.alphaTest>0&&(M.alphaTest.value=S.alphaTest)}function _(M,S){M.specular.value.copy(S.specular),M.shininess.value=Math.max(S.shininess,1e-4)}function g(M,S){S.gradientMap&&(M.gradientMap.value=S.gradientMap)}function v(M,S){M.metalness.value=S.metalness,S.metalnessMap&&(M.metalnessMap.value=S.metalnessMap,i(S.metalnessMap,M.metalnessMapTransform)),M.roughness.value=S.roughness,S.roughnessMap&&(M.roughnessMap.value=S.roughnessMap,i(S.roughnessMap,M.roughnessMapTransform)),S.envMap&&(M.envMapIntensity.value=S.envMapIntensity)}function y(M,S,L){M.ior.value=S.ior,S.sheen>0&&(M.sheenColor.value.copy(S.sheenColor).multiplyScalar(S.sheen),M.sheenRoughness.value=S.sheenRoughness,S.sheenColorMap&&(M.sheenColorMap.value=S.sheenColorMap,i(S.sheenColorMap,M.sheenColorMapTransform)),S.sheenRoughnessMap&&(M.sheenRoughnessMap.value=S.sheenRoughnessMap,i(S.sheenRoughnessMap,M.sheenRoughnessMapTransform))),S.clearcoat>0&&(M.clearcoat.value=S.clearcoat,M.clearcoatRoughness.value=S.clearcoatRoughness,S.clearcoatMap&&(M.clearcoatMap.value=S.clearcoatMap,i(S.clearcoatMap,M.clearcoatMapTransform)),S.clearcoatRoughnessMap&&(M.clearcoatRoughnessMap.value=S.clearcoatRoughnessMap,i(S.clearcoatRoughnessMap,M.clearcoatRoughnessMapTransform)),S.clearcoatNormalMap&&(M.clearcoatNormalMap.value=S.clearcoatNormalMap,i(S.clearcoatNormalMap,M.clearcoatNormalMapTransform),M.clearcoatNormalScale.value.copy(S.clearcoatNormalScale),S.side===qn&&M.clearcoatNormalScale.value.negate())),S.dispersion>0&&(M.dispersion.value=S.dispersion),S.iridescence>0&&(M.iridescence.value=S.iridescence,M.iridescenceIOR.value=S.iridescenceIOR,M.iridescenceThicknessMinimum.value=S.iridescenceThicknessRange[0],M.iridescenceThicknessMaximum.value=S.iridescenceThicknessRange[1],S.iridescenceMap&&(M.iridescenceMap.value=S.iridescenceMap,i(S.iridescenceMap,M.iridescenceMapTransform)),S.iridescenceThicknessMap&&(M.iridescenceThicknessMap.value=S.iridescenceThicknessMap,i(S.iridescenceThicknessMap,M.iridescenceThicknessMapTransform))),S.transmission>0&&(M.transmission.value=S.transmission,M.transmissionSamplerMap.value=L.texture,M.transmissionSamplerSize.value.set(L.width,L.height),S.transmissionMap&&(M.transmissionMap.value=S.transmissionMap,i(S.transmissionMap,M.transmissionMapTransform)),M.thickness.value=S.thickness,S.thicknessMap&&(M.thicknessMap.value=S.thicknessMap,i(S.thicknessMap,M.thicknessMapTransform)),M.attenuationDistance.value=S.attenuationDistance,M.attenuationColor.value.copy(S.attenuationColor)),S.anisotropy>0&&(M.anisotropyVector.value.set(S.anisotropy*Math.cos(S.anisotropyRotation),S.anisotropy*Math.sin(S.anisotropyRotation)),S.anisotropyMap&&(M.anisotropyMap.value=S.anisotropyMap,i(S.anisotropyMap,M.anisotropyMapTransform))),M.specularIntensity.value=S.specularIntensity,M.specularColor.value.copy(S.specularColor),S.specularColorMap&&(M.specularColorMap.value=S.specularColorMap,i(S.specularColorMap,M.specularColorMapTransform)),S.specularIntensityMap&&(M.specularIntensityMap.value=S.specularIntensityMap,i(S.specularIntensityMap,M.specularIntensityMapTransform))}function T(M,S){S.matcap&&(M.matcap.value=S.matcap)}function R(M,S){const L=t.get(S).light;M.referencePosition.value.setFromMatrixPosition(L.matrixWorld),M.nearDistance.value=L.shadow.camera.near,M.farDistance.value=L.shadow.camera.far}return{refreshFogUniforms:s,refreshMaterialUniforms:l}}function rR(r,t,i,s){let l={},c={},f=[];const d=r.getParameter(r.MAX_UNIFORM_BUFFER_BINDINGS);function m(L,D){const U=D.program;s.uniformBlockBinding(L,U)}function p(L,D){let U=l[L.id];U===void 0&&(T(L),U=_(L),l[L.id]=U,L.addEventListener("dispose",M));const z=D.program;s.updateUBOMapping(L,z);const I=t.render.frame;c[L.id]!==I&&(v(L),c[L.id]=I)}function _(L){const D=g();L.__bindingPointIndex=D;const U=r.createBuffer(),z=L.__size,I=L.usage;return r.bindBuffer(r.UNIFORM_BUFFER,U),r.bufferData(r.UNIFORM_BUFFER,z,I),r.bindBuffer(r.UNIFORM_BUFFER,null),r.bindBufferBase(r.UNIFORM_BUFFER,D,U),U}function g(){for(let L=0;L<d;L++)if(f.indexOf(L)===-1)return f.push(L),L;return we("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function v(L){const D=l[L.id],U=L.uniforms,z=L.__cache;r.bindBuffer(r.UNIFORM_BUFFER,D);for(let I=0,F=U.length;I<F;I++){const Z=Array.isArray(U[I])?U[I]:[U[I]];for(let C=0,w=Z.length;C<w;C++){const V=Z[C];if(y(V,I,C,z)===!0){const nt=V.__offset,it=Array.isArray(V.value)?V.value:[V.value];let dt=0;for(let rt=0;rt<it.length;rt++){const B=it[rt],H=R(B);typeof B=="number"||typeof B=="boolean"?(V.__data[0]=B,r.bufferSubData(r.UNIFORM_BUFFER,nt+dt,V.__data)):B.isMatrix3?(V.__data[0]=B.elements[0],V.__data[1]=B.elements[1],V.__data[2]=B.elements[2],V.__data[3]=0,V.__data[4]=B.elements[3],V.__data[5]=B.elements[4],V.__data[6]=B.elements[5],V.__data[7]=0,V.__data[8]=B.elements[6],V.__data[9]=B.elements[7],V.__data[10]=B.elements[8],V.__data[11]=0):(B.toArray(V.__data,dt),dt+=H.storage/Float32Array.BYTES_PER_ELEMENT)}r.bufferSubData(r.UNIFORM_BUFFER,nt,V.__data)}}}r.bindBuffer(r.UNIFORM_BUFFER,null)}function y(L,D,U,z){const I=L.value,F=D+"_"+U;if(z[F]===void 0)return typeof I=="number"||typeof I=="boolean"?z[F]=I:z[F]=I.clone(),!0;{const Z=z[F];if(typeof I=="number"||typeof I=="boolean"){if(Z!==I)return z[F]=I,!0}else if(Z.equals(I)===!1)return Z.copy(I),!0}return!1}function T(L){const D=L.uniforms;let U=0;const z=16;for(let F=0,Z=D.length;F<Z;F++){const C=Array.isArray(D[F])?D[F]:[D[F]];for(let w=0,V=C.length;w<V;w++){const nt=C[w],it=Array.isArray(nt.value)?nt.value:[nt.value];for(let dt=0,rt=it.length;dt<rt;dt++){const B=it[dt],H=R(B),$=U%z,yt=$%H.boundary,xt=$+yt;U+=yt,xt!==0&&z-xt<H.storage&&(U+=z-xt),nt.__data=new Float32Array(H.storage/Float32Array.BYTES_PER_ELEMENT),nt.__offset=U,U+=H.storage}}}const I=U%z;return I>0&&(U+=z-I),L.__size=U,L.__cache={},this}function R(L){const D={boundary:0,storage:0};return typeof L=="number"||typeof L=="boolean"?(D.boundary=4,D.storage=4):L.isVector2?(D.boundary=8,D.storage=8):L.isVector3||L.isColor?(D.boundary=16,D.storage=12):L.isVector4?(D.boundary=16,D.storage=16):L.isMatrix3?(D.boundary=48,D.storage=48):L.isMatrix4?(D.boundary=64,D.storage=64):L.isTexture?pe("WebGLRenderer: Texture samplers can not be part of an uniforms group."):pe("WebGLRenderer: Unsupported uniform value type.",L),D}function M(L){const D=L.target;D.removeEventListener("dispose",M);const U=f.indexOf(D.__bindingPointIndex);f.splice(U,1),r.deleteBuffer(l[D.id]),delete l[D.id],delete c[D.id]}function S(){for(const L in l)r.deleteBuffer(l[L]);f=[],l={},c={}}return{bind:m,update:p,dispose:S}}const oR=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let Oi=null;function lR(){return Oi===null&&(Oi=new SM(oR,16,16,Pr,xa),Oi.name="DFG_LUT",Oi.minFilter=xn,Oi.magFilter=xn,Oi.wrapS=ga,Oi.wrapT=ga,Oi.generateMipmaps=!1,Oi.needsUpdate=!0),Oi}class cR{constructor(t={}){const{canvas:i=qy(),context:s=null,depth:l=!0,stencil:c=!1,alpha:f=!1,antialias:d=!1,premultipliedAlpha:m=!0,preserveDrawingBuffer:p=!1,powerPreference:_="default",failIfMajorPerformanceCaveat:g=!1,reversedDepthBuffer:v=!1,outputBufferType:y=ii}=t;this.isWebGLRenderer=!0;let T;if(s!==null){if(typeof WebGLRenderingContext<"u"&&s instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");T=s.getContextAttributes().alpha}else T=f;const R=y,M=new Set([jd,Zd,Yd]),S=new Set([ii,Gi,jo,Ko,Wd,qd]),L=new Uint32Array(4),D=new Int32Array(4);let U=null,z=null;const I=[],F=[];let Z=null;this.domElement=i,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Bi,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const C=this;let w=!1;this._outputColorSpace=ni;let V=0,nt=0,it=null,dt=-1,rt=null;const B=new an,H=new an;let $=null;const yt=new Fe(0);let xt=0,O=i.width,K=i.height,ft=1,Et=null,Rt=null;const Q=new an(0,0,O,K),ct=new an(0,0,O,K);let Dt=!1;const Gt=new ep;let qt=!1,ye=!1;const Ue=new tn,fe=new j,gt=new an,At={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Mt=!1;function Ft(){return it===null?ft:1}let P=s;function ne(A,q){return i.getContext(A,q)}try{const A={alpha:!0,depth:l,stencil:c,antialias:d,premultipliedAlpha:m,preserveDrawingBuffer:p,powerPreference:_,failIfMajorPerformanceCaveat:g};if("setAttribute"in i&&i.setAttribute("data-engine",`three.js r${Xd}`),i.addEventListener("webglcontextlost",he,!1),i.addEventListener("webglcontextrestored",Ie,!1),i.addEventListener("webglcontextcreationerror",Ce,!1),P===null){const q="webgl2";if(P=ne(q,A),P===null)throw ne(q)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(A){throw we("WebGLRenderer: "+A.message),A}let Ht,ae,Ut,N,E,W,ut,St,ht,Qt,Lt,Jt,le,Tt,Ct,Yt,Vt,Ot,_e,k,zt,wt,Xt,bt;function vt(){Ht=new l1(P),Ht.init(),wt=new $A(P,Ht),ae=new $b(P,Ht,t,wt),Ut=new JA(P,Ht),ae.reversedDepthBuffer&&v&&Ut.buffers.depth.setReversed(!0),N=new f1(P),E=new zA,W=new QA(P,Ht,Ut,E,ae,wt,N),ut=new e1(C),St=new o1(C),ht=new mE(P),Xt=new Jb(P,ht),Qt=new c1(P,ht,N,Xt),Lt=new d1(P,Qt,ht,N),_e=new h1(P,ae,W),Yt=new t1(E),Jt=new PA(C,ut,St,Ht,ae,Xt,Yt),le=new sR(C,E),Tt=new BA,Ct=new kA(Ht),Ot=new Kb(C,ut,St,Ut,Lt,T,m),Vt=new jA(C,Lt,ae),bt=new rR(P,N,ae,Ut),k=new Qb(P,Ht,N),zt=new u1(P,Ht,N),N.programs=Jt.programs,C.capabilities=ae,C.extensions=Ht,C.properties=E,C.renderLists=Tt,C.shadowMap=Vt,C.state=Ut,C.info=N}vt(),R!==ii&&(Z=new m1(R,i.width,i.height,l,c));const Nt=new iR(C,P);this.xr=Nt,this.getContext=function(){return P},this.getContextAttributes=function(){return P.getContextAttributes()},this.forceContextLoss=function(){const A=Ht.get("WEBGL_lose_context");A&&A.loseContext()},this.forceContextRestore=function(){const A=Ht.get("WEBGL_lose_context");A&&A.restoreContext()},this.getPixelRatio=function(){return ft},this.setPixelRatio=function(A){A!==void 0&&(ft=A,this.setSize(O,K,!1))},this.getSize=function(A){return A.set(O,K)},this.setSize=function(A,q,ot=!0){if(Nt.isPresenting){pe("WebGLRenderer: Can't change size while VR device is presenting.");return}O=A,K=q,i.width=Math.floor(A*ft),i.height=Math.floor(q*ft),ot===!0&&(i.style.width=A+"px",i.style.height=q+"px"),Z!==null&&Z.setSize(i.width,i.height),this.setViewport(0,0,A,q)},this.getDrawingBufferSize=function(A){return A.set(O*ft,K*ft).floor()},this.setDrawingBufferSize=function(A,q,ot){O=A,K=q,ft=ot,i.width=Math.floor(A*ot),i.height=Math.floor(q*ot),this.setViewport(0,0,A,q)},this.setEffects=function(A){if(R===ii){console.error("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(A){for(let q=0;q<A.length;q++)if(A[q].isOutputPass===!0){console.warn("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}Z.setEffects(A||[])},this.getCurrentViewport=function(A){return A.copy(B)},this.getViewport=function(A){return A.copy(Q)},this.setViewport=function(A,q,ot,at){A.isVector4?Q.set(A.x,A.y,A.z,A.w):Q.set(A,q,ot,at),Ut.viewport(B.copy(Q).multiplyScalar(ft).round())},this.getScissor=function(A){return A.copy(ct)},this.setScissor=function(A,q,ot,at){A.isVector4?ct.set(A.x,A.y,A.z,A.w):ct.set(A,q,ot,at),Ut.scissor(H.copy(ct).multiplyScalar(ft).round())},this.getScissorTest=function(){return Dt},this.setScissorTest=function(A){Ut.setScissorTest(Dt=A)},this.setOpaqueSort=function(A){Et=A},this.setTransparentSort=function(A){Rt=A},this.getClearColor=function(A){return A.copy(Ot.getClearColor())},this.setClearColor=function(){Ot.setClearColor(...arguments)},this.getClearAlpha=function(){return Ot.getClearAlpha()},this.setClearAlpha=function(){Ot.setClearAlpha(...arguments)},this.clear=function(A=!0,q=!0,ot=!0){let at=0;if(A){let J=!1;if(it!==null){const Pt=it.texture.format;J=M.has(Pt)}if(J){const Pt=it.texture.type,Zt=S.has(Pt),Bt=Ot.getClearColor(),jt=Ot.getClearAlpha(),$t=Bt.r,re=Bt.g,te=Bt.b;Zt?(L[0]=$t,L[1]=re,L[2]=te,L[3]=jt,P.clearBufferuiv(P.COLOR,0,L)):(D[0]=$t,D[1]=re,D[2]=te,D[3]=jt,P.clearBufferiv(P.COLOR,0,D))}else at|=P.COLOR_BUFFER_BIT}q&&(at|=P.DEPTH_BUFFER_BIT),ot&&(at|=P.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),P.clear(at)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){i.removeEventListener("webglcontextlost",he,!1),i.removeEventListener("webglcontextrestored",Ie,!1),i.removeEventListener("webglcontextcreationerror",Ce,!1),Ot.dispose(),Tt.dispose(),Ct.dispose(),E.dispose(),ut.dispose(),St.dispose(),Lt.dispose(),Xt.dispose(),bt.dispose(),Jt.dispose(),Nt.dispose(),Nt.removeEventListener("sessionstart",Os),Nt.removeEventListener("sessionend",kr),wi.stop()};function he(A){A.preventDefault(),a_("WebGLRenderer: Context Lost."),w=!0}function Ie(){a_("WebGLRenderer: Context Restored."),w=!1;const A=N.autoReset,q=Vt.enabled,ot=Vt.autoUpdate,at=Vt.needsUpdate,J=Vt.type;vt(),N.autoReset=A,Vt.enabled=q,Vt.autoUpdate=ot,Vt.needsUpdate=at,Vt.type=J}function Ce(A){we("WebGLRenderer: A WebGL context could not be created. Reason: ",A.statusMessage)}function Un(A){const q=A.target;q.removeEventListener("dispose",Un),gi(q)}function gi(A){ol(A),E.remove(A)}function ol(A){const q=E.get(A).programs;q!==void 0&&(q.forEach(function(ot){Jt.releaseProgram(ot)}),A.isShaderMaterial&&Jt.releaseShaderCache(A))}this.renderBufferDirect=function(A,q,ot,at,J,Pt){q===null&&(q=At);const Zt=J.isMesh&&J.matrixWorld.determinant()<0,Bt=ns(A,q,ot,at,J);Ut.setMaterial(at,Zt);let jt=ot.index,$t=1;if(at.wireframe===!0){if(jt=Qt.getWireframeAttribute(ot),jt===void 0)return;$t=2}const re=ot.drawRange,te=ot.attributes.position;let ce=re.start*$t,Oe=(re.start+re.count)*$t;Pt!==null&&(ce=Math.max(ce,Pt.start*$t),Oe=Math.min(Oe,(Pt.start+Pt.count)*$t)),jt!==null?(ce=Math.max(ce,0),Oe=Math.min(Oe,jt.count)):te!=null&&(ce=Math.max(ce,0),Oe=Math.min(Oe,te.count));const Je=Oe-ce;if(Je<0||Je===1/0)return;Xt.setup(J,at,Bt,ot,jt);let Ze,Be=k;if(jt!==null&&(Ze=ht.get(jt),Be=zt,Be.setIndex(Ze)),J.isMesh)at.wireframe===!0?(Ut.setLineWidth(at.wireframeLinewidth*Ft()),Be.setMode(P.LINES)):Be.setMode(P.TRIANGLES);else if(J.isLine){let ie=at.linewidth;ie===void 0&&(ie=1),Ut.setLineWidth(ie*Ft()),J.isLineSegments?Be.setMode(P.LINES):J.isLineLoop?Be.setMode(P.LINE_LOOP):Be.setMode(P.LINE_STRIP)}else J.isPoints?Be.setMode(P.POINTS):J.isSprite&&Be.setMode(P.TRIANGLES);if(J.isBatchedMesh)if(J._multiDrawInstances!==null)Jo("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),Be.renderMultiDrawInstances(J._multiDrawStarts,J._multiDrawCounts,J._multiDrawCount,J._multiDrawInstances);else if(Ht.get("WEBGL_multi_draw"))Be.renderMultiDraw(J._multiDrawStarts,J._multiDrawCounts,J._multiDrawCount);else{const ie=J._multiDrawStarts,Pe=J._multiDrawCounts,de=J._multiDrawCount,yn=jt?ht.get(jt).bytesPerElement:1,qi=E.get(at).currentProgram.getUniforms();for(let Mn=0;Mn<de;Mn++)qi.setValue(P,"_gl_DrawID",Mn),Be.render(ie[Mn]/yn,Pe[Mn])}else if(J.isInstancedMesh)Be.renderInstances(ce,Je,J.count);else if(ot.isInstancedBufferGeometry){const ie=ot._maxInstanceCount!==void 0?ot._maxInstanceCount:1/0,Pe=Math.min(ot.instanceCount,ie);Be.renderInstances(ce,Je,Pe)}else Be.render(ce,Je)};function Vr(A,q,ot){A.transparent===!0&&A.side===ma&&A.forceSinglePass===!1?(A.side=qn,A.needsUpdate=!0,zs(A,q,ot),A.side=es,A.needsUpdate=!0,zs(A,q,ot),A.side=ma):zs(A,q,ot)}this.compile=function(A,q,ot=null){ot===null&&(ot=A),z=Ct.get(ot),z.init(q),F.push(z),ot.traverseVisible(function(J){J.isLight&&J.layers.test(q.layers)&&(z.pushLight(J),J.castShadow&&z.pushShadow(J))}),A!==ot&&A.traverseVisible(function(J){J.isLight&&J.layers.test(q.layers)&&(z.pushLight(J),J.castShadow&&z.pushShadow(J))}),z.setupLights();const at=new Set;return A.traverse(function(J){if(!(J.isMesh||J.isPoints||J.isLine||J.isSprite))return;const Pt=J.material;if(Pt)if(Array.isArray(Pt))for(let Zt=0;Zt<Pt.length;Zt++){const Bt=Pt[Zt];Vr(Bt,ot,J),at.add(Bt)}else Vr(Pt,ot,J),at.add(Pt)}),z=F.pop(),at},this.compileAsync=function(A,q,ot=null){const at=this.compile(A,q,ot);return new Promise(J=>{function Pt(){if(at.forEach(function(Zt){E.get(Zt).currentProgram.isReady()&&at.delete(Zt)}),at.size===0){J(A);return}setTimeout(Pt,10)}Ht.get("KHR_parallel_shader_compile")!==null?Pt():setTimeout(Pt,10)})};let Ls=null;function Xr(A){Ls&&Ls(A)}function Os(){wi.stop()}function kr(){wi.start()}const wi=new Iv;wi.setAnimationLoop(Xr),typeof self<"u"&&wi.setContext(self),this.setAnimationLoop=function(A){Ls=A,Nt.setAnimationLoop(A),A===null?wi.stop():wi.start()},Nt.addEventListener("sessionstart",Os),Nt.addEventListener("sessionend",kr),this.render=function(A,q){if(q!==void 0&&q.isCamera!==!0){we("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(w===!0)return;const ot=Nt.enabled===!0&&Nt.isPresenting===!0,at=Z!==null&&(it===null||ot)&&Z.begin(C,it);if(A.matrixWorldAutoUpdate===!0&&A.updateMatrixWorld(),q.parent===null&&q.matrixWorldAutoUpdate===!0&&q.updateMatrixWorld(),Nt.enabled===!0&&Nt.isPresenting===!0&&(Z===null||Z.isCompositing()===!1)&&(Nt.cameraAutoUpdate===!0&&Nt.updateCamera(q),q=Nt.getCamera()),A.isScene===!0&&A.onBeforeRender(C,A,q,it),z=Ct.get(A,F.length),z.init(q),F.push(z),Ue.multiplyMatrices(q.projectionMatrix,q.matrixWorldInverse),Gt.setFromProjectionMatrix(Ue,Fi,q.reversedDepth),ye=this.localClippingEnabled,qt=Yt.init(this.clippingPlanes,ye),U=Tt.get(A,I.length),U.init(),I.push(U),Nt.enabled===!0&&Nt.isPresenting===!0){const Zt=C.xr.getDepthSensingMesh();Zt!==null&&ai(Zt,q,-1/0,C.sortObjects)}ai(A,q,0,C.sortObjects),U.finish(),C.sortObjects===!0&&U.sort(Et,Rt),Mt=Nt.enabled===!1||Nt.isPresenting===!1||Nt.hasDepthSensing()===!1,Mt&&Ot.addToRenderList(U,A),this.info.render.frame++,qt===!0&&Yt.beginShadows();const J=z.state.shadowsArray;if(Vt.render(J,A,q),qt===!0&&Yt.endShadows(),this.info.autoReset===!0&&this.info.reset(),(at&&Z.hasRenderPass())===!1){const Zt=U.opaque,Bt=U.transmissive;if(z.setupLights(),q.isArrayCamera){const jt=q.cameras;if(Bt.length>0)for(let $t=0,re=jt.length;$t<re;$t++){const te=jt[$t];Sn(Zt,Bt,A,te)}Mt&&Ot.render(A);for(let $t=0,re=jt.length;$t<re;$t++){const te=jt[$t];on(U,A,te,te.viewport)}}else Bt.length>0&&Sn(Zt,Bt,A,q),Mt&&Ot.render(A),on(U,A,q)}it!==null&&nt===0&&(W.updateMultisampleRenderTarget(it),W.updateRenderTargetMipmap(it)),at&&Z.end(C),A.isScene===!0&&A.onAfterRender(C,A,q),Xt.resetDefaultState(),dt=-1,rt=null,F.pop(),F.length>0?(z=F[F.length-1],qt===!0&&Yt.setGlobalState(C.clippingPlanes,z.state.camera)):z=null,I.pop(),I.length>0?U=I[I.length-1]:U=null};function ai(A,q,ot,at){if(A.visible===!1)return;if(A.layers.test(q.layers)){if(A.isGroup)ot=A.renderOrder;else if(A.isLOD)A.autoUpdate===!0&&A.update(q);else if(A.isLight)z.pushLight(A),A.castShadow&&z.pushShadow(A);else if(A.isSprite){if(!A.frustumCulled||Gt.intersectsSprite(A)){at&&gt.setFromMatrixPosition(A.matrixWorld).applyMatrix4(Ue);const Zt=Lt.update(A),Bt=A.material;Bt.visible&&U.push(A,Zt,Bt,ot,gt.z,null)}}else if((A.isMesh||A.isLine||A.isPoints)&&(!A.frustumCulled||Gt.intersectsObject(A))){const Zt=Lt.update(A),Bt=A.material;if(at&&(A.boundingSphere!==void 0?(A.boundingSphere===null&&A.computeBoundingSphere(),gt.copy(A.boundingSphere.center)):(Zt.boundingSphere===null&&Zt.computeBoundingSphere(),gt.copy(Zt.boundingSphere.center)),gt.applyMatrix4(A.matrixWorld).applyMatrix4(Ue)),Array.isArray(Bt)){const jt=Zt.groups;for(let $t=0,re=jt.length;$t<re;$t++){const te=jt[$t],ce=Bt[te.materialIndex];ce&&ce.visible&&U.push(A,Zt,ce,ot,gt.z,te)}}else Bt.visible&&U.push(A,Zt,Bt,ot,gt.z,null)}}const Pt=A.children;for(let Zt=0,Bt=Pt.length;Zt<Bt;Zt++)ai(Pt[Zt],q,ot,at)}function on(A,q,ot,at){const{opaque:J,transmissive:Pt,transparent:Zt}=A;z.setupLightsView(ot),qt===!0&&Yt.setGlobalState(C.clippingPlanes,ot),at&&Ut.viewport(B.copy(at)),J.length>0&&_i(J,q,ot),Pt.length>0&&_i(Pt,q,ot),Zt.length>0&&_i(Zt,q,ot),Ut.buffers.depth.setTest(!0),Ut.buffers.depth.setMask(!0),Ut.buffers.color.setMask(!0),Ut.setPolygonOffset(!1)}function Sn(A,q,ot,at){if((ot.isScene===!0?ot.overrideMaterial:null)!==null)return;if(z.state.transmissionRenderTarget[at.id]===void 0){const ce=Ht.has("EXT_color_buffer_half_float")||Ht.has("EXT_color_buffer_float");z.state.transmissionRenderTarget[at.id]=new Ii(1,1,{generateMipmaps:!0,type:ce?xa:ii,minFilter:ws,samples:ae.samples,stencilBuffer:c,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:De.workingColorSpace})}const Pt=z.state.transmissionRenderTarget[at.id],Zt=at.viewport||B;Pt.setSize(Zt.z*C.transmissionResolutionScale,Zt.w*C.transmissionResolutionScale);const Bt=C.getRenderTarget(),jt=C.getActiveCubeFace(),$t=C.getActiveMipmapLevel();C.setRenderTarget(Pt),C.getClearColor(yt),xt=C.getClearAlpha(),xt<1&&C.setClearColor(16777215,.5),C.clear(),Mt&&Ot.render(ot);const re=C.toneMapping;C.toneMapping=Bi;const te=at.viewport;if(at.viewport!==void 0&&(at.viewport=void 0),z.setupLightsView(at),qt===!0&&Yt.setGlobalState(C.clippingPlanes,at),_i(A,ot,at),W.updateMultisampleRenderTarget(Pt),W.updateRenderTargetMipmap(Pt),Ht.has("WEBGL_multisampled_render_to_texture")===!1){let ce=!1;for(let Oe=0,Je=q.length;Oe<Je;Oe++){const Ze=q[Oe],{object:Be,geometry:ie,material:Pe,group:de}=Ze;if(Pe.side===ma&&Be.layers.test(at.layers)){const yn=Pe.side;Pe.side=qn,Pe.needsUpdate=!0,Ps(Be,ot,at,ie,Pe,de),Pe.side=yn,Pe.needsUpdate=!0,ce=!0}}ce===!0&&(W.updateMultisampleRenderTarget(Pt),W.updateRenderTargetMipmap(Pt))}C.setRenderTarget(Bt,jt,$t),C.setClearColor(yt,xt),te!==void 0&&(at.viewport=te),C.toneMapping=re}function _i(A,q,ot){const at=q.isScene===!0?q.overrideMaterial:null;for(let J=0,Pt=A.length;J<Pt;J++){const Zt=A[J],{object:Bt,geometry:jt,group:$t}=Zt;let re=Zt.material;re.allowOverride===!0&&at!==null&&(re=at),Bt.layers.test(ot.layers)&&Ps(Bt,q,ot,jt,re,$t)}}function Ps(A,q,ot,at,J,Pt){A.onBeforeRender(C,q,ot,at,J,Pt),A.modelViewMatrix.multiplyMatrices(ot.matrixWorldInverse,A.matrixWorld),A.normalMatrix.getNormalMatrix(A.modelViewMatrix),J.onBeforeRender(C,q,ot,at,A,Pt),J.transparent===!0&&J.side===ma&&J.forceSinglePass===!1?(J.side=qn,J.needsUpdate=!0,C.renderBufferDirect(ot,q,at,J,A,Pt),J.side=es,J.needsUpdate=!0,C.renderBufferDirect(ot,q,at,J,A,Pt),J.side=ma):C.renderBufferDirect(ot,q,at,J,A,Pt),A.onAfterRender(C,q,ot,at,J,Pt)}function zs(A,q,ot){q.isScene!==!0&&(q=At);const at=E.get(A),J=z.state.lights,Pt=z.state.shadowsArray,Zt=J.state.version,Bt=Jt.getParameters(A,J.state,Pt,q,ot),jt=Jt.getProgramCacheKey(Bt);let $t=at.programs;at.environment=A.isMeshStandardMaterial?q.environment:null,at.fog=q.fog,at.envMap=(A.isMeshStandardMaterial?St:ut).get(A.envMap||at.environment),at.envMapRotation=at.environment!==null&&A.envMap===null?q.environmentRotation:A.envMapRotation,$t===void 0&&(A.addEventListener("dispose",Un),$t=new Map,at.programs=$t);let re=$t.get(jt);if(re!==void 0){if(at.currentProgram===re&&at.lightsStateVersion===Zt)return Wr(A,Bt),re}else Bt.uniforms=Jt.getUniforms(A),A.onBeforeCompile(Bt,C),re=Jt.acquireProgram(Bt,jt),$t.set(jt,re),at.uniforms=Bt.uniforms;const te=at.uniforms;return(!A.isShaderMaterial&&!A.isRawShaderMaterial||A.clipping===!0)&&(te.clippingPlanes=Yt.uniform),Wr(A,Bt),at.needsLights=ya(A),at.lightsStateVersion=Zt,at.needsLights&&(te.ambientLightColor.value=J.state.ambient,te.lightProbe.value=J.state.probe,te.directionalLights.value=J.state.directional,te.directionalLightShadows.value=J.state.directionalShadow,te.spotLights.value=J.state.spot,te.spotLightShadows.value=J.state.spotShadow,te.rectAreaLights.value=J.state.rectArea,te.ltc_1.value=J.state.rectAreaLTC1,te.ltc_2.value=J.state.rectAreaLTC2,te.pointLights.value=J.state.point,te.pointLightShadows.value=J.state.pointShadow,te.hemisphereLights.value=J.state.hemi,te.directionalShadowMap.value=J.state.directionalShadowMap,te.directionalShadowMatrix.value=J.state.directionalShadowMatrix,te.spotShadowMap.value=J.state.spotShadowMap,te.spotLightMatrix.value=J.state.spotLightMatrix,te.spotLightMap.value=J.state.spotLightMap,te.pointShadowMap.value=J.state.pointShadowMap,te.pointShadowMatrix.value=J.state.pointShadowMatrix),at.currentProgram=re,at.uniformsList=null,re}function ll(A){if(A.uniformsList===null){const q=A.currentProgram.getUniforms();A.uniformsList=Yc.seqWithValue(q.seq,A.uniforms)}return A.uniformsList}function Wr(A,q){const ot=E.get(A);ot.outputColorSpace=q.outputColorSpace,ot.batching=q.batching,ot.batchingColor=q.batchingColor,ot.instancing=q.instancing,ot.instancingColor=q.instancingColor,ot.instancingMorph=q.instancingMorph,ot.skinning=q.skinning,ot.morphTargets=q.morphTargets,ot.morphNormals=q.morphNormals,ot.morphColors=q.morphColors,ot.morphTargetsCount=q.morphTargetsCount,ot.numClippingPlanes=q.numClippingPlanes,ot.numIntersection=q.numClipIntersection,ot.vertexAlphas=q.vertexAlphas,ot.vertexTangents=q.vertexTangents,ot.toneMapping=q.toneMapping}function ns(A,q,ot,at,J){q.isScene!==!0&&(q=At),W.resetTextureUnits();const Pt=q.fog,Zt=at.isMeshStandardMaterial?q.environment:null,Bt=it===null?C.outputColorSpace:it.isXRRenderTarget===!0?it.texture.colorSpace:zr,jt=(at.isMeshStandardMaterial?St:ut).get(at.envMap||Zt),$t=at.vertexColors===!0&&!!ot.attributes.color&&ot.attributes.color.itemSize===4,re=!!ot.attributes.tangent&&(!!at.normalMap||at.anisotropy>0),te=!!ot.morphAttributes.position,ce=!!ot.morphAttributes.normal,Oe=!!ot.morphAttributes.color;let Je=Bi;at.toneMapped&&(it===null||it.isXRRenderTarget===!0)&&(Je=C.toneMapping);const Ze=ot.morphAttributes.position||ot.morphAttributes.normal||ot.morphAttributes.color,Be=Ze!==void 0?Ze.length:0,ie=E.get(at),Pe=z.state.lights;if(qt===!0&&(ye===!0||A!==rt)){const Tn=A===rt&&at.id===dt;Yt.setState(at,A,Tn)}let de=!1;at.version===ie.__version?(ie.needsLights&&ie.lightsStateVersion!==Pe.state.version||ie.outputColorSpace!==Bt||J.isBatchedMesh&&ie.batching===!1||!J.isBatchedMesh&&ie.batching===!0||J.isBatchedMesh&&ie.batchingColor===!0&&J.colorTexture===null||J.isBatchedMesh&&ie.batchingColor===!1&&J.colorTexture!==null||J.isInstancedMesh&&ie.instancing===!1||!J.isInstancedMesh&&ie.instancing===!0||J.isSkinnedMesh&&ie.skinning===!1||!J.isSkinnedMesh&&ie.skinning===!0||J.isInstancedMesh&&ie.instancingColor===!0&&J.instanceColor===null||J.isInstancedMesh&&ie.instancingColor===!1&&J.instanceColor!==null||J.isInstancedMesh&&ie.instancingMorph===!0&&J.morphTexture===null||J.isInstancedMesh&&ie.instancingMorph===!1&&J.morphTexture!==null||ie.envMap!==jt||at.fog===!0&&ie.fog!==Pt||ie.numClippingPlanes!==void 0&&(ie.numClippingPlanes!==Yt.numPlanes||ie.numIntersection!==Yt.numIntersection)||ie.vertexAlphas!==$t||ie.vertexTangents!==re||ie.morphTargets!==te||ie.morphNormals!==ce||ie.morphColors!==Oe||ie.toneMapping!==Je||ie.morphTargetsCount!==Be)&&(de=!0):(de=!0,ie.__version=at.version);let yn=ie.currentProgram;de===!0&&(yn=zs(at,q,J));let qi=!1,Mn=!1,si=!1;const He=yn.getUniforms(),En=ie.uniforms;if(Ut.useProgram(yn.program)&&(qi=!0,Mn=!0,si=!0),at.id!==dt&&(dt=at.id,Mn=!0),qi||rt!==A){Ut.buffers.depth.getReversed()&&A.reversedDepth!==!0&&(A._reversedDepth=!0,A.updateProjectionMatrix()),He.setValue(P,"projectionMatrix",A.projectionMatrix),He.setValue(P,"viewMatrix",A.matrixWorldInverse);const bn=He.map.cameraPosition;bn!==void 0&&bn.setValue(P,fe.setFromMatrixPosition(A.matrixWorld)),ae.logarithmicDepthBuffer&&He.setValue(P,"logDepthBufFC",2/(Math.log(A.far+1)/Math.LN2)),(at.isMeshPhongMaterial||at.isMeshToonMaterial||at.isMeshLambertMaterial||at.isMeshBasicMaterial||at.isMeshStandardMaterial||at.isShaderMaterial)&&He.setValue(P,"isOrthographic",A.isOrthographicCamera===!0),rt!==A&&(rt=A,Mn=!0,si=!0)}if(ie.needsLights&&(Pe.state.directionalShadowMap.length>0&&He.setValue(P,"directionalShadowMap",Pe.state.directionalShadowMap,W),Pe.state.spotShadowMap.length>0&&He.setValue(P,"spotShadowMap",Pe.state.spotShadowMap,W),Pe.state.pointShadowMap.length>0&&He.setValue(P,"pointShadowMap",Pe.state.pointShadowMap,W)),J.isSkinnedMesh){He.setOptional(P,J,"bindMatrix"),He.setOptional(P,J,"bindMatrixInverse");const Tn=J.skeleton;Tn&&(Tn.boneTexture===null&&Tn.computeBoneTexture(),He.setValue(P,"boneTexture",Tn.boneTexture,W))}J.isBatchedMesh&&(He.setOptional(P,J,"batchingTexture"),He.setValue(P,"batchingTexture",J._matricesTexture,W),He.setOptional(P,J,"batchingIdTexture"),He.setValue(P,"batchingIdTexture",J._indirectTexture,W),He.setOptional(P,J,"batchingColorTexture"),J._colorsTexture!==null&&He.setValue(P,"batchingColorTexture",J._colorsTexture,W));const dn=ot.morphAttributes;if((dn.position!==void 0||dn.normal!==void 0||dn.color!==void 0)&&_e.update(J,ot,yn),(Mn||ie.receiveShadow!==J.receiveShadow)&&(ie.receiveShadow=J.receiveShadow,He.setValue(P,"receiveShadow",J.receiveShadow)),at.isMeshGouraudMaterial&&at.envMap!==null&&(En.envMap.value=jt,En.flipEnvMap.value=jt.isCubeTexture&&jt.isRenderTargetTexture===!1?-1:1),at.isMeshStandardMaterial&&at.envMap===null&&q.environment!==null&&(En.envMapIntensity.value=q.environmentIntensity),En.dfgLUT!==void 0&&(En.dfgLUT.value=lR()),Mn&&(He.setValue(P,"toneMappingExposure",C.toneMappingExposure),ie.needsLights&&qr(En,si),Pt&&at.fog===!0&&le.refreshFogUniforms(En,Pt),le.refreshMaterialUniforms(En,at,ft,K,z.state.transmissionRenderTarget[A.id]),Yc.upload(P,ll(ie),En,W)),at.isShaderMaterial&&at.uniformsNeedUpdate===!0&&(Yc.upload(P,ll(ie),En,W),at.uniformsNeedUpdate=!1),at.isSpriteMaterial&&He.setValue(P,"center",J.center),He.setValue(P,"modelViewMatrix",J.modelViewMatrix),He.setValue(P,"normalMatrix",J.normalMatrix),He.setValue(P,"modelMatrix",J.matrixWorld),at.isShaderMaterial||at.isRawShaderMaterial){const Tn=at.uniformsGroups;for(let bn=0,Fs=Tn.length;bn<Fs;bn++){const vi=Tn[bn];bt.update(vi,yn),bt.bind(vi,yn)}}return yn}function qr(A,q){A.ambientLightColor.needsUpdate=q,A.lightProbe.needsUpdate=q,A.directionalLights.needsUpdate=q,A.directionalLightShadows.needsUpdate=q,A.pointLights.needsUpdate=q,A.pointLightShadows.needsUpdate=q,A.spotLights.needsUpdate=q,A.spotLightShadows.needsUpdate=q,A.rectAreaLights.needsUpdate=q,A.hemisphereLights.needsUpdate=q}function ya(A){return A.isMeshLambertMaterial||A.isMeshToonMaterial||A.isMeshPhongMaterial||A.isMeshStandardMaterial||A.isShadowMaterial||A.isShaderMaterial&&A.lights===!0}this.getActiveCubeFace=function(){return V},this.getActiveMipmapLevel=function(){return nt},this.getRenderTarget=function(){return it},this.setRenderTargetTextures=function(A,q,ot){const at=E.get(A);at.__autoAllocateDepthBuffer=A.resolveDepthBuffer===!1,at.__autoAllocateDepthBuffer===!1&&(at.__useRenderToTexture=!1),E.get(A.texture).__webglTexture=q,E.get(A.depthTexture).__webglTexture=at.__autoAllocateDepthBuffer?void 0:ot,at.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(A,q){const ot=E.get(A);ot.__webglFramebuffer=q,ot.__useDefaultFramebuffer=q===void 0};const Ma=P.createFramebuffer();this.setRenderTarget=function(A,q=0,ot=0){it=A,V=q,nt=ot;let at=null,J=!1,Pt=!1;if(A){const Bt=E.get(A);if(Bt.__useDefaultFramebuffer!==void 0){Ut.bindFramebuffer(P.FRAMEBUFFER,Bt.__webglFramebuffer),B.copy(A.viewport),H.copy(A.scissor),$=A.scissorTest,Ut.viewport(B),Ut.scissor(H),Ut.setScissorTest($),dt=-1;return}else if(Bt.__webglFramebuffer===void 0)W.setupRenderTarget(A);else if(Bt.__hasExternalTextures)W.rebindTextures(A,E.get(A.texture).__webglTexture,E.get(A.depthTexture).__webglTexture);else if(A.depthBuffer){const re=A.depthTexture;if(Bt.__boundDepthTexture!==re){if(re!==null&&E.has(re)&&(A.width!==re.image.width||A.height!==re.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");W.setupDepthRenderbuffer(A)}}const jt=A.texture;(jt.isData3DTexture||jt.isDataArrayTexture||jt.isCompressedArrayTexture)&&(Pt=!0);const $t=E.get(A).__webglFramebuffer;A.isWebGLCubeRenderTarget?(Array.isArray($t[q])?at=$t[q][ot]:at=$t[q],J=!0):A.samples>0&&W.useMultisampledRTT(A)===!1?at=E.get(A).__webglMultisampledFramebuffer:Array.isArray($t)?at=$t[ot]:at=$t,B.copy(A.viewport),H.copy(A.scissor),$=A.scissorTest}else B.copy(Q).multiplyScalar(ft).floor(),H.copy(ct).multiplyScalar(ft).floor(),$=Dt;if(ot!==0&&(at=Ma),Ut.bindFramebuffer(P.FRAMEBUFFER,at)&&Ut.drawBuffers(A,at),Ut.viewport(B),Ut.scissor(H),Ut.setScissorTest($),J){const Bt=E.get(A.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_CUBE_MAP_POSITIVE_X+q,Bt.__webglTexture,ot)}else if(Pt){const Bt=q;for(let jt=0;jt<A.textures.length;jt++){const $t=E.get(A.textures[jt]);P.framebufferTextureLayer(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0+jt,$t.__webglTexture,ot,Bt)}}else if(A!==null&&ot!==0){const Bt=E.get(A.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,Bt.__webglTexture,ot)}dt=-1},this.readRenderTargetPixels=function(A,q,ot,at,J,Pt,Zt,Bt=0){if(!(A&&A.isWebGLRenderTarget)){we("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let jt=E.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&Zt!==void 0&&(jt=jt[Zt]),jt){Ut.bindFramebuffer(P.FRAMEBUFFER,jt);try{const $t=A.textures[Bt],re=$t.format,te=$t.type;if(!ae.textureFormatReadable(re)){we("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!ae.textureTypeReadable(te)){we("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}q>=0&&q<=A.width-at&&ot>=0&&ot<=A.height-J&&(A.textures.length>1&&P.readBuffer(P.COLOR_ATTACHMENT0+Bt),P.readPixels(q,ot,at,J,wt.convert(re),wt.convert(te),Pt))}finally{const $t=it!==null?E.get(it).__webglFramebuffer:null;Ut.bindFramebuffer(P.FRAMEBUFFER,$t)}}},this.readRenderTargetPixelsAsync=async function(A,q,ot,at,J,Pt,Zt,Bt=0){if(!(A&&A.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let jt=E.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&Zt!==void 0&&(jt=jt[Zt]),jt)if(q>=0&&q<=A.width-at&&ot>=0&&ot<=A.height-J){Ut.bindFramebuffer(P.FRAMEBUFFER,jt);const $t=A.textures[Bt],re=$t.format,te=$t.type;if(!ae.textureFormatReadable(re))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!ae.textureTypeReadable(te))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const ce=P.createBuffer();P.bindBuffer(P.PIXEL_PACK_BUFFER,ce),P.bufferData(P.PIXEL_PACK_BUFFER,Pt.byteLength,P.STREAM_READ),A.textures.length>1&&P.readBuffer(P.COLOR_ATTACHMENT0+Bt),P.readPixels(q,ot,at,J,wt.convert(re),wt.convert(te),0);const Oe=it!==null?E.get(it).__webglFramebuffer:null;Ut.bindFramebuffer(P.FRAMEBUFFER,Oe);const Je=P.fenceSync(P.SYNC_GPU_COMMANDS_COMPLETE,0);return P.flush(),await Yy(P,Je,4),P.bindBuffer(P.PIXEL_PACK_BUFFER,ce),P.getBufferSubData(P.PIXEL_PACK_BUFFER,0,Pt),P.deleteBuffer(ce),P.deleteSync(Je),Pt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(A,q=null,ot=0){const at=Math.pow(2,-ot),J=Math.floor(A.image.width*at),Pt=Math.floor(A.image.height*at),Zt=q!==null?q.x:0,Bt=q!==null?q.y:0;W.setTexture2D(A,0),P.copyTexSubImage2D(P.TEXTURE_2D,ot,0,0,Zt,Bt,J,Pt),Ut.unbindTexture()};const is=P.createFramebuffer(),Ea=P.createFramebuffer();this.copyTextureToTexture=function(A,q,ot=null,at=null,J=0,Pt=null){Pt===null&&(J!==0?(Jo("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),Pt=J,J=0):Pt=0);let Zt,Bt,jt,$t,re,te,ce,Oe,Je;const Ze=A.isCompressedTexture?A.mipmaps[Pt]:A.image;if(ot!==null)Zt=ot.max.x-ot.min.x,Bt=ot.max.y-ot.min.y,jt=ot.isBox3?ot.max.z-ot.min.z:1,$t=ot.min.x,re=ot.min.y,te=ot.isBox3?ot.min.z:0;else{const dn=Math.pow(2,-J);Zt=Math.floor(Ze.width*dn),Bt=Math.floor(Ze.height*dn),A.isDataArrayTexture?jt=Ze.depth:A.isData3DTexture?jt=Math.floor(Ze.depth*dn):jt=1,$t=0,re=0,te=0}at!==null?(ce=at.x,Oe=at.y,Je=at.z):(ce=0,Oe=0,Je=0);const Be=wt.convert(q.format),ie=wt.convert(q.type);let Pe;q.isData3DTexture?(W.setTexture3D(q,0),Pe=P.TEXTURE_3D):q.isDataArrayTexture||q.isCompressedArrayTexture?(W.setTexture2DArray(q,0),Pe=P.TEXTURE_2D_ARRAY):(W.setTexture2D(q,0),Pe=P.TEXTURE_2D),P.pixelStorei(P.UNPACK_FLIP_Y_WEBGL,q.flipY),P.pixelStorei(P.UNPACK_PREMULTIPLY_ALPHA_WEBGL,q.premultiplyAlpha),P.pixelStorei(P.UNPACK_ALIGNMENT,q.unpackAlignment);const de=P.getParameter(P.UNPACK_ROW_LENGTH),yn=P.getParameter(P.UNPACK_IMAGE_HEIGHT),qi=P.getParameter(P.UNPACK_SKIP_PIXELS),Mn=P.getParameter(P.UNPACK_SKIP_ROWS),si=P.getParameter(P.UNPACK_SKIP_IMAGES);P.pixelStorei(P.UNPACK_ROW_LENGTH,Ze.width),P.pixelStorei(P.UNPACK_IMAGE_HEIGHT,Ze.height),P.pixelStorei(P.UNPACK_SKIP_PIXELS,$t),P.pixelStorei(P.UNPACK_SKIP_ROWS,re),P.pixelStorei(P.UNPACK_SKIP_IMAGES,te);const He=A.isDataArrayTexture||A.isData3DTexture,En=q.isDataArrayTexture||q.isData3DTexture;if(A.isDepthTexture){const dn=E.get(A),Tn=E.get(q),bn=E.get(dn.__renderTarget),Fs=E.get(Tn.__renderTarget);Ut.bindFramebuffer(P.READ_FRAMEBUFFER,bn.__webglFramebuffer),Ut.bindFramebuffer(P.DRAW_FRAMEBUFFER,Fs.__webglFramebuffer);for(let vi=0;vi<jt;vi++)He&&(P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,E.get(A).__webglTexture,J,te+vi),P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,E.get(q).__webglTexture,Pt,Je+vi)),P.blitFramebuffer($t,re,Zt,Bt,ce,Oe,Zt,Bt,P.DEPTH_BUFFER_BIT,P.NEAREST);Ut.bindFramebuffer(P.READ_FRAMEBUFFER,null),Ut.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else if(J!==0||A.isRenderTargetTexture||E.has(A)){const dn=E.get(A),Tn=E.get(q);Ut.bindFramebuffer(P.READ_FRAMEBUFFER,is),Ut.bindFramebuffer(P.DRAW_FRAMEBUFFER,Ea);for(let bn=0;bn<jt;bn++)He?P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,dn.__webglTexture,J,te+bn):P.framebufferTexture2D(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,dn.__webglTexture,J),En?P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,Tn.__webglTexture,Pt,Je+bn):P.framebufferTexture2D(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,Tn.__webglTexture,Pt),J!==0?P.blitFramebuffer($t,re,Zt,Bt,ce,Oe,Zt,Bt,P.COLOR_BUFFER_BIT,P.NEAREST):En?P.copyTexSubImage3D(Pe,Pt,ce,Oe,Je+bn,$t,re,Zt,Bt):P.copyTexSubImage2D(Pe,Pt,ce,Oe,$t,re,Zt,Bt);Ut.bindFramebuffer(P.READ_FRAMEBUFFER,null),Ut.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else En?A.isDataTexture||A.isData3DTexture?P.texSubImage3D(Pe,Pt,ce,Oe,Je,Zt,Bt,jt,Be,ie,Ze.data):q.isCompressedArrayTexture?P.compressedTexSubImage3D(Pe,Pt,ce,Oe,Je,Zt,Bt,jt,Be,Ze.data):P.texSubImage3D(Pe,Pt,ce,Oe,Je,Zt,Bt,jt,Be,ie,Ze):A.isDataTexture?P.texSubImage2D(P.TEXTURE_2D,Pt,ce,Oe,Zt,Bt,Be,ie,Ze.data):A.isCompressedTexture?P.compressedTexSubImage2D(P.TEXTURE_2D,Pt,ce,Oe,Ze.width,Ze.height,Be,Ze.data):P.texSubImage2D(P.TEXTURE_2D,Pt,ce,Oe,Zt,Bt,Be,ie,Ze);P.pixelStorei(P.UNPACK_ROW_LENGTH,de),P.pixelStorei(P.UNPACK_IMAGE_HEIGHT,yn),P.pixelStorei(P.UNPACK_SKIP_PIXELS,qi),P.pixelStorei(P.UNPACK_SKIP_ROWS,Mn),P.pixelStorei(P.UNPACK_SKIP_IMAGES,si),Pt===0&&q.generateMipmaps&&P.generateMipmap(Pe),Ut.unbindTexture()},this.initRenderTarget=function(A){E.get(A).__webglFramebuffer===void 0&&W.setupRenderTarget(A)},this.initTexture=function(A){A.isCubeTexture?W.setTextureCube(A,0):A.isData3DTexture?W.setTexture3D(A,0):A.isDataArrayTexture||A.isCompressedArrayTexture?W.setTexture2DArray(A,0):W.setTexture2D(A,0),Ut.unbindTexture()},this.resetState=function(){V=0,nt=0,it=null,Ut.reset(),Xt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Fi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const i=this.getContext();i.drawingBufferColorSpace=De._getDrawingBufferColorSpace(t),i.unpackColorSpace=De._getUnpackColorSpace()}}const uR=2e3,Q_=2.4,Gc=5,$_=.25,fR=.3,tv=.15;function hR(r,t,i){const s=new Lv,l=r/2,c=t/2;return s.moveTo(-l+i,-c),s.lineTo(l-i,-c),s.quadraticCurveTo(l,-c,l,-c+i),s.lineTo(l,c-i),s.quadraticCurveTo(l,c,l-i,c),s.lineTo(-l+i,c),s.quadraticCurveTo(-l,c,-l,c-i),s.lineTo(-l,-c+i),s.quadraticCurveTo(-l,-c,-l+i,-c),s}function dR({selectedSession:r}){const t=oe.useRef(null),i=oe.useRef(null);return oe.useEffect(()=>{const s=i.current;s&&s.readyState===WebSocket.OPEN&&s.send(JSON.stringify({type:"select",session:r}))},[r]),oe.useEffect(()=>{const s=t.current;if(!s)return;const l=new xM,c=new mi(35,3/4,.1,100);c.position.set(0,0,10),c.lookAt(0,0,0);const f=new cR({antialias:!0,alpha:!0});f.setPixelRatio(Math.min(window.devicePixelRatio,2)),s.appendChild(f.domElement),l.add(new hE(16777215,.6));const d=new fE(16777215,.8);d.position.set(3,5,8),l.add(d);const m=new wr;l.add(m);const p=new wr;m.add(p);const _=document.createElement("canvas");_.width=540,_.height=1170;const g=_.getContext("2d");g.fillStyle="#111",g.fillRect(0,0,_.width,_.height);const v=new TM(_);v.colorSpace=ni,v.minFilter=xn,v.magFilter=xn;const y=new rE({color:1710638,metalness:.3,roughness:.7}),T=new tp({map:v});let R=null,M=null,S=null,L=null,D=Q_,U=Gc;function z(K,ft){R&&(p.remove(R),S.dispose()),M&&(p.remove(M),L.dispose()),D=K,U=ft;const Et=hR(K,ft,fR);S=new ap(Et,{depth:$_,bevelEnabled:!0,bevelThickness:.04,bevelSize:.04,bevelSegments:3}),S.center(),R=new Ci(S,y),p.add(R);const Rt=K-tv*2,Q=ft-tv*2;L=new rl(Rt,Q),M=new Ci(L,T),M.position.z=($_+.08)/2+.01,p.add(M),_.width=Math.round(Rt*200),_.height=Math.round(Q*200),g.fillStyle="#111",g.fillRect(0,0,_.width,_.height),v.dispose(),v.needsUpdate=!0,nt()}const I=.85;let F=0,Z=0,C=0;const w=[0,Math.PI/2,Math.PI,-Math.PI/2];let V=10;function nt(){const ft=(F===1||F===3?U:D)*I,Et=Math.atan(Math.tan(c.fov/2*Math.PI/180)*c.aspect);V=ft/2/Math.tan(Et)}z(Q_,Gc),p.scale.setScalar(I);function it(){const K=s.clientWidth,ft=s.clientHeight;K===0||ft===0||(c.aspect=K/ft,c.updateProjectionMatrix(),f.setSize(K,ft),nt())}it();const dt=new ResizeObserver(it);dt.observe(s);let rt=performance.now(),B=0;function H(){B=requestAnimationFrame(H);const K=performance.now(),ft=Math.min((K-rt)/1e3,.1);rt=K;const Et=1-Math.exp(-8*ft);let Rt=Z-C;Rt>Math.PI&&(Rt-=2*Math.PI),Rt<-Math.PI&&(Rt+=2*Math.PI),C+=Rt*Et,m.rotation.z=C,c.position.z+=(V-c.position.z)*Et,f.render(l,c)}H();let $=null,yt=null,xt=!1;function O(){if(xt)return;const ft=`${window.location.protocol==="https:"?"wss:":"ws:"}//${window.location.host}/ws/preview`;$=new WebSocket(ft),i.current=$,$.binaryType="arraybuffer",$.onopen=()=>{$.send(JSON.stringify({type:"select",session:r}))},$.onclose=()=>{i.current=null,xt||(yt=setTimeout(O,uR))},$.onerror=()=>{},$.onmessage=Et=>{if(typeof Et.data=="string")try{const Rt=JSON.parse(Et.data);if(Rt.type==="device"){const Q=Math.min(Rt.w,Rt.h),ct=Math.max(Rt.w,Rt.h),Dt=Q/ct;z(Gc*Dt,Gc)}if(Rt.type==="orient"&&Rt.o!==void 0){const Q=Rt.o;if(Q!==F){F=Q,Z=w[F],nt();const ct=F===1||F===3,Dt=s==null?void 0:s.closest(".preview-column");Dt&&(Dt.style.width=ct?`${Math.round(400*U/D)}px`:"400px")}}}catch{}else{const Rt=new Blob([Et.data],{type:"image/jpeg"});createImageBitmap(Rt).then(Q=>{const ct=F===1||F===3;if(g.clearRect(0,0,_.width,_.height),ct){const Dt=w[F];g.save(),g.translate(_.width/2,_.height/2),g.rotate(Dt),g.drawImage(Q,-_.height/2,-_.width/2,_.height,_.width),g.restore()}else F===2?(g.save(),g.translate(_.width/2,_.height/2),g.rotate(w[2]),g.drawImage(Q,-_.width/2,-_.height/2,_.width,_.height),g.restore()):g.drawImage(Q,0,0,_.width,_.height);v.needsUpdate=!0,Q.close()})}}}return O(),()=>{xt=!0,yt&&clearTimeout(yt),$&&($.onclose=null,$.close(),i.current=null),cancelAnimationFrame(B),dt.disconnect(),f.dispose(),S&&S.dispose(),y.dispose(),L&&L.dispose(),T.dispose(),v.dispose(),s.contains(f.domElement)&&s.removeChild(f.domElement)}},[]),kt.jsx("div",{className:"phone-preview",ref:t})}function pR({sessions:r,selected:t,onSelect:i}){return r.length===0?null:kt.jsxs("div",{className:"session-list",children:[kt.jsx("h2",{className:"session-title",children:"Sessions"}),kt.jsxs("div",{className:"session-items",children:[kt.jsxs("button",{className:`session-item ${t===null?"selected":""}`,onClick:()=>i(null),children:[kt.jsx("span",{className:"session-dot all"}),kt.jsx("span",{className:"session-name",children:"All"})]}),r.map(s=>kt.jsxs("button",{className:`session-item ${t===s.id?"selected":""} ${s.active?"":"inactive"}`,onClick:()=>i(s.id),children:[kt.jsx("span",{className:`session-dot ${s.active?"active":"dead"}`}),kt.jsx("span",{className:"session-name",children:s.id})]},s.id))]})]})}function mR(){const[r,t]=oe.useState(!1),[i,s]=oe.useState(!1),[l,c]=oe.useState(!1),f=oe.useRef(!1),[d,m]=oe.useState("ge"),p=oe.useRef(!1),[_,g]=oe.useState([]),[v,y]=oe.useState(null),T=oe.useCallback(L=>{g(D=>D.find(z=>z.id===L)?D.map(z=>z.id===L?{...z,active:!0}:z):[...D,{id:L,active:!0}])},[]),R=oe.useCallback(L=>{g(D=>D.map(U=>U.id===L?{...U,active:!1}:U))},[]);oe.useEffect(()=>{fetch("/api/info").then(L=>L.json()).then(L=>{if(L.name){m(L.name);const D=window.location.port;document.title=D?`${L.name} :${D}`:L.name}}).catch(()=>{})},[]);const M=oe.useCallback(()=>{c(!0),p.current=!0,s(!1),fetch("/api/stop",{method:"POST"}).catch(()=>{})},[]);oe.useEffect(()=>{const L=()=>{p.current||navigator.sendBeacon("/api/stop")};return window.addEventListener("pagehide",L),()=>window.removeEventListener("pagehide",L)},[]);const S=oe.useCallback(L=>{f.current=L,s(!0)},[]);return oe.useEffect(()=>{const L=D=>{if(D.key==="c"&&(D.ctrlKey||D.metaKey)){if(D.preventDefault(),l)return;i&&f.current?M():i||S(!0)}else D.key==="Escape"&&i&&s(!1)};return window.addEventListener("keydown",L),()=>window.removeEventListener("keydown",L)},[i,l,M,S]),kt.jsxs("div",{className:"app",children:[kt.jsxs("header",{className:"header",children:[kt.jsx("h1",{className:"title",children:d}),kt.jsx("button",{className:"stop-btn",onClick:()=>S(!1),disabled:l,title:"Stop server (Ctrl-C)",children:l?"Stopped":"Stop"}),kt.jsx("span",{className:`status-dot ${r?"connected":"disconnected"}`}),kt.jsx("span",{className:"status-text",children:r?"connected":"disconnected"})]}),kt.jsxs("div",{className:"layout",children:[kt.jsxs("aside",{className:"sidebar",children:[kt.jsx(ay,{}),kt.jsx(pR,{sessions:_,selected:v,onSelect:y}),kt.jsx(dy,{})]}),kt.jsx("main",{className:"main",children:kt.jsx(uy,{onConnectionChange:t,sessionFilter:v,onSessionAdd:T,onSessionRemove:R})}),kt.jsx("aside",{className:"preview-column",children:kt.jsx(dR,{selectedSession:v})})]}),i&&kt.jsx("div",{className:"confirm-overlay",onClick:()=>s(!1),children:kt.jsxs("div",{className:"confirm-dialog",onClick:L=>L.stopPropagation(),children:[kt.jsx("p",{className:"confirm-text",children:"Stop the game server?"}),f.current&&kt.jsx("p",{className:"confirm-hint",children:"Ctrl-C again to confirm"}),kt.jsxs("div",{className:"confirm-actions",children:[kt.jsx("button",{className:"confirm-btn confirm-btn-stop",onClick:M,children:"Stop Server"}),kt.jsx("button",{className:"confirm-btn confirm-btn-cancel",onClick:()=>s(!1),children:"Cancel"})]})]})})]})}iy.createRoot(document.getElementById("root")).render(kt.jsx(oe.StrictMode,{children:kt.jsx(mR,{})}));
